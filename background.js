...
`);
  ...
  var n = { defaultTargetLanguage: "en-GB", defaultUiLanguage: "en-GB", enableReadAloud: "true", readAloudSource: "both" };
  ...
  chrome.contextMenus.onClicked.addListener((t2, c) => {
    if (t2.menuItemId === "addToEasyNote" && t2.selectionText) {
      const o = new C("glm-4-flash-250414", new O(t[n.defaultTargetLanguage].name), false);
