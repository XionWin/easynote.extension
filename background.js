...
`);
  ...
  chrome.contextMenus.onClicked.addListener((t2, c) => {
    if (t2.menuItemId === "addToEasyNote" && t2.selectionText) {
      ...
      new k("https://open.bigmodel.cn/api/paas/v4/chat/completions", "Bearer f1987d86479f430491bb5210379b814f.Jh99XCkw0kS7tLiN", o.getPrompt(t2.selectionText), { onOpen: (e) => console.log("opened, status", e.status), onEvent: (e) => {
