...
` + a[p].replace(" at new ", " at ");
    ...
    var Ku, Ai3, Qu, Yu, Xu, Oi3 = false, Ko = [], ln3 = null, an3 = null, sn3 = null, Kr2 = /* @__PURE__ */ new Map(), Qr = /* @__PURE__ */ new Map(), un2 = [], zv = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
    function Zu(e, t) {
      switch (e) {
        case "focusin":
        case "focusout":
    ...
    function Zr(e) {
      ...
      for (ln3 !== null && Xr(ln3, e), an3 !== null && Xr(an3, e), sn3 !== null && Xr(sn3, e), Kr2.forEach(t), Qr.forEach(t), n = 0; n < un2.length; n++) o = un2[n], o.blockedOn === e && (o.blockedOn = null);
...
`).replace($h, "");
    ...
    var $a2 = [];
    function Ca() {
      for (var e = 0; e < $a2.length; e++) $a2[e]._workInProgressVersionPrimary = null;
      $a2.length = 0;
    }
...
@layer {
  ...
  function eo(o) {
    const { ref: e, box: a, onResize: l3 } = o;
    S.useEffect(() => {
      ...
      } else return window.addEventListener("resize", l3, false), () => {
        window.removeEventListener("resize", l3, false);
      };
    }, [l3, e, a]);
  }
  function ll(o, e) {
  ...
  function Rr3(o, e, a, l3) {
    let s = $t2(a), u = a == null;
    S.useEffect(() => {
      if (u || !o.current) return;
      let h = o.current;
      return h.addEventListener(e, s, l3), () => {
        h.removeEventListener(e, s, l3);
      };
    }, [o, e, l3, u, s]);
  }
  function Oo(o, e) {
    let a = to(o, e, "left"), l3 = to(o, e, "top"), s = e.offsetWidth, u = e.offsetHeight, h = o.scrollLeft, g = o.scrollTop, { borderTopWidth: v, borderLeftWidth: b3, scrollPaddingTop: m3, scrollPaddingRight: E, scrollPaddingBottom: R3, scrollPaddingLeft: K2 } = getComputedStyle(o), F = h + parseInt(b3, 10), j2 = g + parseInt(v, 10), w3 = F + o.clientWidth, P3 = j2 + o.clientHeight, S2 = parseInt(m3, 10) || 0, I2 = parseInt(R3, 10) || 0, N3 = parseInt(E, 10) || 0, H = parseInt(K2, 10) || 0;
    a <= h + H ? h = a - parseInt(b3, 10) - H : a + s > w3 - N3 && (h += a + s - w3 + N3), l3 <= j2 + S2 ? g = l3 - parseInt(v, 10) - S2 : l3 + u > P3 - I2 && (g += l3 + u - P3 + I2), o.scrollLeft = h, o.scrollTop = g;
  }
  function to(o, e, a) {
    const l3 = a === "left" ? "offsetLeft" : "offsetTop";
    let s = 0;
    for (; e.offsetParent && (s += e[l3], e.offsetParent !== o); ) {
  ...
  function ro(o, e) {
    if (o && document.contains(o)) {
      ...
      if (window.getComputedStyle(h).overflow === "hidden") {
        let v = ll(o);
        for (let b3 of v) Oo(b3, o);
      } else {
        var a;
        let { left: v, top: b3 } = o.getBoundingClientRect();
        o == null || (a = o.scrollIntoView) === null || a === void 0 || a.call(o, { block: "nearest" });
        let { left: m3, top: E } = o.getBoundingClientRect();
        if (Math.abs(v - m3) > 1 || Math.abs(b3 - E) > 1) {
          var l3, s, u;
          e == null || (s = e.containingElement) === null || s === void 0 || (l3 = s.scrollIntoView) === null || l3 === void 0 || l3.call(s, { block: "center", inline: "center" }), (u = o.scrollIntoView) === null || u === void 0 || u.call(o, { block: "nearest" });
        }
      }
    }
  }
  var il = "react-aria-clear-focus";
  var sl = "react-aria-focus";
  function tr2(o) {
  ...
  function pl(o) {
    ...
    let l3 = new Intl.Collator(e, o);
    return ca.set(a, l3), l3;
  }
  var fl = /* @__PURE__ */ new Set(["opacity", "clipPath", "filter", "transform"]);
  var hl = S.createContext(null);
  function gl() {
  ...
  function vl() {
    const o = gl(), [e, a] = S.useState(0), l3 = S.useCallback(() => {
      o.current && a(e + 1);
    }, [e]);
    return [S.useCallback(() => O.postRender(l3), [l3]), e];
  }
  var bl = (o) => !o.isLayoutDirty && o.willUpdate(false);
  function ao() {
    const o = /* @__PURE__ */ new Set(), e = /* @__PURE__ */ new WeakMap(), a = () => o.forEach(bl);
    return { add: (l3) => {
      o.add(l3), e.set(l3, l3.addEventListener("willUpdate", a));
    }, remove: (l3) => {
      o.delete(l3);
      const s = e.get(l3);
      s && (s(), e.delete(l3)), a();
  ...
  var Bo = (o) => o === true;
  var wl = (o) => Bo(o === true) || o === "id";
  var ml = ({ children: o, id: e, inherit: a = true }) => {
    const l3 = S.useContext(am), s = S.useContext(hl), [u, h] = vl(), g = S.useRef(null), v = l3.id || s;
    g.current === null && (wl(a) && v && (e = e ? v + "-" + e : v), g.current = { id: e, group: Bo(a) && l3.group || ao() });
  ...
  var xl = class extends z {
    ...
    add(e) {
      (dm.has(e) || fl.has(e)) && (this.isEnabled = true, this.update());
    }
    update() {
  ...
  function yl() {
    return pu(() => new xl("auto"));
  }
  var tt2 = { top: "top", bottom: "top", left: "left", right: "left" };
  var Lr2 = { top: "bottom", bottom: "top", left: "right", right: "left" };
  var kl = { top: "left", left: "top" };
  var Sa = { top: "height", left: "width" };
  var Ho = { width: "totalWidth", height: "totalHeight" };
  var Kr = {};
  var Ke = typeof document < "u" ? window.visualViewport : null;
  function oo(o) {
    let e = 0, a = 0, l3 = 0, s = 0, u = 0, h = 0, g = {};
    var v;
    let b3 = ((v = Ke == null ? void 0 : Ke.scale) !== null && v !== void 0 ? v : 1) > 1;
    if (o.tagName === "BODY") {
      let F = document.documentElement;
      l3 = F.clientWidth, s = F.clientHeight;
      var m3;
      e = (m3 = Ke == null ? void 0 : Ke.width) !== null && m3 !== void 0 ? m3 : l3;
      var E;
      a = (E = Ke == null ? void 0 : Ke.height) !== null && E !== void 0 ? E : s, g.top = F.scrollTop || o.scrollTop, g.left = F.scrollLeft || o.scrollLeft, Ke && (u = Ke.offsetTop, h = Ke.offsetLeft);
    } else ({ width: e, height: a, top: u, left: h } = At(o)), g.top = o.scrollTop, g.left = o.scrollLeft, l3 = e, s = a;
    if (ey() && (o.tagName === "BODY" || o.tagName === "HTML") && b3) {
      g.top = 0, g.left = 0;
      var R3;
      u = (R3 = Ke == null ? void 0 : Ke.pageTop) !== null && R3 !== void 0 ? R3 : 0;
      var K2;
      h = (K2 = Ke == null ? void 0 : Ke.pageLeft) !== null && K2 !== void 0 ? K2 : 0;
    }
    return { width: e, height: a, totalWidth: l3, totalHeight: s, scroll: g, top: u, left: h };
  }
  function Sl(o) {
    return { top: o.scrollTop, left: o.scrollLeft, width: o.scrollWidth, height: o.scrollHeight };
  }
  function no(o, e, a, l3, s, u, h) {
    var g;
    let v = (g = s.scroll[o]) !== null && g !== void 0 ? g : 0, b3 = l3[Sa[o]], m3 = l3.scroll[tt2[o]] + u, E = b3 + l3.scroll[tt2[o]] - u, R3 = e - v + h[o] - l3[tt2[o]], K2 = e - v + a + h[o] - l3[tt2[o]];
    return R3 < m3 ? m3 - R3 : K2 > E ? Math.max(E - K2, m3 - R3) : 0;
  }
  function Cl(o) {
  ...
  function lo(o) {
    if (Kr[o]) return Kr[o];
    let [e, a] = o.split(" "), l3 = tt2[e] || "right", s = kl[l3];
    tt2[a] || (a = "center");
    let u = Sa[l3], h = Sa[s];
    return Kr[o] = { placement: e, crossPlacement: a, axis: l3, crossAxis: s, size: u, crossSize: h }, Kr[o];
  }
  function da(o, e, a, l3, s, u, h, g, v, b3) {
    let { placement: m3, crossPlacement: E, axis: R3, crossAxis: K2, size: F, crossSize: j2 } = l3, w3 = {};
    var P3;
    w3[K2] = (P3 = o[K2]) !== null && P3 !== void 0 ? P3 : 0;
    var S2, I2, N3, H;
    ...
    if (w3[K2] = ka(w3[K2], O3, B2), m3 === R3) {
      const ae2 = g ? h[F] : e[Ho[F]];
      w3[Lr2[R3]] = Math.floor(ae2 - o[R3] + s);
    } else w3[R3] = Math.floor(o[R3] + o[F] + s);
    return w3;
  }
  function El(o, e, a, l3, s, u, h, g) {
    const v = l3 ? a.height : e[Ho.height];
    var b3;
    let m3 = o.top != null ? a.top + o.top : a.top + (v - ((b3 = o.bottom) !== null && b3 !== void 0 ? b3 : 0) - h);
    var E, R3, K2, F, j2, w3;
    let P3 = g !== "top" ? Math.max(0, e.height + e.top + ((E = e.scroll.top) !== null && E !== void 0 ? E : 0) - m3 - (((R3 = s.top) !== null && R3 !== void 0 ? R3 : 0) + ((K2 = s.bottom) !== null && K2 !== void 0 ? K2 : 0) + u)) : Math.max(0, m3 + h - (e.top + ((F = e.scroll.top) !== null && F !== void 0 ? F : 0)) - (((j2 = s.top) !== null && j2 !== void 0 ? j2 : 0) + ((w3 = s.bottom) !== null && w3 !== void 0 ? w3 : 0) + u));
    return Math.min(e.height - u * 2, P3);
  }
  function io(o, e, a, l3, s, u) {
    let { placement: h, axis: g, size: v } = u;
    var b3, m3;
    if (h === g) return Math.max(0, a[g] - o[g] - ((b3 = o.scroll[g]) !== null && b3 !== void 0 ? b3 : 0) + e[g] - ((m3 = l3[g]) !== null && m3 !== void 0 ? m3 : 0) - l3[Lr2[g]] - s);
    var E;
    return Math.max(0, o[v] + o[g] + o.scroll[g] - e[g] - a[g] - a[v] - ((E = l3[g]) !== null && E !== void 0 ? E : 0) - l3[Lr2[g]] - s);
  }
  function _l(o, e, a, l3, s, u, h, g, v, b3, m3, E, R3, K2, F, j2) {
    let w3 = lo(o), { size: P3, crossAxis: S2, crossSize: I2, placement: N3, crossPlacement: H } = w3, O3 = da(e, g, a, w3, m3, E, b3, R3, F, j2), B2 = m3, ae2 = io(g, b3, e, s, u + m3, w3);
    if (h && l3[P3] > ae2) {
      let Ee2 = lo(`${Lr2[N3]} ${H}`), _e2 = da(e, g, a, Ee2, m3, E, b3, R3, F, j2);
      io(g, b3, e, s, u + m3, Ee2) > ae2 && (w3 = Ee2, O3 = _e2, B2 = m3);
    }
    let re2 = "bottom";
    ...
    let ne2 = no(S2, O3[S2], a[I2], g, v, u, b3);
    O3[S2] += ne2;
    let le2 = El(O3, g, b3, R3, s, u, a.height, re2);
    K2 && K2 < le2 && (le2 = K2), a.height = Math.min(a.height, le2), O3 = da(e, g, a, w3, B2, E, b3, R3, F, j2), ne2 = no(S2, O3[S2], a[I2], g, v, u, b3), O3[S2] += ne2;
    let J3 = {}, ie2 = e[S2] - O3[S2] - s[tt2[S2]], ge2 = ie2 + 0.5 * e[I2];
    const ue2 = F / 2 + j2;
    var Se2, A2, W, V2;
    const q3 = tt2[S2] === "left" ? ((Se2 = s.left) !== null && Se2 !== void 0 ? Se2 : 0) + ((A2 = s.right) !== null && A2 !== void 0 ? A2 : 0) : ((W = s.top) !== null && W !== void 0 ? W : 0) + ((V2 = s.bottom) !== null && V2 !== void 0 ? V2 : 0), U3 = a[I2] - q3 - F / 2 - j2, se = e[S2] + F / 2 - (O3[S2] + s[tt2[S2]]), ce2 = e[S2] + e[I2] - F / 2 - (O3[S2] + s[tt2[S2]]), ee2 = ka(ge2, se, ce2);
    J3[S2] = ka(ee2, ue2, U3), { placement: N3, crossPlacement: H } = w3, F ? ie2 = J3[S2] : H === "right" ? ie2 += e[I2] : H === "center" && (ie2 += e[I2] / 2);
    let we2 = N3 === "left" || N3 === "top" ? a[P3] : 0, Fe2 = { x: N3 === "top" || N3 === "bottom" ? ie2 : we2, y: N3 === "left" || N3 === "right" ? ie2 : we2 };
    return { position: O3, maxHeight: le2, arrowOffsetLeft: J3.left, arrowOffsetTop: J3.top, placement: N3, triggerAnchorPoint: Fe2 };
  }
  function Pl(o) {
    let { placement: e, targetNode: a, overlayNode: l3, scrollNode: s, padding: u, shouldFlip: h, boundaryElement: g, offset: v, crossOffset: b3, maxHeight: m3, arrowSize: E = 0, arrowBoundaryOffset: R3 = 0 } = o, K2 = l3 instanceof HTMLElement ? zl(l3) : document.documentElement, F = K2 === document.documentElement;
    const j2 = window.getComputedStyle(K2).position;
    let w3 = !!j2 && j2 !== "static", P3 = F ? At(a) : so(a, K2);
    if (!F) {
      let { marginTop: J3, marginLeft: ie2 } = window.getComputedStyle(a);
      P3.top += parseInt(J3, 10) || 0, P3.left += parseInt(ie2, 10) || 0;
    }
    let S2 = At(l3), I2 = Cl(l3);
    var N3, H;
    ...
    let ae2 = Sl(s), re2 = oo(g), ne2 = oo(K2), le2 = g.tagName === "BODY" ? At(K2) : so(K2, g);
    return K2.tagName === "HTML" && g.tagName === "BODY" && (ne2.scroll.top = 0, ne2.scroll.left = 0), _l(e, P3, S2, ae2, I2, u, h, re2, ne2, le2, v, b3, w3, m3, E, R3);
  }
  function At(o) {
    let { top: e, left: a, width: l3, height: s } = o.getBoundingClientRect(), { scrollTop: u, scrollLeft: h, clientTop: g, clientLeft: v } = document.documentElement;
    return { top: e + u - g, left: a + h - v, width: l3, height: s };
  }
  function so(o, e) {
    let a = window.getComputedStyle(o), l3;
    if (a.position === "fixed") {
      let { top: s, left: u, width: h, height: g } = o.getBoundingClientRect();
      l3 = { top: s, left: u, width: h, height: g };
    } else {
      l3 = At(o);
      let s = At(e), u = window.getComputedStyle(e);
      s.top += (parseInt(u.borderTopWidth, 10) || 0) - e.scrollTop, s.left += (parseInt(u.borderLeftWidth, 10) || 0) - e.scrollLeft, l3.top -= s.top, l3.left -= s.left;
    }
    return l3.top -= parseInt(a.marginTop, 10) || 0, l3.left -= parseInt(a.marginLeft, 10) || 0, l3;
  }
  function zl(o) {
    let e = o.offsetParent;
    if (e && e === document.body && window.getComputedStyle(e).position === "static" && !co(e) && (e = document.documentElement), e == null) for (e = o.parentElement; e && !co(e); ) e = e.parentElement;
  ...
  function $l(o) {
    let { triggerRef: e, isOpen: a, onClose: l3 } = o;
    S.useEffect(() => {
      if (!a || l3 === null) return;
      let s = (u) => {
        let h = u.target;
  ...
  function Tl(o) {
    let { direction: e } = s1(), { arrowSize: a, targetRef: l3, overlayRef: s, arrowRef: u, scrollRef: h = s, placement: g = "bottom", containerPadding: v = 12, shouldFlip: b3 = true, boundaryElement: m3 = typeof document < "u" ? document.body : null, offset: E = 0, crossOffset: R3 = 0, shouldUpdatePosition: K2 = true, isOpen: F = true, onClose: j2, maxHeight: w3, arrowBoundaryOffset: P3 = 0 } = o, [S2, I2] = S.useState(null), N3 = [K2, g, s.current, l3.current, u == null ? void 0 : u.current, h.current, v, b3, m3, E, R3, F, e, w3, P3, a], H = S.useRef(ze2 == null ? void 0 : ze2.scale);
    S.useEffect(() => {
      F && (H.current = ze2 == null ? void 0 : ze2.scale);
    }, [F]);
    let O3 = S.useCallback(() => {
      var J3, ie2, ge2;
      if (K2 === false || !F || !s.current || !l3.current || !m3 || (ze2 == null ? void 0 : ze2.scale) !== H.current || s.current.querySelector("[data-react-aria-incomplete]") || ((J3 = (ie2 = s.current).getAnimations) === null || J3 === void 0 ? void 0 : J3.call(ie2).length) > 0) return;
      let ue2 = null;
      ...
      var se;
      let ce2 = Pl({ placement: Rl(g, e), overlayNode: s.current, targetNode: l3.current, scrollNode: h.current || s.current, padding: v, shouldFlip: b3, boundaryElement: m3, offset: E, crossOffset: R3, maxHeight: w3, arrowSize: (se = a ?? (u == null || (ge2 = u.current) === null || ge2 === void 0 ? void 0 : ge2.getBoundingClientRect().width)) !== null && se !== void 0 ? se : 0, arrowBoundaryOffset: P3 });
      if (ce2.position) {
    ...
    Xe(O3, N3), Fl(O3), eo({ ref: s, onResize: O3 }), eo({ ref: l3, onResize: O3 });
    ...
    $l({ triggerRef: l3, isOpen: F, onClose: j2 && ae2 });
    var re2, ne2, le2;
  ...
  function Kl2(o, e, a) {
    let { type: l3 } = o, { isOpen: s } = e;
    S.useEffect(() => {
      a && a.current && Vo.set(a.current, e.close);
    });
    let u;
    l3 === "menu" ? u = true : l3 === "listbox" && (u = "listbox");
    let h = _p();
    return { triggerProps: { "aria-haspopup": u, "aria-expanded": s, "aria-controls": s ? h : void 0, onPress: e.toggle }, overlayProps: { id: h } };
  }
  var uo = (o) => Q2.jsx("svg", { "aria-hidden": "true", fill: "none", focusable: "false", height: "1em", role: "presentation", viewBox: "0 0 24 24", width: "1em", ...o, children: Q2.jsx("path", { d: "M15.5 19l-7-7 7-7", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5" }) });
  function Il(o, e) {
    let { elementType: a = "button", isDisabled: l3, onPress: s, onPressStart: u, onPressEnd: h, onPressUp: g, onPressChange: v, preventFocusOnPress: b3, allowFocusWhenDisabled: m3, onClick: E, href: R3, target: K2, rel: F, type: j2 = "button" } = o, w3;
    a === "button" ? w3 = { type: j2, disabled: l3, form: o.form, formAction: o.formAction, formEncType: o.formEncType, formMethod: o.formMethod, formNoValidate: o.formNoValidate, formTarget: o.formTarget, name: o.name, value: o.value } : w3 = { role: "button", href: a === "a" && !l3 ? R3 : void 0, target: a === "a" ? K2 : void 0, type: a === "input" ? j2 : void 0, disabled: a === "input" ? l3 : void 0, "aria-disabled": !l3 || a === "input" ? void 0 : l3, rel: a === "a" ? F : void 0 };
    let { pressProps: P3, isPressed: S2 } = Kp({ onPressStart: u, onPressEnd: h, onPressChange: v, onPress: s, onPressUp: g, onClick: E, isDisabled: l3, preventFocusOnPress: b3, ref: e }), { focusableProps: I2 } = nm(o, e);
    m3 && (I2.tabIndex = l3 ? -1 : I2.tabIndex);
    let N3 = nn2(I2, P3, eu(o, { labelable: true }));
  ...
  function Ml() {
    ...
    var a = Object.prototype.hasOwnProperty, l3 = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, s = {}, u = {};
    function h(t) {
      return a.call(u, t) ? true : a.call(s, t) ? false : l3.test(t) ? u[t] = true : (s[t] = true, false);
    }
    function g(t, i, d, f3, C, x3, z2) {
      this.acceptsBooleans = i === 2 || i === 3 || i === 4, this.attributeName = f3, this.attributeNamespace = C, this.mustUseProperty = d, this.propertyName = t, this.type = i, this.sanitizeURL = x3, this.removeEmptyString = z2;
    }
    var v = {};
    ...
    var j2 = /([A-Z])/g, w3 = /^ms-/, P3 = Array.isArray;
    function S2(t, i) {
      ...
      for (var f3 in d) if (a.call(d, f3)) {
        ...
        if (C != null && typeof C != "boolean" && C !== "") {
          if (f3.indexOf("--") === 0) {
            ...
            x3 = f3;
            var z2 = N3.get(x3);
            z2 !== void 0 || (z2 = F(x3.replace(j2, "-$1").toLowerCase().replace(w3, "-ms-")), N3.set(x3, z2)), x3 = z2, C = typeof C == "number" ? C === 0 || a.call(E, f3) ? "" + C : C + "px" : F(("" + C).trim());
          }
          i ? (i = false, t.push(' style="', x3, ":", C)) : t.push(";", x3, ":", C);
        }
      }
      i || t.push('"');
    }
        ...
        if (i = v.hasOwnProperty(d) ? v[d] : null, i !== null) {
          ...
          switch (d = i.attributeName, i.type) {
            case 3:
              ...
              break;
            case 4:
              f3 === true ? t.push(" ", d, '=""') : f3 !== false && t.push(" ", d, '="', F(f3), '"');
              break;
            case 5:
              isNaN(f3) || t.push(" ", d, '="', F(f3), '"');
              break;
            case 6:
              !isNaN(f3) && 1 <= f3 && t.push(" ", d, '="', F(f3), '"');
              break;
            default:
              i.sanitizeURL && (f3 = "" + f3), t.push(" ", d, '="', F(f3), '"');
          }
        } else if (h(d)) {
          switch (typeof f3) {
            case "function":
    ...
    function re2(t, i, d, f3) {
      t.push(J3(d));
      var C = d = null, x3;
      for (x3 in i) if (a.call(i, x3)) {
        var z2 = i[x3];
        if (z2 != null) switch (x3) {
          case "children":
            d = z2;
            break;
    ...
    function ie2(t, i, d, f3, C) {
      switch (i) {
        case "select":
          ...
          return t.push(">"), B2(t, z2, x3), x3;
        case "option":
          z2 = C.selectedValue, t.push(J3("option"));
          var Z2 = D2 = null, G2 = null, Q3 = null;
          for (x3 in d) if (a.call(d, x3)) {
            var ke = d[x3];
            if (ke != null) switch (x3) {
              case "children":
                D2 = ke;
                break;
              case "selected":
          ...
          if (z2 != null) if (d = Z2 !== null ? "" + Z2 : ae2(D2), P3(z2)) {
        ...
        case "textarea":
          t.push(J3("textarea")), Q3 = z2 = x3 = null;
          ...
          if (x3 === null && z2 !== null && (x3 = z2), t.push(">"), Q3 != null) {
            if (x3 != null) throw Error(e(92));
            if (P3(Q3) && 1 < Q3.length) throw Error(e(93));
            x3 = "" + Q3;
          }
          return typeof x3 == "string" && x3[0] === `
` && t.push(`
`), x3 !== null && t.push(F("" + x3)), null;
        case "input":
          t.push(J3("input")), Z2 = Q3 = D2 = x3 = null;
          ...
          return Q3 !== null ? O3(t, f3, "checked", Q3) : Z2 !== null && O3(t, f3, "checked", Z2), x3 !== null ? O3(t, f3, "value", x3) : D2 !== null && O3(t, f3, "value", D2), t.push("/>"), null;
        case "menuitem":
          t.push(J3("menuitem"));
          for (var qe in d) if (a.call(d, qe) && (x3 = d[qe], x3 != null)) switch (qe) {
            case "children":
            case "dangerouslySetInnerHTML":
              throw Error(e(400));
            default:
...
`), x3;
        ...
        case "wbr":
          t.push(J3(i));
          for (var Ze in d) if (a.call(d, Ze) && (x3 = d[Ze], x3 != null)) switch (Ze) {
            case "children":
            case "dangerouslySetInnerHTML":
              throw Error(e(399, i));
            default:
    ...
    function q3(t, i, d, f3) {
      return d.generateStaticMarkup ? (t.push(F(i)), false) : (i === "" ? t = f3 : (f3 && t.push("<!-- -->"), t.push(F(i)), t = true), t);
    }
    ...
    function Ue2(t) {
      var i = je2;
      i !== t && (i === null ? ct2(t) : t === null ? st2(i) : i.depth === t.depth ? Re3(i, t) : i.depth > t.depth ? Pe2(i, t) : rt2(i, t), je2 = t);
    }
    ...
    function gt2(t, i, d) {
      ...
      if (30 < x3) {
        var z2 = C - C % 5;
        return x3 = (f3 & (1 << z2) - 1).toString(32), f3 >>= z2, C -= z2, { id: 1 << 32 - _t2(i) + C | d << C | f3, overflow: x3 + t };
      }
      return { id: 1 << x3 | d << C | f3, overflow: t };
    }
    var _t2 = Math.clz32 ? Math.clz32 : qr, Ur = Math.log, Wr = Math.LN2;
    function qr(t) {
      return t >>>= 0, t === 0 ? 32 : 31 - (Ur(t) / Wr | 0) | 0;
    }
    function Zr(t, i) {
      return t === i && (t !== 0 || 1 / t === 1 / i) || t !== t && i !== i;
    }
    var Yr = typeof Object.is == "function" ? Object.is : Zr, Be3 = null, Dt = null, Pt = null, ve2 = null, vt2 = false, zt2 = false, bt2 = 0, et2 = null, $t3 = 0;
    function ot2() {
    ...
    function Bt3(t, i, d, f3, C, x3, z2, D2) {
      ...
      }, blockedBoundary: d, blockedSegment: f3, abortSet: C, legacyContext: x3, context: z2, treeContext: D2 };
      return C.add(Z2), Z2;
    }
    function Rt2(t, i, d, f3, C, x3) {
      return { status: 0, id: -1, index: i, parentFlushed: false, chunks: [], children: [], formatContext: f3, boundary: d, lastPushedText: C, textEmbedded: x3 };
    }
    function mt3(t, i) {
    ...
    function pr2(t, i, d, f3) {
      var C = d.render(), x3 = f3.childContextTypes;
      if (x3 != null) {
        var z2 = i.legacyContext;
        if (typeof d.getChildContext != "function") f3 = z2;
        else {
          d = d.getChildContext();
          for (var D2 in d) if (!(D2 in x3)) throw Error(e(108, Ve3(f3) || "Unknown", D2));
          f3 = U3({}, z2, d);
        }
    ...
    function Ht2(t, i, d, f3, C) {
      if (typeof d == "function") if (d.prototype && d.prototype.isReactComponent) {
        ...
        var x3 = d.contextType;
        x3 = new d(f3, typeof x3 == "object" && x3 !== null ? x3._currentValue2 : C), We2(x3, d, f3, C), pr2(t, i, x3, d);
      } else {
        x3 = it2(d, i.legacyContext), C = ur2(t, i, d, f3, x3);
        var z2 = bt2 !== 0;
        if (typeof C == "object" && C !== null && typeof C.render == "function" && C.$$typeof === void 0) We2(C, d, f3, x3), pr2(t, i, C, d);
        else if (z2) {
        ...
        switch (C = i.blockedSegment, x3 = ie2(C.chunks, d, f3, t.responseState, C.formatContext), C.lastPushedText = false, z2 = C.formatContext, C.formatContext = I2(z2, d, f3), Vt2(t, i, x3), C.formatContext = z2, d) {
          case "area":
          case "base":
          case "br":
          case "col":
        ...
        switch (d) {
          ...
          case ye:
            e: {
              d = i.blockedBoundary, C = i.blockedSegment, x3 = f3.fallback, f3 = f3.children, z2 = /* @__PURE__ */ new Set();
              var D2 = { id: null, rootSegmentID: -1, parentFlushed: false, pendingTasks: 0, forceClientRender: false, completedSegments: [], byteSize: 0, fallbackAbortableTasks: z2, errorDigest: null }, Z2 = Rt2(t, C.chunks.length, D2, C.formatContext, false, false);
              ...
              i = Bt3(t, x3, d, Z2, z2, i.legacyContext, i.context, i.treeContext), t.pingedTasks.push(i);
            }
            return;
        }
        if (typeof d == "object" && d !== null) switch (d.$$typeof) {
          ...
          case L3:
            ...
            return;
          case Ee2:
            if (C = f3.children, d = d._context, f3 = f3.value, x3 = d._currentValue2, d._currentValue2 = f3, z2 = je2, je2 = f3 = { parent: z2, depth: z2 === null ? 0 : z2.depth + 1, context: d, parentValue: x3, value: f3 }, i.context = f3, Me2(t, i, C), t = je2, t === null) throw Error(e(403));
    ...
    function Me2(t, i, d) {
      ...
      typeof d == "string" ? (f3 = i.blockedSegment, f3.lastPushedText = q3(i.blockedSegment.chunks, d, t.responseState, f3.lastPushedText)) : typeof d == "number" && (f3 = i.blockedSegment, f3.lastPushedText = q3(i.blockedSegment.chunks, "" + d, t.responseState, f3.lastPushedText));
    }
    function hr2(t, i, d) {
      for (var f3 = d.length, C = 0; C < f3; C++) {
        var x3 = i.treeContext;
        i.treeContext = gt2(x3, f3, C);
        try {
          Vt2(t, i, d[C]);
        } finally {
          i.treeContext = x3;
    ...
    function Vt2(t, i, d) {
      var f3 = i.blockedSegment.formatContext, C = i.legacyContext, x3 = i.context;
      try {
        return Me2(t, i, d);
      } catch (Z2) {
        if (Ot2(), typeof Z2 == "object" && Z2 !== null && typeof Z2.then == "function") {
          d = Z2;
          var z2 = i.blockedSegment, D2 = Rt2(t, z2.chunks.length, null, z2.formatContext, z2.lastPushedText, true);
          z2.children.push(D2), z2.lastPushedText = false, t = Bt3(t, i.node, i.blockedBoundary, D2, i.abortSet, i.legacyContext, i.context, i.treeContext).ping, d.then(t, t), i.blockedSegment.formatContext = f3, i.legacyContext = C, i.context = x3, Ue2(x3);
        } else throw i.blockedSegment.formatContext = f3, i.legacyContext = C, i.context = x3, Ue2(x3), Z2;
      }
    }
    function Ut3(t) {
    ...
    function vr2(t) {
      if (t.status !== 2) {
        ...
        Ft = t.responseState;
        try {
          var C = t.pingedTasks, x3;
          for (x3 = 0; x3 < C.length; x3++) {
            var z2 = C[x3], D2 = t, Z2 = z2.blockedSegment;
            if (Z2.status === 0) {
              Ue2(z2.context);
              try {
                ...
                if (Ot2(), typeof De2 == "object" && De2 !== null && typeof De2.then == "function") {
                  ...
                  var Q3 = z2.blockedBoundary, ke = De2, qe = mt3(D2, ke);
                  if (Q3 === null ? Kt2(D2, ke) : (Q3.pendingTasks--, Q3.forceClientRender || (Q3.forceClientRender = true, Q3.errorDigest = qe, Q3.parentFlushed && D2.clientRenderedBoundaries.push(Q3))), D2.allPendingTasks--, D2.allPendingTasks === 0) {
          ...
          C.splice(0, x3), t.destination !== null && It3(t, t.destination);
        } catch (De2) {
          mt3(t, De2), Kt2(t, De2);
        } finally {
          Ft = f3, Lt2.current = d, d === dr2 && Ue2(i);
        }
      }
    }
    function xt(t, i, d) {
      switch (d.parentFlushed = true, d.status) {
        ...
        case 1:
          ...
          for (var z2 = 0; z2 < d.length; z2++) {
            for (C = d[z2]; x3 < C.index; x3++) i.push(f3[x3]);
            C = yt2(t, i, C);
          }
          for (; x3 < f3.length - 1; x3++) i.push(f3[x3]);
          return x3 < f3.length && (C = i.push(f3[x3])), C;
        default:
          throw Error(e(390));
      }
    }
    function yt2(t, i, d) {
      ...
      if (f3.parentFlushed = true, f3.forceClientRender) return t.responseState.generateStaticMarkup || (f3 = f3.errorDigest, i.push("<!--$!-->"), i.push("<template"), f3 && (i.push(' data-dgst="'), f3 = F(f3), i.push(f3), i.push('"')), i.push("></template>")), xt(t, i, d), t = t.responseState.generateStaticMarkup ? true : i.push("<!--/$-->"), t;
      if (0 < f3.pendingTasks) {
        f3.rootSegmentID = t.nextSegmentId++, 0 < f3.completedSegments.length && t.partialBoundaries.push(f3);
        var C = t.responseState, x3 = C.nextSuspenseID++;
        return C = C.boundaryPrefix + x3.toString(16), f3 = f3.id = C, ge2(i, t.responseState, f3), xt(t, i, d), i.push("<!--/$-->");
      }
    ...
    function Zt2(t, i, d, f3) {
      ...
      return Wt2(t, i, f3), t = t.responseState, i.push(t.startInlineScript), t.sentCompleteSegmentFunction ? i.push('$RS("') : (t.sentCompleteSegmentFunction = true, i.push('function $RS(a,b){a=document.getElementById(a);b=document.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)};$RS("')), i.push(t.segmentPrefix), C = C.toString(16), i.push(C), i.push('","'), i.push(t.placeholderPrefix), i.push(C), i.push('")<\/script>');
    }
    function It3(t, i) {
      try {
        ...
        var C = t.clientRenderedBoundaries, x3;
        for (x3 = 0; x3 < C.length; x3++) {
          var z2 = C[x3];
          f3 = i;
          ...
          if (!f3.push(")<\/script>")) {
            t.destination = null, x3++, C.splice(0, x3);
            return;
          }
        }
        C.splice(0, x3);
        var kt2 = t.completedBoundaries;
        for (x3 = 0; x3 < kt2.length; x3++) if (!qt2(t, i, kt2[x3])) {
          t.destination = null, x3++, kt2.splice(0, x3);
          return;
        }
        kt2.splice(0, x3);
        var nt2 = t.partialBoundaries;
        for (x3 = 0; x3 < nt2.length; x3++) {
          var Xt2 = nt2[x3];
          e: {
            C = t, z2 = i;
          ...
          if (!mr2) {
            t.destination = null, x3++, nt2.splice(0, x3);
            return;
          }
        }
        nt2.splice(0, x3);
        var pt3 = t.completedBoundaries;
        for (x3 = 0; x3 < pt3.length; x3++) if (!qt2(t, i, pt3[x3])) {
          t.destination = null, x3++, pt3.splice(0, x3);
          return;
        }
        pt3.splice(0, x3);
      } finally {
    ...
    function Yt2(t, i, d, f3) {
      var C = false, x3 = null, z2 = "", D2 = { push: function(G2) {
  ...
  function jl() {
    ...
    var o = Ys2();
    function e(r) {
      for (var n = "https://reactjs.org/docs/error-decoder.html?invariant=" + r, c = 1; c < arguments.length; c++) n += "&args[]=" + encodeURIComponent(arguments[c]);
    ...
    var a = null, l3 = 0;
    function s(r, n) {
      if (n.length !== 0) if (512 < n.length) 0 < l3 && (r.enqueue(new Uint8Array(a.buffer, 0, l3)), a = new Uint8Array(512), l3 = 0), r.enqueue(n);
      else {
        var c = a.length - l3;
        c < n.length && (c === 0 ? r.enqueue(a) : (a.set(n.subarray(0, c), l3), r.enqueue(a), n = n.subarray(c)), a = new Uint8Array(512), l3 = 0), a.set(n, l3), l3 += n.length;
      }
    }
    function u(r, n) {
      return s(r, n), true;
    ...
    function h(r) {
      a && 0 < l3 && (r.enqueue(new Uint8Array(a.buffer, 0, l3)), a = null, l3 = 0);
    }
    ...
    function m3(r, n) {
      typeof r.error == "function" ? r.error(n) : r.close();
    }
    var E = Object.prototype.hasOwnProperty, R3 = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, K2 = {}, F = {};
    function j2(r) {
      return E.call(F, r) ? true : E.call(K2, r) ? false : R3.test(r) ? F[r] = true : (K2[r] = true, false);
    }
    function w3(r, n, c, p, k3, y3, T) {
      this.acceptsBooleans = n === 2 || n === 3 || n === 4, this.attributeName = p, this.attributeNamespace = k3, this.mustUseProperty = c, this.propertyName = r, this.type = n, this.sanitizeURL = y3, this.removeEmptyString = T;
    }
    var P3 = {};
    "children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(r) {
      P3[r] = new w3(r, 0, false, r, null, false, false);
    }), [["acceptCharset", "accept-charset"], ["className", "class"], ["htmlFor", "for"], ["httpEquiv", "http-equiv"]].forEach(function(r) {
      var n = r[0];
      P3[n] = new w3(n, 1, false, r[1], null, false, false);
    }), ["contentEditable", "draggable", "spellCheck", "value"].forEach(function(r) {
      P3[r] = new w3(r, 2, false, r.toLowerCase(), null, false, false);
    }), ["autoReverse", "externalResourcesRequired", "focusable", "preserveAlpha"].forEach(function(r) {
      P3[r] = new w3(r, 2, false, r, null, false, false);
    }), "allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(r) {
      P3[r] = new w3(r, 3, false, r.toLowerCase(), null, false, false);
    }), ["checked", "multiple", "muted", "selected"].forEach(function(r) {
      P3[r] = new w3(r, 3, true, r, null, false, false);
    }), ["capture", "download"].forEach(function(r) {
      P3[r] = new w3(r, 4, false, r, null, false, false);
    }), ["cols", "rows", "size", "span"].forEach(function(r) {
      P3[r] = new w3(r, 6, false, r, null, false, false);
    }), ["rowSpan", "start"].forEach(function(r) {
      P3[r] = new w3(r, 5, false, r.toLowerCase(), null, false, false);
    });
    var S2 = /[\-:]([a-z])/g;
    function I2(r) {
    ...
    "accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(r) {
      var n = r.replace(S2, I2);
      P3[n] = new w3(n, 1, false, r, null, false, false);
    }), "xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(r) {
      var n = r.replace(S2, I2);
      P3[n] = new w3(n, 1, false, r, "http://www.w3.org/1999/xlink", false, false);
    }), ["xml:base", "xml:lang", "xml:space"].forEach(function(r) {
      var n = r.replace(S2, I2);
      P3[n] = new w3(n, 1, false, r, "http://www.w3.org/XML/1998/namespace", false, false);
    }), ["tabIndex", "crossOrigin"].forEach(function(r) {
      P3[r] = new w3(r, 1, false, r.toLowerCase(), null, false, false);
    }), P3.xlinkHref = new w3("xlinkHref", 1, false, "xlink:href", "http://www.w3.org/1999/xlink", true, false), ["src", "href", "action", "formAction"].forEach(function(r) {
      P3[r] = new w3(r, 1, false, r.toLowerCase(), null, true, true);
    });
    ...
    Object.keys(N3).forEach(function(r) {
      H.forEach(function(n) {
        n = n + r.charAt(0).toUpperCase() + r.substring(1), N3[n] = N3[r];
      });
    });
    var O3 = /["'&<>]/;
    function B2(r) {
      ...
      if (n) {
        ...
        for (p = n.index; p < r.length; p++) {
          ...
          k3 !== p && (c += r.substring(k3, p)), k3 = p + 1, c += n;
        }
    ...
    function W(r, n, c, p, k3) {
      r = r === void 0 ? "" : r, n = n === void 0 ? le2 : b3('<script nonce="' + B2(n) + '">');
      var y3 = [];
      if (c !== void 0 && y3.push(n, v(("" + c).replace(Se2, A2)), J3), p !== void 0) for (c = 0; c < p.length; c++) y3.push(ie2, v(B2(p[c])), ue2);
      if (k3 !== void 0) for (p = 0; p < k3.length; p++) y3.push(ge2, v(B2(k3[p])), ue2);
      return { bootstrapChunks: y3, startInlineScript: n, placeholderPrefix: b3(r + "P:"), segmentPrefix: b3(r + "S:"), boundaryPrefix: r + "B:", idPrefix: r, nextSuspenseID: 0, sentCompleteSegmentFunction: false, sentCompleteBoundaryFunction: false, sentClientRenderFunction: false };
    }
    function V2(r, n) {
      return { insertionMode: r, selectedValue: n };
    }
    function q3(r) {
    ...
    var se = b3("<!-- -->");
    function ce2(r, n, c, p) {
      return n === "" ? p : (p && r.push(se), r.push(v(B2(n))), true);
    }
    var ee2 = /* @__PURE__ */ new Map(), we2 = b3(' style="'), Fe2 = b3(":"), Ee2 = b3(";");
    function _e2(r, n, c) {
      ...
      for (var p in c) if (E.call(c, p)) {
        ...
        if (k3 != null && typeof k3 != "boolean" && k3 !== "") {
          if (p.indexOf("--") === 0) {
            ...
            y3 = p;
            var T = ee2.get(y3);
            T !== void 0 || (T = b3(B2(y3.replace(ae2, "-$1").toLowerCase().replace(re2, "-ms-"))), ee2.set(y3, T)), y3 = T, k3 = typeof k3 == "number" ? k3 === 0 || E.call(N3, p) ? v("" + k3) : v(k3 + "px") : v(B2(("" + k3).trim()));
          }
          n ? (n = false, r.push(we2, y3, Fe2, k3)) : r.push(Ee2, y3, Fe2, k3);
        }
      }
      n || r.push(de2);
    }
    var pe2 = b3(" "), ye = b3('="'), de2 = b3('"'), L3 = b3('=""');
    function fe2(r, n, c, p) {
      switch (c) {
        case "style":
          _e2(r, n, p);
          return;
      ...
      if (!(2 < c.length) || c[0] !== "o" && c[0] !== "O" || c[1] !== "n" && c[1] !== "N") {
        if (n = P3.hasOwnProperty(c) ? P3[c] : null, n !== null) {
          switch (typeof p) {
            case "function":
            case "symbol":
              return;
          ...
          switch (c = v(n.attributeName), n.type) {
            case 3:
              p && r.push(pe2, c, L3);
              break;
            case 4:
            ...
            case 6:
              ...
              break;
            default:
              n.sanitizeURL && (p = "" + p), r.push(pe2, c, ye, v(B2(p)), de2);
          }
        } else if (j2(c)) {
          switch (typeof p) {
            case "function":
            case "symbol":
              return;
            case "boolean":
              if (n = c.toLowerCase().slice(0, 5), n !== "data-" && n !== "aria-") return;
          }
    ...
    var He2 = b3(' selected=""');
    function Ve3(r, n, c, p) {
      r.push(Re3(c));
      var k3 = c = null, y3;
      for (y3 in n) if (E.call(n, y3)) {
        var T = n[y3];
        if (T != null) switch (y3) {
          case "children":
            c = T;
    ...
    function ct2(r, n, c, p, k3) {
      switch (n) {
        case "select":
          ...
          return r.push(he3), X2(r, T, y3), y3;
        case "option":
          T = k3.selectedValue, r.push(Re3("option"));
          var Y2 = M = null, oe = null, te2 = null;
          for (y3 in c) if (E.call(c, y3)) {
            var me2 = c[y3];
            if (me2 != null) switch (y3) {
              case "children":
                M = me2;
                break;
              case "selected":
        ...
        case "textarea":
          r.push(Re3("textarea")), te2 = T = y3 = null;
          ...
          if (y3 === null && T !== null && (y3 = T), r.push(he3), te2 != null) {
            if (y3 != null) throw Error(e(92));
            if (ne2(te2) && 1 < te2.length) throw Error(e(93));
            y3 = "" + te2;
          }
          return typeof y3 == "string" && y3[0] === `
` && r.push(Ie2), y3 !== null && r.push(v(B2("" + y3))), null;
        case "input":
          r.push(Re3("input")), Y2 = te2 = M = y3 = null;
          ...
          return te2 !== null ? fe2(r, p, "checked", te2) : Y2 !== null && fe2(r, p, "checked", Y2), y3 !== null ? fe2(r, p, "value", y3) : M !== null && fe2(r, p, "value", M), r.push(Le3), null;
        case "menuitem":
          r.push(Re3("menuitem"));
          for (var Oe2 in c) if (E.call(c, Oe2) && (y3 = c[Oe2], y3 != null)) switch (Oe2) {
            case "children":
            case "dangerouslySetInnerHTML":
              throw Error(e(400));
            default:
        ...
        case "title":
          ...
          return r.push(he3), y3;
        case "listing":
        case "pre":
          r.push(Re3(n)), T = y3 = null;
...
` && r.push(Ie2), y3;
        ...
        case "wbr":
          r.push(Re3(n));
          for (var Ye2 in c) if (E.call(c, Ye2) && (y3 = c[Ye2], y3 != null)) switch (Ye2) {
            case "children":
            case "dangerouslySetInnerHTML":
              throw Error(e(399, n));
            default:
        ...
        case "missing-glyph":
          return Ve3(r, c, n, p);
        case "html":
          return k3.insertionMode === 0 && r.push(st2), Ve3(r, c, n, p);
        default:
          if (n.indexOf("-") === -1 && typeof c.is != "string") return Ve3(r, c, n, p);
          r.push(Re3(n)), T = y3 = null;
    ...
    var Pe2 = b3("</"), rt2 = b3(">"), Ue2 = b3('<template id="'), Ce2 = b3('"></template>'), We2 = b3("<!--$-->"), at2 = b3('<!--$?--><template id="'), gt2 = b3('"></template>'), _t2 = b3("<!--$!-->"), Ur = b3("<!--/$-->"), Wr = b3("<template"), qr = b3('"'), Zr = b3(' data-dgst="');
    ...
    var Dt = b3('<div hidden id="'), Pt = b3('">'), ve2 = b3("</div>"), vt2 = b3('<svg aria-hidden="true" style="display:none" id="'), zt2 = b3('">'), bt2 = b3("</svg>"), et2 = b3('<math aria-hidden="true" style="display:none" id="'), $t3 = b3('">'), ot2 = b3("</math>"), lr2 = b3('<table hidden id="'), Nt2 = b3('">'), Ot2 = b3("</table>"), ir2 = b3('<table hidden><tbody id="'), sr2 = b3('">'), cr2 = b3("</tbody></table>"), Xr = b3('<table hidden><tr id="'), Gr = b3('">'), Tt2 = b3("</tr></table>"), dr2 = b3('<table hidden><colgroup id="'), Ft = b3('">'), Lt2 = b3("</colgroup></table>");
    function Jr(r, n, c, p) {
      switch (c.insertionMode) {
        case 0:
        case 1:
          return s(r, Dt), s(r, n.segmentPrefix), s(r, v(p.toString(16))), u(r, Pt);
        case 2:
          return s(r, vt2), s(r, n.segmentPrefix), s(r, v(p.toString(16))), u(r, zt2);
        case 3:
          return s(r, et2), s(r, n.segmentPrefix), s(r, v(p.toString(16))), u(r, $t3);
        case 4:
          return s(r, lr2), s(r, n.segmentPrefix), s(r, v(p.toString(16))), u(r, Nt2);
        case 5:
          return s(r, ir2), s(r, n.segmentPrefix), s(r, v(p.toString(16))), u(r, sr2);
        case 6:
          return s(r, Xr), s(r, n.segmentPrefix), s(r, v(p.toString(16))), u(r, Gr);
        case 7:
          return s(r, dr2), s(r, n.segmentPrefix), s(r, v(p.toString(16))), u(r, Ft);
        default:
          throw Error(e(397));
      }
    }
    ...
    function D2(r) {
      ...
      if (typeof r == "object") switch (r.$$typeof) {
        ...
        case t:
          return n = r.displayName || null, n !== null ? n : D2(r.type) || "Memo";
        case i:
    ...
    function Ze(r) {
      var n = r.parent;
      n !== null && Ze(n), r.context._currentValue = r.value;
    }
    function De2(r, n) {
      if (r.context._currentValue = r.parentValue, r = r.parent, r === null) throw Error(e(402));
      r.depth === n.depth ? ke(r, n) : De2(r, n);
    }
    function kt2(r, n) {
      var c = n.parent;
      if (c === null) throw Error(e(402));
      r.depth === c.depth ? ke(r, c) : kt2(r, c), n.context._currentValue = n.value;
    }
    function nt2(r) {
      var n = Q3;
      n !== r && (n === null ? Ze(r) : r === null ? qe(n) : n.depth === r.depth ? ke(n, r) : n.depth > r.depth ? De2(n, r) : kt2(n, r), Q3 = r);
    }
    var Xt2 = { isMounted: function() {
      return false;
    }, enqueueSetState: function(r, n) {
      r = r._reactInternals, r.queue !== null && r.queue.push(n);
    }, enqueueReplaceState: function(r, n) {
    ...
    function St(r, n, c, p) {
      ...
      var y3 = { queue: [], replace: false };
      r._reactInternals = y3;
      var T = n.contextType;
      if (r.context = typeof T == "object" && T !== null ? T._currentValue : p, T = n.getDerivedStateFromProps, typeof T == "function" && (T = T(c, k3), k3 = T == null ? k3 : ut2({}, k3, T), r.state = k3), typeof n.getDerivedStateFromProps != "function" && typeof r.getSnapshotBeforeUpdate != "function" && (typeof r.UNSAFE_componentWillMount == "function" || typeof r.componentWillMount == "function")) if (n = r.state, typeof r.componentWillMount == "function" && r.componentWillMount(), typeof r.UNSAFE_componentWillMount == "function" && r.UNSAFE_componentWillMount(), n !== r.state && Xt2.enqueueReplaceState(r, r.state, null), y3.queue !== null && 0 < y3.queue.length) if (n = y3.queue, T = y3.replace, y3.queue = null, y3.replace = false, T && n.length === 1) r.state = n[0];
      else {
        for (y3 = T ? n[0] : r.state, k3 = true, T = T ? 1 : 0; T < n.length; T++) {
          var M = n[T];
          M = typeof M == "function" ? M.call(r, y3, c, p) : M, M != null && (k3 ? (k3 = false, y3 = ut2({}, y3, M)) : ut2(y3, M));
        }
        r.state = y3;
      }
      else y3.queue = null;
    ...
    function pt3(r, n, c) {
      ...
      if (30 < y3) {
        var T = k3 - k3 % 5;
        return y3 = (p & (1 << T) - 1).toString(32), p >>= T, k3 -= T, { id: 1 << 32 - xr2(n) + k3 | c << k3 | p, overflow: y3 + r };
      }
      return { id: 1 << y3 | c << k3 | p, overflow: r };
    }
    var xr2 = Math.clz32 ? Math.clz32 : pn2, dn2 = Math.log, un2 = Math.LN2;
    function pn2(r) {
      return r >>>= 0, r === 0 ? 32 : 31 - (dn2(r) / un2 | 0) | 0;
    }
    function fn2(r, n) {
      return r === n && (r !== 0 || 1 / r === 1 / n) || r !== r && n !== n;
    }
    var hn2 = typeof Object.is == "function" ? Object.is : fn2, lt3 = null, ea = null, yr2 = null, be3 = null, Gt2 = false, kr = false, Jt3 = 0, ft3 = null, Sr2 = 0;
    function Ct2() {
    ...
    function ta() {
      return be3 === null ? yr2 === null ? (Gt2 = false, yr2 = be3 = Ta()) : (Gt2 = true, be3 = yr2) : be3.next === null ? (Gt2 = false, be3 = be3.next = Ta()) : (Gt2 = true, be3 = be3.next), be3;
    }
    function ra() {
    ...
    function Ra(r, n, c) {
      if (lt3 = Ct2(), be3 = ta(), Gt2) {
        var p = be3.queue;
        if (n = p.dispatch, ft3 !== null && (c = ft3.get(p), c !== void 0)) {
          ft3.delete(p), p = be3.memoizedState;
          do
            p = r(p, c.action), c = c.next;
          while (c !== null);
          return be3.memoizedState = p, [p, n];
        }
        return [be3.memoizedState, n];
      }
      return r = r === Fa ? typeof n == "function" ? n() : n : c !== void 0 ? c(n) : n, be3.memoizedState = r, r = be3.queue = { last: null, dispatch: null }, r = r.dispatch = gn2.bind(null, lt3, r), [be3.memoizedState, r];
    }
    function Ka(r, n) {
      if (lt3 = Ct2(), be3 = ta(), n = n === void 0 ? null : n, be3 !== null) {
        var c = be3.memoizedState;
        if (c !== null && n !== null) {
          var p = c[1];
          e: if (p === null) p = false;
          else {
            for (var k3 = 0; k3 < p.length && k3 < n.length; k3++) if (!hn2(n[k3], p[k3])) {
              p = false;
              break e;
            }
            p = true;
      ...
      return r = r(), be3.memoizedState = [r, n], r;
    }
    function gn2(r, n, c) {
      if (25 <= Sr2) throw Error(e(301));
      if (r === lt3) if (kr = true, r = { action: c, next: null }, ft3 === null && (ft3 = /* @__PURE__ */ new Map()), c = ft3.get(n), c === void 0) ft3.set(n, r);
      else {
    ...
    var Ia = { readContext: function(r) {
      return r._currentValue;
    }, useContext: function(r) {
      return Ct2(), r._currentValue;
    }, useMemo: Ka, useReducer: Ra, useRef: function(r) {
      lt3 = Ct2(), be3 = ta();
      var n = be3.memoizedState;
      return n === null ? (r = { current: r }, be3.memoizedState = r) : n;
    }, useState: function(r) {
      return Ra(Fa, r);
    }, useInsertionEffect: Cr3, useLayoutEffect: function() {
    }, useCallback: function(r, n) {
      return Ka(function() {
        return r;
      }, n);
      ...
      return Ct2(), [false, vn2];
    }, useId: function() {
      var r = ea.treeContext, n = r.overflow;
      r = r.id, r = (r & ~(1 << 32 - xr2(r) - 1)).toString(32) + n;
      var c = Er;
      if (c === null) throw Error(e(404));
      return n = Jt3++, r = ":" + c.idPrefix + "R" + r, 0 < n && (r += "H" + n.toString(32)), r + ":";
    }, useMutableSource: function(r, n) {
      return Ct2(), n(r._source);
    }, useSyncExternalStore: function(r, n, c) {
    ...
    function wn2(r, n, c, p, k3, y3, T, M, Y2) {
      var oe = [], te2 = /* @__PURE__ */ new Set();
      return n = { destination: null, responseState: n, progressiveChunkSize: p === void 0 ? 12800 : p, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: te2, pingedTasks: oe, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: k3 === void 0 ? bn2 : k3, onAllReady: y3 === void 0 ? Qt2 : y3, onShellReady: T === void 0 ? Qt2 : T, onShellError: M === void 0 ? Qt2 : M, onFatalError: Y2 === void 0 ? Qt2 : Y2 }, c = _r2(n, 0, null, c, false, false), c.parentFlushed = true, r = oa(n, r, null, c, te2, Z2, null, mr2), oe.push(r), n;
    }
    function oa(r, n, c, p, k3, y3, T, M) {
      r.allPendingTasks++, c === null ? r.pendingRootTasks++ : c.pendingTasks++;
      var Y2 = { node: n, ping: function() {
        var oe = r.pingedTasks;
        oe.push(Y2), oe.length === 1 && La(r);
      }, blockedBoundary: c, blockedSegment: p, abortSet: k3, legacyContext: y3, context: T, treeContext: M };
      return k3.add(Y2), Y2;
    }
    function _r2(r, n, c, p, k3, y3) {
      return { status: 0, id: -1, index: n, parentFlushed: false, chunks: [], children: [], formatContext: p, boundary: c, lastPushedText: k3, textEmbedded: y3 };
    }
    function er2(r, n) {
      if (r = r.onError(n), r != null && typeof r != "string") throw Error('onError returned something with a type other than "string". onError should return a string and may return null or undefined but must not return anything else. It received something of type "' + typeof r + '" instead');
      return r;
    }
    function Pr3(r, n) {
      var c = r.onShellError;
      c(n), c = r.onFatalError, c(n), r.destination !== null ? (r.status = 2, m3(r.destination, n)) : (r.status = 1, r.fatalError = n);
    }
    function Ma(r, n, c, p, k3) {
      for (lt3 = {}, ea = n, Jt3 = 0, r = c(p, k3); kr; ) kr = false, Jt3 = 0, Sr2 += 1, be3 = null, r = c(p, k3);
      return ra(), r;
    }
    function ja(r, n, c, p) {
      var k3 = c.render(), y3 = p.childContextTypes;
      if (y3 != null) {
        var T = n.legacyContext;
        if (typeof c.getChildContext != "function") p = T;
        else {
          c = c.getChildContext();
          for (var M in c) if (!(M in y3)) throw Error(e(108, D2(p) || "Unknown", M));
          p = ut2({}, T, c);
        }
        n.legacyContext = p, Ne2(r, n, k3), n.legacyContext = T;
      } else Ne2(r, n, k3);
    }
    function Aa(r, n) {
      if (r && r.defaultProps) {
        n = ut2({}, n), r = r.defaultProps;
        for (var c in r) n[c] === void 0 && (n[c] = r[c]);
        return n;
      }
      return n;
    }
    function na(r, n, c, p, k3) {
      if (typeof c == "function") if (c.prototype && c.prototype.isReactComponent) {
        k3 = G2(c, n.legacyContext);
        var y3 = c.contextType;
        y3 = new c(p, typeof y3 == "object" && y3 !== null ? y3._currentValue : k3), St(y3, c, p, k3), ja(r, n, y3, c);
      } else {
        y3 = G2(c, n.legacyContext), k3 = Ma(r, n, c, p, y3);
        var T = Jt3 !== 0;
        if (typeof k3 == "object" && k3 !== null && typeof k3.render == "function" && k3.$$typeof === void 0) St(k3, c, p, y3), ja(r, n, k3, c);
        else if (T) {
          p = n.treeContext, n.treeContext = pt3(p, 1, 0);
          try {
            Ne2(r, n, k3);
          } finally {
            n.treeContext = p;
        ...
        switch (k3 = n.blockedSegment, y3 = ct2(k3.chunks, c, p, r.responseState, k3.formatContext), k3.lastPushedText = false, T = k3.formatContext, k3.formatContext = U3(T, c, p), la(r, n, y3), k3.formatContext = T, c) {
          case "area":
          case "base":
          case "br":
          case "col":
        ...
        switch (c) {
          ...
          case wr2:
            e: {
              c = n.blockedBoundary, k3 = n.blockedSegment, y3 = p.fallback, p = p.children, T = /* @__PURE__ */ new Set();
              var M = { id: null, rootSegmentID: -1, parentFlushed: false, pendingTasks: 0, forceClientRender: false, completedSegments: [], byteSize: 0, fallbackAbortableTasks: T, errorDigest: null }, Y2 = _r2(r, k3.chunks.length, M, k3.formatContext, false, false);
              k3.children.push(Y2), k3.lastPushedText = false;
              var oe = _r2(r, 0, null, k3.formatContext, false, false);
              oe.parentFlushed = true, n.blockedBoundary = M, n.blockedSegment = oe;
              try {
                if (la(r, n, p), oe.lastPushedText && oe.textEmbedded && oe.chunks.push(se), oe.status = 1, zr2(M, oe), M.pendingTasks === 0) break e;
              } catch (te2) {
                oe.status = 4, M.forceClientRender = true, M.errorDigest = er2(r, te2);
              } finally {
                n.blockedBoundary = c, n.blockedSegment = k3;
              }
              n = oa(r, y3, c, Y2, T, n.legacyContext, n.context, n.treeContext), r.pingedTasks.push(n);
            }
            return;
        }
        if (typeof c == "object" && c !== null) switch (c.$$typeof) {
          case br2:
            if (p = Ma(r, n, c.render, p, k3), Jt3 !== 0) {
              c = n.treeContext, n.treeContext = pt3(c, 1, 0);
              try {
                Ne2(r, n, p);
              } finally {
                n.treeContext = c;
            ...
            return;
          case t:
            c = c.type, p = Aa(c, p), na(r, n, c, p, k3);
            return;
          case Zt2:
            if (k3 = p.children, c = c._context, p = p.value, y3 = c._currentValue, c._currentValue = p, T = Q3, Q3 = p = { parent: T, depth: T === null ? 0 : T.depth + 1, context: c, parentValue: y3, value: p }, n.context = p, Ne2(r, n, k3), r = Q3, r === null) throw Error(e(403));
            p = r.parentValue, r.context._currentValue = p === x3 ? r.context._defaultValue : p, r = Q3 = r.parent, n.context = r;
            return;
          case It3:
            p = p.children, p = p(c._currentValue), Ne2(r, n, p);
            return;
          case i:
            k3 = c._init, c = k3(c._payload), p = Aa(c, p), na(r, n, c, p, void 0);
            return;
        }
    ...
    function Ne2(r, n, c) {
      if (n.node = c, typeof c == "object" && c !== null) {
        switch (c.$$typeof) {
          case vr2:
            na(r, n, c.type, c.props, c.ref);
            return;
          case xt:
            throw Error(e(257));
          case i:
            var p = c._init;
            c = p(c._payload), Ne2(r, n, c);
            return;
        }
        if (ne2(c)) {
          Da(r, n, c);
      ...
      typeof c == "string" ? (p = n.blockedSegment, p.lastPushedText = ce2(n.blockedSegment.chunks, c, r.responseState, p.lastPushedText)) : typeof c == "number" && (p = n.blockedSegment, p.lastPushedText = ce2(n.blockedSegment.chunks, "" + c, r.responseState, p.lastPushedText));
    }
    function Da(r, n, c) {
      for (var p = c.length, k3 = 0; k3 < p; k3++) {
        var y3 = n.treeContext;
        n.treeContext = pt3(y3, p, k3);
        try {
          la(r, n, c[k3]);
        } finally {
          n.treeContext = y3;
    ...
    function la(r, n, c) {
      var p = n.blockedSegment.formatContext, k3 = n.legacyContext, y3 = n.context;
      try {
        return Ne2(r, n, c);
      } catch (Y2) {
        if (ra(), typeof Y2 == "object" && Y2 !== null && typeof Y2.then == "function") {
          c = Y2;
          var T = n.blockedSegment, M = _r2(r, T.chunks.length, null, T.formatContext, T.lastPushedText, true);
          T.children.push(M), T.lastPushedText = false, r = oa(r, n.node, n.blockedBoundary, M, n.abortSet, n.legacyContext, n.context, n.treeContext).ping, c.then(r, r), n.blockedSegment.formatContext = p, n.legacyContext = k3, n.context = y3, nt2(y3);
        } else throw n.blockedSegment.formatContext = p, n.legacyContext = k3, n.context = y3, nt2(y3), Y2;
      }
    }
    function mn2(r) {
      var n = r.blockedBoundary;
      r = r.blockedSegment, r.status = 3, Oa(this, n, r);
    }
    function Na(r, n, c) {
      var p = r.blockedBoundary;
      r.blockedSegment.status = 3, p === null ? (n.allPendingTasks--, n.status !== 2 && (n.status = 2, n.destination !== null && n.destination.close())) : (p.pendingTasks--, p.forceClientRender || (p.forceClientRender = true, r = c === void 0 ? Error(e(432)) : c, p.errorDigest = n.onError(r), p.parentFlushed && n.clientRenderedBoundaries.push(p)), p.fallbackAbortableTasks.forEach(function(k3) {
        return Na(k3, n, c);
      }), p.fallbackAbortableTasks.clear(), n.allPendingTasks--, n.allPendingTasks === 0 && (p = n.onAllReady, p()));
    }
    function zr2(r, n) {
      if (n.chunks.length === 0 && n.children.length === 1 && n.children[0].boundary === null) {
        var c = n.children[0];
        c.id = n.id, c.parentFlushed = true, c.status === 1 && zr2(r, c);
    ...
    function Oa(r, n, c) {
      if (n === null) {
        ...
        r.pendingRootTasks--, r.pendingRootTasks === 0 && (r.onShellError = Qt2, n = r.onShellReady, n());
      } else n.pendingTasks--, n.forceClientRender || (n.pendingTasks === 0 ? (c.parentFlushed && c.status === 1 && zr2(n, c), n.parentFlushed && r.completedBoundaries.push(n), n.fallbackAbortableTasks.forEach(mn2, r), n.fallbackAbortableTasks.clear()) : c.parentFlushed && c.status === 1 && (zr2(n, c), n.completedSegments.length === 1 && n.parentFlushed && r.partialBoundaries.push(n)));
      r.allPendingTasks--, r.allPendingTasks === 0 && (r = r.onAllReady, r());
    }
    function La(r) {
      if (r.status !== 2) {
        var n = Q3, c = aa.current;
        aa.current = Ia;
        var p = Er;
        Er = r.responseState;
        try {
          var k3 = r.pingedTasks, y3;
          for (y3 = 0; y3 < k3.length; y3++) {
            var T = k3[y3], M = r, Y2 = T.blockedSegment;
            if (Y2.status === 0) {
              nt2(T.context);
              try {
                Ne2(M, T, T.node), Y2.lastPushedText && Y2.textEmbedded && Y2.chunks.push(se), T.abortSet.delete(T), Y2.status = 1, Oa(M, T.blockedBoundary, Y2);
              } catch (Xe2) {
                if (ra(), typeof Xe2 == "object" && Xe2 !== null && typeof Xe2.then == "function") {
                  ...
                  if (te2 === null ? Pr3(M, me2) : (te2.pendingTasks--, te2.forceClientRender || (te2.forceClientRender = true, te2.errorDigest = Oe2, te2.parentFlushed && M.clientRenderedBoundaries.push(te2))), M.allPendingTasks--, M.allPendingTasks === 0) {
          ...
          k3.splice(0, y3), r.destination !== null && ia(r, r.destination);
        } catch (Xe2) {
          er2(r, Xe2), Pr3(r, Xe2);
        } finally {
          Er = p, aa.current = c, c === Ia && nt2(n);
        }
      }
    }
    function $r2(r, n, c) {
      switch (c.parentFlushed = true, c.status) {
        case 0:
          ...
          return c.lastPushedText = false, c.textEmbedded = false, r = r.responseState, s(n, Ue2), s(n, r.placeholderPrefix), r = v(p.toString(16)), s(n, r), u(n, Ce2);
        case 1:
          c.status = 2;
          var k3 = true;
          p = c.chunks;
          ...
          for (var T = 0; T < c.length; T++) {
            for (k3 = c[T]; y3 < k3.index; y3++) s(n, p[y3]);
            k3 = Tr3(r, n, k3);
          }
          for (; y3 < p.length - 1; y3++) s(n, p[y3]);
          return y3 < p.length && (k3 = u(n, p[y3])), k3;
        default:
          throw Error(e(390));
      }
    }
    function Tr3(r, n, c) {
      var p = c.boundary;
      if (p === null) return $r2(r, n, c);
      if (p.parentFlushed = true, p.forceClientRender) p = p.errorDigest, u(n, _t2), s(n, Wr), p && (s(n, Zr), s(n, v(B2(p))), s(n, qr)), u(n, Yr), $r2(r, n, c);
      else if (0 < p.pendingTasks) {
        p.rootSegmentID = r.nextSegmentId++, 0 < p.completedSegments.length && r.partialBoundaries.push(p);
        var k3 = r.responseState, y3 = k3.nextSuspenseID++;
        k3 = b3(k3.boundaryPrefix + y3.toString(16)), p = p.id = k3, Be3(n, r.responseState, p), $r2(r, n, c);
      } else if (p.byteSize > r.progressiveChunkSize) p.rootSegmentID = r.nextSegmentId++, r.completedBoundaries.push(p), Be3(n, r.responseState, p.id), $r2(r, n, c);
      else {
        if (u(n, We2), c = p.completedSegments, c.length !== 1) throw Error(e(391));
        Tr3(r, n, c[0]);
      }
      return u(n, Ur);
    }
    function Ba(r, n, c) {
      return Jr(n, r.responseState, c.formatContext, c.id), Tr3(r, n, c), wt(n, c.formatContext);
    }
    function Ha(r, n, c) {
      for (var p = c.completedSegments, k3 = 0; k3 < p.length; k3++) Va(r, n, c, p[k3]);
      if (p.length = 0, r = r.responseState, p = c.id, c = c.rootSegmentID, s(n, r.startInlineScript), r.sentCompleteBoundaryFunction ? s(n, ur2) : (r.sentCompleteBoundaryFunction = true, s(n, Kt2)), p === null) throw Error(e(395));
      return c = v(c.toString(16)), s(n, p), s(n, pr2), s(n, r.segmentPrefix), s(n, c), u(n, fr2);
    }
    function Va(r, n, c, p) {
      ...
      return Ba(r, n, p), r = r.responseState, s(n, r.startInlineScript), r.sentCompleteSegmentFunction ? s(n, Bt3) : (r.sentCompleteSegmentFunction = true, s(n, Qr)), s(n, r.segmentPrefix), k3 = v(k3.toString(16)), s(n, k3), s(n, Rt2), s(n, r.placeholderPrefix), s(n, k3), u(n, mt3);
    }
    function ia(r, n) {
      a = new Uint8Array(512), l3 = 0;
      try {
        var c = r.completedRootSegment;
        if (c !== null && r.pendingRootTasks === 0) {
          Tr3(r, n, c), r.completedRootSegment = null;
          var p = r.responseState.bootstrapChunks;
          for (c = 0; c < p.length - 1; c++) s(n, p[c]);
          c < p.length && u(n, p[c]);
        }
        var k3 = r.clientRenderedBoundaries, y3;
        for (y3 = 0; y3 < k3.length; y3++) {
          var T = k3[y3];
          p = n;
          ...
          s(p, Y2), s(p, hr2), (oe || te2 || me2) && (s(p, Ut3), s(p, v(dt3(oe || "")))), (te2 || me2) && (s(p, Ut3), s(p, v(dt3(te2 || "")))), me2 && (s(p, Ut3), s(p, v(dt3(me2)))), u(p, Vt2);
        }
        k3.splice(0, y3);
        var Oe2 = r.completedBoundaries;
        for (y3 = 0; y3 < Oe2.length; y3++) Ha(r, n, Oe2[y3]);
        Oe2.splice(0, y3), h(n), a = new Uint8Array(512), l3 = 0;
        var Ye2 = r.partialBoundaries;
        for (y3 = 0; y3 < Ye2.length; y3++) {
          var Xe2 = Ye2[y3];
          e: {
            k3 = r, T = n;
            var Fr3 = Xe2.completedSegments;
            for (M = 0; M < Fr3.length; M++) if (!Va(k3, T, Xe2, Fr3[M])) {
              M++, Fr3.splice(0, M);
              var Wa = false;
              break e;
            }
            Fr3.splice(0, M), Wa = true;
          }
          if (!Wa) {
            r.destination = null, y3++, Ye2.splice(0, y3);
            return;
          }
        }
        Ye2.splice(0, y3);
        var sa = r.completedBoundaries;
        for (y3 = 0; y3 < sa.length; y3++) Ha(r, n, sa[y3]);
        sa.splice(0, y3);
      } finally {
        h(n), r.allPendingTasks === 0 && r.pingedTasks.length === 0 && r.clientRenderedBoundaries.length === 0 && r.completedBoundaries.length === 0 && n.close();
      }
    }
    function Ua(r, n) {
      try {
    ...
    return Ir3.renderToReadableStream = function(r, n) {
      return new Promise(function(c, p) {
        var k3, y3, T = new Promise(function(te2, me2) {
          y3 = te2, k3 = me2;
        }), M = wn2(r, W(n ? n.identifierPrefix : void 0, n ? n.nonce : void 0, n ? n.bootstrapScriptContent : void 0, n ? n.bootstrapScripts : void 0, n ? n.bootstrapModules : void 0), q3(n ? n.namespaceURI : void 0), n ? n.progressiveChunkSize : void 0, n ? n.onError : void 0, y3, function() {
          var te2 = new ReadableStream({ type: "bytes", pull: function(me2) {
            if (M.status === 1) M.status = 2, m3(me2, M.fatalError);
        ...
        if (n && n.signal) {
          var Y2 = n.signal, oe = function() {
            Ua(M, Y2.reason), Y2.removeEventListener("abort", oe);
          };
  ...
  function Al() {
    ...
    ho = 1;
    var o, e;
    return o = Ml(), e = jl(), ht2.version = o.version, ht2.renderToString = o.renderToString, ht2.renderToStaticMarkup = o.renderToStaticMarkup, ht2.renderToNodeStream = o.renderToNodeStream, ht2.renderToStaticNodeStream = o.renderToStaticNodeStream, ht2.renderToReadableStream = e.renderToReadableStream, ht2;
  }
  var Dl = Al();
  var ua = { exports: {} };
  var pa;
  ...
  function Ol() {
    ...
    return a.resetWarningCache = e, fa = function() {
      function l3(h, g, v, b3, m3, E) {
        if (E !== o) {
          var R3 = new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");
          throw R3.name = "Invariant Violation", R3;
        }
      }
      l3.isRequired = l3;
      function s() {
      ...
      var u = { array: l3, bigint: l3, bool: l3, func: l3, number: l3, object: l3, string: l3, symbol: l3, any: l3, arrayOf: s, element: l3, elementType: l3, instanceOf: s, node: l3, objectOf: s, oneOf: s, oneOfType: s, shape: s, exact: s, checkPropTypes: a, resetWarningCache: e };
      return u.PropTypes = u, u;
    }, fa;
  }
  var bo;
  function Ll() {
    return bo || (bo = 1, ua.exports = Ol()()), ua.exports;
  }
  var Bl = Ll();
  var Je = Qs2(Bl);
  ...
  var Vl = Uo((function(o) {
    (function(e) {
      var a = function(w3, P3, S2) {
        if (!v(P3) || m3(P3) || E(P3) || R3(P3) || g(P3)) return P3;
        var I2, N3 = 0, H = 0;
        if (b3(P3)) for (I2 = [], H = P3.length; N3 < H; N3++) I2.push(a(w3, P3[N3], S2));
        else for (var O3 in I2 = {}, P3) Object.prototype.hasOwnProperty.call(P3, O3) && (I2[w3(O3, S2)] = a(w3, P3[O3], S2));
        return I2;
      }, l3 = function(w3) {
        return K2(w3) ? w3 : (w3 = w3.replace(/[\-_\s]+(.)?/g, (function(P3, S2) {
          return S2 ? S2.toUpperCase() : "";
        }))).substr(0, 1).toLowerCase() + w3.substr(1);
      }, s = function(w3) {
        var P3 = l3(w3);
        return P3.substr(0, 1).toUpperCase() + P3.substr(1);
      }, u = function(w3, P3) {
        ...
        var S2 = P3 && "process" in P3 ? P3.process : P3;
        return typeof S2 != "function" ? w3 : function(I2, N3) {
          return S2(I2, w3, N3);
        };
      }, j2 = { camelize: l3, decamelize: u, pascalize: s, depascalize: u, camelizeKeys: function(w3, P3) {
        return a(F(l3, P3), w3);
      }, decamelizeKeys: function(w3, P3) {
        return a(F(u, P3), w3, P3);
      }, pascalizeKeys: function(w3, P3) {
        return a(F(s, P3), w3);
  ...
  var Wl = function(o, e) {
    if (typeof Symbol < "u" && Symbol.iterator in Object(o)) {
      var a = [], l3 = true, s = false, u = void 0;
      try {
        for (var h, g = o[Symbol.iterator](); !(l3 = (h = g.next()).done) && (a.push(h.value), !e || a.length !== e); l3 = true) ;
      } catch (v) {
        s = true, u = v;
      } finally {
        try {
          l3 || g.return == null || g.return();
        } finally {
          if (s) throw u;
        }
      }
  ...
  var wo = function(o, e) {
    ...
    for (var a = 0, l3 = new Array(e); a < e; a++) l3[a] = o[a];
    return l3;
  };
  var ql2 = function(o, e) {
    if (o) {
      ...
      return a === "Object" && o.constructor && (a = o.constructor.name), a === "Map" || a === "Set" ? Array.from(o) : a === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(a) ? wo(o, e) : void 0;
    }
  };
  var Zl2 = function() {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var Yl2 = function(o, e) {
    return Ul(o) || Wl(o, e) || ql2(o, e) || Zl2();
  };
  var Wo = Uo((function(o) {
    function e() {
  ...
  var Xl2 = function(o, e) {
    if (o == null) return {};
    var a, l3, s = {}, u = Object.keys(o);
    for (l3 = 0; l3 < u.length; l3++) a = u[l3], e.indexOf(a) >= 0 || (s[a] = o[a]);
    return s;
  };
  var qo = function(o, e) {
    if (o == null) return {};
    ...
    if (Object.getOwnPropertySymbols) {
      ...
      for (l3 = 0; l3 < u.length; l3++) a = u[l3], e.indexOf(a) >= 0 || Object.prototype.propertyIsEnumerable.call(o, a) && (s[a] = o[a]);
    }
    return s;
  };
  var Zo = S.createContext(null);
  function Yo(o) {
    var e = o.children, a = e === void 0 ? "" : e, l3 = qo(o, ["children"]);
    return typeof a != "string" && (a = Dl.renderToString(a)), Re2.createElement("template", Wo({}, l3, { dangerouslySetInnerHTML: { __html: a } }));
  }
  function Xo(o) {
  ...
  function Gl(o) {
    var e = S.forwardRef((function(a, l3) {
      var s, u, h = a.mode, g = h === void 0 ? "open" : h, v = a.delegatesFocus, b3 = v !== void 0 && v, m3 = a.styleSheets, E = m3 === void 0 ? [] : m3, R3 = a.ssr, K2 = R3 !== void 0 && R3, F = a.children, j2 = qo(a, ["mode", "delegatesFocus", "styleSheets", "ssr", "children"]), w3 = (u = S.useRef((s = l3) && s.current), S.useEffect((function() {
        s && (s.current = u.current);
      }), [s]), u), P3 = S.useState(null), S2 = Yl2(P3, 2), I2 = S2[0], N3 = S2[1], H = "node_".concat(g).concat(b3);
      return S.useLayoutEffect((function() {
        if (w3.current) try {
          if (typeof l3 == "function" && l3(w3.current), K2) {
      ...
      }), [l3, w3, E]), Re2.createElement(Re2.Fragment, null, Re2.createElement(o.tag, Wo({ key: H, ref: w3 }, j2), (I2 || K2) && Re2.createElement(Zo.Provider, { value: I2 }, K2 ? Re2.createElement(Yo, { shadowroot: g, shadowrootmode: g }, o.render({ root: I2, ssr: K2, children: F })) : Re2.createElement(Xo, { root: I2 }, o.render({ root: I2, ssr: K2, children: F })))));
    }));
  ...
  Yo.propTypes = { children: Je.oneOfType([Je.string, Je.node]) }, Xo.propTypes = { root: Je.object.isRequired, children: Je.node };
  var ha = /* @__PURE__ */ new Map();
  function Jl2() {
    return S.useContext(Zo);
  }
  function Ql2() {
    var o = arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : {}, e = arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "core", a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : function(l3) {
      return l3.children;
    };
    return new Proxy(o, { get: function(l3, s) {
      var u = Vl(s, { separator: "-" }), h = "".concat(e, "-").concat(u);
      return ha.has(h) || ha.set(h, Gl({ tag: u, render: a })), ha.get(h);
    } });
  }
  var ei3 = Ql2();
  var ga;
  ...
  function ti3() {
    ...
    ga = function(E) {
      ...
      return o.forEach(function(K2) {
        var F = v(K2);
        function j2(w3) {
          for (var P3 = w3.path || w3.composedPath && w3.composedPath() || b3(w3.target), S2 = 0; S2 < P3.length; S2++) {
            var I2 = P3[S2], N3 = null, H = s(I2), O3 = l3(I2);
            if (O3 ? N3 = O3 : N3 = h(H), H && N3 && g(w3, K2, N3), H && N3 && a[K2] && g(w3, a[K2], N3), w3.cancelBubble || I2 === E) break;
          }
        }
        E.addEventListener(F, j2, false), R3.push(function() {
          E.removeEventListener(F, j2, false);
        });
      }), function() {
        R3.forEach(function(K2) {
          K2();
        });
      };
    };
    function l3(m3) {
      return u(m3, "__reactEventHandlers");
    }
    function s(m3) {
      return u(m3, "_reactInternal");
    }
    function u(m3, E) {
      for (var R3 in m3) if (m3.hasOwnProperty(R3) && R3.indexOf(E) !== -1) return m3[R3];
    }
    function h(m3) {
      if (m3) {
        if (m3.memoizedProps) return m3.memoizedProps;
        if (m3._currentElement && m3._currentElement.props) return m3._currentElement.props;
      }
    }
    function g(m3, E, R3) {
      m3.persist = function() {
        m3.isPersistent = function() {
          return true;
        };
      }, R3[E] && R3[E](m3);
    }
    function v(m3) {
      return e[m3] ? e[m3] : m3.replace(/^on/, "").toLowerCase();
    }
    function b3(m3) {
      for (var E = []; m3; ) {
        if (E.push(m3), m3.tagName === "HTML") return E.push(document), E.push(window), E;
        m3 = m3.parentElement;
      }
    }
    return ga;
  ...
  var ci3 = class {
    build(e, a) {
      return this.context = a, xo(() => this.iterateCollection(e));
    }
    *iterateCollection(e) {
      let { children: a, items: l3 } = e;
      if (Re2.isValidElement(a) && a.type === Re2.Fragment) yield* this.iterateCollection({ children: a.props.children, items: l3 });
      else if (typeof a == "function") {
        if (!l3) throw new Error("props.children was a function but props.items is missing");
        let s = 0;
        for (let u of l3) yield* this.getFullNode({ value: u, index: s }, { renderer: a }), s++;
      } else {
        let s = [];
    ...
    *getFullNode(e, a, l3, s) {
      if (Re2.isValidElement(e.element) && e.element.type === Re2.Fragment) {
        ...
        var u;
        let P3 = (u = e.index) !== null && u !== void 0 ? u : 0;
        for (const S2 of w3) yield* this.getFullNode({ element: S2, index: P3++ }, a, l3, s);
        return;
      }
      let h = e.element;
      ...
      if (Re2.isValidElement(h)) {
        ...
        let P3 = w3.getCollectionNode(h.props, this.context);
        var g;
        let S2 = (g = e.index) !== null && g !== void 0 ? g : 0, I2 = P3.next();
        for (; !I2.done && I2.value; ) {
          let N3 = I2.value;
          e.index = S2;
          var v;
          let H = (v = N3.key) !== null && v !== void 0 ? v : null;
          H == null && (H = N3.element ? null : this.getKey(h, e, a, l3));
          let B2 = [...this.getFullNode({ ...N3, key: H, index: S2, wrapper: di3(e.wrapper, N3.wrapper) }, this.getChildState(a, N3), l3 ? `${l3}${h.key}` : h.key, s)];
          for (let ae2 of B2) {
            var b3, m3;
            ae2.value = (m3 = (b3 = N3.value) !== null && b3 !== void 0 ? b3 : e.value) !== null && m3 !== void 0 ? m3 : null, ae2.value && this.cache.set(ae2.value, ae2);
            var E;
  ...
  function xo(o) {
    ...
    return { *[Symbol.iterator]() {
      for (let l3 of e) yield l3;
      a || (a = o());
      for (let l3 of a) e.push(l3), yield l3;
    } };
  }
  function di3(o, e) {
  ...
  function ui3(o, e, a) {
    let l3 = S.useMemo(() => new ci3(), []), { children: s, items: u, collection: h } = o;
    return S.useMemo(() => {
      if (h) return h;
      let v = l3.build({ children: s, items: u }, a);
      return e(v);
    }, [l3, s, u, h, a, e]);
  }
  function pi3(o, e) {
  ...
  function ba(o, e, a) {
    ...
    let l3 = [...yo(o, e), e], s = [...yo(o, a), a], u = l3.slice(0, s.length).findIndex((h, g) => h !== s[g]);
    return u !== -1 ? (e = l3[u], a = s[u], e.index - a.index) : l3.findIndex((h) => h === a) >= 0 ? 1 : (s.findIndex((h) => h === e) >= 0, -1);
  }
  function yo(o, e) {
    let a = [], l3 = e;
    for (; (l3 == null ? void 0 : l3.parentKey) != null; ) l3 = o.getItem(l3.parentKey), l3 && a.unshift(l3);
    return a;
  }
  var gi3 = (o) => {
  ...
  var vi3 = (o) => ({ top: "top", bottom: "bottom", left: "left", right: "right", "top-start": "top start", "top-end": "top end", "bottom-start": "bottom start", "bottom-end": "bottom end", "left-start": "left top", "left-end": "left bottom", "right-start": "right top", "right-end": "right bottom" })[o];
  var bi3 = (o, e) => {
    if (e.includes("-")) {
      const [a] = e.split("-");
  ...
  var Ae2 = [];
  function wi3(o, e = document.body) {
    let a = new Set(o), l3 = /* @__PURE__ */ new Set(), s = (v) => {
      for (let R3 of v.querySelectorAll("[data-live-announcer], [data-react-aria-top-layer]")) a.add(R3);
      let b3 = (R3) => {
        if (a.has(R3) || R3.parentElement && l3.has(R3.parentElement) && R3.parentElement.getAttribute("role") !== "row") return NodeFilter.FILTER_REJECT;
        for (let K2 of a) if (R3.contains(K2)) return NodeFilter.FILTER_SKIP;
        return NodeFilter.FILTER_ACCEPT;
      }, m3 = document.createTreeWalker(v, NodeFilter.SHOW_ELEMENT, { acceptNode: b3 }), E = b3(v);
      if (E === NodeFilter.FILTER_ACCEPT && u(v), E !== NodeFilter.FILTER_REJECT) {
        let R3 = m3.nextNode();
        for (; R3 != null; ) u(R3), R3 = m3.nextNode();
      }
    }, u = (v) => {
      var b3;
      let m3 = (b3 = rr2.get(v)) != null ? b3 : 0;
      v.getAttribute("aria-hidden") === "true" && m3 === 0 || (m3 === 0 && v.setAttribute("aria-hidden", "true"), l3.add(v), rr2.set(v, m3 + 1));
    };
    Ae2.length && Ae2[Ae2.length - 1].disconnect(), s(e);
    let h = new MutationObserver((v) => {
      for (let b3 of v) if (!(b3.type !== "childList" || b3.addedNodes.length === 0) && ![...a, ...l3].some((m3) => m3.contains(b3.target))) {
        for (let m3 of b3.removedNodes) m3 instanceof Element && (a.delete(m3), l3.delete(m3));
        for (let m3 of b3.addedNodes) (m3 instanceof HTMLElement || m3 instanceof SVGElement) && (m3.dataset.liveAnnouncer === "true" || m3.dataset.reactAriaTopLayer === "true") ? a.add(m3) : m3 instanceof Element && s(m3);
      }
    });
    h.observe(e, { childList: true, subtree: true });
    let g = { visibleNodes: a, hiddenNodes: l3, observe() {
      h.observe(e, { childList: true, subtree: true });
    }, disconnect() {
      h.disconnect();
    } };
  ...
  function xi3(o, e) {
    const { groupRef: a, triggerRef: l3, popoverRef: s, showArrow: u, offset: h = 7, crossOffset: g = 0, scrollRef: v, shouldFlip: b3, boundaryElement: m3, isDismissable: E = true, shouldCloseOnBlur: R3 = true, shouldCloseOnScroll: K2 = true, placement: F = "top", containerPadding: j2, shouldCloseOnInteractOutside: w3, isNonModal: P3, isKeyboardDismissDisabled: S2, updatePositionDeps: I2 = [], ...N3 } = o, H = P3 ?? true, O3 = N3.trigger === "SubmenuTrigger", { overlayProps: B2, underlayProps: ae2 } = C2({ isOpen: e.isOpen, onClose: e.close, shouldCloseOnBlur: R3, isDismissable: E || O3, isKeyboardDismissDisabled: S2, shouldCloseOnInteractOutside: w3 || ((ge2) => {
      var ue2;
      return !((ue2 = l3.current) != null && ue2.contains(ge2));
    }), disableOutsideEvents: !H }, s), { overlayProps: re2, arrowProps: ne2, placement: le2, updatePosition: J3, triggerAnchorPoint: ie2 } = Tl({ ...N3, shouldFlip: b3, crossOffset: g, targetRef: l3, overlayRef: s, isOpen: e.isOpen, scrollRef: v, boundaryElement: m3, containerPadding: j2, placement: vi3(F), offset: u ? h + 3 : h, onClose: H && !O3 && K2 ? e.close : () => {
    } });
    return y2(() => {
      I2.length && J3();
    }, I2), S.useEffect(() => {
      var ge2, ue2;
      if (e.isOpen && s.current) return H ? mi3((ge2 = a == null ? void 0 : a.current) != null ? ge2 : s.current) : wi3([(ue2 = a == null ? void 0 : a.current) != null ? ue2 : s.current]);
    }, [H, e.isOpen, s, a]), { popoverProps: Io(B2, re2), arrowProps: ne2, underlayProps: ae2, placement: le2, triggerAnchorPoint: ie2 };
  }
  var yi3 = "top";
  function ki3(o) {
    var e, a, l3;
    const s = wi2(), [u, h] = xu(o, Ja.variantKeys), { as: g, ref: v, children: b3, state: m3, triggerRef: E, scrollRef: R3, defaultOpen: K2, onOpenChange: F, isOpen: j2, isNonModal: w3 = true, shouldFlip: P3 = true, containerPadding: S2 = 12, shouldBlockScroll: I2 = false, isDismissable: N3 = true, shouldCloseOnBlur: H, portalContainer: O3, updatePositionDeps: B2, dialogProps: ae2, placement: re2 = yi3, triggerType: ne2 = "dialog", showArrow: le2 = false, offset: J3 = 7, crossOffset: ie2 = 0, boundaryElement: ge2, isKeyboardDismissDisabled: ue2, shouldCloseOnInteractOutside: Se2, shouldCloseOnScroll: A2, triggerAnchorPoint: W, motionProps: V2, className: q3, classNames: U3, onClose: se, ...ce2 } = u, ee2 = g || "div", we2 = Ar2(v), Fe2 = S.useRef(null), Ee2 = S.useRef(false), _e2 = E || Fe2, pe2 = (a = (e = o.disableAnimation) != null ? e : s == null ? void 0 : s.disableAnimation) != null ? a : false, ye = P2({ isOpen: j2, defaultOpen: K2, onOpenChange: (Ce2) => {
      F == null || F(Ce2), Ce2 || se == null || se();
    } }), de2 = m3 || ye, { popoverProps: L3, underlayProps: fe2, placement: he3 } = xi3({ triggerRef: _e2, isNonModal: w3, popoverRef: we2, placement: re2, offset: J3, scrollRef: R3, isDismissable: N3, shouldCloseOnBlur: H, boundaryElement: ge2, crossOffset: ie2, shouldFlip: P3, containerPadding: S2, updatePositionDeps: B2, isKeyboardDismissDisabled: ue2, shouldCloseOnScroll: A2, shouldCloseOnInteractOutside: Se2, triggerAnchorPoint: W }, de2), Le3 = S.useMemo(() => he3 ? bi3(he3, re2) ? he3 : re2 : null, [he3, re2]), { triggerProps: X2 } = Kl2({ type: ne2 }, de2, _e2), { isFocusVisible: $e2, isFocused: He2, focusProps: Ve3 } = lm(), Ie2 = S.useMemo(() => Ja({ ...h }), [qs2(h)]), it2 = Nn(U3 == null ? void 0 : U3.base, q3), je2 = { "--trigger-anchor-point": W ? `${W.x}px ${W.y}px` : void 0 };
    yw({ isDisabled: !(I2 && de2.isOpen) });
    const Re3 = (Ce2 = {}) => ({ ref: we2, ...Io(L3, ce2, Ce2), style: Io(L3.style, ce2.style, Ce2.style) }), st2 = (Ce2 = {}) => ({ "data-slot": "base", "data-open": lt2(de2.isOpen), "data-focus": lt2(He2), "data-arrow": lt2(le2), "data-focus-visible": lt2($e2), "data-placement": he3 ? ko(he3, re2) : void 0, ...Io(Ve3, ae2, Ce2), className: Ie2.base({ class: Nn(it2) }), style: { outline: "none", ...je2 } }), ct2 = S.useCallback((Ce2 = {}) => ({ "data-slot": "content", "data-open": lt2(de2.isOpen), "data-arrow": lt2(le2), "data-placement": he3 ? ko(he3, re2) : void 0, className: Ie2.content({ class: Nn(U3 == null ? void 0 : U3.content, Ce2.className) }) }), [Ie2, de2.isOpen, le2, Le3, re2, U3, he3]), Pe2 = S.useCallback((Ce2) => {
      var We2;
      let at2;
      ...
      return { "data-slot": "trigger", ...Io({ "aria-haspopup": "dialog" }, X2, gt2), onPress: Pe2, isDisabled: at2, className: Ie2.trigger({ class: Nn(U3 == null ? void 0 : U3.trigger, Ce2.className), isTriggerDisabled: at2 }), ref: o2(We2, _e2) };
    }, [de2, X2, Pe2, _e2]), Ue2 = S.useCallback((Ce2 = {}) => ({ "data-slot": "backdrop", className: Ie2.backdrop({ class: U3 == null ? void 0 : U3.backdrop }), onClick: (We2) => {
      if (!Ee2.current) {
        We2.preventDefault();
        return;
      }
      de2.close(), Ee2.current = false;
    }, ...fe2, ...Ce2 }), [Ie2, de2.isOpen, U3, fe2]);
    return { state: de2, Component: ee2, children: b3, classNames: U3, showArrow: le2, triggerRef: _e2, placement: Le3, isNonModal: w3, popoverRef: we2, portalContainer: O3, isOpen: de2.isOpen, onClose: de2.close, disableAnimation: pe2, shouldBlockScroll: I2, backdrop: (l3 = o.backdrop) != null ? l3 : "transparent", motionProps: V2, getBackdropProps: Ue2, getPopoverProps: Re3, getTriggerProps: rt2, getDialogProps: st2, getContentProps: ct2 };
  }
  var [Si3, Qo] = fu({ name: "PopoverContext", errorMessage: "usePopoverContext: `context` is undefined. Seems you forgot to wrap all popover components within `<Popover />`" });
  var So = () => ku(() => Promise.resolve().then(() => (init_index_chunk(), index_chunk_exports)), __vite__mapDeps2([0, 1, 2])).then((o) => o.default);
  var en3 = (o) => {
    const { as: e, children: a, className: l3, ...s } = o, { Component: u, placement: h, backdrop: g, motionProps: v, disableAnimation: b3, getPopoverProps: m3, getDialogProps: E, getBackdropProps: R3, getContentProps: K2, isNonModal: F, onClose: j2 } = Qo(), w3 = S.useRef(null), { dialogProps: P3, titleProps: S2 } = $2({}, w3), I2 = E({ ref: w3, ...P3, ...s }), N3 = e || u || "div", H = a && Q2.jsxs(Q2.Fragment, { children: [!F && Q2.jsx(c2, { onDismiss: j2 }), Q2.jsx(N3, { ...I2, children: Q2.jsx("div", { ...K2({ className: l3 }), children: typeof a == "function" ? a(S2) : a }) }), Q2.jsx(c2, { onDismiss: j2 })] }), O3 = S.useMemo(() => g === "transparent" ? null : b3 ? Q2.jsx("div", { ...R3() }) : Q2.jsx(gu, { features: So, children: Q2.jsx(bu.div, { animate: "enter", exit: "exit", initial: "exit", variants: f2.fade, ...R3() }) }), [g, b3, R3]), B2 = h ? gi3(h === "center" ? "top" : h) : void 0, ae2 = Q2.jsx(Q2.Fragment, { children: b3 ? H : Q2.jsx(gu, { features: So, children: Q2.jsx(bu.div, { animate: "enter", exit: "exit", initial: "initial", style: B2, variants: f2.scaleSpringOpacity, ...v, children: H }) }) });
    return Q2.jsxs("div", { ...m3(), children: [O3, ae2] });
  };
  en3.displayName = "HeroUI.PopoverContent";
  var Ci2 = en3;
  var tn3 = (o) => {
    var e;
    const { triggerRef: a, getTriggerProps: l3 } = Qo(), { children: s, ...u } = o, h = S.useMemo(() => typeof s == "string" ? Q2.jsx("p", { children: s }) : S.Children.only(s), [s]), g = (e = h.props.ref) != null ? e : h.ref, { onPress: v, isDisabled: b3, ...m3 } = S.useMemo(() => l3(Io(u, h.props), g), [l3, h.props, u, g]), [, E] = qy(s, g2), { buttonProps: R3 } = Uw({ onPress: v, isDisabled: b3 }, a), K2 = S.useMemo(() => (E == null ? void 0 : E[0]) !== void 0, [E]);
    return K2 || delete m3.preventFocusOnPress, S.cloneElement(h, Io(m3, K2 ? { onPress: v, isDisabled: b3 } : R3));
  };
  tn3.displayName = "HeroUI.PopoverTrigger";
  var Ei2 = tn3;
  var rn3 = qn2((o, e) => {
    const { children: a, ...l3 } = o, s = ki3({ ...l3, ref: e }), [u, h] = S.Children.toArray(a), g = Q2.jsx(dp, { portalContainer: s.portalContainer, children: h });
    return Q2.jsxs(Si3, { value: s, children: [u, s.disableAnimation && s.isOpen ? g : Q2.jsx(mm, { children: s.isOpen ? g : null })] });
  });
  rn3.displayName = "HeroUI.Popover";
  var _i2 = rn3;
  function Pi2(o, e, a) {
    let { item: l3, isDisabled: s } = o, u = l3.key, h = e.selectionManager, g = S.useId(), v = S.useId(), b3 = e.disabledKeys.has(l3.key) || s;
    S.useEffect(() => {
      u === e.focusedKey && document.activeElement !== a.current && a.current && di2(a.current);
    }, [a, u, e.focusedKey]);
    let m3 = S.useCallback((j2) => {
    ...
    const E = S.useCallback((j2) => {
      ...
      P3 && (j2.preventDefault(), h.canSelectItem(u) && P3(j2));
    }, [u, h]);
    let { buttonProps: K2 } = Il({ id: g, elementType: "button", isDisabled: b3, onKeyDown: R3, onPress: m3 }, a), F = e.selectionManager.isSelected(l3.key);
    return { buttonProps: { ...K2, "aria-expanded": F, "aria-controls": F ? v : void 0 }, regionProps: { id: v, role: "region", "aria-labelledby": g } };
  }
  function Co2(o) {
  ...
  function jr(o, e) {
    ...
    return u && (s = `[data-collection="${CSS.escape(u)}"]${s}`), (l3 = o.current) === null || l3 === void 0 ? void 0 : l3.querySelector(s);
  }
  var zi2 = /* @__PURE__ */ new WeakMap();
  function $i2(o) {
    let e = _p();
    return zi2.set(o, e), e;
  }
  var Ti2 = 1e3;
  function Fi2(o) {
    let { keyboardDelegate: e, selectionManager: a, onTypeSelect: l3 } = o, s = S.useRef({ search: "", timeout: void 0 }).current, u = (h) => {
      let g = Ri2(h.key);
      if (!(!g || h.ctrlKey || h.metaKey || !h.currentTarget.contains(h.target) || s.search.length === 0 && g === " ")) {
        if (g === " " && s.search.trim().length > 0 && (h.preventDefault(), "continuePropagation" in h || h.stopPropagation()), s.search += g, e.getKeyForSearch != null) {
          ...
          v == null && (v = e.getKeyForSearch(s.search)), v != null && (a.setFocusedKey(v), l3 && l3(v));
        }
  ...
  function Ki2(o) {
    let { selectionManager: e, keyboardDelegate: a, ref: l3, autoFocus: s = false, shouldFocusWrap: u = false, disallowEmptySelection: h = false, disallowSelectAll: g = false, escapeKeyBehavior: v = "clearSelection", selectOnFocus: b3 = e.selectionBehavior === "replace", disallowTypeAhead: m3 = false, shouldUseVirtualFocus: E, allowsTabNavigation: R3 = false, isVirtualized: K2, scrollRef: F = l3, linkBehavior: j2 = "action" } = o, { direction: w3 } = s1(), P3 = Fp(), S2 = (A2) => {
      var W;
      if (A2.altKey && A2.key === "Tab" && A2.preventDefault(), !(!((W = l3.current) === null || W === void 0) && W.contains(A2.target))) return;
      const V2 = (L3, fe2) => {
        if (L3 != null) {
          if (e.isLink(L3) && j2 === "selection" && b3 && !Co2(A2)) {
            dy.flushSync(() => {
              e.setFocusedKey(L3, fe2);
            });
            let he3 = jr(l3, L3), Le3 = e.getItemProps(L3);
            he3 && P3.open(he3, A2, Le3.href, Le3.routerOptions);
            return;
          }
          if (e.setFocusedKey(L3, fe2), e.isLink(L3) && j2 === "override") return;
          A2.shiftKey && e.selectionMode === "multiple" ? e.extendSelection(L3) : b3 && !Co2(A2) && e.replaceSelection(L3);
        }
      };
      switch (A2.key) {
        case "ArrowDown":
          if (a.getKeyBelow) {
            var q3, U3, se;
            let L3 = e.focusedKey != null ? (q3 = a.getKeyBelow) === null || q3 === void 0 ? void 0 : q3.call(a, e.focusedKey) : (U3 = a.getFirstKey) === null || U3 === void 0 ? void 0 : U3.call(a);
        ...
        case "ArrowLeft":
          if (a.getKeyLeftOf) {
            var Fe2, Ee2, _e2;
            let L3 = e.focusedKey != null ? (Fe2 = a.getKeyLeftOf) === null || Fe2 === void 0 ? void 0 : Fe2.call(a, e.focusedKey) : null;
            L3 == null && u && (L3 = w3 === "rtl" ? (Ee2 = a.getFirstKey) === null || Ee2 === void 0 ? void 0 : Ee2.call(a, e.focusedKey) : (_e2 = a.getLastKey) === null || _e2 === void 0 ? void 0 : _e2.call(a, e.focusedKey)), L3 != null && (A2.preventDefault(), V2(L3, w3 === "rtl" ? "first" : "last"));
          }
          break;
        case "ArrowRight":
          if (a.getKeyRightOf) {
        ...
        case "Tab":
          if (!R3) {
            if (A2.shiftKey) l3.current.focus();
            else {
              let L3 = Tn2(l3.current, { tabbable: true }), fe2, he3;
              do
    ...
    Rr3(F, "scroll", K2 ? void 0 : () => {
      var A2, W, V2, q3;
      I2.current = { top: (V2 = (A2 = F.current) === null || A2 === void 0 ? void 0 : A2.scrollTop) !== null && V2 !== void 0 ? V2 : 0, left: (q3 = (W = F.current) === null || W === void 0 ? void 0 : W.scrollLeft) !== null && q3 !== void 0 ? q3 : 0 };
    });
    let N3 = (A2) => {
      if (e.isFocused) {
      ...
      if (A2.currentTarget.contains(A2.target)) {
        ...
        } else !K2 && F.current && (F.current.scrollTop = I2.current.top, F.current.scrollLeft = I2.current.left);
        if (e.focusedKey != null && F.current) {
          let se = jr(l3, e.focusedKey);
          se instanceof HTMLElement && (!se.contains(document.activeElement) && !E && Mr2(se), em() === "keyboard" && ro(se, { containingElement: l3.current }));
        }
      }
    }, H = (A2) => {
    ...
    Rr3(l3, sl, E ? (A2) => {
      let { detail: W } = A2;
      A2.stopPropagation(), e.setFocused(true), (W == null ? void 0 : W.focusStrategy) === "first" && (O3.current = true);
    } : void 0);
    let B2 = $t2(() => {
      var A2, W;
      ...
      if (V2 == null) {
        let q3 = mt2();
        cl(l3.current), Lo2(q3, null), e.collection.size > 0 && (O3.current = false);
    ...
    Qa(() => {
      ae2();
    }, [e.focusedKey, ae2]), Rr3(l3, il, E ? (A2) => {
      var W;
    ...
    S.useEffect(() => {
      if (re2.current) {
        ...
        e.setFocused(true), e.setFocusedKey(U3), U3 == null && !E && l3.current && di2(l3.current), e.collection.size > 0 && (re2.current = false, ne2.current = true);
      }
    });
    let le2 = S.useRef(e.focusedKey), J3 = S.useRef(null);
    S.useEffect(() => {
      if (e.isFocused && e.focusedKey != null && (e.focusedKey !== le2.current || ne2.current) && F.current && l3.current) {
        let A2 = em(), W = jr(l3, e.focusedKey);
        ...
        (A2 === "keyboard" || ne2.current) && (J3.current && cancelAnimationFrame(J3.current), J3.current = requestAnimationFrame(() => {
          F.current && (Oo(F.current, W), A2 !== "virtual" && ro(W, { containingElement: l3.current }));
        }));
      }
      !E && e.isFocused && e.focusedKey == null && le2.current != null && l3.current && di2(l3.current), le2.current = e.focusedKey, ne2.current = false;
    }), S.useEffect(() => () => {
      J3.current && cancelAnimationFrame(J3.current);
    }, []), Rr3(l3, "react-aria-focus-scope-restore", (A2) => {
    ...
    } }, { typeSelectProps: ge2 } = Fi2({ keyboardDelegate: a, selectionManager: e });
    m3 || (ie2 = nn2(ge2, ie2));
    let ue2;
    E || (ue2 = e.focusedKey == null ? 0 : -1);
    let Se2 = $i2(e.collection);
  ...
  var Eo = class {
    getItemRect(e) {
      ...
      if (!a) return null;
      let l3 = e != null ? jr(this.ref, e) : null;
      if (!l3) return null;
      let s = a.getBoundingClientRect(), u = l3.getBoundingClientRect();
      return { x: u.left - s.left + a.scrollLeft, y: u.top - s.top + a.scrollTop, width: u.width, height: u.height };
    }
    getContentSize() {
      let e = this.ref.current;
      var a, l3;
      return { width: (a = e == null ? void 0 : e.scrollWidth) !== null && a !== void 0 ? a : 0, height: (l3 = e == null ? void 0 : e.scrollHeight) !== null && l3 !== void 0 ? l3 : 0 };
    }
    getVisibleRect() {
      let e = this.ref.current;
      var a, l3, s, u;
      return { x: (a = e == null ? void 0 : e.scrollLeft) !== null && a !== void 0 ? a : 0, y: (l3 = e == null ? void 0 : e.scrollTop) !== null && l3 !== void 0 ? l3 : 0, width: (s = e == null ? void 0 : e.offsetWidth) !== null && s !== void 0 ? s : 0, height: (u = e == null ? void 0 : e.offsetHeight) !== null && u !== void 0 ? u : 0 };
    }
    constructor(e) {
      this.ref = e;
    }
  ...
  var Ii2 = class {
    ...
    findNextNonDisabled(e, a) {
      let l3 = e;
      for (; l3 != null; ) {
        let s = this.collection.getItem(l3);
        if ((s == null ? void 0 : s.type) === "item" && !this.isDisabled(s)) return l3;
        l3 = a(l3);
      }
      return null;
    }
    getNextKey(e) {
      let a = e;
      return a = this.collection.getKeyAfter(a), this.findNextNonDisabled(a, (l3) => this.collection.getKeyAfter(l3));
    }
    getPreviousKey(e) {
      let a = e;
      return a = this.collection.getKeyBefore(a), this.findNextNonDisabled(a, (l3) => this.collection.getKeyBefore(l3));
    }
    findKey(e, a, l3) {
    ...
    getKeyRightOf(e) {
      ...
      return this.layoutDelegate[a] ? (e = this.layoutDelegate[a](e), this.findNextNonDisabled(e, (l3) => this.layoutDelegate[a](l3))) : this.layout === "grid" ? this.orientation === "vertical" ? this.getNextColumn(e, this.direction === "rtl") : this.findKey(e, (l3) => this.getNextColumn(l3, this.direction === "rtl"), this.isSameColumn) : this.orientation === "horizontal" ? this.getNextColumn(e, this.direction === "rtl") : null;
    }
    getKeyLeftOf(e) {
      let a = this.direction === "ltr" ? "getKeyLeftOf" : "getKeyRightOf";
      return this.layoutDelegate[a] ? (e = this.layoutDelegate[a](e), this.findNextNonDisabled(e, (l3) => this.layoutDelegate[a](l3))) : this.layout === "grid" ? this.orientation === "vertical" ? this.getNextColumn(e, this.direction === "ltr") : this.findKey(e, (l3) => this.getNextColumn(l3, this.direction === "ltr"), this.isSameColumn) : this.orientation === "horizontal" ? this.getNextColumn(e, this.direction === "ltr") : null;
    }
    getFirstKey() {
    ...
    getKeyPageAbove(e) {
      let a = this.ref.current, l3 = this.layoutDelegate.getItemRect(e);
      if (!l3) return null;
      if (a && !Of(a)) return this.getFirstKey();
      let s = e;
      if (this.orientation === "horizontal") {
        let u = Math.max(0, l3.x + l3.width - this.layoutDelegate.getVisibleRect().width);
        for (; l3 && l3.x > u && s != null; ) s = this.getKeyAbove(s), l3 = s == null ? null : this.layoutDelegate.getItemRect(s);
      } else {
        let u = Math.max(0, l3.y + l3.height - this.layoutDelegate.getVisibleRect().height);
        for (; l3 && l3.y > u && s != null; ) s = this.getKeyAbove(s), l3 = s == null ? null : this.layoutDelegate.getItemRect(s);
      }
    ...
    getKeyPageBelow(e) {
      ...
      let s = e;
      if (this.orientation === "horizontal") {
        let u = Math.min(this.layoutDelegate.getContentSize().width, l3.y - l3.width + this.layoutDelegate.getVisibleRect().width);
        for (; l3 && l3.x < u && s != null; ) s = this.getKeyBelow(s), l3 = s == null ? null : this.layoutDelegate.getItemRect(s);
      } else {
        let u = Math.min(this.layoutDelegate.getContentSize().height, l3.y - l3.height + this.layoutDelegate.getVisibleRect().height);
        for (; l3 && l3.y < u && s != null; ) s = this.getKeyBelow(s), l3 = s == null ? null : this.layoutDelegate.getItemRect(s);
      }
      return s ?? this.getLastKey();
    }
    getKeyForSearch(e, a) {
      if (!this.collator) return null;
      let l3 = this.collection, s = a || this.getFirstKey();
      for (; s != null; ) {
        let u = l3.getItem(s);
        if (!u) return null;
    ...
    constructor(...e) {
      if (e.length === 1) {
        let a = e[0];
        this.collection = a.collection, this.ref = a.ref, this.collator = a.collator, this.disabledKeys = a.disabledKeys || /* @__PURE__ */ new Set(), this.disabledBehavior = a.disabledBehavior || "all", this.orientation = a.orientation || "vertical", this.direction = a.direction, this.layout = a.layout || "stack", this.layoutDelegate = a.layoutDelegate || new Eo(a.ref);
      } else this.collection = e[0], this.disabledKeys = e[1], this.ref = e[2], this.collator = e[3], this.layout = "stack", this.orientation = "vertical", this.disabledBehavior = "all", this.layoutDelegate = new Eo(this.ref);
      this.layout === "stack" && this.orientation === "vertical" && (this.getKeyLeftOf = void 0, this.getKeyRightOf = void 0);
    }
  };
  function Mi2(o) {
    let { selectionManager: e, collection: a, disabledKeys: l3, ref: s, keyboardDelegate: u, layoutDelegate: h } = o, g = pl({ usage: "search", sensitivity: "base" }), v = e.disabledBehavior, b3 = S.useMemo(() => u || new Ii2({ collection: a, disabledKeys: l3, disabledBehavior: v, ref: s, collator: g, layoutDelegate: h }), [u, h, a, l3, s, g, v]), { collectionProps: m3 } = Ki2({ ...o, ref: s, selectionManager: e, keyboardDelegate: b3 });
    return { listProps: m3 };
  }
  function ji2(o, e, a) {
    let { listProps: l3 } = Mi2({ ...o, ...e, allowsTabNavigation: true, disallowSelectAll: true, ref: a });
    return delete l3.onKeyDownCapture, { accordionProps: { ...l3, tabIndex: void 0 } };
  }
  function Ai2(o) {
    var e, a;
    const l3 = wi2(), { ref: s, as: u, item: h, onFocusChange: g } = o, { state: v, className: b3, indicator: m3, children: E, title: R3, subtitle: K2, startContent: F, motionProps: j2, focusedKey: w3, variant: P3, isCompact: S2 = false, classNames: I2 = {}, isDisabled: N3 = false, hideIndicator: H = false, disableAnimation: O3 = (e = l3 == null ? void 0 : l3.disableAnimation) != null ? e : false, keepContentMounted: B2 = false, disableIndicatorAnimation: ae2 = false, HeadingComponent: re2 = u || "h2", onPress: ne2, onPressStart: le2, onPressEnd: J3, onPressChange: ie2, onPressUp: ge2, onClick: ue2, ...Se2 } = o, A2 = u || "div", W = typeof A2 == "string", V2 = Ar2(s), q3 = v.disabledKeys.has(h.key) || N3, U3 = v.selectionManager.isSelected(h.key), { buttonProps: se, regionProps: ce2 } = Pi2({ item: h, isDisabled: q3 }, { ...v, focusedKey: w3 }, V2), { onFocus: ee2, onBlur: we2, ...Fe2 } = se, { isFocused: Ee2, isFocusVisible: _e2, focusProps: pe2 } = lm({ autoFocus: (a = h.props) == null ? void 0 : a.autoFocus }), { isHovered: ye, hoverProps: de2 } = Vy({ isDisabled: q3 }), { pressProps: L3, isPressed: fe2 } = Kp({ ref: V2, isDisabled: q3, onPress: ne2, onPressStart: le2, onPressEnd: J3, onPressChange: ie2, onPressUp: ge2 }), he3 = S.useCallback(() => {
      g == null || g(true, h.key);
    }, []), Le3 = S.useCallback(() => {
      g == null || g(false, h.key);
    }, []), X2 = S.useMemo(() => ({ ...I2 }), [qs2(I2)]), $e2 = S.useMemo(() => ol({ isCompact: S2, isDisabled: q3, hideIndicator: H, disableAnimation: O3, disableIndicatorAnimation: ae2, variant: P3 }), [S2, q3, H, O3, ae2, P3]), He2 = Nn(X2 == null ? void 0 : X2.base, b3), Ve3 = S.useCallback((Pe2 = {}) => ({ "data-open": lt2(U3), "data-disabled": lt2(q3), "data-slot": "base", className: $e2.base({ class: He2 }), ...Io(qf(Se2, { enabled: W }), Pe2) }), [He2, W, Se2, $e2, h.props, U3, q3]), Ie2 = (Pe2 = {}) => {
      var rt2, Ue2;
      return { ref: V2, "data-open": lt2(U3), "data-focus": lt2(Ee2), "data-focus-visible": lt2(_e2), "data-disabled": lt2(q3), "data-hover": lt2(ye), "data-pressed": lt2(fe2), "data-slot": "trigger", className: $e2.trigger({ class: X2 == null ? void 0 : X2.trigger }), onFocus: r2(he3, ee2, pe2.onFocus, Se2.onFocus, (rt2 = h.props) == null ? void 0 : rt2.onFocus), onBlur: r2(Le3, we2, pe2.onBlur, Se2.onBlur, (Ue2 = h.props) == null ? void 0 : Ue2.onBlur), ...Io(Fe2, de2, L3, Pe2, { onClick: Np(L3.onClick, ue2) }) };
    ...
    return { Component: A2, HeadingComponent: re2, item: h, slots: $e2, classNames: X2, domRef: V2, indicator: m3, children: E, title: R3, subtitle: K2, startContent: F, isOpen: U3, isDisabled: q3, hideIndicator: H, keepContentMounted: B2, disableAnimation: O3, motionProps: j2, getBaseProps: Ve3, getHeadingProps: Re3, getButtonProps: Ie2, getContentProps: it2, getIndicatorProps: je2, getTitleProps: st2, getSubtitleProps: ct2 };
  }
  var _o2 = () => ku(() => Promise.resolve().then(() => (init_index_chunk(), index_chunk_exports)), __vite__mapDeps2([0, 1, 2])).then((o) => o.default);
  var an2 = qn2((o, e) => {
    const { Component: a, HeadingComponent: l3, classNames: s, slots: u, indicator: h, children: g, title: v, subtitle: b3, startContent: m3, isOpen: E, isDisabled: R3, hideIndicator: K2, keepContentMounted: F, disableAnimation: j2, motionProps: w3, getBaseProps: P3, getHeadingProps: S2, getButtonProps: I2, getTitleProps: N3, getSubtitleProps: H, getContentProps: O3, getIndicatorProps: B2 } = Ai2({ ...o, ref: e }), ae2 = yl(), ne2 = S.useMemo(() => typeof h == "function" ? h({ indicator: Q2.jsx(uo, {}), isOpen: E, isDisabled: R3 }) : h || null, [h, E, R3]) || Q2.jsx(uo, {}), le2 = S.useMemo(() => {
      if (j2) return F ? Q2.jsx("div", { ...O3(), children: g }) : E && Q2.jsx("div", { ...O3(), children: g });
      const J3 = { exit: { ...f2.collapse.exit, overflowY: "hidden" }, enter: { ...f2.collapse.enter, overflowY: "unset" } };
      return F ? Q2.jsx(gu, { features: _o2, children: Q2.jsx(bu.section, { animate: E ? "enter" : "exit", exit: "exit", initial: "exit", style: { willChange: ae2 }, variants: J3, onKeyDown: (ie2) => {
        ie2.stopPropagation();
      }, ...w3, children: Q2.jsx("div", { ...O3(), children: g }) }, "accordion-content") }) : Q2.jsx(mm, { initial: false, children: E && Q2.jsx(gu, { features: _o2, children: Q2.jsx(bu.section, { animate: "enter", exit: "exit", initial: "exit", style: { willChange: ae2 }, variants: J3, onKeyDown: (ie2) => {
        ie2.stopPropagation();
      }, ...w3, children: Q2.jsx("div", { ...O3(), children: g }) }, "accordion-content") }) });
    }, [E, j2, F, g, w3]);
    return Q2.jsxs(a, { ...P3(), children: [Q2.jsx(l3, { ...S2(), children: Q2.jsxs("button", { ...I2(), children: [m3 && Q2.jsx("div", { className: u.startContent({ class: s == null ? void 0 : s.startContent }), children: m3 }), Q2.jsxs("div", { className: u.titleWrapper({ class: s == null ? void 0 : s.titleWrapper }), children: [v && Q2.jsx("span", { ...N3(), children: v }), b3 && Q2.jsx("span", { ...H(), children: b3 })] }), !K2 && ne2 && Q2.jsx("span", { ...B2(), children: ne2 })] }) }), le2] });
  });
  an2.displayName = "HeroUI.AccordionItem";
  var Di2 = an2;
  var Ni2 = class {
    *[Symbol.iterator]() {
      yield* this.iterable;
    ...
    getKeyBefore(e) {
      ...
      var l3;
      return a && (l3 = a.prevKey) !== null && l3 !== void 0 ? l3 : null;
    }
    getKeyAfter(e) {
      let a = this.keyMap.get(e);
      var l3;
      return a && (l3 = a.nextKey) !== null && l3 !== void 0 ? l3 : null;
    }
    getFirstKey() {
    ...
    constructor(e, { expandedKeys: a } = {}) {
      ...
      let l3 = (g) => {
        if (this.keyMap.set(g.key, g), g.childNodes && (g.type === "section" || a.has(g.key))) for (let v of g.childNodes) l3(v);
      };
      for (let g of e) l3(g);
      let s = null, u = 0;
  ...
  var Ge3 = class _Ge extends Set {
    constructor(e, a, l3) {
      super(e), e instanceof _Ge ? (this.anchorKey = a ?? e.anchorKey, this.currentKey = l3 ?? e.currentKey) : (this.anchorKey = a ?? null, this.currentKey = l3 ?? null);
    }
  };
  function Oi2(o, e) {
  ...
  function Li2(o) {
    let { selectionMode: e = "none", disallowEmptySelection: a = false, allowDuplicateSelectionEvents: l3, selectionBehavior: s = "toggle", disabledBehavior: u = "all" } = o, h = S.useRef(false), [, g] = S.useState(false), v = S.useRef(null), b3 = S.useRef(null), [, m3] = S.useState(null), E = S.useMemo(() => Po2(o.selectedKeys), [o.selectedKeys]), R3 = S.useMemo(() => Po2(o.defaultSelectedKeys, new Ge3()), [o.defaultSelectedKeys]), [K2, F] = Bp(E, R3, o.onSelectionChange), j2 = S.useMemo(() => o.disabledKeys ? new Set(o.disabledKeys) : /* @__PURE__ */ new Set(), [o.disabledKeys]), [w3, P3] = S.useState(s);
    s === "replace" && w3 === "toggle" && typeof K2 == "object" && K2.size === 0 && P3("replace");
    let S2 = S.useRef(s);
    return S.useEffect(() => {
      s !== S2.current && (P3(s), S2.current = s);
    }, [s]), { selectionMode: e, disallowEmptySelection: a, selectionBehavior: w3, setSelectionBehavior: P3, get isFocused() {
      return h.current;
    }, setFocused(I2) {
      h.current = I2, g(I2);
    }, get focusedKey() {
      ...
      v.current = I2, b3.current = N3, m3(I2);
  ...
  var za = class _za {
    ...
    get isSelectAll() {
      ...
      return this._isSelectAll = e.every((l3) => a.has(l3)), this._isSelectAll;
    }
    get firstSelectedKey() {
      let e = null;
      for (let l3 of this.state.selectedKeys) {
        let s = this.collection.getItem(l3);
    ...
    extendSelection(e) {
      ...
      if (a == null) return;
      let l3;
      if (this.state.selectedKeys === "all") l3 = new Ge3([a], a, a);
      else {
        ...
        l3 = new Ge3(h, g, a);
        var u;
        for (let v of this.getKeyRange(g, (u = h.currentKey) !== null && u !== void 0 ? u : a)) l3.delete(v);
        for (let v of this.getKeyRange(a, g)) this.canSelectItem(v) && l3.add(v);
      }
      this.state.setSelectedKeys(l3);
    }
    getKeyRange(e, a) {
      let l3 = this.collection.getItem(e), s = this.collection.getItem(a);
      return l3 && s ? ba(this.collection, l3, s) <= 0 ? this.getKeyRangeInternal(e, a) : this.getKeyRangeInternal(a, e) : [];
    }
    getKeyRangeInternal(e, a) {
      var l3;
      if (!((l3 = this.layoutDelegate) === null || l3 === void 0) && l3.getKeyRange) return this.layoutDelegate.getKeyRange(e, a);
      let s = [], u = e;
      for (; u != null; ) {
    ...
    toggleSelection(e) {
      ...
      let a = this.getKey(e);
      if (a == null) return;
      let l3 = new Ge3(this.state.selectedKeys === "all" ? this.getSelectAllKeys() : this.state.selectedKeys);
      l3.has(a) ? l3.delete(a) : this.canSelectItem(a) && (l3.add(a), l3.anchorKey = a, l3.currentKey = a), !(this.disallowEmptySelection && l3.size === 0) && this.state.setSelectedKeys(l3);
    }
    replaceSelection(e) {
      if (this.selectionMode === "none") return;
      let a = this.getKey(e);
      if (a == null) return;
      let l3 = this.canSelectItem(a) ? new Ge3([a], a, a) : new Ge3();
      this.state.setSelectedKeys(l3);
    }
    setSelectedKeys(e) {
      if (this.selectionMode === "none") return;
    ...
    getSelectAllKeys() {
      let e = [], a = (l3) => {
        for (; l3 != null; ) {
          if (this.canSelectItem(l3)) {
            var s;
            let h = this.collection.getItem(l3);
            (h == null ? void 0 : h.type) === "item" && e.push(l3);
            var u;
            h != null && h.hasChildNodes && (this.allowsCellSelection || h.type !== "item") && a((u = (s = fi3(pi3(h, this.collection))) === null || s === void 0 ? void 0 : s.key) !== null && u !== void 0 ? u : null);
          }
          l3 = this.collection.getKeyAfter(l3);
        }
      };
    ...
    isSelectionEqual(e) {
      ...
      for (let l3 of e) if (!a.has(l3)) return false;
      for (let l3 of a) if (!e.has(l3)) return false;
      return true;
    }
    canSelectItem(e) {
      var a;
      if (this.state.selectionMode === "none" || this.state.disabledKeys.has(e)) return false;
      let l3 = this.collection.getItem(e);
      return !(!l3 || !(l3 == null || (a = l3.props) === null || a === void 0) && a.isDisabled || l3.type === "cell" && !this.allowsCellSelection);
    }
    isDisabled(e) {
      var a, l3;
      return this.state.disabledBehavior === "all" && (this.state.disabledKeys.has(e) || !!(!((l3 = this.collection.getItem(e)) === null || l3 === void 0 || (a = l3.props) === null || a === void 0) && a.isDisabled));
    }
    isLink(e) {
      var a, l3;
      return !!(!((l3 = this.collection.getItem(e)) === null || l3 === void 0 || (a = l3.props) === null || a === void 0) && a.href);
    }
    getItemProps(e) {
      var a;
    ...
    constructor(e, a, l3) {
      ...
      var s;
      this.allowsCellSelection = (s = l3 == null ? void 0 : l3.allowsCellSelection) !== null && s !== void 0 ? s : false, this._isSelectAll = null, this.layoutDelegate = (l3 == null ? void 0 : l3.layoutDelegate) || null;
    }
  };
  function Bi2(o) {
    let { onExpandedChange: e } = o, [a, l3] = Bp(o.expandedKeys ? new Set(o.expandedKeys) : void 0, o.defaultExpandedKeys ? new Set(o.defaultExpandedKeys) : /* @__PURE__ */ new Set(), e), s = Li2(o), u = S.useMemo(() => o.disabledKeys ? new Set(o.disabledKeys) : /* @__PURE__ */ new Set(), [o.disabledKeys]), h = ui3(o, S.useCallback((v) => new Ni2(v, { expandedKeys: a }), [a]), null);
    return S.useEffect(() => {
      ...
      l3(Hi2(a, v));
    }, setExpandedKeys: l3, selectionManager: new za(h, s) };
  }
  function Hi2(o, e) {
    let a = new Set(o);
  ...
  function Vi2(o) {
    var e;
    const a = wi2(), { ref: l3, as: s, className: u, items: h, variant: g, motionProps: v, expandedKeys: b3, disabledKeys: m3, selectedKeys: E, children: R3, defaultExpandedKeys: K2, selectionMode: F = "single", selectionBehavior: j2 = "toggle", keepContentMounted: w3 = false, disallowEmptySelection: P3, defaultSelectedKeys: S2, onExpandedChange: I2, onSelectionChange: N3, dividerProps: H = {}, isCompact: O3 = false, isDisabled: B2 = false, showDivider: ae2 = true, hideIndicator: re2 = false, disableAnimation: ne2 = (e = a == null ? void 0 : a.disableAnimation) != null ? e : false, disableIndicatorAnimation: le2 = false, itemClasses: J3, ...ie2 } = o, [ge2, ue2] = S.useState(null), Se2 = s || "div", A2 = typeof Se2 == "string", W = Ar2(l3), V2 = S.useMemo(() => al({ variant: g, className: u }), [g, u]), U3 = { children: S.useMemo(() => {
      let pe2 = [];
      return Re2.Children.map(R3, (ye) => {
        var de2;
    ...
    }, [R3]), items: h }, se = { expandedKeys: b3, defaultExpandedKeys: K2, onExpandedChange: I2 }, ce2 = { disabledKeys: m3, selectedKeys: E, selectionMode: F, selectionBehavior: j2, disallowEmptySelection: P3, defaultSelectedKeys: S2 ?? K2, onSelectionChange: N3, ...U3, ...se }, ee2 = Bi2(ce2);
    ee2.selectionManager.setFocusedKey = (pe2) => {
      ue2(pe2);
    };
    const { accordionProps: we2 } = ji2({ ...U3, ...se }, ee2, W), Fe2 = S.useMemo(() => ({ state: ee2, focusedKey: ge2, motionProps: v, isCompact: O3, isDisabled: B2, hideIndicator: re2, disableAnimation: ne2, keepContentMounted: w3, disableIndicatorAnimation: le2 }), [ge2, O3, B2, re2, E, ne2, w3, ee2 == null ? void 0 : ee2.expandedKeys.values, le2, ee2.expandedKeys.size, ee2.disabledKeys.size, v]), Ee2 = S.useCallback((pe2 = {}) => ({ ref: W, className: V2, "data-orientation": "vertical", ...Io(we2, qf(ie2, { enabled: A2 }), pe2) }), []), _e2 = S.useCallback((pe2, ye) => {
      pe2 && ue2(ye);
    }, []);
    return { Component: Se2, values: Fe2, state: ee2, focusedKey: ge2, getBaseProps: Ee2, isSplitted: g === "splitted", classNames: V2, showDivider: ae2, dividerProps: H, disableAnimation: ne2, handleFocusChanged: _e2, itemClasses: J3 };
  }
  function Ui2(o) {
  ...
  function Wi2(o) {
    const { as: e, className: a, orientation: l3, ...s } = o;
    let u = e || "hr";
    u === "hr" && l3 === "vertical" && (u = "div");
    const { separatorProps: h } = Ui2({ elementType: typeof u == "string" ? u : "hr", orientation: l3 }), g = S.useMemo(() => rl({ orientation: l3, className: a }), [l3, a]), v = S.useCallback((b3 = {}) => ({ className: g, role: "separator", "data-orientation": l3, ...h, ...s, ...b3 }), [g, l3, h, s]);
    return { Component: u, getDividerProps: v };
  }
  var on2 = qn2((o, e) => {
    const { Component: a, getDividerProps: l3 } = Wi2({ ...o });
    return Q2.jsx(a, { ref: e, ...l3() });
  });
  on2.displayName = "HeroUI.Divider";
  var qi2 = on2;
  var nn3 = qn2((o, e) => {
    const { Component: a, values: l3, state: s, isSplitted: u, showDivider: h, getBaseProps: g, disableAnimation: v, handleFocusChanged: b3, itemClasses: m3, dividerProps: E } = Vi2({ ...o, ref: e }), R3 = S.useCallback((F, j2) => b3(F, j2), [b3]), K2 = S.useMemo(() => [...s.collection].map((F, j2) => {
      const w3 = { ...m3, ...F.props.classNames || {} };
      return Q2.jsxs(S.Fragment, { children: [Q2.jsx(Di2, { item: F, variant: o.variant, onFocusChange: R3, ...l3, ...F.props, classNames: w3 }), !F.props.hidden && !u && h && j2 < s.collection.size - 1 && Q2.jsx(qi2, { ...E })] }, F.key);
    }), [l3, m3, R3, u, h, s.collection]);
    return Q2.jsx(a, { ...g(), children: v ? K2 : Q2.jsx(ml, { children: K2 }) });
  });
  nn3.displayName = "HeroUI.Accordion";
  var Zi2 = nn3;
  var Yi2 = si3;
  var Xi2 = Yi2;
  var Gi2 = ({ items: o, isCompact: e, variant: a, defaultSelectedKeys: l3, className: s, hideIndicator: u = true }) => {
    const h = S.useRef([]), [g, v] = S.useState(l3 ?? []), b3 = (m3) => {
      v((E) => E.includes(m3) ? E.filter((R3) => R3 !== m3) : [...E, m3]);
    };
    return S.useEffect(() => {
      h.current.forEach((m3, E) => {
        if (m3) {
          const R3 = String(E), K2 = () => b3(R3);
          return m3.addEventListener("click", K2), () => {
            m3.removeEventListener("click", K2);
          };
        }
      });
    }, []), Q2.jsx(Zi2, { isCompact: e, variant: a, selectedKeys: g, className: s, hideIndicator: u, children: o.map((m3, E) => Q2.jsx(Xi2, { "aria-label": m3.label ? m3.label : `Accordion ${E + 1}`, title: Q2.jsx("div", { ref: (R3) => h.current[E] = R3, children: m3.title }), hideIndicator: u, className: "w-full", children: m3.content }, E)) });
  };
  var $a = ((o) => (o.None = "auto", o.ZH_CN = "zh-CN", o.EN_US = "en-US", o.JA_JP = "ja-JP", o.KO_KR = "ko-KR", o.ES_ES = "es-ES", o.FR_FR = "fr-FR", o.DE_DE = "de-DE", o.RU_RU = "ru-RU", o.IT_IT = "it-IT", o.PT_PT = "pt-PT", o.PT_BR = "pt-BR", o.AR_SA = "ar-SA", o.HI_IN = "hi-IN", o))($a || {});
  var Ji2 = "https://translate.googleapis.com/translate_a/single";
  function Qi2(o, e, a, l3) {
    const s = ["t", "bd", "ex", "qc", "rm", "ss", "md", "at"], h = [...Object.entries({ dj: "1", client: "gtx", hl: o, sl: e, tl: a, q: l3 }).map(([g, v]) => `${g}=${encodeURIComponent(v)}`), ...s.map((g) => `dt=${g}`)].join("&");
    return `${Ji2}?${h}`;
  }
  var es2 = (o) => {
  ...
  var rs2 = (o) => o.replace(/^([a-z])/, (e, a) => a.toUpperCase()).replace(/^<b>([a-z])/, (e, a) => "<b>" + a.toUpperCase());
  var as2 = (o) => {
    if (o && o.examples && o.examples.example && Array.isArray(o.examples.example) && o.examples.example.length > 0) return o.examples.example.map((e) => rs2(e.text));
  };
  var os2 = (o) => {
  ...
  function ds2() {
    ...
    const e = o.getRangeAt(0), a = !o.isCollapsed && o.anchorNode === e.endContainer && o.anchorOffset === e.endOffset, l3 = document.createRange();
    l3.setStart(e.startContainer, e.startOffset), l3.setEnd(e.startContainer, e.startOffset);
    const s = l3.getBoundingClientRect(), u = document.createRange();
  ...
  var us2 = ({ isVisible: o, flowDirection: e, content: a, isClickOnMeFuncRef: l3 }) => {
    const s = S.useRef(null), u = S.useRef(null), h = S.useRef(null), [g, v] = S.useState(document.body), [b3, m3] = S.useState(false), [E, R3] = S.useState(void 0), K2 = (w3) => {
      const P3 = w3.composedPath(), S2 = P3 && P3.length > 0 ? P3.at(0) : null, I2 = s.current, N3 = u.current;
      ...
      const P3 = ln2();
      try {
        P3.translate(w3, $a.ZH_CN).then((S2) => {
          m3(false), R3(S2), m3(true), console.log("result\uFF1A", S2), console.log("\u539F\u59CB\u6570\u636E\uFF1A", S2.raw);
        });
      } catch (S2) {
        console.error("translate failed:", S2), R3(void 0);
      }
    };
    return S.useEffect(() => {
      const w3 = document.getElementById(Go), P3 = w3 == null ? void 0 : w3.shadowRoot, S2 = P3 == null ? void 0 : P3.getElementById("root");
      return S2 && v(S2), l3.current = K2, o || m3(false), h.current && h.current.addEventListener("click", F), a !== (E == null ? void 0 : E.text) && R3(void 0), !E && b3 && j2(a), () => {
        var I2;
        (I2 = h.current) == null || I2.removeEventListener("click", F);
      };
    }, [o, h.current, b3]), Q2.jsx(p2, { ref: s, id: "NAVBAR", maxWidth: "sm", height: "2.75em", position: "sticky", className: "bg-background rounded-full outline-solid outline-current/6 outline-1 shadow-sm", classNames: { wrapper: "px-3 h-[var(--navbar-height)/2]" }, children: Q2.jsx(m2, { className: "flex", children: Q2.jsxs(v2, { className: "flex", children: [Q2.jsx(g2, { isIconOnly: true, variant: "light", className: "min-w-8 w-8 text-current/75 hover:text-current/100", children: Q2.jsx(b2, { className: "w-5 h-5" }) }), Q2.jsx(g2, { isIconOnly: true, variant: "light", className: "min-w-8 w-8 text-current/75 hover:text-current/100", onPressStart: () => console.log("discord pressed"), children: Q2.jsx(x2, { className: "w-5 h-5" }) }), Q2.jsxs(_i2, { ref: u, isOpen: o && b3, portalContainer: g, offset: 3, placement: e === Br.Backward ? "top" : "bottom", children: [Q2.jsx(Ei2, { children: Q2.jsx(g2, { ref: h, isIconOnly: true, variant: "light", className: U0("min-w-8 w-8", b3 ? "text-current/100 aria-expanded:opacity-100" : "text-current/60 dark:text-current/75", "hover:text-current/100", "transition-colors duration-150 ease-in-out"), children: Q2.jsx(k2, { className: U0("w-4 h-4") }) }) }), Q2.jsx(Ci2, { className: U0("bg-background/90 dark:bg-background/80 subpixel-antialiased outline-solid outline-current/6 outline-1 box-border rounded-large shadow-medium", "subpixel-antialiased backdrop-blur backdrop-saturate-150"), children: E ? Q2.jsx(ss2, { translateResult: E }) : Q2.jsx(Xw, { size: "sm", color: "success" }) })] })] }) }) });
  };
  var ps3 = () => {
    var j2, w3;
    const o = S.useRef(null), [e, a] = S.useState(false), [l3, s] = S.useState({ top: 0, left: 0 }), [u, h] = S.useState(false), [g, v] = S.useState(false), b3 = S.useRef(null), m3 = S.useRef(null), E = (P3, S2) => {
      u || (h(true), a(P3), s(S2), m3.current && (clearTimeout(m3.current), m3.current = null), m3.current = setTimeout(() => {
        v(true);
      }, 250));
    }, R3 = () => {
      h(false), v(false), m3.current && (clearTimeout(m3.current), m3.current = null);
    }, K2 = () => {
      setTimeout(() => {
        o.current && E(o.current.flowDirection === Br.Backward, o.current.coords);
      }, 50);
    }, F = (P3) => {
      u && b3.current && !b3.current(P3) && R3();
    };
    return S.useEffect(() => {
      const P3 = cs2({ callback: (S2) => {
        o.current = S2;
      } });
      return document.addEventListener("mouseup", K2), document.addEventListener("mousedown", F), () => {
        P3.destroy(), document.removeEventListener("mouseup", K2), document.removeEventListener("mousedown", F);
      };
    }, [u]), Q2.jsx(li3, { children: Q2.jsx(S.StrictMode, { children: Q2.jsx("div", { className: U0("absolute z-[9999]  transition-transform duration-250 ease-in-out will-change-transform", "rounded-[12px] border-0 bg-transparent backface-visibility-hidden", u ? e ? "translate-x-[-50%] translate-y-[-100%]" : "translate-x-[-50%] translate-y-0" : "translate-x-[-50%] translate-y-[-50%] scale-[0.6]", g ? "pointer-events-auto" : "pointer-events-none"), style: { top: (l3 == null ? void 0 : l3.top) ?? 0, left: (l3 == null ? void 0 : l3.left) ?? 0 }, children: Q2.jsx("div", { className: U0("transition-opacity duration-250 ease-in-out will-change-opacity", "border-0 bg-transparent backface-visibility-hidden", u ? "opacity-100" : "opacity-0"), children: Q2.jsx(us2, { isVisible: u, flowDirection: ((j2 = o.current) == null ? void 0 : j2.flowDirection) ?? Br.Forward, isClickOnMeFuncRef: b3, content: ((w3 = o.current) == null ? void 0 : w3.text) ?? "" }) }) }) }) });
  };
  var cn2 = "easynote-host";
  var or2 = document.getElementById(cn2);
  or2 || (or2 = document.createElement("div"), or2.id = cn2, document.documentElement.appendChild(or2));
  var fs2 = wg.createRoot(or2);
  fs2.render(Re2.createElement(ps3));
})();
/**
* @license React
