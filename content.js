...
(() => {
  ...
  function L(i, e) {
    let t = false, n = true;
    const s = { delta: 0, timestamp: 0, isProcessing: false }, o = () => t = true, a = f.reduce((c, h) => (c[h] = q(o), c), {}), { setup: d, read: v, resolveKeyframes: u, preUpdate: r, update: g, preRender: A2, render: F, postRender: p } = a, w2 = () => {
      const c = y.useManualTiming ? s.timestamp : performance.now();
      t = false, y.useManualTiming || (s.delta = n ? 1e3 / 60 : Math.max(Math.min(c - s.timestamp, D), 1)), s.timestamp = c, s.isProcessing = true, d.process(s), v.process(s), u.process(s), r.process(s), g.process(s), A2.process(s), F.process(s), p.process(s), s.isProcessing = false, t && e && (n = false, i(w2));
    }, T = () => {
      t = true, n = true, s.isProcessing || i(w2);
    };
  ...
  function Q(t) {
    ...
    let r = 0;
    const o = e.replace(hs, (l2) => (A.test(l2) ? (s.color.push(r), i.push(Ht), n.push(A.parse(l2))) : l2.startsWith(cs) ? (s.var.push(r), i.push(us), n.push(l2)) : (s.number.push(r), i.push(Ut), n.push(parseFloat(l2))), ++r, tt)).split(tt);
  ...
  function zt(t) {
    ...
    return (i) => {
      ...
      for (let a = 0; a < s; a++) if (r += e[a], i[a] !== void 0) {
        const o = n[a];
        o === Ut ? r += Z(i[a]) : o === Ht ? r += A.transform(i[a]) : r += i[a];
      }
      return r;
    };
  }
  ...
  function ps({ hue: t, saturation: e, lightness: n, alpha: s }) {
    ...
    if (!e) i = r = a = n;
      ...
      const o = n < 0.5 ? n * (1 + e) : n + e - n * e, l2 = 2 * n - o;
      i = he2(l2, o, t + 1 / 3), r = he2(l2, o, t), a = he2(l2, o, t - 1 / 3);
    }
  ...
  function je(t) {
    return typeof t == "number" ? bs : typeof t == "string" ? ab(t) ? ie : A.test(t) ? st : Vs : Array.isArray(t) ? Yt : typeof t == "object" ? A.test(t) ? st : Ts : ie;
  }
  function Yt(t, e) {
  ...
  function xs({ duration: t = w.duration, bounce: e = w.bounce, velocity: n = w.velocity, mass: s = w.mass }) {
    ...
    a = g1(w.minDamping, w.maxDamping, a), t = g1(w.minDuration, w.maxDuration, R2(t)), a < 1 ? (i = (u) => {
      const c = u * a, f2 = c * t, h = c - n, d = ve(u, a), T = Math.exp(-f2);
      return de - h / d * T;
    }, r = (u) => {
      const f2 = u * a * t, h = f2 * n + n, d = Math.pow(a, 2) * Math.pow(u, 2) * t, T = Math.exp(-f2), y2 = ve(Math.pow(u, 2), a);
      return (-i(u) + de > 0 ? -1 : 1) * ((h - d) * T) / y2;
    }) : (i = (u) => {
      const c = Math.exp(-u * t), f2 = (u - n) * t + 1;
      return -de + c * f2;
    }, r = (u) => {
      const c = Math.exp(-u * t), f2 = (n - u) * (t * t);
      return c * f2;
    });
    const o = 5 / t, l2 = Cs(i, r, o);
    if (t = O2(t), isNaN(l2)) return { stiffness: w.stiffness, damping: w.damping, duration: t };
    {
      const u = Math.pow(l2, 2) * s;
  ...
  function ae(t = w.visualDuration, e = w.bounce) {
    ...
    const r = n.keyframes[0], a = n.keyframes[n.keyframes.length - 1], o = { done: false, value: r }, { stiffness: l2, damping: u, mass: c, duration: f2, velocity: h, isResolvedFromDuration: d } = Ds({ ...n, velocity: -R2(n.velocity || 0) }), T = h || 0, y2 = u / (2 * Math.sqrt(l2 * c)), b2 = a - r, p = R2(Math.sqrt(l2 / c)), v = Math.abs(b2) < 5;
    s || (s = v ? w.restSpeed.granular : w.restSpeed.default), i || (i = v ? w.restDelta.granular : w.restDelta.default);
    let V2;
    if (y2 < 1) {
      const m2 = ve(p, y2);
      V2 = (S2) => {
        const x2 = Math.exp(-y2 * p * S2);
        return a - x2 * ((T + y2 * p * b2) / m2 * Math.sin(m2 * S2) + b2 * Math.cos(m2 * S2));
      };
    } else if (y2 === 1) V2 = (m2) => a - Math.exp(-p * m2) * (b2 + (T + p * b2) * m2);
    else {
      const m2 = p * Math.sqrt(y2 * y2 - 1);
      V2 = (S2) => {
        const x2 = Math.exp(-y2 * p * S2), g = Math.min(m2 * S2, 300);
        return a - x2 * ((T + y2 * p * b2) * Math.sinh(g) + m2 * b2 * Math.cosh(g)) / m2;
      };
    }
    const P2 = { calculatedDuration: d && f2 || null, next: (m2) => {
      const S2 = V2(m2);
      if (d) o.done = m2 >= f2;
      else {
        let x2 = m2 === 0 ? T : 0;
        y2 < 1 && (x2 = m2 === 0 ? O2(T) : Zt(V2, m2, S2));
        const g = Math.abs(x2) <= s, C = Math.abs(a - S2) <= i;
        o.done = g && C;
      }
      return o.value = o.done ? a : S2, o;
    }, toString: () => {
      const m2 = Math.min(Ue(P2), re), S2 = qt((x2) => P2.next(m2 * x2).value, m2, 30);
      return m2 + "ms " + S2;
    }, toTransition: () => {
    } };
    return P2;
  }
  function Ve({ keyframes: t, velocity: e = 0, power: n = 0.8, timeConstant: s = 325, bounceDamping: i = 10, bounceStiffness: r = 500, modifyTarget: a, min: o, max: l2, restDelta: u = 0.5, restSpeed: c }) {
    const f2 = t[0], h = { done: false, value: f2 }, d = (g) => o !== void 0 && g < o || l2 !== void 0 && g > l2, T = (g) => o === void 0 ? l2 : l2 === void 0 || Math.abs(o - g) < Math.abs(l2 - g) ? o : l2;
    let y2 = n * e;
    const b2 = f2 + y2, p = a === void 0 ? b2 : a(b2);
    p !== b2 && (y2 = p - f2);
    const v = (g) => -y2 * Math.exp(-g / s), V2 = (g) => p + v(g), P2 = (g) => {
      const C = v(g), F = V2(g);
      h.done = Math.abs(C) <= u, h.value = h.done ? p : F;
    };
    let m2, S2;
    const x2 = (g) => {
      d(h.value) && (m2 = g, S2 = ae({ keyframes: [h.value, T(h.value)], velocity: Zt(V2, g, h.value), damping: i, stiffness: r, restDelta: u, restSpeed: c }));
    };
    return x2(0), { calculatedDuration: null, next: (g) => {
      let C = false;
      return !S2 && m2 === void 0 && (C = true, P2(g), x2(g)), m2 !== void 0 && g >= m2 ? S2.next(g - m2) : (!C && P2(g), h);
    } };
  }
  function Is(t, e, n) {
    ...
    for (let a = 0; a < r; a++) {
      let o = i(t[a], t[a + 1]);
      if (e) {
        const l2 = Array.isArray(e) ? e[a] || R : e;
        o = le(l2, o);
      }
      s.push(o);
    }
  ...
  function Os(t, e, { clamp: n = true, ease: s, mixer: i } = {}) {
    ...
    const o = Is(e, s, i), l2 = o.length, u = (c) => {
      if (a && c < t[0]) return e[0];
      let f2 = 0;
      if (l2 > 1) for (; f2 < t.length - 2 && !(c < t[f2 + 1]); f2++) ;
      const h = Rt(t[f2], t[f2 + 1], c);
      return o[f2](h);
    };
  ...
  function J({ duration: t = 300, keyframes: e, times: n, ease: s = "easeInOut" }) {
    ...
    return { calculatedDuration: t, next: (l2) => (r.value = o(l2), r.done = l2 >= t, r) };
  }
  ...
  function ei(t, e, n, { delay: s = 0, duration: i = 300, repeat: r = 0, repeatType: a = "loop", ease: o = "easeOut", times: l2 } = {}, u = void 0) {
    const c = { [e]: n };
    l2 && (c.offset = l2);
    const f2 = nn(o, i);
    Array.isArray(f2) && (c.easing = f2);
    const h = { delay: s, duration: i, easing: Array.isArray(f2) ? "linear" : f2, fill: "both", iterations: r + 1, direction: a === "reverse" ? "alternate" : "normal" };
  ...
  function ci(t) {
    ...
    const { onUpdate: l2, transformTemplate: u } = e.owner.getProps();
    return ui() && n && li.has(n) && (n !== "transform" || !u) && !l2 && !s && i !== "mirror" && r !== 0 && a !== "inertia";
  }
  function pi2(t) {
    const e = di.exec(t);
    if (!e) return [,];
  ...
  function Pi(t, e, n = {}) {
    const [s, i, r] = dn(t, n), a = (o) => {
      if (!dt(o)) return;
      const { target: l2 } = o, u = e(l2, o);
      if (typeof u != "function" || !l2) return;
      const c = (f2) => {
        dt(f2) && (u(f2), l2.removeEventListener("pointerleave", c));
      };
      l2.addEventListener("pointerleave", c, i);
    };
    return s.forEach((o) => {
  ...
  function Ri(t, e, n = {}) {
    const [s, i, r] = dn(t, n), a = (o) => {
      const l2 = o.currentTarget;
      if (!mt(o)) return;
      ne.add(l2);
      const u = e(l2, o), c = (d, T) => {
        window.removeEventListener("pointerup", f2), window.removeEventListener("pointercancel", h), ne.has(l2) && ne.delete(l2), mt(d) && typeof u == "function" && u(d, { success: T });
      }, f2 = (d) => {
        c(d, l2 === window || l2 === document || n.useGlobalTarget || pn(l2, d.target));
      }, h = (d) => {
        c(d, false);
      };
      window.addEventListener("pointerup", f2, i), window.addEventListener("pointercancel", h, i);
    };
    return s.forEach((o) => {
  ...
  function or({ when: t, delay: e, delayChildren: n, staggerChildren: s, staggerDirection: i, repeat: r, repeatType: a, repeatDelay: o, from: l2, elapsed: u, ...c }) {
  ...
  function vn(t, e, { delay: n = 0, transitionOverride: s, type: i } = {}) {
    ...
    s && (r = s);
    const l2 = [], u = i && t.animationState && t.animationState.getState()[i];
    for (const c in o) {
      const f2 = t.getValue(c, t.latestValues[c] ?? null), h = o[c];
      if (h === void 0 || u && ur(u, c)) continue;
      const d = { delay: n, ...on(r || {}, c) }, T = f2.get();
      if (T !== void 0 && !f2.isAnimating && !Array.isArray(h) && h === T && !d.velocity) continue;
      let y2 = false;
      if (window.MotionHandoffAnimation) {
        const p = Qi(t);
        if (p) {
          const v = window.MotionHandoffAnimation(p, c, O);
          v !== null && (d.startTime = v, y2 = true);
        }
      }
      Ji(t, c), f2.start(lr(c, f2, h, t.shouldReduceMotion && ln.has(c) ? { type: false } : d, t, y2));
      const b2 = f2.animation;
      b2 && l2.push(b2);
    }
    return a && Promise.all(l2).then(() => {
      O.update(() => {
        a && qi(t, a);
      });
    }), l2;
  ...
  function Re(t, e, n = {}) {
    var l2;
    const s = H(t, e, n.type === "exit" ? (l2 = t.presenceContext) == null ? void 0 : l2.custom : void 0);
    let { transition: i = t.getDefaultTransition() || {} } = s || {};
    n.transitionOverride && (i = n.transitionOverride);
    const r = s ? () => Promise.all(vn(t, s, n)) : () => Promise.resolve(), a = t.variantChildren && t.variantChildren.size ? (u = 0) => {
      const { delayChildren: c = 0, staggerChildren: f2, staggerDirection: h } = i;
      return cr(t, e, u, c, f2, h, n);
  ...
  function cr(t, e, n = 0, s = 0, i = 0, r = 1, a) {
    const o = [];
    for (const l2 of t.variantChildren) l2.notify("AnimationStart", e), o.push(Re(l2, e, { ...a, delay: n + (typeof s == "function" ? 0 : s) + Vn(t.variantChildren, l2, s, i, r) }).then(() => l2.notify("AnimationComplete", e)));
  ...
  function hr(t, e, n = {}) {
    ...
    if (Array.isArray(e)) {
      ...
      const i = typeof e == "function" ? H(t, e, n.custom) : e;
  ...
  function gr(t) {
    ...
    const i = (l2) => (u, c) => {
      var h;
      const f2 = H(t, c, l2 === "exit" ? (h = t.presenceContext) == null ? void 0 : h.custom : void 0);
      if (f2) {
        const { transition: d, transitionEnd: T, ...y2 } = f2;
        u = { ...u, ...y2, ...T };
      }
      return u;
    };
    ...
    function a(l2) {
      const { props: u } = t, c = wn(t.parent) || {}, f2 = [], h = /* @__PURE__ */ new Set();
      let d = {}, T = 1 / 0;
      for (let b2 = 0; b2 < pr; b2++) {
        const p = dr[b2], v = n[p], V2 = u[p] !== void 0 ? u[p] : c[p], P2 = Ks(V2), m2 = p === l2 ? v.isActive : null;
        m2 === false && (T = b2);
        let S2 = V2 === c[p] && V2 !== u[p] && P2;
        if (S2 && s && t.manuallyAnimateOnMount && (S2 = false), v.protectedKeys = { ...d }, !v.isActive && m2 === null || !V2 && !v.prevProp || hm(V2) || typeof V2 == "boolean") continue;
        const x2 = yr(v.prevProp, V2);
        let g = x2 || p === l2 && v.isActive && !S2 && P2 || b2 > T && P2, C = false;
        ...
        for (const M in xn) {
          const D2 = W[M], k2 = Xe2[M];
          if (d.hasOwnProperty(M)) continue;
          let j2 = false;
          Oe(D2) && Oe(k2) ? j2 = !Sn(D2, k2) : j2 = D2 !== k2, j2 ? D2 != null ? qe(M) : h.add(M) : D2 !== void 0 && h.has(M) ? qe(M) : v.protectedKeys[M] = true;
        }
        v.prevProp = V2, v.prevResolvedValues = W, v.isActive && (d = { ...d, ...W }), s && t.blockInitialAnimation && (g = false);
        const Ze = S2 && x2;
        g && (!Ze || C) && f2.push(...F.map((M) => {
          const D2 = { type: p };
          if (typeof M == "string" && s && !Ze && t.manuallyAnimateOnMount && t.parent) {
            const { parent: k2 } = t, j2 = H(k2, M);
            if (k2.enteringChildren && j2) {
              const { delayChildren: Mn } = j2.transition || {};
              D2.delay = Vn(k2.enteringChildren, t, Mn);
            }
          }
      ...
      if (h.size) {
        ...
        if (typeof u.initial != "boolean") {
          const p = H(t, Array.isArray(u.initial) ? u.initial[0] : u.initial);
          p && p.transition && (b2.transition = p.transition);
        }
        h.forEach((p) => {
          const v = t.getBaseTarget(p), V2 = t.getValue(p);
          V2 && (V2.liveStyle = true), b2[p] = v ?? null;
        }), f2.push({ animation: b2 });
      }
      let y2 = !!f2.length;
      return s && (u.initial === false || u.initial === u.animate) && !t.manuallyAnimateOnMount && (y2 = false), s = false, y2 ? e(f2) : Promise.resolve();
    }
    function o(l2, u) {
      var f2;
      if (n[l2].isActive === u) return Promise.resolve();
      (f2 = t.variantChildren) == null || f2.forEach((h) => {
        var d;
        return (d = h.animationState) == null ? void 0 : d.setActive(l2, u);
      }), n[l2].isActive = u;
      const c = a(l2);
  ...
  var Ne, It, Ot, zn, le, Rt, O2, R2, Et, Yn, Xn, Kt, kt, Nt, Le, Bt, Lt, _e, Zn2, _t, Jn, Qn, Gt, es, Wt, ts, ns, et, Z, Ge, is, We, jt, rs, ce, B, be, U2, A, os, Ut, Ht, us, cs, tt, hs, fs, Y, ue, fe, ms, gs, st, Te, Vs, Ss2, qt, re, As, w, de, Ms, Ps, Fs, Ns, Bs, $e, Ls, ze, L2, Se, Gs, we, rt, at, ot, Ws2, js, lt, Hs, $s, _, G, Me, Ce, Pe, Ye, Xs, Zs, Js, tn, q2, ut, ni, rn, ct, ri, ht, li, ui, hi, fi, di, ln, mi, un, cn, ft, yi, Ti, De, vi, hn, Vi, wi, xi, Mi, pn, Fi, Di, ne, Oi, Ei, Ki, gt, mn, Ie, gn, _i, yt, Wi, yn, Ui, Tn, $i, zi, Oe, er, nr, sr, ir, rr, ar, lr, fr, dr, pr, X, br, Tr, vr, Vr, Sr, wr, Ar, Ee, me, xr, Mr, Fr, Dr, Or, Rr, Nr;
  var init_index_chunk = __esm({
    "dist/index-chunk.js"() {
      ...
      Y = { test: ls, parse: $t, createTransformer: zt, getAnimatableNone: ds };
      ue = (t, e, n) => t + (e - t) * n;
      fe = (t, e, n) => {
      ...
      ze = class extends $e {
        ...
        initAnimation() {
          ...
          let { keyframes: o } = e;
          const l2 = n || J;
          l2 !== J && typeof o[0] != "number" && (this.mixKeyframes = le(Ls, Xt(o[0], o[1])), o = [0, 100]);
          const u = l2({ ...e, keyframes: o });
          r === "mirror" && (this.mirroredGenerator = l2({ ...e, keyframes: [...o].reverse(), velocity: -a })), u.calculatedDuration === null && (u.calculatedDuration = Ue(u));
        ...
        tick(e, n = false) {
          const { generator: s, totalDuration: i, mixKeyframes: r, mirroredGenerator: a, resolvedDuration: o, calculatedDuration: l2 } = this;
          if (this.startTime === null) return s.next(0);
          const { delay: u = 0, keyframes: c, repeat: f2, repeatType: h, repeatDelay: d, type: T, onUpdate: y2, finalKeyframe: b2 } = this.options;
          ...
          let V2 = this.currentTime, P2 = s;
          if (f2) {
            const g = Math.min(this.currentTime, i) / o;
            let C = Math.floor(g), F = g % 1;
            !F && g >= 1 && (F = 1), F === 1 && C--, C = Math.min(C, f2 + 1), !!(C % 2) && (h === "reverse" ? (F = 1 - F, d && (F -= d / o)) : h === "mirror" && (P2 = a)), V2 = g1(0, 1, F) * o;
          }
          const m2 = v ? { done: false, value: c[0] } : P2.next(V2);
          r && (m2.value = r(m2.value));
          let { done: S2 } = m2;
          !v && l2 !== null && (S2 = this.playbackSpeed >= 0 ? this.currentTime >= i : this.currentTime <= 0);
          const x2 = this.holdTime === null && (this.state === "finished" || this.state === "running" && S2);
          return x2 && T !== Ve && (m2.value = He(c, this.options, b2, this.speed)), y2 && y2(m2.value), x2 && this.finish(), m2;
        }
        then(e, n) {
          return this.finished.then(e, n);
        }
      ...
      lt = (t) => t === mu || t === he;
      Hs = /* @__PURE__ */ new Set(["x", "y", "z"]);
      $s = ki.filter((t) => !Hs.has(t));
      ...
      ni = class extends $e {
        constructor(e) {
          ...
          const { element: n, name: s, keyframes: i, pseudoElement: r, allowFlatten: a = false, finalKeyframe: o, onComplete: l2 } = e;
      ...
      ri = class extends ni {
        ...
        updateMotionValue(e) {
          ...
          const o = new ze({ ...a, autoplay: false }), l2 = O2(this.finishedTime ?? this.time);
          n.setWithVelocity(o.sample(l2 - ct).value, o.sample(l2).value, ct), o.stop();
        }
      };
      ...
      hi = 40;
        ...
        constructor({ autoplay: e = true, delay: n = 0, type: s = "keyframes", repeat: i = 0, repeatDelay: r = 0, repeatType: a = "loop", keyframes: o, name: l2, motionValue: u, element: c, ...f2 }) {
          var T;
          super(), this.stop = () => {
            var y2, b2;
            this._animation && (this._animation.stop(), (y2 = this.stopTimeline) == null || y2.call(this)), (b2 = this.keyframeResolver) == null || b2.cancel();
          }, this.createdAt = m.now();
          const h = { autoplay: e, delay: n, type: s, repeat: i, repeatDelay: r, repeatType: a, name: l2, motionValue: u, element: c, ...f2 }, d = (c == null ? void 0 : c.KeyframeResolver) || Ye;
          this.keyframeResolver = new d(o, (y2, b2, p) => this.onKeyframesResolved(y2, b2, h, !p), l2, u, c), (T = this.keyframeResolver) == null || T.scheduleResolve();
        }
        onKeyframesResolved(e, n, s, i) {
          this.keyframeResolver = void 0;
          const { name: r, type: a, velocity: o, delay: l2, isHandoff: u, onUpdate: c } = s;
          this.resolvedAt = m.now(), oi(e, r, a, o) || ((y.instantAnimations || !l2) && (c == null || c(He(e, s, n))), e[0] = e[e.length - 1], Fe(s), s.repeat = 0);
      ...
      wi = class extends Ye {
        ...
        readKeyframes() {
          ...
          for (let l2 = 0; l2 < e.length; l2++) {
            let u = e[l2];
            if (typeof u == "string" && (u = u.trim(), ab(u))) {
              const c = an(u, n.current);
              c !== void 0 && (e[l2] = c), l2 === e.length - 1 && (this.finalKeyframe = u);
            }
          }
          if (this.resolveNoneKeyframes(), !ln.has(s) || e.length !== 2) return;
          const [i, r] = e, a = ft(i), o = ft(r);
          if (a !== o) if (lt(a) && lt(o)) for (let l2 = 0; l2 < e.length; l2++) {
            const u = e[l2];
            typeof u == "string" && (e[l2] = parseFloat(u));
          }
        ...
        measureEndState() {
          ...
          s[r] = _[n](e.measureViewportBox(), window.getComputedStyle(e.current)), a !== null && this.finalKeyframe === void 0 && (this.finalKeyframe = a), (o = this.removedTransforms) != null && o.length && this.removedTransforms.forEach(([l2, u]) => {
            e.getValue(l2).set(u);
      ...
      Wi = class {
        ...
        constructor({ parent: e, props: n, presenceContext: s, reducedMotionConfig: i, blockInitialAnimation: r, visualState: a }, o = {}) {
          ...
          const { latestValues: l2, renderState: u } = a;
          this.latestValues = l2, this.baseTarget = { ...l2 }, this.initialValues = n.initial ? { ...l2 } : {}, this.renderState = u, this.parent = e, this.props = n, this.presenceContext = s, this.depth = e ? e.depth + 1 : 0, this.reducedMotionConfig = i, this.options = o, this.blockInitialAnimation = !!r, this.isControllingVariants = yu(n), this.isVariantNode = z1(n), this.isVariantNode && (this.variantChildren = /* @__PURE__ */ new Set()), this.manuallyAnimateOnMount = !!(e && e.current);
          const { willChange: c, ...f2 } = this.scrapeMotionValuesFromProps(n, {}, this);
          for (const h in f2) {
            const d = f2[h];
            l2[h] !== void 0 && Zn(d) && d.set(l2[h]);
          }
        }
        mount(e) {
          var n;
      ...
      zi = (t, e) => xm(t) ? new $i(e) : new Ui(e, { allowProjection: t !== S.Fragment });
      ...
      lr = (t, e, n, s = {}, i, r) => (a) => {
        const o = on(s, t) || {}, l2 = o.delay || s.delay || 0;
        let { elapsed: u = 0 } = s;
        u = u - O2(l2);
        ...
        let f2 = false;
        if ((c.type === false || c.duration === 0 && !c.repeatDelay) && (Fe(c), c.delay === 0 && (f2 = true)), (y.instantAnimations || y.skipAnimations) && (f2 = true, Fe(c), c.delay = 0), c.allowFlatten = !o.type && !o.ease, f2 && !r && e.get() !== void 0) {
      ...
      Dr = class extends X {
        ...
        startObserver() {
          this.unmount();
          const { viewport: e = {} } = this.node.getProps(), { root: n, margin: s, amount: i = "some", once: r } = e, a = { root: n ? n.current : void 0, rootMargin: s, threshold: typeof i == "number" ? i : Fr[i] }, o = (l2) => {
            const { isIntersecting: u } = l2;
            ...
            const { onViewportEnter: c, onViewportLeave: f2 } = this.node.getProps(), h = u ? c : f2;
            h && h(l2);
          };
  ...
  function fg() {
    if (vf) return xe2;
    vf = 1;
    var r = Symbol.for("react.element"), l2 = Symbol.for("react.portal"), i = Symbol.for("react.fragment"), s = Symbol.for("react.strict_mode"), c = Symbol.for("react.profiler"), d = Symbol.for("react.provider"), f2 = Symbol.for("react.context"), m2 = Symbol.for("react.forward_ref"), v = Symbol.for("react.suspense"), y2 = Symbol.for("react.memo"), g = Symbol.for("react.lazy"), x2 = Symbol.iterator;
    function E(b2) {
      return b2 === null || typeof b2 != "object" ? null : (b2 = x2 && b2[x2] || b2["@@iterator"], typeof b2 == "function" ? b2 : null);
    }
    var _2 = { isMounted: function() {
      return false;
    }, enqueueForceUpdate: function() {
    }, enqueueReplaceState: function() {
    }, enqueueSetState: function() {
    } }, I2 = Object.assign, F = {};
    function A2(b2, N3, U3) {
      this.props = b2, this.context = N3, this.refs = F, this.updater = U3 || _2;
    }
    A2.prototype.isReactComponent = {}, A2.prototype.setState = function(b2, N3) {
      if (typeof b2 != "object" && typeof b2 != "function" && b2 != null) throw Error("setState(...): takes an object of state variables to update or a function which returns an object of state variables.");
      this.updater.enqueueSetState(this, b2, N3, "setState");
    }, A2.prototype.forceUpdate = function(b2) {
      this.updater.enqueueForceUpdate(this, b2, "forceUpdate");
    };
    function te2() {
    }
    te2.prototype = A2.prototype;
    function re2(b2, N3, U3) {
      this.props = b2, this.context = N3, this.refs = F, this.updater = U3 || _2;
    }
    ...
    function W(b2, N3, U3) {
      ...
      if (b2 && b2.defaultProps) for (ne2 in ke = b2.defaultProps, ke) se[ne2] === void 0 && (se[ne2] = ke[ne2]);
      return { $$typeof: r, type: b2, key: ue2, ref: ce2, props: se, _owner: ie2.current };
    }
    function we2(b2, N3) {
      return { $$typeof: r, type: b2.type, key: N3, ref: b2.ref, props: b2.props, _owner: b2._owner };
    }
    function Ce2(b2) {
      return typeof b2 == "object" && b2 !== null && b2.$$typeof === r;
    }
    function R3(b2) {
      var N3 = { "=": "=0", ":": "=2" };
      return "$" + b2.replace(/[=:]/g, function(U3) {
        return N3[U3];
      });
    }
    var X2 = /\/+/g;
    function ve2(b2, N3) {
      return typeof b2 == "object" && b2 !== null && b2.key != null ? R3("" + b2.key) : N3.toString(36);
    }
    function M(b2, N3, U3, ne2, se) {
      var ue2 = typeof b2;
      (ue2 === "undefined" || ue2 === "boolean") && (b2 = null);
      var ce2 = false;
      if (b2 === null) ce2 = true;
      else switch (ue2) {
        case "string":
      ...
      if (ce2) return ce2 = b2, se = se(ce2), b2 = ne2 === "" ? "." + ve2(ce2, 0) : ne2, K2(se) ? (U3 = "", b2 != null && (U3 = b2.replace(X2, "$&/") + "/"), M(se, N3, U3, "", function(Oe2) {
        return Oe2;
      })) : se != null && (Ce2(se) && (se = we2(se, U3 + (!se.key || ce2 && ce2.key === se.key ? "" : ("" + se.key).replace(X2, "$&/") + "/") + b2)), N3.push(se)), 1;
      if (ce2 = 0, ne2 = ne2 === "" ? "." : ne2 + ":", K2(b2)) for (var ke = 0; ke < b2.length; ke++) {
        ue2 = b2[ke];
        var Ee2 = ne2 + ve2(ue2, ke);
        ce2 += M(ue2, N3, U3, Ee2, se);
      }
      else if (Ee2 = E(b2), typeof Ee2 == "function") for (b2 = Ee2.call(b2), ke = 0; !(ue2 = b2.next()).done; ) ue2 = ue2.value, Ee2 = ne2 + ve2(ue2, ke++), ce2 += M(ue2, N3, U3, Ee2, se);
      else if (ue2 === "object") throw N3 = String(b2), Error("Objects are not valid as a React child (found: " + (N3 === "[object Object]" ? "object with keys {" + Object.keys(b2).join(", ") + "}" : N3) + "). If you meant to render a collection of children, use an array instead.");
      return ce2;
    }
    function G2(b2, N3, U3) {
      if (b2 == null) return b2;
      var ne2 = [], se = 0;
      return M(b2, ne2, "", "", function(ue2) {
    ...
    function L3(b2) {
      if (b2._status === -1) {
        ...
        N3 = N3(), N3.then(function(U3) {
          (b2._status === 0 || b2._status === -1) && (b2._status = 1, b2._result = U3);
        }, function(U3) {
          (b2._status === 0 || b2._status === -1) && (b2._status = 2, b2._result = U3);
        }), b2._status === -1 && (b2._status = 0, b2._result = N3);
      }
      if (b2._status === 1) return b2._result.default;
      throw b2._result;
    }
    var H2 = { current: null }, $ = { transition: null }, D2 = { ReactCurrentDispatcher: H2, ReactCurrentBatchConfig: $, ReactCurrentOwner: ie2 };
    function z2() {
      throw Error("act(...) is not supported in production builds of React.");
    }
    return xe2.Children = { map: G2, forEach: function(b2, N3, U3) {
      G2(b2, function() {
        N3.apply(this, arguments);
      }, U3);
    }, count: function(b2) {
      var N3 = 0;
      return G2(b2, function() {
        N3++;
      }), N3;
    }, toArray: function(b2) {
      return G2(b2, function(N3) {
        return N3;
      }) || [];
    }, only: function(b2) {
      if (!Ce2(b2)) throw Error("React.Children.only expected to receive a single React element child.");
      return b2;
    } }, xe2.Component = A2, xe2.Fragment = i, xe2.Profiler = c, xe2.PureComponent = re2, xe2.StrictMode = s, xe2.Suspense = v, xe2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = D2, xe2.act = z2, xe2.cloneElement = function(b2, N3, U3) {
      if (b2 == null) throw Error("React.cloneElement(...): The argument must be a React element, but you passed " + b2 + ".");
      var ne2 = I2({}, b2.props), se = b2.key, ue2 = b2.ref, ce2 = b2._owner;
      if (N3 != null) {
        if (N3.ref !== void 0 && (ue2 = N3.ref, ce2 = ie2.current), N3.key !== void 0 && (se = "" + N3.key), b2.type && b2.type.defaultProps) var ke = b2.type.defaultProps;
      ...
      return { $$typeof: r, type: b2.type, key: se, ref: ue2, props: ne2, _owner: ce2 };
    }, xe2.createContext = function(b2) {
      return b2 = { $$typeof: f2, _currentValue: b2, _currentValue2: b2, _threadCount: 0, Provider: null, Consumer: null, _defaultValue: null, _globalName: null }, b2.Provider = { $$typeof: d, _context: b2 }, b2.Consumer = b2;
    }, xe2.createElement = W, xe2.createFactory = function(b2) {
      var N3 = W.bind(null, b2);
      return N3.type = b2, N3;
    }, xe2.createRef = function() {
      return { current: null };
    }, xe2.forwardRef = function(b2) {
      return { $$typeof: m2, render: b2 };
    }, xe2.isValidElement = Ce2, xe2.lazy = function(b2) {
      return { $$typeof: g, _payload: { _status: -1, _result: b2 }, _init: L3 };
    }, xe2.memo = function(b2, N3) {
      return { $$typeof: y2, type: b2, compare: N3 === void 0 ? null : N3 };
    }, xe2.startTransition = function(b2) {
      var N3 = $.transition;
      $.transition = {};
      try {
        b2();
    ...
    }, xe2.unstable_act = z2, xe2.useCallback = function(b2, N3) {
      return H2.current.useCallback(b2, N3);
    }, xe2.useContext = function(b2) {
      return H2.current.useContext(b2);
    }, xe2.useDebugValue = function() {
    }, xe2.useDeferredValue = function(b2) {
      return H2.current.useDeferredValue(b2);
    }, xe2.useEffect = function(b2, N3) {
      return H2.current.useEffect(b2, N3);
    }, xe2.useId = function() {
      return H2.current.useId();
    }, xe2.useImperativeHandle = function(b2, N3, U3) {
      return H2.current.useImperativeHandle(b2, N3, U3);
    }, xe2.useInsertionEffect = function(b2, N3) {
      return H2.current.useInsertionEffect(b2, N3);
    }, xe2.useLayoutEffect = function(b2, N3) {
      return H2.current.useLayoutEffect(b2, N3);
    }, xe2.useMemo = function(b2, N3) {
      return H2.current.useMemo(b2, N3);
    }, xe2.useReducer = function(b2, N3, U3) {
      return H2.current.useReducer(b2, N3, U3);
    }, xe2.useRef = function(b2) {
      return H2.current.useRef(b2);
    }, xe2.useState = function(b2) {
      return H2.current.useState(b2);
    }, xe2.useSyncExternalStore = function(b2, N3, U3) {
      return H2.current.useSyncExternalStore(b2, N3, U3);
    }, xe2.useTransition = function() {
      return H2.current.useTransition();
  ...
  function pg() {
    if (gf) return $o;
    gf = 1;
    var r = Ys2(), l2 = Symbol.for("react.element"), i = Symbol.for("react.fragment"), s = Object.prototype.hasOwnProperty, c = r.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, d = { key: true, ref: true, __self: true, __source: true };
    function f2(m2, v, y2) {
      var g, x2 = {}, E = null, _2 = null;
      y2 !== void 0 && (E = "" + y2), v.key !== void 0 && (E = "" + v.key), v.ref !== void 0 && (_2 = v.ref);
      for (g in v) s.call(v, g) && !d.hasOwnProperty(g) && (x2[g] = v[g]);
      if (m2 && m2.defaultProps) for (g in v = m2.defaultProps, v) x2[g] === void 0 && (x2[g] = v[g]);
      return { $$typeof: l2, type: m2, key: E, ref: _2, props: x2, _owner: c.current };
    }
    return $o.Fragment = i, $o.jsx = f2, $o.jsxs = f2, $o;
  }
  function mg() {
  ...
  function vg() {
    return wf || (wf = 1, (function(r) {
      function l2($, D2) {
        ...
        e: for (; 0 < z2; ) {
          var b2 = z2 - 1 >>> 1, N3 = $[b2];
          if (0 < c(N3, D2)) $[b2] = D2, $[z2] = N3, z2 = b2;
          else break e;
        }
      }
      function i($) {
      ...
      function s($) {
        ...
        if (z2 !== D2) {
          $[0] = z2;
          e: for (var b2 = 0, N3 = $.length, U3 = N3 >>> 1; b2 < U3; ) {
            var ne2 = 2 * (b2 + 1) - 1, se = $[ne2], ue2 = ne2 + 1, ce2 = $[ue2];
            if (0 > c(se, z2)) ue2 < N3 && 0 > c(ce2, se) ? ($[b2] = ce2, $[ue2] = z2, b2 = ue2) : ($[b2] = se, $[ne2] = z2, b2 = ne2);
            else if (ue2 < N3 && 0 > c(ce2, z2)) $[b2] = ce2, $[ue2] = z2, b2 = ue2;
            else break e;
          }
        }
        return D2;
      ...
      function c($, D2) {
        var z2 = $.sortIndex - D2.sortIndex;
        return z2 !== 0 ? z2 : $.id - D2.id;
      }
      if (typeof performance == "object" && typeof performance.now == "function") {
        ...
        var f2 = Date, m2 = f2.now();
        r.unstable_now = function() {
          return f2.now() - m2;
        };
      }
      var v = [], y2 = [], g = 1, x2 = null, E = 3, _2 = false, I2 = false, F = false, A2 = typeof setTimeout == "function" ? setTimeout : null, te2 = typeof clearTimeout == "function" ? clearTimeout : null, re2 = typeof setImmediate < "u" ? setImmediate : null;
      typeof navigator < "u" && navigator.scheduling !== void 0 && navigator.scheduling.isInputPending !== void 0 && navigator.scheduling.isInputPending.bind(navigator.scheduling);
      function pe2($) {
        for (var D2 = i(y2); D2 !== null; ) {
          if (D2.callback === null) s(y2);
          else if (D2.startTime <= $) s(y2), D2.sortIndex = D2.expirationTime, l2(v, D2);
          else break;
          D2 = i(y2);
        }
      }
      function K2($) {
        if (F = false, pe2($), !I2) if (i(v) !== null) I2 = true, L3(ye);
        else {
          var D2 = i(y2);
          D2 !== null && H2(K2, D2.startTime - $);
        }
      }
      function ye($, D2) {
        I2 = false, F && (F = false, te2(W), W = -1), _2 = true;
        var z2 = E;
        try {
          for (pe2(D2), x2 = i(v); x2 !== null && (!(x2.expirationTime > D2) || $ && !R3()); ) {
            var b2 = x2.callback;
            if (typeof b2 == "function") {
              x2.callback = null, E = x2.priorityLevel;
              var N3 = b2(x2.expirationTime <= D2);
              D2 = r.unstable_now(), typeof N3 == "function" ? x2.callback = N3 : x2 === i(v) && s(v), pe2(D2);
            } else s(v);
            x2 = i(v);
          }
          if (x2 !== null) var U3 = true;
          else {
            var ne2 = i(y2);
            ne2 !== null && H2(K2, ne2.startTime - D2), U3 = false;
          }
          return U3;
        } finally {
          x2 = null, E = z2, _2 = false;
        }
      }
      ...
      if (typeof re2 == "function") ve2 = function() {
        ...
        var M = new MessageChannel(), G2 = M.port2;
        M.port1.onmessage = X2, ve2 = function() {
          G2.postMessage(null);
        };
      } else ve2 = function() {
        A2(X2, 0);
      ...
      r.unstable_IdlePriority = 5, r.unstable_ImmediatePriority = 1, r.unstable_LowPriority = 4, r.unstable_NormalPriority = 3, r.unstable_Profiling = null, r.unstable_UserBlockingPriority = 2, r.unstable_cancelCallback = function($) {
        ...
        0 > $ || 125 < $ ? console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported") : we2 = 0 < $ ? Math.floor(1e3 / $) : 5;
      ...
      }, r.unstable_runWithPriority = function($, D2) {
        switch ($) {
          case 1:
          case 2:
          case 3:
      ...
      }, r.unstable_scheduleCallback = function($, D2, z2) {
        var b2 = r.unstable_now();
        switch (typeof z2 == "object" && z2 !== null ? (z2 = z2.delay, z2 = typeof z2 == "number" && 0 < z2 ? b2 + z2 : b2) : z2 = b2, $) {
          case 1:
            var N3 = -1;
            break;
          case 2:
        ...
        return N3 = z2 + N3, $ = { id: g++, callback: D2, priorityLevel: $, startTime: z2, expirationTime: N3, sortIndex: -1 }, z2 > b2 ? ($.sortIndex = z2, l2(y2, $), i(v) === null && $ === i(y2) && (F ? (te2(W), W = -1) : F = true, H2(K2, z2 - b2))) : ($.sortIndex = N3, l2(v, $), I2 || _2 || (I2 = true, L3(ye))), $;
      }, r.unstable_shouldYield = R3, r.unstable_wrapCallback = function($) {
        var D2 = E;
        return function() {
          var z2 = E;
          E = D2;
  ...
  function gg() {
    ...
    function d(e, t) {
      f2(e, t), f2(e + "Capture", t);
    }
    function f2(e, t) {
      for (c[e] = t, e = 0; e < t.length; e++) s.add(t[e]);
    }
    var m2 = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u"), v = Object.prototype.hasOwnProperty, y2 = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, g = {}, x2 = {};
    function E(e) {
      return v.call(x2, e) ? true : v.call(g, e) ? false : y2.test(e) ? x2[e] = true : (g[e] = true, false);
    }
    function _2(e, t, n, o) {
    ...
    function I2(e, t, n, o) {
      if (t === null || typeof t > "u" || _2(e, t, n, o)) return true;
      if (o) return false;
...
` + a[p].replace(" at new ", " at ");
                return e.displayName && w2.includes("<anonymous>") && (w2 = w2.replace("<anonymous>", e.displayName)), w2;
              }
            while (1 <= p && 0 <= h);
            break;
          }
    ...
    function Ru() {
      if (tr3) {
        var e = tr3, t = nr2;
        if (nr2 = tr3 = null, _u(e), t) for (e = 0; e < t.length; e++) _u(t[e]);
      }
    }
    function zu(e, t) {
      return e(t);
    ...
    function yv(e, t, n, o, a, u, p, h, w2) {
    ...
    var Ur = false, jo = null, Vo2 = false, Mi3 = null, wv = { onError: function(e) {
      Ur = true, jo = e;
    } };
    function bv(e, t, n, o, a, u, p, h, w2) {
      Ur = false, jo = null, yv.apply(wv, arguments);
    }
    function xv(e, t, n, o, a, u, p, h, w2) {
    ...
    var Vu = l2.unstable_scheduleCallback, Hu = l2.unstable_cancelCallback, Sv = l2.unstable_shouldYield, Ev = l2.unstable_requestPaint, De2 = l2.unstable_now, $v = l2.unstable_getCurrentPriorityLevel, Ri3 = l2.unstable_ImmediatePriority, Bu = l2.unstable_UserBlockingPriority, Ho = l2.unstable_NormalPriority, Cv = l2.unstable_LowPriority, Uu = l2.unstable_IdlePriority, Bo = null, Ot2 = null;
    function Pv(e) {
      if (Ot2 && typeof Ot2.onCommitFiberRoot == "function") try {
        Ot2.onCommitFiberRoot(Bo, e, void 0, (e.current.flags & 128) === 128);
      } catch {
      }
    }
    ...
    function Mv(e, t) {
      for (var n = e.suspendedLanes, o = e.pingedLanes, a = e.expirationTimes, u = e.pendingLanes; 0 < u; ) {
        var p = 31 - Tt2(u), h = 1 << p, w2 = a[p];
        w2 === -1 ? ((h & n) === 0 || (h & o) !== 0) && (a[p] = _v(h, t)) : w2 <= t && (e.expiredLanes |= h), u &= ~h;
      }
    }
    function zi3(e) {
    ...
    var Ku, Ai3, Qu, Yu, Xu, Oi3 = false, Ko = [], ln3 = null, an3 = null, sn3 = null, Kr2 = /* @__PURE__ */ new Map(), Qr = /* @__PURE__ */ new Map(), un3 = [], zv = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset submit".split(" ");
    function Zu(e, t) {
      switch (e) {
        case "focusin":
        case "focusout":
    ...
    function Iv(e, t, n, o, a) {
      switch (t) {
        ...
        case "mouseover":
          return sn3 = Yr(sn3, e, t, n, o, a), true;
        case "pointerover":
          var u = a.pointerId;
    ...
    function Fv() {
      Oi3 = false, ln3 !== null && Qo2(ln3) && (ln3 = null), an3 !== null && Qo2(an3) && (an3 = null), sn3 !== null && Qo2(sn3) && (sn3 = null), Kr2.forEach(Ju), Qr.forEach(Ju);
    }
    function Xr(e, t) {
      e.blockedOn === t && (e.blockedOn = null, Oi3 || (Oi3 = true, l2.unstable_scheduleCallback(l2.unstable_NormalPriority, Fv)));
    }
    function Zr(e) {
      function t(a) {
        return Xr(a, e);
      ...
      for (ln3 !== null && Xr(ln3, e), an3 !== null && Xr(an3, e), sn3 !== null && Xr(sn3, e), Kr2.forEach(t), Qr.forEach(t), n = 0; n < un3.length; n++) o = un3[n], o.blockedOn === e && (o.blockedOn = null);
      for (; 0 < un3.length && (n = un3[0], n.blockedOn === null); ) qu(n), n.blockedOn === null && un3.shift();
    }
    ...
    function ji3(e, t, n, o) {
      if (Xo2 = null, e = Ti3(o), e = Rn(e), e !== null) if (t = Mn(e), t === null) e = null;
    ...
    var cn3 = null, Vi3 = null, Zo2 = null;
    function tc() {
      if (Zo2) return Zo2;
      var e, t = Vi3, n = t.length, o, a = "value" in cn3 ? cn3.value : cn3.textContent, u = a.length;
    ...
    }, defaultPrevented: 0, isTrusted: 0 }, Hi3 = vt2(or3), qr = z2({}, or3, { view: 0, detail: 0 }), Dv = vt2(qr), Bi3, Ui3, Jr, el = z2({}, qr, { screenX: 0, screenY: 0, clientX: 0, clientY: 0, pageX: 0, pageY: 0, ctrlKey: 0, shiftKey: 0, altKey: 0, metaKey: 0, getModifierState: Gi3, button: 0, buttons: 0, relatedTarget: function(e) {
    ...
    } }), rc = vt2(el), jv = z2({}, el, { dataTransfer: 0 }), Vv = vt2(jv), Hv = z2({}, qr, { relatedTarget: 0 }), Wi3 = vt2(Hv), Bv = z2({}, or3, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }), Uv = vt2(Bv), Wv = z2({}, or3, { clipboardData: function(e) {
    ...
    } }), Jv = vt2(qv), eh = z2({}, el, { pointerId: 0, width: 0, height: 0, pressure: 0, tangentialPressure: 0, tiltX: 0, tiltY: 0, twist: 0, pointerType: 0, isPrimary: 0 }), lc = vt2(eh), th = z2({}, qr, { touches: 0, targetTouches: 0, changedTouches: 0, altKey: 0, metaKey: 0, ctrlKey: 0, shiftKey: 0, getModifierState: Gi3 }), nh = vt2(th), rh = z2({}, or3, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }), oh = vt2(rh), lh = z2({}, el, { deltaX: function(e) {
      return "deltaX" in e ? e.deltaX : "wheelDeltaX" in e ? -e.wheelDeltaX : 0;
    }, deltaY: function(e) {
      return "deltaY" in e ? e.deltaY : "wheelDeltaY" in e ? -e.wheelDeltaY : "wheelDelta" in e ? -e.wheelDelta : 0;
    }, deltaZ: 0, deltaMode: 0 }), ih = vt2(lh), ah = [9, 13, 27, 32], Ki3 = m2 && "CompositionEvent" in window, eo = null;
    m2 && "documentMode" in document && (eo = document.documentMode);
    var sh = m2 && "TextEvent" in window && !eo, ic = m2 && (!Ki3 || eo && 8 < eo && 11 >= eo), ac = " ", sc = false;
    function uc(e, t) {
      switch (e) {
        case "keyup":
    ...
    function ch(e, t) {
      if (lr2) return e === "compositionend" || !Ki3 && uc(e, t) ? (e = tc(), Zo2 = Vi3 = cn3 = null, lr2 = false, e) : null;
      switch (e) {
        case "paste":
          return null;
        case "keypress":
    ...
    function fc(e, t, n, o) {
      Mu(o), t = ll2(t, "onChange"), 0 < t.length && (n = new Hi3("onChange", "change", null, n, o), e.push({ event: n, listeners: t }));
    }
    ...
    function hc(e) {
      if (e.propertyName === "value" && tl(no2)) {
        var t = [];
    ...
    function vh(e) {
      if (e === "selectionchange" || e === "keyup" || e === "keydown") return tl(no2);
    }
    function hh(e, t) {
    ...
    var bh = m2 && "documentMode" in document && 11 >= document.documentMode, ir2 = null, Zi3 = null, oo2 = null, qi3 = false;
    function xc(e, t, n) {
    ...
    m2 && (kc = document.createElement("div").style, "AnimationEvent" in window || (delete ar2.animationend.animation, delete ar2.animationiteration.animation, delete ar2.animationstart.animation), "TransitionEvent" in window || delete ar2.transitionend.transition);
    function rl(e) {
    ...
    var Sc = rl("animationend"), Ec = rl("animationiteration"), $c = rl("animationstart"), Cc = rl("transitionend"), Pc = /* @__PURE__ */ new Map(), Tc = "abort auxClick cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(" ");
    function dn3(e, t) {
      Pc.set(e, t), d(t, [e]);
    }
      ...
      for (var n = 0; n < e.length; n++) {
        ...
        e: {
          ...
          if (t) for (var p = o.length - 1; 0 <= p; p--) {
            var h = o[p], w2 = h.instance, T = h.currentTarget;
            if (h = h.listener, w2 !== u && a.isPropagationStopped()) break e;
            Nc(a, h, T), u = w2;
          }
          else for (p = 0; p < o.length; p++) {
            if (h = o[p], w2 = h.instance, T = h.currentTarget, h = h.listener, w2 !== u && a.isPropagationStopped()) break e;
            Nc(a, h, T), u = w2;
          }
        }
      }
      if (Vo2) throw e = Mi3, Vo2 = false, Mi3 = null, e;
    }
    function _e2(e, t) {
      var n = t[ua2];
      n === void 0 && (n = t[ua2] = /* @__PURE__ */ new Set());
      var o = e + "__bubble";
      n.has(o) || (_c(t, e, 2, false), n.add(o));
    }
    function na(e, t, n) {
      var o = 0;
      t && (o |= 4), _c(n, e, o, t);
    ...
    function _c(e, t, n, o) {
      ...
      n = a.bind(null, t, n, e), a = void 0, !_i3 || t !== "touchstart" && t !== "touchmove" && t !== "wheel" || (a = true), o ? a !== void 0 ? e.addEventListener(t, n, { capture: true, passive: a }) : e.addEventListener(t, n, true) : a !== void 0 ? e.addEventListener(t, n, { passive: a }) : e.addEventListener(t, n, false);
    }
      ...
      if ((t & 1) === 0 && (t & 2) === 0 && o !== null) e: for (; ; ) {
        ...
        if (p === 3 || p === 4) {
          ...
          if (p === 4) for (p = o.return; p !== null; ) {
            var w2 = p.tag;
            if ((w2 === 3 || w2 === 4) && (w2 = p.stateNode.containerInfo, w2 === a || w2.nodeType === 8 && w2.parentNode === a)) return;
            p = p.return;
          }
          for (; h !== null; ) {
            if (p = Rn(h), p === null) return;
            if (w2 = p.tag, w2 === 5 || w2 === 6) {
              o = u = p;
              continue e;
            }
            h = h.parentNode;
      ...
      Fu(function() {
        ...
        e: {
          ...
          if (O3 !== void 0) {
            ...
            oe = [];
            for (var k2 = T, P2; k2 !== null; ) {
              P2 = k2;
              var B2 = P2.stateNode;
              if (P2.tag === 5 && B2 !== null && (P2 = B2, C !== null && (B2 = Hr2(k2, C), B2 != null && oe.push(ao2(k2, B2, P2)))), je2) break;
              k2 = k2.return;
            }
            0 < oe.length && (O3 = new Q2(O3, q3, null, n, j2), V2.push({ event: O3, listeners: oe }));
          }
        }
        if ((t & 7) === 0) {
          e: {
            if (O3 = e === "mouseover" || e === "pointerover", Q2 = e === "mouseout" || e === "pointerout", O3 && n !== Pi3 && (q3 = n.relatedTarget || n.fromElement) && (Rn(q3) || q3[Wt2])) break e;
            if ((Q2 || O3) && (O3 = j2.window === j2 ? j2 : (O3 = j2.ownerDocument) ? O3.defaultView || O3.parentWindow : window, Q2 ? (q3 = n.relatedTarget || n.toElement, Q2 = T, q3 = q3 ? Rn(q3) : null, q3 !== null && (je2 = Mn(q3), q3 !== je2 || q3.tag !== 5 && q3.tag !== 6) && (q3 = null)) : (Q2 = null, q3 = T), Q2 !== q3)) {
              if (oe = rc, B2 = "onMouseLeave", C = "onMouseEnter", k2 = "mouse", (e === "pointerout" || e === "pointerover") && (oe = lc, B2 = "onPointerLeave", C = "onPointerEnter", k2 = "pointer"), je2 = Q2 == null ? O3 : cr2(Q2), P2 = q3 == null ? O3 : cr2(q3), O3 = new oe(B2, k2 + "leave", Q2, n, j2), O3.target = je2, O3.relatedTarget = P2, B2 = null, Rn(j2) === T && (oe = new oe(C, k2 + "enter", q3, n, j2), oe.target = P2, oe.relatedTarget = je2, B2 = oe), je2 = B2, Q2 && q3) t: {
                for (oe = Q2, C = q3, k2 = 0, P2 = oe; P2; P2 = sr2(P2)) k2++;
                for (P2 = 0, B2 = C; B2; B2 = sr2(B2)) P2++;
                for (; 0 < k2 - P2; ) oe = sr2(oe), k2--;
                for (; 0 < P2 - k2; ) C = sr2(C), P2--;
                for (; k2--; ) {
              ...
              Q2 !== null && Mc(V2, O3, Q2, oe, false), q3 !== null && je2 !== null && Mc(V2, je2, q3, oe, true);
            }
          }
          e: {
            if (O3 = T ? cr2(T) : window, Q2 = O3.nodeName && O3.nodeName.toLowerCase(), Q2 === "select" || Q2 === "input" && O3.type === "file") var le2 = ph;
            else if (dc(O3)) if (pc) le2 = gh;
            else {
              le2 = vh;
              var de2 = mh;
            }
            else (Q2 = O3.nodeName) && Q2.toLowerCase() === "input" && (O3.type === "checkbox" || O3.type === "radio") && (le2 = hh);
            if (le2 && (le2 = le2(e, T))) {
              fc(V2, le2, n, j2);
              break e;
            }
          ...
          me2 && (ic && n.locale !== "ko" && (lr2 || me2 !== "onCompositionStart" ? me2 === "onCompositionEnd" && lr2 && (fe2 = tc()) : (cn3 = j2, Vi3 = "value" in cn3 ? cn3.value : cn3.textContent, lr2 = true)), de2 = ll2(T, me2), 0 < de2.length && (me2 = new oc(me2, e, null, n, j2), V2.push({ event: me2, listeners: de2 }), fe2 ? me2.data = fe2 : (fe2 = cc(n), fe2 !== null && (me2.data = fe2)))), (fe2 = sh ? uh(e, n) : ch(e, n)) && (T = ll2(T, "onBeforeInput"), 0 < T.length && (j2 = new oc("onBeforeInput", "beforeinput", null, n, j2), V2.push({ event: j2, listeners: T }), j2.data = fe2));
        }
        Lc(V2, t);
      });
    }
    ...
    function ll2(e, t) {
      for (var n = t + "Capture", o = []; e !== null; ) {
        ...
        a.tag === 5 && u !== null && (a = u, u = Hr2(e, n), u != null && o.unshift(ao2(e, u, a)), u = Hr2(e, t), u != null && o.push(ao2(e, u, a))), e = e.return;
      }
      return o;
    }
    function sr2(e) {
    ...
    function Mc(e, t, n, o, a) {
      for (var u = t._reactName, p = []; n !== null && n !== o; ) {
        var h = n, w2 = h.alternate, T = h.stateNode;
        if (w2 !== null && w2 === o) break;
        h.tag === 5 && T !== null && (h = T, a ? (w2 = Hr2(n, u), w2 != null && p.unshift(ao2(n, w2, h))) : a || (w2 = Hr2(n, u), w2 != null && p.push(ao2(n, w2, h)))), n = n.return;
      }
...
`).replace($h, "");
    ...
    function Me2(e) {
      0 > dr2 || (e.current = ca[dr2], ca[dr2] = null, dr2--);
    }
    function Ne2(e, t) {
      dr2++, ca[dr2] = e.current, e.current = t;
    }
    var mn2 = {}, Je2 = pn3(mn2), it2 = pn3(false), zn2 = mn2;
    function fr2(e, t) {
    ...
    function Oc(e, t, n) {
      ...
      n ? (e = Ac(e, t, zn2), o.__reactInternalMemoizedMergedChildContext = e, Me2(it2), Me2(Je2), Ne2(Je2, e)) : Me2(it2), Ne2(it2, n);
    }
    var Gt2 = null, dl2 = false, da = false;
    function Dc(e) {
    ...
    var Mh = K2.ReactCurrentBatchConfig;
    function co2(e, t, n) {
    ...
    function Gc(e) {
      function t(C, k2) {
        if (e) {
          var P2 = C.deletions;
          P2 === null ? (C.deletions = [k2], C.flags |= 16) : P2.push(k2);
        }
      }
      function n(C, k2) {
        if (!e) return null;
        for (; k2 !== null; ) t(C, k2), k2 = k2.sibling;
        return null;
      }
      function o(C, k2) {
        for (C = /* @__PURE__ */ new Map(); k2 !== null; ) k2.key !== null ? C.set(k2.key, k2) : C.set(k2.index, k2), k2 = k2.sibling;
        return C;
      }
      function a(C, k2) {
        return C = Sn2(C, k2), C.index = 0, C.sibling = null, C;
      }
      function u(C, k2, P2) {
        return C.index = P2, e ? (P2 = C.alternate, P2 !== null ? (P2 = P2.index, P2 < k2 ? (C.flags |= 2, k2) : P2) : (C.flags |= 2, k2)) : (C.flags |= 1048576, k2);
      }
      function p(C) {
        return e && C.alternate === null && (C.flags |= 2), C;
      }
      function h(C, k2, P2, B2) {
        return k2 === null || k2.tag !== 6 ? (k2 = as3(P2, C.mode, B2), k2.return = C, k2) : (k2 = a(k2, P2), k2.return = C, k2);
      }
      function w2(C, k2, P2, B2) {
        var le2 = P2.type;
        return le2 === ae2 ? j2(C, k2, P2.props.children, B2, P2.key) : k2 !== null && (k2.elementType === le2 || typeof le2 == "object" && le2 !== null && le2.$$typeof === L3 && Wc(le2) === k2.type) ? (B2 = a(k2, P2.props), B2.ref = co2(C, k2, P2), B2.return = C, B2) : (B2 = Dl2(P2.type, P2.key, P2.props, null, C.mode, B2), B2.ref = co2(C, k2, P2), B2.return = C, B2);
      }
      function T(C, k2, P2, B2) {
        return k2 === null || k2.tag !== 4 || k2.stateNode.containerInfo !== P2.containerInfo || k2.stateNode.implementation !== P2.implementation ? (k2 = ss3(P2, C.mode, B2), k2.return = C, k2) : (k2 = a(k2, P2.children || []), k2.return = C, k2);
      }
      function j2(C, k2, P2, B2, le2) {
        return k2 === null || k2.tag !== 7 ? (k2 = Un(P2, C.mode, B2, le2), k2.return = C, k2) : (k2 = a(k2, P2), k2.return = C, k2);
      }
      function V2(C, k2, P2) {
        if (typeof k2 == "string" && k2 !== "" || typeof k2 == "number") return k2 = as3("" + k2, C.mode, P2), k2.return = C, k2;
        if (typeof k2 == "object" && k2 !== null) {
          switch (k2.$$typeof) {
            case ye:
              return P2 = Dl2(k2.type, k2.key, k2.props, null, C.mode, P2), P2.ref = co2(C, null, k2), P2.return = C, P2;
            case ie2:
              return k2 = ss3(k2, C.mode, P2), k2.return = C, k2;
            case L3:
              var B2 = k2._init;
              return V2(C, B2(k2._payload), P2);
          }
          if (_n(k2) || D2(k2)) return k2 = Un(k2, C.mode, P2, null), k2.return = C, k2;
          vl2(C, k2);
        }
        return null;
      }
      function O3(C, k2, P2, B2) {
        var le2 = k2 !== null ? k2.key : null;
        if (typeof P2 == "string" && P2 !== "" || typeof P2 == "number") return le2 !== null ? null : h(C, k2, "" + P2, B2);
        if (typeof P2 == "object" && P2 !== null) {
          switch (P2.$$typeof) {
            case ye:
              return P2.key === le2 ? w2(C, k2, P2, B2) : null;
            case ie2:
              return P2.key === le2 ? T(C, k2, P2, B2) : null;
            case L3:
              return le2 = P2._init, O3(C, k2, le2(P2._payload), B2);
          }
          if (_n(P2) || D2(P2)) return le2 !== null ? null : j2(C, k2, P2, B2, null);
          vl2(C, P2);
        }
        return null;
      }
      function Q2(C, k2, P2, B2, le2) {
        if (typeof B2 == "string" && B2 !== "" || typeof B2 == "number") return C = C.get(P2) || null, h(k2, C, "" + B2, le2);
        if (typeof B2 == "object" && B2 !== null) {
          switch (B2.$$typeof) {
            case ye:
              return C = C.get(B2.key === null ? P2 : B2.key) || null, w2(k2, C, B2, le2);
            case ie2:
              return C = C.get(B2.key === null ? P2 : B2.key) || null, T(k2, C, B2, le2);
            case L3:
              var de2 = B2._init;
              return Q2(C, k2, P2, de2(B2._payload), le2);
          }
          if (_n(B2) || D2(B2)) return C = C.get(P2) || null, j2(k2, C, B2, le2, null);
          vl2(k2, B2);
        }
        return null;
      }
      function q3(C, k2, P2, B2) {
        for (var le2 = null, de2 = null, fe2 = k2, me2 = k2 = 0, Ye2 = null; fe2 !== null && me2 < P2.length; me2++) {
          fe2.index > me2 ? (Ye2 = fe2, fe2 = null) : Ye2 = fe2.sibling;
          var $e2 = O3(C, fe2, P2[me2], B2);
          if ($e2 === null) {
            fe2 === null && (fe2 = Ye2);
            break;
          }
          e && fe2 && $e2.alternate === null && t(C, fe2), k2 = u($e2, k2, me2), de2 === null ? le2 = $e2 : de2.sibling = $e2, de2 = $e2, fe2 = Ye2;
        }
        if (me2 === P2.length) return n(C, fe2), ze3 && Fn(C, me2), le2;
        if (fe2 === null) {
          for (; me2 < P2.length; me2++) fe2 = V2(C, P2[me2], B2), fe2 !== null && (k2 = u(fe2, k2, me2), de2 === null ? le2 = fe2 : de2.sibling = fe2, de2 = fe2);
          return ze3 && Fn(C, me2), le2;
        }
        for (fe2 = o(C, fe2); me2 < P2.length; me2++) Ye2 = Q2(fe2, C, me2, P2[me2], B2), Ye2 !== null && (e && Ye2.alternate !== null && fe2.delete(Ye2.key === null ? me2 : Ye2.key), k2 = u(Ye2, k2, me2), de2 === null ? le2 = Ye2 : de2.sibling = Ye2, de2 = Ye2);
        return e && fe2.forEach(function(En) {
          return t(C, En);
        }), ze3 && Fn(C, me2), le2;
      }
      function oe(C, k2, P2, B2) {
        var le2 = D2(P2);
        if (typeof le2 != "function") throw Error(i(150));
        if (P2 = le2.call(P2), P2 == null) throw Error(i(151));
        for (var de2 = le2 = null, fe2 = k2, me2 = k2 = 0, Ye2 = null, $e2 = P2.next(); fe2 !== null && !$e2.done; me2++, $e2 = P2.next()) {
          fe2.index > me2 ? (Ye2 = fe2, fe2 = null) : Ye2 = fe2.sibling;
          ...
          e && fe2 && En.alternate === null && t(C, fe2), k2 = u(En, k2, me2), de2 === null ? le2 = En : de2.sibling = En, de2 = En, fe2 = Ye2;
        }
        if ($e2.done) return n(C, fe2), ze3 && Fn(C, me2), le2;
        if (fe2 === null) {
          for (; !$e2.done; me2++, $e2 = P2.next()) $e2 = V2(C, $e2.value, B2), $e2 !== null && (k2 = u($e2, k2, me2), de2 === null ? le2 = $e2 : de2.sibling = $e2, de2 = $e2);
          return ze3 && Fn(C, me2), le2;
        }
        for (fe2 = o(C, fe2); !$e2.done; me2++, $e2 = P2.next()) $e2 = Q2(fe2, C, me2, $e2.value, B2), $e2 !== null && (e && $e2.alternate !== null && fe2.delete($e2.key === null ? me2 : $e2.key), k2 = u($e2, k2, me2), de2 === null ? le2 = $e2 : de2.sibling = $e2, de2 = $e2);
        return e && fe2.forEach(function(dg) {
          return t(C, dg);
        }), ze3 && Fn(C, me2), le2;
      }
      function je2(C, k2, P2, B2) {
        if (typeof P2 == "object" && P2 !== null && P2.type === ae2 && P2.key === null && (P2 = P2.props.children), typeof P2 == "object" && P2 !== null) {
          switch (P2.$$typeof) {
            case ye:
              e: {
                for (var le2 = P2.key, de2 = k2; de2 !== null; ) {
                  if (de2.key === le2) {
                    if (le2 = P2.type, le2 === ae2) {
                      if (de2.tag === 7) {
                        n(C, de2.sibling), k2 = a(de2, P2.props.children), k2.return = C, C = k2;
                        break e;
                      }
                    } else if (de2.elementType === le2 || typeof le2 == "object" && le2 !== null && le2.$$typeof === L3 && Wc(le2) === de2.type) {
                      n(C, de2.sibling), k2 = a(de2, P2.props), k2.ref = co2(C, de2, P2), k2.return = C, C = k2;
                      break e;
                    }
                    n(C, de2);
                    break;
                ...
                P2.type === ae2 ? (k2 = Un(P2.props.children, C.mode, B2, P2.key), k2.return = C, C = k2) : (B2 = Dl2(P2.type, P2.key, P2.props, null, C.mode, B2), B2.ref = co2(C, k2, P2), B2.return = C, C = B2);
              }
              return p(C);
            case ie2:
              e: {
                for (de2 = P2.key; k2 !== null; ) {
                  if (k2.key === de2) if (k2.tag === 4 && k2.stateNode.containerInfo === P2.containerInfo && k2.stateNode.implementation === P2.implementation) {
                    n(C, k2.sibling), k2 = a(k2, P2.children || []), k2.return = C, C = k2;
                    break e;
                  } else {
                    n(C, k2);
                    break;
                ...
                k2 = ss3(P2, C.mode, B2), k2.return = C, C = k2;
              }
              return p(C);
            case L3:
              return de2 = P2._init, je2(C, k2, de2(P2._payload), B2);
          }
          if (_n(P2)) return q3(C, k2, P2, B2);
          if (D2(P2)) return oe(C, k2, P2, B2);
          vl2(C, P2);
        }
        return typeof P2 == "string" && P2 !== "" || typeof P2 == "number" ? (P2 = "" + P2, k2 !== null && k2.tag === 6 ? (n(C, k2.sibling), k2 = a(k2, P2), k2.return = C, C = k2) : (n(C, k2), k2 = as3(P2, C.mode, B2), k2.return = C, C = k2), p(C)) : n(C, k2);
      }
      return je2;
    }
    var hr2 = Gc(true), Kc = Gc(false), hl2 = pn3(null), gl2 = null, gr2 = null, ga2 = null;
    function ya() {
      ga2 = gr2 = gl2 = null;
    }
    function wa2(e) {
      var t = hl2.current;
      Me2(hl2), e._currentValue = t;
    }
    function ba2(e, t, n) {
      for (; e !== null; ) {
        var o = e.alternate;
    ...
    function Qc(e, t, n, o) {
      var a = t.interleaved;
      return a === null ? (n.next = n, xa2(t)) : (n.next = a.next, a.next = n), t.interleaved = n, Yt2(e, o);
    }
    function Yt2(e, t) {
      e.lanes |= t;
      var n = e.alternate;
    ...
    function gn2(e, t, n) {
      ...
      return a = o.interleaved, a === null ? (t.next = t, xa2(o)) : (t.next = a.next, a.next = t), o.interleaved = t, Yt2(e, n);
    }
    function yl2(e, t, n) {
    ...
    function wl2(e, t, n, o) {
      ...
      if (h !== null) {
        ...
        var w2 = h, T = w2.next;
        w2.next = null, p === null ? u = T : p.next = T, p = w2;
        var j2 = e.alternate;
        j2 !== null && (j2 = j2.updateQueue, h = j2.lastBaseUpdate, h !== p && (h === null ? j2.firstBaseUpdate = T : h.next = T, j2.lastBaseUpdate = w2));
      }
      if (u !== null) {
        var V2 = a.baseState;
        p = 0, j2 = T = w2 = null, h = u;
        do {
          var O3 = h.lane, Q2 = h.eventTime;
          if ((o & O3) === O3) {
            j2 !== null && (j2 = j2.next = { eventTime: Q2, lane: 0, tag: h.tag, payload: h.payload, callback: h.callback, next: null });
            e: {
              var q3 = e, oe = h;
              switch (O3 = t, Q2 = n, oe.tag) {
                case 1:
                ...
                case 0:
                  if (q3 = oe.payload, O3 = typeof q3 == "function" ? q3.call(Q2, V2, O3) : q3, O3 == null) break e;
                  V2 = z2({}, V2, O3);
                  break e;
                case 2:
                  hn2 = true;
          ...
          } else Q2 = { eventTime: Q2, lane: O3, tag: h.tag, payload: h.payload, callback: h.callback, next: null }, j2 === null ? (T = j2 = Q2, w2 = V2) : j2 = j2.next = Q2, p |= O3;
          if (h = h.next, h === null) {
            if (h = a.shared.pending, h === null) break;
            O3 = h, h = O3.next, O3.next = null, a.lastBaseUpdate = O3, a.shared.pending = null;
          }
        } while (true);
        if (j2 === null && (w2 = V2), a.baseState = w2, a.firstBaseUpdate = T, a.lastBaseUpdate = j2, t = a.shared.interleaved, t !== null) {
          a = t;
          do
            p |= a.lane, a = a.next;
          while (a !== t);
    ...
    var fo2 = {}, jt2 = pn3(fo2), po2 = pn3(fo2), mo2 = pn3(fo2);
    function On(e) {
    ...
    function _a(e) {
      ...
      if (a !== null) {
        ...
        var h = p = null, w2 = null, T = u;
        do {
          var j2 = T.lane;
          if ((Dn & j2) === j2) w2 !== null && (w2 = w2.next = { lane: 0, action: T.action, hasEagerState: T.hasEagerState, eagerState: T.eagerState, next: null }), o = T.hasEagerState ? T.eagerState : e(o, T.action);
          else {
            var V2 = { lane: j2, action: T.action, hasEagerState: T.hasEagerState, eagerState: T.eagerState, next: null };
            w2 === null ? (h = w2 = V2, p = o) : w2 = w2.next = V2, Fe2.lanes |= j2, jn |= j2;
          }
          T = T.next;
        } while (T !== null && T !== u);
        w2 === null ? p = o : w2.next = h, Nt2(o, t.memoizedState) || (st2 = true), t.memoizedState = o, t.baseState = p, t.baseQueue = w2, n.lastRenderedState = o;
      }
    ...
    function ed(e, t) {
      ...
      if (u && (o.memoizedState = a, st2 = true), o = o.queue, Ra2(rd.bind(null, n, o, e), [e]), o.getSnapshot !== t || u || Ke2 !== null && Ke2.memoizedState.tag & 1) {
    ...
    function El2(e, t, n, o) {
      ...
      if (Ue2 !== null) {
        ...
        if (u = p.destroy, o !== null && Ta2(o, p.deps)) {
    ...
    function pd(e, t) {
      ...
      return o !== null && t !== null && Ta2(t, o[1]) ? o[0] : (n.memoizedState = [e, t], e);
    }
    function md(e, t) {
      var n = kt2();
      t = t === void 0 ? null : t;
      var o = n.memoizedState;
      return o !== null && t !== null && Ta2(t, o[1]) ? o[0] : (e = e(), n.memoizedState = [e, t], e);
    }
    function vd(e, t, n) {
      ...
      if (gd(e)) yd(t, a);
        ...
        if (e.lanes === 0 && (u === null || u.lanes === 0) && (u = t.lastRenderedReducer, u !== null)) try {
          ...
          if (a.hasEagerState = true, a.eagerState = h, Nt2(h, p)) {
            var w2 = t.interleaved;
            w2 === null ? (a.next = a, xa2(t)) : (a.next = w2.next, w2.next = a), t.interleaved = a;
            return;
          }
        } catch {
        } finally {
    ...
    var $l2 = { readContext: xt, useCallback: et2, useContext: et2, useEffect: et2, useImperativeHandle: et2, useInsertionEffect: et2, useLayoutEffect: et2, useMemo: et2, useReducer: et2, useRef: et2, useState: et2, useDebugValue: et2, useDeferredValue: et2, useTransition: et2, useMutableSource: et2, useSyncExternalStore: et2, useId: et2, unstable_isNewReconciler: false }, Ah = { readContext: xt, useCallback: function(e, t) {
    ...
    }, useState: id, useDebugValue: za, useDeferredValue: function(e) {
    ...
    }, unstable_isNewReconciler: false }, Oh = { readContext: xt, useCallback: pd, useContext: xt, useEffect: Ra2, useImperativeHandle: fd, useInsertionEffect: ud, useLayoutEffect: cd, useMemo: md, useReducer: _a, useRef: ad, useState: function() {
      return _a(go2);
      ...
      return [e, t];
    }, useMutableSource: Jc, useSyncExternalStore: ed, useId: hd, unstable_isNewReconciler: false }, Dh = { readContext: xt, useCallback: pd, useContext: xt, useEffect: Ra2, useImperativeHandle: fd, useInsertionEffect: ud, useLayoutEffect: cd, useMemo: md, useReducer: Ma, useRef: ad, useState: function() {
      return Ma(go2);
    }, useDebugValue: za, useDeferredValue: function(e) {
      var t = kt2();
    ...
    function Fa2(e, t, n, o) {
      var a = e.stateNode;
      a.props = n, a.state = e.memoizedState, a.refs = {}, ka(e);
      var u = t.contextType;
...
` + u.stack;
    ...
    function Rd(e, t, n, o, a) {
      ...
      if (yr2(t, a), t.stateNode === null) Tl2(e, t), xd(t, n, o), Fa2(t, n, o, a), o = true;
      else if (e === null) {
        var p = t.stateNode, h = t.memoizedProps;
        p.props = h;
        var w2 = p.context, T = n.contextType;
        ...
        V2 || typeof p.UNSAFE_componentWillReceiveProps != "function" && typeof p.componentWillReceiveProps != "function" || (h !== o || w2 !== T) && kd(t, p, o, T), hn2 = false;
        var O3 = t.memoizedState;
        p.state = O3, wl2(t, o, p, a), w2 = t.memoizedState, h !== o || O3 !== w2 || it2.current || hn2 ? (typeof j2 == "function" && (Ia(t, n, j2, o), w2 = t.memoizedState), (h = hn2 || bd(t, n, h, o, O3, w2, T)) ? (V2 || typeof p.UNSAFE_componentWillMount != "function" && typeof p.componentWillMount != "function" || (typeof p.componentWillMount == "function" && p.componentWillMount(), typeof p.UNSAFE_componentWillMount == "function" && p.UNSAFE_componentWillMount()), typeof p.componentDidMount == "function" && (t.flags |= 4194308)) : (typeof p.componentDidMount == "function" && (t.flags |= 4194308), t.memoizedProps = o, t.memoizedState = w2), p.props = o, p.state = w2, p.context = T, o = h) : (typeof p.componentDidMount == "function" && (t.flags |= 4194308), o = false);
      } else {
        p = t.stateNode, Yc(e, t), h = t.memoizedProps, T = t.type === t.elementType ? h : _t2(t.type, h), p.props = T, V2 = t.pendingProps, O3 = p.context, w2 = n.contextType, typeof w2 == "object" && w2 !== null ? w2 = xt(w2) : (w2 = at2(n) ? zn2 : Je2.current, w2 = fr2(t, w2));
        var Q2 = n.getDerivedStateFromProps;
        (j2 = typeof Q2 == "function" || typeof p.getSnapshotBeforeUpdate == "function") || typeof p.UNSAFE_componentWillReceiveProps != "function" && typeof p.componentWillReceiveProps != "function" || (h !== V2 || O3 !== w2) && kd(t, p, o, w2), hn2 = false, O3 = t.memoizedState, p.state = O3, wl2(t, o, p, a);
        var q3 = t.memoizedState;
        h !== V2 || O3 !== q3 || it2.current || hn2 ? (typeof Q2 == "function" && (Ia(t, n, Q2, o), q3 = t.memoizedState), (T = hn2 || bd(t, n, T, o, O3, q3, w2) || false) ? (j2 || typeof p.UNSAFE_componentWillUpdate != "function" && typeof p.componentWillUpdate != "function" || (typeof p.componentWillUpdate == "function" && p.componentWillUpdate(o, q3, w2), typeof p.UNSAFE_componentWillUpdate == "function" && p.UNSAFE_componentWillUpdate(o, q3, w2)), typeof p.componentDidUpdate == "function" && (t.flags |= 4), typeof p.getSnapshotBeforeUpdate == "function" && (t.flags |= 1024)) : (typeof p.componentDidUpdate != "function" || h === e.memoizedProps && O3 === e.memoizedState || (t.flags |= 4), typeof p.getSnapshotBeforeUpdate != "function" || h === e.memoizedProps && O3 === e.memoizedState || (t.flags |= 1024), t.memoizedProps = o, t.memoizedState = q3), p.props = o, p.state = q3, p.context = w2, o = T) : (typeof p.componentDidUpdate != "function" || h === e.memoizedProps && O3 === e.memoizedState || (t.flags |= 4), typeof p.getSnapshotBeforeUpdate != "function" || h === e.memoizedProps && O3 === e.memoizedState || (t.flags |= 1024), o = false);
      }
    ...
    function zd(e) {
      var t = e.stateNode;
      t.pendingContext ? Fc(e, t.pendingContext, t.pendingContext !== t.context) : t.context && Fc(e, t.context, false), Sa(e, t.containerInfo);
    }
    ...
    function Fd(e, t, n) {
      ...
      if (u) {
        ...
        var w2 = { mode: "hidden", children: o.children };
        return (p & 1) === 0 && t.child !== a ? (o = t.child, o.childLanes = 0, o.pendingProps = w2, t.deletions = null) : (o = Sn2(a, w2), o.subtreeFlags = a.subtreeFlags & 14680064), h !== null ? u = Sn2(h, u) : (u = Un(u, p, n, null), u.flags |= 2), u.return = t, o.return = t, o.sibling = u, t.child = o, o = u, u = t.child, p = e.child.memoizedState, p = p === null ? Ha(n) : { baseLanes: p.baseLanes | n, cachePool: null, transitions: p.transitions }, u.memoizedState = p, u.childLanes = e.childLanes & ~n, t.memoizedState = Va, o;
      }
    ...
    Dd = function(e, t) {
      ...
      if (a !== o) {
        ...
        for (T in o) {
          var w2 = o[T];
          if (h = a != null ? a[T] : void 0, o.hasOwnProperty(T) && w2 !== h && (w2 != null || h != null)) if (T === "style") if (h) {
            for (p in h) !h.hasOwnProperty(p) || w2 && w2.hasOwnProperty(p) || (n || (n = {}), n[p] = "");
            for (p in w2) w2.hasOwnProperty(p) && h[p] !== w2[p] && (n || (n = {}), n[p] = w2[p]);
          } else n || (u || (u = []), u.push(T, n)), n = w2;
          else T === "dangerouslySetInnerHTML" ? (w2 = w2 ? w2.__html : void 0, h = h ? h.__html : void 0, w2 != null && h !== w2 && (u = u || []).push(T, w2)) : T === "children" ? typeof w2 != "string" && typeof w2 != "number" || (u = u || []).push(T, "" + w2) : T !== "suppressContentEditableWarning" && T !== "suppressHydrationWarning" && (c.hasOwnProperty(T) ? (w2 != null && T === "onScroll" && _e2("scroll", e), u || h === w2 || (u = [])) : (u = u || []).push(T, w2));
        }
        n && (u = u || []).push("style", n);
        var T = u;
    ...
    function Uh(e, t, n) {
      ...
      switch (pa2(t), t.tag) {
        ...
        case 3:
          return o = t.stateNode, wr2(), Me2(it2), Me2(Je2), Ca2(), o.pendingContext && (o.context = o.pendingContext, o.pendingContext = null), (e === null || e.child === null) && (ml2(t) ? t.flags |= 4 : e === null || e.memoizedState.isDehydrated && (t.flags & 256) === 0 || (t.flags |= 1024, Lt2 !== null && (ns3(Lt2), Lt2 = null))), Wa(e, t), tt3(t), null;
        case 5:
          Ea2(t);
          ...
          if (n = t.type, e !== null && t.stateNode != null) jd(e, t, n, o, a), e.ref !== t.ref && (t.flags |= 512, t.flags |= 2097152);
            ...
            if (e = On(jt2.current), ml2(t)) {
              ...
              switch (o[Dt] = t, o[so2] = u, e = (t.mode & 1) !== 0, n) {
                ...
                case "video":
                case "audio":
                  for (a = 0; a < lo2.length; a++) _e2(lo2[a], o);
                  break;
                case "source":
                  _e2("error", o);
                  break;
                ...
                case "image":
                case "link":
                  _e2("error", o), _e2("load", o);
                  break;
                case "details":
                  _e2("toggle", o);
                  break;
                case "input":
                  Or3(o, u), _e2("invalid", o);
                  break;
                case "select":
                  o._wrapperState = { wasMultiple: !!u.multiple }, _e2("invalid", o);
                  break;
                case "textarea":
                  Eu(o, u), _e2("invalid", o);
              }
              $i3(n, u), a = null;
              for (var p in u) if (u.hasOwnProperty(p)) {
                var h = u[p];
                p === "children" ? typeof h == "string" ? o.textContent !== h && (u.suppressHydrationWarning !== true && il2(o.textContent, h, e), a = ["children", h]) : typeof h == "number" && o.textContent !== "" + h && (u.suppressHydrationWarning !== true && il2(o.textContent, h, e), a = ["children", "" + h]) : c.hasOwnProperty(p) && h != null && p === "onScroll" && _e2("scroll", o);
              }
              switch (n) {
                case "input":
                  Ft(o), Oo(o, u, true);
              ...
              e: {
                switch (p = Ci3(n, o), n) {
                  ...
                  case "video":
                  case "audio":
                    for (a = 0; a < lo2.length; a++) _e2(lo2[a], e);
                    a = o;
                    break;
                  case "source":
                    _e2("error", e), a = o;
                  ...
                  case "image":
                  case "link":
                    _e2("error", e), _e2("load", e), a = o;
                    break;
                  case "details":
                    _e2("toggle", e), a = o;
                    break;
                  case "input":
                    Or3(e, o), a = Jn2(e, o), _e2("invalid", e);
                    break;
                  case "option":
                    a = o;
                    break;
                  case "select":
                    e._wrapperState = { wasMultiple: !!o.multiple }, a = z2({}, o, { value: void 0 }), _e2("invalid", e);
                    break;
                  case "textarea":
                    Eu(e, o), a = Pt(e, o), _e2("invalid", e);
                    break;
                  default:
                    a = o;
                }
                ...
                for (u in h) if (h.hasOwnProperty(u)) {
                  var w2 = h[u];
                  u === "style" ? Lu(e, w2) : u === "dangerouslySetInnerHTML" ? (w2 = w2 ? w2.__html : void 0, w2 != null && Tu(e, w2)) : u === "children" ? typeof w2 == "string" ? (n !== "textarea" || w2 !== "") && jr2(e, w2) : typeof w2 == "number" && jr2(e, "" + w2) : u !== "suppressContentEditableWarning" && u !== "suppressHydrationWarning" && u !== "autoFocus" && (c.hasOwnProperty(u) ? w2 != null && u === "onScroll" && _e2("scroll", e) : w2 != null && pe2(e, u, w2, p));
                }
                switch (n) {
                  case "input":
                    Ft(e), Oo(e, o, false);
        ...
        case 6:
          ...
          return tt3(t), null;
        case 13:
          if (Me2(Ie2), o = t.memoizedState, e === null || e.memoizedState !== null && e.memoizedState.dehydrated !== null) {
        ...
        case 17:
          return at2(t.type) && ul2(), tt3(t), null;
        case 19:
          if (Me2(Ie2), u = t.memoizedState, u === null) return tt3(t), null;
    ...
    function Wh(e, t) {
      switch (pa2(t), t.tag) {
        ...
        case 3:
          return wr2(), Me2(it2), Me2(Je2), Ca2(), e = t.flags, (e & 65536) !== 0 && (e & 128) === 0 ? (t.flags = e & -65537 | 128, t) : null;
        case 5:
          return Ea2(t), null;
        case 13:
          if (Me2(Ie2), e = t.memoizedState, e !== null && e.dehydrated !== null) {
      ...
      if (oa = Yo2, e = bc(), Xi3(e)) {
        if ("selectionStart" in e) var n = { start: e.selectionStart, end: e.selectionEnd };
          ...
          if (o && o.rangeCount !== 0) {
            ...
            var p = 0, h = -1, w2 = -1, T = 0, j2 = 0, V2 = e, O3 = null;
            t: for (; ; ) {
              for (var Q2; V2 !== n || a !== 0 && V2.nodeType !== 3 || (h = p + a), V2 !== u || o !== 0 && V2.nodeType !== 3 || (w2 = p + o), V2.nodeType === 3 && (p += V2.nodeValue.length), (Q2 = V2.firstChild) !== null; ) O3 = V2, V2 = Q2;
              for (; ; ) {
                if (V2 === e) break t;
                if (O3 === n && ++T === a && (h = p), O3 === u && ++j2 === o && (w2 = p), (Q2 = V2.nextSibling) !== null) break;
                V2 = O3, O3 = V2.parentNode;
              }
              V2 = Q2;
            }
            n = h === -1 || w2 === -1 ? null : { start: h, end: w2 };
          } else n = null;
        }
        n = n || { start: 0, end: 0 };
      } else n = null;
      for (la = { focusedElem: e, selectionRange: n }, Yo2 = false, Z2 = t; Z2 !== null; ) if (t = Z2, e = t.child, (t.subtreeFlags & 1028) !== 0 && e !== null) e.return = t, Z2 = e;
        ...
        try {
          ...
          if ((t.flags & 1024) !== 0) switch (t.tag) {
            ...
            case 1:
              if (q3 !== null) {
                var oe = q3.memoizedProps, je2 = q3.memoizedState, C = t.stateNode, k2 = C.getSnapshotBeforeUpdate(t.elementType === t.type ? oe : _t2(t.type, oe), je2);
                C.__reactInternalSnapshotBeforeUpdate = k2;
              }
              break;
            case 3:
              var P2 = t.stateNode.containerInfo;
              P2.nodeType === 1 ? P2.textContent = "" : P2.nodeType === 9 && P2.documentElement && P2.removeChild(P2.documentElement);
              break;
            case 5:
            case 6:
            case 4:
    ...
    function bo2(e, t, n) {
      ...
      if (o = o !== null ? o.lastEffect : null, o !== null) {
        ...
        do {
          if ((a.tag & e) === e) {
            var u = a.destroy;
            a.destroy = void 0, u !== void 0 && Ga(t, n, u);
          }
          a = a.next;
        } while (a !== o);
      }
    ...
    function Qa(e, t, n) {
      ...
      else if (o !== 4 && (e = e.child, e !== null)) for (Qa(e, t, n), e = e.sibling; e !== null; ) Qa(e, t, n), e = e.sibling;
    }
    function Ya(e, t, n) {
      var o = e.tag;
    ...
    function Gd(e, t, n) {
      ...
      switch (n.tag) {
        ...
        case 6:
          var o = Ze, a = Mt;
          Ze = null, yn2(e, t, n), Ze = o, Mt = a, Ze !== null && (Mt ? (e = Ze, n = n.stateNode, e.nodeType === 8 ? e.parentNode.removeChild(n) : e.removeChild(n)) : Ze.removeChild(n.stateNode));
          break;
        case 18:
          Ze !== null && (Mt ? (e = Ze, n = n.stateNode, e.nodeType === 8 ? sa(e.parentNode, n) : e.nodeType === 1 && sa(e, n), Zr(e)) : sa(Ze, n.stateNode));
          break;
        case 4:
          o = Ze, a = Mt, Ze = n.stateNode.containerInfo, Mt = true, yn2(e, t, n), Ze = o, Mt = a;
          break;
        case 0:
        case 11:
        case 14:
        case 15:
          if (!nt2 && (o = n.updateQueue, o !== null && (o = o.lastEffect, o !== null))) {
            ...
            do {
              var u = a, p = u.destroy;
              u = u.tag, p !== void 0 && ((u & 2) !== 0 || (u & 4) !== 0) && Ga(n, t, p), a = a.next;
            } while (a !== o);
          }
          yn2(e, t, n);
          break;
      ...
      if (n !== null) for (var o = 0; o < n.length; o++) {
        ...
        try {
          ...
          e: for (; h !== null; ) {
            switch (h.tag) {
              case 5:
                Ze = h.stateNode, Mt = false;
                break e;
              case 3:
                Ze = h.stateNode.containerInfo, Mt = true;
                break e;
              case 4:
                Ze = h.stateNode.containerInfo, Mt = true;
                break e;
          ...
          Gd(u, p, a), Ze = null, Mt = false;
          var w2 = a.alternate;
          w2 !== null && (w2.return = null), a.return = null;
        } catch (T) {
          Ae3(a, t, T);
        }
      }
      ...
      switch (e.tag) {
        ...
        case 5:
          ...
          if (o & 4 && (a = e.stateNode, a != null)) {
            var u = e.memoizedProps, p = n !== null ? n.memoizedProps : u, h = e.type, w2 = e.updateQueue;
            if (e.updateQueue = null, w2 !== null) try {
              h === "input" && u.type === "radio" && u.name != null && Ao(a, u), Ci3(h, p);
              var T = Ci3(h, u);
              for (p = 0; p < w2.length; p += 2) {
                var j2 = w2[p], V2 = w2[p + 1];
              ...
              switch (h) {
                ...
                case "select":
                  ...
                  var Q2 = u.value;
                  Q2 != null ? on3(a, !!u.multiple, Q2, false) : O3 !== !!u.multiple && (u.defaultValue != null ? on3(a, !!u.multiple, u.defaultValue, true) : on3(a, !!u.multiple, u.multiple ? [] : "", false));
              }
              a[so2] = u;
            } catch (oe) {
              Ae3(e, e.return, oe);
          ...
          if (j2 = n !== null && n.memoizedState !== null, e.mode & 1 ? (nt2 = (T = nt2) || j2, Rt2(t, e), nt2 = T) : Rt2(t, e), Ht2(e), o & 8192) {
            if (T = e.memoizedState !== null, (e.stateNode.isHidden = T) && !j2 && (e.mode & 1) !== 0) for (Z2 = e, j2 = e.child; j2 !== null; ) {
              for (V2 = Z2 = j2; Z2 !== null; ) {
                switch (O3 = Z2, Q2 = O3.child, O3.tag) {
                  case 0:
                  case 11:
                  case 14:
                  case 15:
                ...
                Q2 !== null ? (Q2.return = O3, Z2 = Q2) : Zd(V2);
              }
              j2 = j2.sibling;
            }
            e: for (j2 = null, V2 = e; ; ) {
              if (V2.tag === 5) {
                if (j2 === null) {
                  j2 = V2;
                  try {
                    a = V2.stateNode, T ? (u = a.style, typeof u.setProperty == "function" ? u.setProperty("display", "none", "important") : u.display = "none") : (h = V2.stateNode, w2 = V2.memoizedProps.style, p = w2 != null && w2.hasOwnProperty("display") ? w2.display : null, h.style.display = Nu("display", p));
                  } catch (oe) {
                    Ae3(e, e.return, oe);
                  }
                }
    ...
    function Yd(e, t, n) {
      for (var o = (e.mode & 1) !== 0; Z2 !== null; ) {
        ...
        if (a.tag === 22 && o) {
          ...
          if (!p) {
            var h = a.alternate, w2 = h !== null && h.memoizedState !== null || nt2;
            h = Nl2;
            var T = nt2;
            if (Nl2 = p, (nt2 = w2) && !T) for (Z2 = a; Z2 !== null; ) p = Z2, w2 = p.child, p.tag === 22 && p.memoizedState !== null ? qd(a) : w2 !== null ? (w2.return = p, Z2 = w2) : qd(a);
            ...
            if ((t.flags & 8772) !== 0) switch (t.tag) {
              ...
              case 1:
                ...
                if (t.flags & 4 && !nt2) if (n === null) o.componentDidMount();
                  ...
                  var a = t.elementType === t.type ? n.memoizedProps : _t2(t.type, n.memoizedProps);
              ...
              case 5:
                ...
                if (n === null && t.flags & 4) {
                  n = h;
                  var w2 = t.memoizedProps;
                  switch (t.type) {
                    case "button":
                    case "input":
                    case "select":
                    case "textarea":
                      w2.autoFocus && n.focus();
                      break;
                    case "img":
                      w2.src && (n.src = w2.src);
                  }
    ...
    var Yh = Math.ceil, _l2 = K2.ReactCurrentDispatcher, Xa = K2.ReactCurrentOwner, St = K2.ReactCurrentBatchConfig, Se2 = 0, Qe = null, He2 = null, qe = 0, yt2 = 0, kr = pn3(0), We2 = 0, xo2 = null, jn = 0, Ml2 = 0, Za = 0, ko2 = null, ut2 = null, qa = 0, Sr2 = 1 / 0, qt2 = null, Rl2 = false, Ja = null, wn2 = null, zl2 = false, bn2 = null, Il2 = 0, So2 = 0, es3 = null, Fl2 = -1, Al2 = 0;
    function ot2() {
      return (Se2 & 6) !== 0 ? De2() : Fl2 !== -1 ? Fl2 : Fl2 = De2();
    }
    function xn(e) {
      return (e.mode & 1) === 0 ? 1 : (Se2 & 2) !== 0 && qe !== 0 ? qe & -qe : Mh.transition !== null ? (Al2 === 0 && (Al2 = Wu()), Al2) : (e = Pe2, e !== 0 || (e = window.event, e = e === void 0 ? 16 : ec(e.type)), e);
    }
    function zt2(e, t, n, o) {
      if (50 < So2) throw So2 = 0, es3 = null, Error(i(185));
      Gr(e, n, o), ((Se2 & 2) === 0 || e !== Qe) && (e === Qe && ((Se2 & 2) === 0 && (Ml2 |= n), We2 === 4 && kn(e, qe)), ct2(e, o), n === 1 && Se2 === 0 && (t.mode & 1) === 0 && (Sr2 = De2() + 500, dl2 && vn2()));
    }
    function ct2(e, t) {
      ...
      if (o === 0) n !== null && Hu(n), e.callbackNode = null, e.callbackPriority = 0;
        ...
        if (n != null && Hu(n), t === 1) e.tag === 0 ? _h(ef.bind(null, e)) : Dc(ef.bind(null, e)), Ph(function() {
          (Se2 & 6) === 0 && vn2();
        }), n = null;
        else {
          switch (Gu(o)) {
    ...
    function Jd(e, t) {
      ...
      if ((o & 30) !== 0 || (o & e.expiredLanes) !== 0 || t) t = Ol2(e, o);
        ...
        while (true);
        ya(), _l2.current = u, Se2 = a, He2 !== null ? t = 0 : (Qe = null, qe = 0, t = We2);
      }
      if (t !== 0) {
    ...
    function kn(e, t) {
      for (t &= ~Za, t &= ~Ml2, e.suspendedLanes |= t, e.pingedLanes &= ~t, e = e.expirationTimes; 0 < t; ) {
    ...
    function Hn(e, t) {
      ...
      if (Qe = e, He2 = e = Sn2(e.current, null), qe = yt2 = t, We2 = 0, xo2 = null, Za = Ml2 = jn = 0, ut2 = ko2 = null, An2 !== null) {
    ...
    function tf(e, t) {
      do {
        ...
        try {
          ...
          e: {
            var u = e, p = n.return, h = n, w2 = t;
            if (t = qe, h.flags |= 32768, w2 !== null && typeof w2 == "object" && typeof w2.then == "function") {
              var T = w2, j2 = h, V2 = j2.tag;
              ...
              var Q2 = Cd(p);
              if (Q2 !== null) {
                Q2.flags &= -257, Pd(Q2, p, h, u, t), Q2.mode & 1 && $d(u, T, t), t = Q2, w2 = T;
                var q3 = t.updateQueue;
                if (q3 === null) {
                  var oe = /* @__PURE__ */ new Set();
                  oe.add(w2), t.updateQueue = oe;
                } else q3.add(w2);
                break e;
              } else {
                if ((t & 1) === 0) {
              ...
              var je2 = Cd(p);
              if (je2 !== null) {
                (je2.flags & 65536) === 0 && (je2.flags |= 256), Pd(je2, p, h, u, t), ha2(br2(w2, h));
                break e;
              }
            }
            u = w2 = br2(w2, h), We2 !== 4 && (We2 = 2), ko2 === null ? ko2 = [u] : ko2.push(u), u = p;
            do {
              switch (u.tag) {
                case 3:
                ...
                case 1:
                  h = w2;
                  var k2 = u.type, P2 = u.stateNode;
                  if ((u.flags & 128) === 0 && (typeof k2.getDerivedStateFromError == "function" || P2 !== null && typeof P2.componentDidCatch == "function" && (wn2 === null || !wn2.has(P2)))) {
                    u.flags |= 65536, t &= -t, u.lanes |= t;
                    var B2 = Ed(u, h, t);
                    Xc(u, B2);
                    break e;
    ...
    function nf() {
      var e = _l2.current;
      return _l2.current = $l2, e === null ? $l2 : e;
    }
    function ls3() {
      (We2 === 0 || We2 === 3 || We2 === 2) && (We2 = 4), Qe === null || (jn & 268435455) === 0 && (Ml2 & 268435455) === 0 || kn(Qe, qe);
    }
    function Ol2(e, t) {
      var n = Se2;
      Se2 |= 2;
      ...
      while (true);
      if (ya(), Se2 = n, _l2.current = o, He2 !== null) throw Error(i(261));
    ...
    function Jh(e, t, n, o) {
      ...
      if (Rv(e, u), e === Qe && (He2 = Qe = null, qe = 0), (n.subtreeFlags & 2064) === 0 && (n.flags & 2064) === 0 || zl2 || (zl2 = true, uf(Ho, function() {
        return Er(), null;
      ...
      if (Rl2) throw Rl2 = false, e = Ja, Ja = null, e;
        ...
        try {
          if (St.transition = null, Pe2 = 16 > e ? 16 : e, bn2 === null) var o = false;
                  ...
                  for (var w2 = 0; w2 < h.length; w2++) {
                    ...
                    for (Z2 = T; Z2 !== null; ) {
                      ...
                      if (V2 !== null) V2.return = j2, Z2 = V2;
                        ...
                        j2 = Z2;
                        var O3 = j2.sibling, Q2 = j2.return;
                        if (Bd(j2), j2 === T) {
                          Z2 = null;
                          break;
                        }
            ...
            for (Z2 = k2; Z2 !== null; ) {
              p = Z2;
              var P2 = p.child;
              if ((p.subtreeFlags & 2064) !== 0 && P2 !== null) P2.return = p, Z2 = P2;
              else e: for (p = k2; Z2 !== null; ) {
            ...
            if (Se2 = a, vn2(), Ot2 && typeof Ot2.onPostCommitFiberRoot == "function") try {
              Ot2.onPostCommitFiberRoot(Bo, e);
            } catch {
            }
            o = true;
          }
    ...
    sf = function(e, t, n) {
      ...
      switch (t.lanes = 0, t.tag) {
        case 2:
          ...
          var u = La();
          return t.flags |= 1, typeof a == "object" && a !== null && typeof a.render == "function" && a.$$typeof === void 0 ? (t.tag = 1, t.memoizedState = null, t.updateQueue = null, at2(o) ? (u = true, cl2(t)) : u = false, t.memoizedState = a.state !== null && a.state !== void 0 ? a.state : null, ka(t), a.updater = Cl2, t.stateNode = a, a._reactInternals = t, Fa2(t, o, e, n), t = ja(null, t, o, true, u, n)) : (t.tag = 0, ze3 && u && fa2(t), rt2(null, t, a, n), t = t.child), t;
        case 16:
          o = t.elementType;
          e: {
            switch (Tl2(e, t), e = t.pendingProps, a = o._init, o = a(o._payload), t.type = o, a = t.tag = og(o), e = _t2(o, e), a) {
              case 0:
                t = Da(null, t, o, e, n);
                break e;
              case 1:
          ...
          return t;
        case 0:
          return o = t.type, a = t.pendingProps, a = t.elementType === o ? a : _t2(o, a), Da(e, t, o, a, n);
        case 1:
          return o = t.type, a = t.pendingProps, a = t.elementType === o ? a : _t2(o, a), Rd(e, t, o, a, n);
        case 3:
          e: {
          ...
          return t;
        case 5:
          return qc(t), e === null && va2(t), o = t.type, a = t.pendingProps, u = e !== null ? e.memoizedProps : null, p = a.children, ia(o, a) ? p = null : u !== null && ia(o, u) && (t.flags |= 32), Md(e, t), rt2(e, t, p, n), t.child;
        case 6:
          return e === null && va2(t), null;
        case 13:
          return Fd(e, t, n);
        case 4:
          return Sa(t, t.stateNode.containerInfo), o = t.pendingProps, e === null ? t.child = hr2(t, null, o, n) : rt2(e, t, o, n), t.child;
        case 11:
          return o = t.type, a = t.pendingProps, a = t.elementType === o ? a : _t2(o, a), Td(e, t, o, a, n);
        case 7:
        ...
        case 10:
          e: {
            if (o = t.type._context, a = t.pendingProps, u = t.memoizedProps, p = a.value, Ne2(hl2, o._currentValue), o._currentValue = p, u !== null) if (Nt2(u.value, p)) {
              ...
              if (h !== null) {
                p = u.child;
                for (var w2 = h.firstContext; w2 !== null; ) {
                  if (w2.context === o) {
                    if (u.tag === 1) {
                      w2 = Xt2(-1, n & -n), w2.tag = 2;
                      var T = u.updateQueue;
                      if (T !== null) {
                        T = T.shared;
                        var j2 = T.pending;
                        j2 === null ? w2.next = w2 : (w2.next = j2.next, j2.next = w2), T.pending = w2;
                      }
                    }
                    u.lanes |= n, w2 = u.alternate, w2 !== null && (w2.lanes |= n), ba2(u.return, n, t), h.lanes |= n;
                    break;
                  }
                  w2 = w2.next;
                }
        ...
        case 14:
          return o = t.type, a = _t2(o, t.pendingProps), a = _t2(o.type, a), Nd(e, t, o, a, n);
        case 15:
          return Ld(e, t, t.type, t.pendingProps, n);
        case 17:
          return o = t.type, a = t.pendingProps, a = t.elementType === o ? a : _t2(o, a), Tl2(e, t), t.tag = 1, at2(o) ? (e = true, cl2(t)) : e = false, yr2(t, n), xd(t, o, a), Fa2(t, o, a, n), ja(null, t, o, true, e, n);
        case 19:
          return Od(e, t, n);
        case 22:
          return _d(e, t, n);
    ...
    function Dl2(e, t, n, o, a, u) {
      ...
      if (o = e, typeof e == "function") is3(e) && (p = 1);
        ...
        case M:
          return e = Et3(19, n, t, a), e.elementType = M, e.lanes = u, e;
        case H2:
          return jl2(n, a, u, t);
        default:
    ...
    function jl2(e, t, n, o) {
      return e = Et3(22, e, o, t), e.elementType = H2, e.lanes = n, e.stateNode = { isHidden: false }, e;
    }
    function as3(e, t, n) {
    ...
    function us3(e, t, n, o, a, u, p, h, w2) {
      return e = new lg(e, t, n, h, w2), t === 1 ? (t = 1, u === true && (t |= 8)) : t = 0, u = Et3(3, null, null, t), e.current = u, u.stateNode = e, u.memoizedState = { element: o, isDehydrated: n, cache: null, transitions: null, pendingSuspenseBoundaries: null }, ka(u), e;
    }
    function ig(e, t, n) {
    ...
    function df(e, t, n, o, a, u, p, h, w2) {
      return e = us3(n, o, true, e, a, u, p, h, w2), e.context = cf(null), n = e.current, o = ot2(), a = xn(n), u = Xt2(o, a), u.callback = t ?? null, gn2(n, u, a), e.current.lanes = a, Gr(e, a, o), ct2(e, o), e;
    }
    ...
    Bl2.prototype.unstable_scheduleHydration = function(e) {
      if (e) {
        ...
        for (var n = 0; n < un3.length && t !== 0 && t < un3[n].priority; n++) ;
        un3.splice(n, 0, e), n === 0 && qu(e);
      }
    };
    function fs3(e) {
    ...
    function sg(e, t, n, o, a) {
      ...
      var w2 = us3(e, 0, false, null, null, false, false, "", mf);
      return e._reactRootContainer = w2, e[Wt2] = w2.current, io2(e.nodeType === 8 ? e.parentNode : e), Vn2(function() {
        Vl2(t, w2, n, o);
      }), w2;
    }
  ...
  function Xg() {
    let r = 0, l2, i, s = "";
    for (; r < arguments.length; ) (l2 = arguments[r++]) && (i = yp(l2)) && (s && (s += " "), s += i);
    return s;
  }
  function Rs2(r, ...l2) {
    let i, s, c, d = f2;
    function f2(v) {
      const y2 = l2.reduce((g, x2) => x2(g), r());
      return i = Kg(y2), s = i.cache.get, c = i.cache.set, d = m2, m2(v);
    }
    function m2(v) {
      const y2 = s(v);
      if (y2) return y2;
  ...
  function Tp(r) {
    ...
    else if (typeof r == "object") if (Array.isArray(r)) for (l2 = 0; l2 < r.length; l2++) r[l2] && (i = Tp(r[l2])) && (s && (s += " "), s += i);
    else for (l2 in r) r[l2] && (s && (s += " "), s += l2);
    return s;
  }
  function Nn(...r) {
    for (var l2 = 0, i, s, c = ""; l2 < r.length; ) (i = r[l2++]) && (s = Tp(i)) && (c && (c += " "), c += s);
    return c;
  }
  function rb(...r) {
    return function(i) {
  ...
  function E0(r, l2, i) {
    return Math.min(Math.max(r, l2), i);
  }
  function Np(...r) {
    return (...l2) => {
      for (let i of r) typeof i == "function" && i(...l2);
    };
  }
  function $0(r, l2) {
    if (r === l2) return r;
    let i = zf.get(r);
    if (i) return i.forEach((c) => c.current = l2), l2;
    let s = zf.get(l2);
    return s ? (s.forEach((c) => c.current = r), r) : l2;
  }
  function Io(...r) {
    let l2 = { ...r[0] };
    for (let i = 1; i < r.length; i++) {
      ...
      for (let c in s) {
        let d = l2[c], f2 = s[c];
        typeof d == "function" && typeof f2 == "function" && c[0] === "o" && c[1] === "n" && c.charCodeAt(2) >= 65 && c.charCodeAt(2) <= 90 ? l2[c] = Np(d, f2) : (c === "className" || c === "UNSAFE_className") && typeof d == "string" && typeof f2 == "string" ? l2[c] = Nn(d, f2) : c === "id" && d && f2 ? l2.id = $0(d, f2) : l2[c] = f2 !== void 0 ? f2 : d;
      }
    }
    return l2;
  }
  function ob(...r) {
    return r.length === 1 && r[0] ? r[0] : (l2) => {
      let i = false;
      const s = r.map((c) => {
        const d = If(c, l2);
  ...
  function If(r, l2) {
    if (typeof r == "function") return () => r(l2);
    r != null && "current" in r && (r.current = l2);
  }
  function $t2(r) {
    const l2 = S.useRef(null);
    return C0(() => {
      l2.current = r;
    }, [r]), S.useCallback((...i) => {
      const s = l2.current;
  ...
  function P0(r) {
    let [l2, i] = S.useState(r), s = S.useRef(null), c = $t2(() => {
      if (!s.current) return;
      let f2 = s.current.next();
      if (f2.done) {
        s.current = null;
        return;
      }
      l2 === f2.value ? c() : i(f2.value);
    });
    Xe(() => {
      s.current && c();
    });
  ...
  function N0(r = false) {
    let l2 = S.useContext(_p), i = S.useRef(null);
    if (i.current === null && !r) {
      var s, c;
      ...
      if (d) {
        let f2 = xs2.get(d);
        f2 == null ? xs2.set(d, { id: l2.current, state: d.memoizedState }) : d.memoizedState !== f2.state && (l2.current = f2.id, xs2.delete(d));
      }
      i.current = ++l2.current;
    }
    return i.current;
  }
  function L0(r) {
    let l2 = S.useContext(_p), i = N0(!!r), s = `react-aria${l2.prefix}`;
    return r || `${s}-${i}`;
  }
  function _0(r) {
    let l2 = Re2.useId(), [i] = S.useState(Js2()), s = i ? "react-aria" : `react-aria${Lp.prefix}`;
    return r || `${s}-${l2}`;
  }
  function R0() {
    return false;
  ...
  function Mp(r) {
    let [l2, i] = S.useState(r), s = S.useRef(null), c = M0(l2), d = S.useRef(null);
    if (No && No.register(d, c), F0) {
      const f2 = Nr2.get(c);
      f2 && !f2.includes(s) ? f2.push(s) : Nr2.set(c, [s]);
    }
    return Xe(() => {
      let f2 = c;
      return () => {
        No && No.unregister(d), Nr2.delete(f2);
      };
    }, [c]), S.useEffect(() => {
      let f2 = s.current;
      return f2 && i(f2), () => {
  ...
  function O0(r = []) {
    let l2 = Mp(), [i, s] = P0(l2), c = S.useCallback(() => {
      s(function* () {
        yield l2, yield document.getElementById(l2) ? l2 : void 0;
      });
    }, [l2, s]);
    return Xe(c, [l2, c, ...r]), i;
  }
  function Ro(...r) {
    return (...l2) => {
      for (let i of r) typeof i == "function" && i(...l2);
  ...
  function pt2(r, l2) {
    if (!hi2()) return l2 && r ? r.contains(l2) : false;
  ...
  function B0(r, l2, i, s) {
    return hi2() ? new H0(r, l2, i, s) : r.createTreeWalker(l2, i, s);
  }
  function Rp(r) {
    var l2, i, s = "";
    if (typeof r == "string" || typeof r == "number") s += r;
      ...
      var c = r.length;
      for (l2 = 0; l2 < c; l2++) r[l2] && (i = Rp(r[l2])) && (s && (s += " "), s += i);
    } else for (i in r) r[i] && (s && (s += " "), s += i);
    return s;
  }
  function U0() {
    for (var r, l2, i = 0, s = "", c = arguments.length; i < c; i++) (r = arguments[i]) && (l2 = Rp(r)) && (s && (s += " "), s += l2);
    return s;
  }
  function nn2(...r) {
    let l2 = { ...r[0] };
    for (let i = 1; i < r.length; i++) {
      ...
      for (let c in s) {
        let d = l2[c], f2 = s[c];
        typeof d == "function" && typeof f2 == "function" && c[0] === "o" && c[1] === "n" && c.charCodeAt(2) >= 65 && c.charCodeAt(2) <= 90 ? l2[c] = Ro(d, f2) : (c === "className" || c === "UNSAFE_className") && typeof d == "string" && typeof f2 == "string" ? l2[c] = U0(d, f2) : c === "id" && d && f2 ? l2.id = A0(d, f2) : l2[c] = f2 !== void 0 ? f2 : d;
      }
    }
    return l2;
  }
  function eu(r, l2 = {}) {
    let { labelable: i, isLink: s, global: c, events: d = c, propNames: f2 } = l2, m2 = {};
    for (const v in r) Object.prototype.hasOwnProperty.call(r, v) && (W0.has(v) || i && G0.has(v) || s && K0.has(v) || c && Q0.has(v) || d && Ff.has(v) || v.endsWith("Capture") && Ff.has(v.slice(0, -7)) || f2 != null && f2.has(v) || Y0.test(v)) && (m2[v] = r[v]);
    return m2;
  }
  function _r(r) {
  ...
  function Z0(r) {
    let l2 = r.parentNode, i = [], s = document.scrollingElement || document.documentElement;
    for (; l2 instanceof HTMLElement && l2 !== s; ) (l2.offsetHeight < l2.scrollHeight || l2.offsetWidth < l2.scrollWidth) && i.push({ element: l2, scrollTop: l2.scrollTop, scrollLeft: l2.scrollLeft }), l2 = l2.parentNode;
    return s instanceof HTMLElement && i.push({ element: s, scrollTop: s.scrollTop, scrollLeft: s.scrollLeft }), i;
  }
  function q0(r) {
    for (let { element: l2, scrollTop: i, scrollLeft: s } of r) l2.scrollTop = i, l2.scrollLeft = s;
  }
  function gi2(r) {
    var l2;
    if (typeof window > "u" || window.navigator == null) return false;
    let i = (l2 = window.navigator.userAgentData) === null || l2 === void 0 ? void 0 : l2.brands;
    return Array.isArray(i) && i.some((s) => r.test(s.brand)) || r.test(window.navigator.userAgent);
  }
  function tu(r) {
    var l2;
    return typeof window < "u" && window.navigator != null ? r.test(((l2 = window.navigator.userAgentData) === null || l2 === void 0 ? void 0 : l2.platform) || window.navigator.platform) : false;
  }
  function rn2(r) {
    let l2 = null;
    return () => (l2 == null && (l2 = r()), l2);
  }
  function Fp() {
  ...
  function ry(r, l2) {
    ...
    return (!i || i === "_self") && r.origin === location.origin && !r.hasAttribute("download") && !l2.metaKey && !l2.ctrlKey && !l2.altKey && !l2.shiftKey;
  }
  function Rr2(r, l2, i = true) {
    var s, c;
    let { metaKey: d, ctrlKey: f2, altKey: m2, shiftKey: v } = l2;
    ty() && (!((c = window.event) === null || c === void 0 || (s = c.type) === null || s === void 0) && s.startsWith("key")) && r.target === "_blank" && (Mr2() ? d = true : f2 = true);
    let y2 = ey() && Mr2() && !zp() ? new KeyboardEvent("keydown", { keyIdentifier: "Enter", metaKey: d, ctrlKey: f2, altKey: m2, shiftKey: v }) : new MouseEvent("click", { metaKey: d, ctrlKey: f2, altKey: m2, shiftKey: v, bubbles: true, cancelable: true });
    Rr2.isOpening = i, _r(r), r.dispatchEvent(y2), Rr2.isOpening = false;
  }
  function oy(r, l2) {
    if (r instanceof HTMLAnchorElement) l2(r);
    else if (r.hasAttribute("data-href")) {
      let i = document.createElement("a");
      i.href = r.getAttribute("data-href"), r.hasAttribute("data-target") && (i.target = r.getAttribute("data-target")), r.hasAttribute("data-rel") && (i.rel = r.getAttribute("data-rel")), r.hasAttribute("data-download") && (i.download = r.getAttribute("data-download")), r.hasAttribute("data-ping") && (i.ping = r.getAttribute("data-ping")), r.hasAttribute("data-referrer-policy") && (i.referrerPolicy = r.getAttribute("data-referrer-policy")), r.appendChild(i), l2(i), r.removeChild(i);
    }
  }
  function ly(r, l2) {
    oy(r, (i) => Rr2(i, l2));
  ...
  function iy(r) {
    let l2 = Fp();
    var i;
    const s = l2.useHref((i = r == null ? void 0 : r.href) !== null && i !== void 0 ? i : "");
  ...
  function ay(r, l2, i, s) {
    !l2.isNative && r.currentTarget instanceof HTMLAnchorElement && r.currentTarget.href && !r.isDefaultPrevented() && ry(r.currentTarget, r) && i && (r.preventDefault(), l2.open(r.currentTarget, r, i, s));
  }
  function Af() {
    ...
    document.body.addEventListener("transitionrun", l2), document.body.addEventListener("transitionend", i);
  }
  function sy() {
  ...
  function ru() {
    let r = S.useRef(/* @__PURE__ */ new Map()), l2 = S.useCallback((c, d, f2, m2) => {
      let v = m2 != null && m2.once ? (...y2) => {
        r.current.delete(f2), f2(...y2);
      } : f2;
      r.current.set(f2, { type: d, eventTarget: c, fn: v, options: m2 }), c.addEventListener(d, v, m2);
    }, []), i = S.useCallback((c, d, f2, m2) => {
      var v;
      let y2 = ((v = r.current.get(f2)) === null || v === void 0 ? void 0 : v.fn) || f2;
      c.removeEventListener(d, y2, m2), r.current.delete(f2);
    }, []), s = S.useCallback(() => {
      r.current.forEach((c, d) => {
        i(c.eventTarget, c.type, d, c.options);
      });
    }, [i]);
    return S.useEffect(() => s, [s]), { addGlobalListener: l2, removeGlobalListener: i, removeAllGlobalListeners: s };
  }
  function uy(r, l2) {
    let { id: i, "aria-label": s, "aria-labelledby": c } = r;
    return i = Mp(i), c && s ? c = [.../* @__PURE__ */ new Set([i, ...c.trim().split(/\s+/)])].join(" ") : c && (c = c.trim().split(/\s+/).join(" ")), !s && !c && l2 && (s = l2), { id: i, "aria-label": s, "aria-labelledby": c };
  }
  function Op(r, l2) {
    Xe(() => {
      if (r && r.ref && l2) return r.ref.current = l2.current, () => {
  ...
  function Of(r, l2) {
    ...
    return s && l2 && (s = r.scrollHeight !== r.clientHeight || r.scrollWidth !== r.clientWidth), s;
  }
  function Dp(r, l2) {
    let i = r;
    for (Of(i, l2) && (i = i.parentElement); i && !Of(i, l2); ) i = i.parentElement;
  ...
  function my(r) {
    const l2 = It2(r);
    if (!(r instanceof l2.HTMLElement) && !(r instanceof l2.SVGElement)) return false;
    let { display: i, visibility: s } = r.style, c = i !== "none" && s !== "hidden" && s !== "collapse";
    if (c) {
      const { getComputedStyle: d } = r.ownerDocument.defaultView;
      let { display: f2, visibility: m2 } = d(r);
      c = f2 !== "none" && m2 !== "hidden" && m2 !== "collapse";
    }
    return c;
  }
  function vy(r, l2) {
    return !r.hasAttribute("hidden") && !r.hasAttribute("data-react-aria-prevent-focus") && (r.nodeName === "DETAILS" && l2 && l2.nodeName !== "SUMMARY" ? r.hasAttribute("open") : true);
  }
  function ou(r, l2) {
    return py ? r.checkVisibility() && !r.closest("[data-react-aria-prevent-focus]") : r.nodeName !== "#comment" && my(r) && vy(r, l2) && (!r.parentElement || ou(r.parentElement, r));
  }
  function Vp(r) {
  ...
  function Hp(r) {
    let l2 = r;
    for (; l2 != null; ) {
      if (l2 instanceof l2.ownerDocument.defaultView.HTMLElement && l2.inert) return true;
      l2 = l2.parentElement;
    }
    return false;
  }
  function Bp(r, l2, i) {
    let [s, c] = S.useState(r || l2), d = S.useRef(r !== void 0), f2 = r !== void 0;
    S.useEffect(() => {
      d.current, d.current = f2;
    }, [f2]);
    let m2 = f2 ? r : s, v = S.useCallback((y2, ...g) => {
      let x2 = (E, ..._2) => {
        i && (Object.is(m2, E) || i(E, ..._2)), f2 || (m2 = E);
      };
      typeof y2 == "function" ? c((_2, ...I2) => {
        let F = y2(f2 ? m2 : _2, ...I2);
        return x2(F, ...g), f2 ? _2 : F;
      }) : (f2 || c(y2), x2(y2, ...g));
    }, [f2, m2, i]);
    return [m2, v];
  }
  function iu(r) {
    let l2 = r;
    return l2.nativeEvent = r, l2.isDefaultPrevented = () => l2.defaultPrevented, l2.isPropagationStopped = () => l2.cancelBubble, l2.persist = () => {
    }, l2;
  }
  function Up(r, l2) {
    Object.defineProperty(r, "target", { value: l2 }), Object.defineProperty(r, "currentTarget", { value: l2 });
  }
  function Wp(r) {
    let l2 = S.useRef({ isFocused: false, observer: null });
    Xe(() => {
      const s = l2.current;
      return () => {
    ...
    return S.useCallback((s) => {
      if (s.target instanceof HTMLButtonElement || s.target instanceof HTMLInputElement || s.target instanceof HTMLTextAreaElement || s.target instanceof HTMLSelectElement) {
        l2.current.isFocused = true;
        let c = s.target, d = (f2) => {
          if (l2.current.isFocused = false, c.disabled) {
            let m2 = iu(f2);
            i(m2);
          }
          l2.current.observer && (l2.current.observer.disconnect(), l2.current.observer = null);
        };
        c.addEventListener("focusout", d, { once: true }), l2.current.observer = new MutationObserver(() => {
          if (l2.current.isFocused && c.disabled) {
            var f2;
            (f2 = l2.current.observer) === null || f2 === void 0 || f2.disconnect();
            let m2 = c === document.activeElement ? null : document.activeElement;
            c.dispatchEvent(new FocusEvent("blur", { relatedTarget: m2 })), c.dispatchEvent(new FocusEvent("focusout", { bubbles: true, relatedTarget: m2 }));
          }
        }), l2.current.observer.observe(c, { attributes: true, attributeFilter: ["disabled"] });
      }
    }, [i]);
  }
  function wy(r) {
    for (; r && !Vp(r); ) r = r.parentElement;
    let l2 = It2(r), i = l2.document.activeElement;
    if (!i || i === r) return;
    ui2 = true;
    let s = false, c = (g) => {
      (g.target === i || s) && g.stopImmediatePropagation();
    }, d = (g) => {
      (g.target === i || s) && (g.stopImmediatePropagation(), !r && !s && (s = true, _r(i), v()));
    }, f2 = (g) => {
      (g.target === r || s) && g.stopImmediatePropagation();
    }, m2 = (g) => {
      (g.target === r || s) && (g.stopImmediatePropagation(), s || (s = true, _r(i), v()));
    };
    l2.addEventListener("blur", c, true), l2.addEventListener("focusout", d, true), l2.addEventListener("focusin", m2, true), l2.addEventListener("focus", f2, true);
    let v = () => {
      cancelAnimationFrame(y2), l2.removeEventListener("blur", c, true), l2.removeEventListener("focusout", d, true), l2.removeEventListener("focusin", m2, true), l2.removeEventListener("focus", f2, true), ui2 = false, s = false;
    }, y2 = requestAnimationFrame(v);
    return v;
  }
  function by(r) {
    if (yi2()) {
      if (Tr2 === "default") {
        const l2 = Te2(r);
        Fs2 = l2.documentElement.style.webkitUserSelect, l2.documentElement.style.webkitUserSelect = "none";
      }
      Tr2 = "disabled";
    } else if (r instanceof HTMLElement || r instanceof SVGElement) {
      let l2 = "userSelect" in r.style ? "userSelect" : "webkitUserSelect";
      ai2.set(r, r.style[l2]), r.style[l2] = "none";
    }
  }
  function Df(r) {
    if (yi2()) {
      ...
      Tr2 = "restoring", setTimeout(() => {
        Ap(() => {
          if (Tr2 === "restoring") {
            const l2 = Te2(r);
            l2.documentElement.style.webkitUserSelect === "none" && (l2.documentElement.style.webkitUserSelect = Fs2 || ""), Fs2 = "", Tr2 = "default";
          }
        });
      }, 300);
    } else if ((r instanceof HTMLElement || r instanceof SVGElement) && r && ai2.has(r)) {
      let l2 = ai2.get(r), i = "userSelect" in r.style ? "userSelect" : "webkitUserSelect";
      r.style[i] === "none" && (r.style[i] = l2), r.getAttribute("style") === "" && r.removeAttribute("style"), ai2.delete(r);
    }
  }
  function xy(r, l2) {
    return l2.get ? l2.get.call(r) : l2.value;
  }
  function Gp(r, l2, i) {
    if (!l2.has(r)) throw new TypeError("attempted to " + i + " private field on non-instance");
    return l2.get(r);
  }
  function ky(r, l2) {
    var i = Gp(r, l2, "get");
  ...
  function Sy(r, l2) {
    if (l2.has(r)) throw new TypeError("Cannot initialize the same private elements twice on an object");
  }
  function Ey(r, l2, i) {
    Sy(r, l2), l2.set(r, i);
  }
  function $y(r, l2, i) {
    if (l2.set) l2.set.call(r, i);
    else {
      if (!l2.writable) throw new TypeError("attempted to set read only private field");
      l2.value = i;
    }
  }
  function jf(r, l2, i) {
  ...
  function Cy(r) {
    let l2 = S.useContext(au);
    if (l2) {
      let { register: i, ...s } = l2;
      r = nn2(s, r), i();
    }
    return Op(l2, r.ref), r;
  }
  function Kp(r) {
    let { onPress: l2, onPressChange: i, onPressStart: s, onPressEnd: c, onPressUp: d, onClick: f2, isDisabled: m2, isPressed: v, preventFocusOnPress: y2, shouldCancelOnPointerExit: g, allowTextSelectionOnPress: x2, ref: E, ..._2 } = Cy(r), [I2, F] = S.useState(false), A2 = S.useRef({ isPressed: false, ignoreEmulatedMouseEvents: false, didFirePressStart: false, isTriggeringEvent: false, activePointerId: null, target: null, isOverTarget: false, pointerType: null, disposables: [] }), { addGlobalListener: te2, removeAllGlobalListeners: re2 } = ru(), pe2 = $t2((R3, X2) => {
      let ve2 = A2.current;
      if (m2 || ve2.didFirePressStart) return false;
      let M = true;
      if (ve2.isTriggeringEvent = true, s) {
        let G2 = new ti2("pressstart", X2, R3);
        s(G2), M = G2.shouldStopPropagation;
      }
      return i && i(true), ve2.isTriggeringEvent = false, ve2.didFirePressStart = true, F(true), M;
    }), K2 = $t2((R3, X2, ve2 = true) => {
      let M = A2.current;
      if (!M.didFirePressStart) return false;
      M.didFirePressStart = false, M.isTriggeringEvent = true;
      let G2 = true;
      if (c) {
        let L3 = new ti2("pressend", X2, R3);
        c(L3), G2 = L3.shouldStopPropagation;
      }
      if (i && i(false), F(false), l2 && ve2 && !m2) {
        let L3 = new ti2("press", X2, R3);
        l2(L3), G2 && (G2 = L3.shouldStopPropagation);
      }
      return M.isTriggeringEvent = false, G2;
    }), ye = $t2((R3, X2) => {
      let ve2 = A2.current;
      if (m2) return false;
      if (d) {
        ve2.isTriggeringEvent = true;
        let M = new ti2("pressup", X2, R3);
        return d(M), ve2.isTriggeringEvent = false, M.shouldStopPropagation;
      }
      return true;
    }), ie2 = $t2((R3) => {
      let X2 = A2.current;
      if (X2.isPressed && X2.target) {
        X2.didFirePressStart && X2.pointerType != null && K2(Gn(X2.target, R3), X2.pointerType, false), X2.isPressed = false, X2.isOverTarget = false, X2.activePointerId = null, X2.pointerType = null, re2(), x2 || Df(X2.target);
      ...
      let R3 = A2.current, X2 = { onKeyDown(M) {
        if (ks2(M.nativeEvent, M.currentTarget) && pt2(M.currentTarget, Ve2(M.nativeEvent))) {
          var G2;
          Uf(Ve2(M.nativeEvent), M.key) && M.preventDefault();
          let L3 = true;
          if (!R3.isPressed && !M.repeat) {
            R3.target = M.currentTarget, R3.isPressed = true, R3.pointerType = "keyboard", L3 = pe2(M, "keyboard");
            let H2 = M.currentTarget, $ = (D2) => {
              ks2(D2, H2) && !D2.repeat && pt2(H2, Ve2(D2)) && R3.target && ye(Gn(R3.target, D2), "keyboard");
            };
            te2(Te2(M.currentTarget), "keyup", Ro($, ve2), true);
          }
          L3 && M.stopPropagation(), M.metaKey && Mr2() && ((G2 = R3.metaKeyEvents) === null || G2 === void 0 || G2.set(M.key, M.nativeEvent));
        } else M.key === "Meta" && (R3.metaKeyEvents = /* @__PURE__ */ new Map());
      }, onClick(M) {
        if (!(M && !pt2(M.currentTarget, Ve2(M.nativeEvent))) && M && M.button === 0 && !R3.isTriggeringEvent && !Rr2.isOpening) {
          let G2 = true;
          if (m2 && M.preventDefault(), !R3.ignoreEmulatedMouseEvents && !R3.isPressed && (R3.pointerType === "virtual" || jp(M.nativeEvent))) {
            let L3 = pe2(M, "virtual"), H2 = ye(M, "virtual"), $ = K2(M, "virtual");
            W(M), G2 = L3 && H2 && $;
          } else if (R3.isPressed && R3.pointerType !== "keyboard") {
            let L3 = R3.pointerType || M.nativeEvent.pointerType || "virtual", H2 = ye(Gn(M.currentTarget, M), L3), $ = K2(Gn(M.currentTarget, M), L3, true);
            G2 = H2 && $, R3.isOverTarget = false, W(M), ie2(M);
          }
          R3.ignoreEmulatedMouseEvents = false, G2 && M.stopPropagation();
        }
      } }, ve2 = (M) => {
        var G2;
        if (R3.isPressed && R3.target && ks2(M, R3.target)) {
          var L3;
          Uf(Ve2(M), M.key) && M.preventDefault();
          let $ = Ve2(M), D2 = pt2(R3.target, Ve2(M));
          K2(Gn(R3.target, M), "keyboard", D2), D2 && we2(M, R3.target), re2(), M.key !== "Enter" && su(R3.target) && pt2(R3.target, $) && !M[Vf] && (M[Vf] = true, Rr2(R3.target, M, false)), R3.isPressed = false, (L3 = R3.metaKeyEvents) === null || L3 === void 0 || L3.delete(M.key);
        } else if (M.key === "Meta" && (!((G2 = R3.metaKeyEvents) === null || G2 === void 0) && G2.size)) {
          var H2;
          let $ = R3.metaKeyEvents;
          R3.metaKeyEvents = void 0;
          for (let D2 of $.values()) (H2 = R3.target) === null || H2 === void 0 || H2.dispatchEvent(new KeyboardEvent("keyup", D2));
        }
      };
      if (typeof PointerEvent < "u") {
        X2.onPointerDown = (L3) => {
          ...
          let H2 = true;
          if (!R3.isPressed) {
            R3.isPressed = true, R3.isOverTarget = true, R3.activePointerId = L3.pointerId, R3.target = L3.currentTarget, x2 || by(R3.target), H2 = pe2(L3, R3.pointerType);
            let $ = Ve2(L3.nativeEvent);
            "releasePointerCapture" in $ && $.releasePointerCapture(L3.pointerId), te2(Te2(L3.currentTarget), "pointerup", M, false), te2(Te2(L3.currentTarget), "pointercancel", G2, false);
          }
          H2 && L3.stopPropagation();
        }, X2.onMouseDown = (L3) => {
          if (pt2(L3.currentTarget, Ve2(L3.nativeEvent)) && L3.button === 0) {
            if (y2) {
              let H2 = wy(L3.target);
              H2 && R3.disposables.push(H2);
            }
            L3.stopPropagation();
          }
        }, X2.onPointerUp = (L3) => {
        ...
        let M = (L3) => {
          if (L3.pointerId === R3.activePointerId && R3.isPressed && L3.button === 0 && R3.target) {
            if (pt2(R3.target, Ve2(L3)) && R3.pointerType != null) {
              let H2 = false, $ = setTimeout(() => {
                R3.isPressed && R3.target instanceof HTMLElement && (H2 ? ie2(L3) : (_r(R3.target), R3.target.click()));
              }, 80);
              te2(L3.currentTarget, "click", () => H2 = true, true), R3.disposables.push(() => clearTimeout($));
            } else ie2(L3);
      ...
      return X2;
    }, [te2, m2, y2, re2, x2, ie2, ae2, K2, pe2, ye, W, we2]);
    return S.useEffect(() => {
      if (!E) return;
...
@layer {
  [${Bf}] {
    ...
    `.trim(), R3.head.prepend(X2);
      ...
      return () => {
        var X2;
        x2 || Df((X2 = R3.target) !== null && X2 !== void 0 ? X2 : void 0);
        for (let ve2 of R3.disposables) ve2();
        R3.disposables = [];
      };
    }, [x2]), { isPressed: v || I2, pressProps: nn2(_2, Ce2, { [Bf]: true }) };
  }
  function su(r) {
    return r.tagName === "A" && r.hasAttribute("href");
  }
  function ks2(r, l2) {
    const { key: i, code: s } = r, c = l2, d = c.getAttribute("role");
  ...
  function Gn(r, l2) {
    let i = l2.clientX, s = l2.clientY;
    return { currentTarget: r, shiftKey: l2.shiftKey, ctrlKey: l2.ctrlKey, metaKey: l2.metaKey, altKey: l2.altKey, clientX: i, clientY: s };
  }
  function Py(r) {
    return r instanceof HTMLInputElement ? false : r instanceof HTMLButtonElement ? r.type !== "submit" && r.type !== "reset" : !su(r);
  }
  function Uf(r, l2) {
    return r instanceof HTMLInputElement ? !Qp(r, l2) : Py(r);
  }
  function Qp(r, l2) {
    return r.type === "checkbox" || r.type === "radio" ? l2 === " " : Ty.has(r.type);
  }
  function uu(r, l2) {
    for (let i of As2) i(r, l2);
  }
  function Ly(r) {
    return !(r.metaKey || !Mr2() && r.altKey || r.ctrlKey || r.key === "Control" || r.key === "Shift" || r.key === "Meta");
  }
  function ci2(r) {
  ...
  function Ds2(r) {
    if (typeof window > "u" || typeof document > "u" || Mo.get(It2(r))) return;
    const l2 = It2(r), i = Te2(r);
    let s = l2.HTMLElement.prototype.focus;
    l2.HTMLElement.prototype.focus = function() {
      Xn2 = true, s.apply(this, arguments);
    }, i.addEventListener("keydown", ci2, true), i.addEventListener("keyup", ci2, true), i.addEventListener("click", Yp, true), l2.addEventListener("focus", Xp, true), l2.addEventListener("blur", Zp, false), typeof PointerEvent < "u" && (i.addEventListener("pointerdown", Lr, true), i.addEventListener("pointermove", Lr, true), i.addEventListener("pointerup", Lr, true)), l2.addEventListener("beforeunload", () => {
      qp(r);
    }, { once: true }), Mo.set(l2, { focus: s });
  }
  function _y(r) {
    const l2 = Te2(r);
    let i;
    return l2.readyState !== "loading" ? Ds2(r) : (i = () => {
      Ds2(r);
    }, l2.addEventListener("DOMContentLoaded", i)), () => qp(r, i);
  }
  function Jp() {
    return Fr2 !== "pointer";
  }
  ...
  function Ry(r, l2, i) {
    ...
    const c = typeof window < "u" ? It2(i == null ? void 0 : i.target).HTMLInputElement : HTMLInputElement, d = typeof window < "u" ? It2(i == null ? void 0 : i.target).HTMLTextAreaElement : HTMLTextAreaElement, f2 = typeof window < "u" ? It2(i == null ? void 0 : i.target).HTMLElement : HTMLElement, m2 = typeof window < "u" ? It2(i == null ? void 0 : i.target).KeyboardEvent : KeyboardEvent;
    return r = r || s.activeElement instanceof c && !My.has(s.activeElement.type) || s.activeElement instanceof d || s.activeElement instanceof f2 && s.activeElement.isContentEditable, !(r && l2 === "keyboard" && i instanceof m2 && !Ny[i.key]);
  }
  function zy(r, l2, i) {
    Ds2(), S.useEffect(() => {
      let s = (c, d) => {
  ...
  function di2(r) {
    const l2 = Te2(r), i = mt2(l2);
    if (em() === "virtual") {
      let s = i;
      Ap(() => {
        mt2(l2) === s && r.isConnected && _r(r);
      });
    } else _r(r);
  }
  function tm(r) {
    let { isDisabled: l2, onFocus: i, onBlur: s, onFocusChange: c } = r;
    const d = S.useCallback((v) => {
      if (v.target === v.currentTarget) return s && s(v), c && c(false), true;
    }, [s, c]), f2 = Wp(d), m2 = S.useCallback((v) => {
      const y2 = Te2(v.target), g = y2 ? mt2(y2) : mt2();
      v.target === v.currentTarget && g === Ve2(v.nativeEvent) && (i && i(v), c && c(true), f2(v));
    }, [c, i, f2]);
    return { focusProps: { onFocus: !l2 && (i || c || s) ? m2 : void 0, onBlur: !l2 && (s || c) ? d : void 0 } };
  }
  function Wf(r) {
    if (!r) return;
    let l2 = true;
  ...
  function Ay(r) {
    let l2 = S.useContext(Fy) || {};
    Op(l2, r);
    let { ref: i, ...s } = l2;
    return s;
  }
  function nm(r, l2) {
    let { focusProps: i } = tm(r), { keyboardProps: s } = Iy(r), c = nn2(i, s), d = Ay(l2), f2 = r.isDisabled ? {} : d, m2 = S.useRef(r.autoFocus);
    S.useEffect(() => {
      m2.current && l2.current && di2(l2.current), m2.current = false;
    }, [l2]);
    let v = r.excludeFromTabOrder ? -1 : 0;
    return r.isDisabled && (v = void 0), { focusableProps: nn2({ ...c, tabIndex: v }, f2) };
  }
  function Oy({ children: r }) {
    let l2 = S.useMemo(() => ({ register: () => {
    } }), []);
    return Re2.createElement(au.Provider, { value: l2 }, r);
  }
  function cu(r) {
    let { isDisabled: l2, onBlurWithin: i, onFocusWithin: s, onFocusWithinChange: c } = r, d = S.useRef({ isFocusWithin: false }), { addGlobalListener: f2, removeAllGlobalListeners: m2 } = ru(), v = S.useCallback((x2) => {
      x2.currentTarget.contains(x2.target) && d.current.isFocusWithin && !x2.currentTarget.contains(x2.relatedTarget) && (d.current.isFocusWithin = false, m2(), i && i(x2), c && c(false));
    }, [i, c, d, m2]), y2 = Wp(v), g = S.useCallback((x2) => {
      if (!x2.currentTarget.contains(x2.target)) return;
      const E = Te2(x2.target), _2 = mt2(E);
      if (!d.current.isFocusWithin && _2 === Ve2(x2.nativeEvent)) {
        s && s(x2), c && c(true), d.current.isFocusWithin = true, y2(x2);
        let I2 = x2.currentTarget;
        f2(E, "focus", (F) => {
    ...
    return l2 ? { focusWithinProps: { onFocus: void 0, onBlur: void 0 } } : { focusWithinProps: { onFocus: g, onBlur: v } };
  }
  function Dy() {
    js2 = true, setTimeout(() => {
      js2 = false;
  ...
  function Vy(r) {
    let { onHoverStart: l2, onHoverChange: i, onHoverEnd: s, isDisabled: c } = r, [d, f2] = S.useState(false), m2 = S.useRef({ isHovered: false, ignoreEmulatedMouseEvents: false, pointerType: "", target: null }).current;
    S.useEffect(jy, []);
    let { addGlobalListener: v, removeAllGlobalListeners: y2 } = ru(), { hoverProps: g, triggerHoverEnd: x2 } = S.useMemo(() => {
      let E = (F, A2) => {
        if (m2.pointerType = A2, c || A2 === "touch" || m2.isHovered || !F.currentTarget.contains(F.target)) return;
        m2.isHovered = true;
        let te2 = F.currentTarget;
        m2.target = te2, v(Te2(F.target), "pointerover", (re2) => {
          m2.isHovered && m2.target && !pt2(m2.target, re2.target) && _2(re2, re2.pointerType);
        }, { capture: true }), l2 && l2({ type: "hoverstart", target: te2, pointerType: A2 }), i && i(true), f2(true);
      }, _2 = (F, A2) => {
        let te2 = m2.target;
        m2.pointerType = "", m2.target = null, !(A2 === "touch" || !m2.isHovered || !te2) && (m2.isHovered = false, y2(), s && s({ type: "hoverend", target: te2, pointerType: A2 }), i && i(false), f2(false));
      }, I2 = {};
      return typeof PointerEvent < "u" && (I2.onPointerEnter = (F) => {
        js2 && F.pointerType === "mouse" || E(F, F.pointerType);
      }, I2.onPointerLeave = (F) => {
        !c && F.currentTarget.contains(F.target) && _2(F, F.pointerType);
      }), { hoverProps: I2, triggerHoverEnd: _2 };
    }, [l2, i, s, c, m2, v, y2]);
    return S.useEffect(() => {
      c && x2({ currentTarget: m2.target }, m2.pointerType);
    }, [c]), { hoverProps: g, isHovered: d };
  }
  function Hy(r) {
    let { ref: l2, onInteractOutside: i, isDisabled: s, onInteractOutsideStart: c } = r, d = S.useRef({ isPointerDown: false, ignoreEmulatedMouseEvents: false }), f2 = $t2((v) => {
      i && Kf(v, l2) && (c && c(v), d.current.isPointerDown = true);
    }), m2 = $t2((v) => {
      i && i(v);
    });
    S.useEffect(() => {
      let v = d.current;
      if (s) return;
      const y2 = l2.current, g = Te2(y2);
      if (typeof PointerEvent < "u") {
        let x2 = (E) => {
          v.isPointerDown && Kf(E, l2) && m2(E), v.isPointerDown = false;
        };
        return g.addEventListener("pointerdown", f2, true), g.addEventListener("click", x2, true), () => {
          g.removeEventListener("pointerdown", f2, true), g.removeEventListener("click", x2, true);
        };
      }
    }, [l2, s, f2, m2]);
  }
  function Kf(r, l2) {
    ...
    return l2.current ? !r.composedPath().includes(l2.current) : false;
  }
  function By(r) {
    let { children: l2, contain: i, restoreFocus: s, autoFocus: c } = r, d = S.useRef(null), f2 = S.useRef(null), m2 = S.useRef([]), { parentNode: v } = S.useContext(Qf) || {}, y2 = S.useMemo(() => new Bs2({ scopeRef: m2 }), [m2]);
    Xe(() => {
      let E = v || Be2.root;
      if (Be2.getTreeNode(E.scopeRef) && Le2 && !fi2(Le2, E.scopeRef)) {
        let _2 = Be2.getTreeNode(Le2);
        _2 && (E = _2);
      }
      E.addChild(y2), Be2.addNode(y2);
    }, [y2, v]), Xe(() => {
      let E = Be2.getTreeNode(m2);
      E && (E.contain = !!i);
    }, [i]), Xe(() => {
      var E;
      let _2 = (E = d.current) === null || E === void 0 ? void 0 : E.nextSibling, I2 = [], F = (A2) => A2.stopPropagation();
      for (; _2 && _2 !== f2.current; ) I2.push(_2), _2.addEventListener(Vs2, F), _2 = _2.nextSibling;
      return m2.current = I2, () => {
        for (let A2 of I2) A2.removeEventListener(Vs2, F);
      };
    }, [l2]), Yy(m2, s, i), Gy(m2, i), Xy(m2, s, i), Qy(m2, c), S.useEffect(() => {
      const E = mt2(Te2(m2.current ? m2.current[0] : void 0));
      let _2 = null;
      if (Ct(E, m2.current)) {
        for (let I2 of Be2.traverse()) I2.scopeRef && Ct(E, I2.scopeRef.current) && (_2 = I2);
        _2 === Be2.getTreeNode(m2) && (Le2 = _2.scopeRef);
      }
    }, [m2]), Xe(() => () => {
      var E, _2, I2;
      let F = (I2 = (_2 = Be2.getTreeNode(m2)) === null || _2 === void 0 || (E = _2.parent) === null || E === void 0 ? void 0 : E.scopeRef) !== null && I2 !== void 0 ? I2 : null;
      (m2 === Le2 || fi2(m2, Le2)) && (!F || Be2.getTreeNode(F)) && (Le2 = F), Be2.removeTreeNode(m2);
    }, [m2]);
    let g = S.useMemo(() => Uy(m2), []), x2 = S.useMemo(() => ({ focusManager: g, parentNode: y2 }), [y2, g]);
    return Re2.createElement(Qf.Provider, { value: x2 }, Re2.createElement("span", { "data-focus-scope-start": true, hidden: true, ref: d }), l2, Re2.createElement("span", { "data-focus-scope-end": true, hidden: true, ref: f2 }));
  }
  function Uy(r) {
    return { focusNext(l2 = {}) {
      let i = r.current, { from: s, tabbable: c, wrap: d, accept: f2 } = l2;
      var m2;
      let v = s || mt2(Te2((m2 = i[0]) !== null && m2 !== void 0 ? m2 : void 0)), y2 = i[0].previousElementSibling, g = Qn2(i), x2 = Tn2(g, { tabbable: c, accept: f2 }, i);
      x2.currentNode = Ct(v, i) ? v : y2;
      let E = x2.nextNode();
      return !E && d && (x2.currentNode = y2, E = x2.nextNode()), E && tn2(E, true), E;
    }, focusPrevious(l2 = {}) {
      let i = r.current, { from: s, tabbable: c, wrap: d, accept: f2 } = l2;
      var m2;
      let v = s || mt2(Te2((m2 = i[0]) !== null && m2 !== void 0 ? m2 : void 0)), y2 = i[i.length - 1].nextElementSibling, g = Qn2(i), x2 = Tn2(g, { tabbable: c, accept: f2 }, i);
      x2.currentNode = Ct(v, i) ? v : y2;
      let E = x2.previousNode();
      return !E && d && (x2.currentNode = y2, E = x2.previousNode()), E && tn2(E, true), E;
    }, focusFirst(l2 = {}) {
      let i = r.current, { tabbable: s, accept: c } = l2, d = Qn2(i), f2 = Tn2(d, { tabbable: s, accept: c }, i);
      f2.currentNode = i[0].previousElementSibling;
      let m2 = f2.nextNode();
      return m2 && tn2(m2, true), m2;
    }, focusLast(l2 = {}) {
      let i = r.current, { tabbable: s, accept: c } = l2, d = Qn2(i), f2 = Tn2(d, { tabbable: s, accept: c }, i);
      f2.currentNode = i[i.length - 1].nextElementSibling;
      let m2 = f2.previousNode();
      return m2 && tn2(m2, true), m2;
    } };
  }
  function Qn2(r) {
  ...
  function Lo(r) {
    let l2 = Be2.getTreeNode(Le2);
    for (; l2 && l2.scopeRef !== r; ) {
      if (l2.contain) return false;
      l2 = l2.parent;
    }
    return true;
  }
  function Wy(r) {
    ...
    let l2 = [];
    if (!r.form) l2 = [...Te2(r).querySelectorAll(`input[type="radio"][name="${CSS.escape(r.name)}"]`)].filter((d) => !d.form);
    else {
      var i, s;
      let d = (s = r.form) === null || s === void 0 || (i = s.elements) === null || i === void 0 ? void 0 : i.namedItem(r.name);
      l2 = [...d ?? []];
    }
    return l2 ? !l2.some((d) => d.checked) : false;
  }
  function Gy(r, l2) {
    ...
    Xe(() => {
      ...
      let f2 = (y2) => {
        if (y2.key !== "Tab" || y2.altKey || y2.ctrlKey || y2.metaKey || !Lo(r) || y2.isComposing) return;
        let g = mt2(d), x2 = r.current;
        if (!x2 || !Ct(g, x2)) return;
        let E = Qn2(x2), _2 = Tn2(E, { tabbable: true }, x2);
        if (!g) return;
        _2.currentNode = g;
        let I2 = y2.shiftKey ? _2.previousNode() : _2.nextNode();
        I2 || (_2.currentNode = y2.shiftKey ? x2[x2.length - 1].nextElementSibling : x2[0].previousElementSibling, I2 = y2.shiftKey ? _2.previousNode() : _2.nextNode()), y2.preventDefault(), I2 && tn2(I2, true);
      }, m2 = (y2) => {
        (!Le2 || fi2(Le2, r)) && Ct(Ve2(y2), r.current) ? (Le2 = r, i.current = Ve2(y2)) : Lo(r) && !Pn(Ve2(y2), r) ? i.current ? i.current.focus() : Le2 && Le2.current && Hs2(Le2.current) : Lo(r) && (i.current = Ve2(y2));
      }, v = (y2) => {
        s.current && cancelAnimationFrame(s.current), s.current = requestAnimationFrame(() => {
          let g = em(), x2 = (g === "virtual" || g === null) && nu() && Ip(), E = mt2(d);
          if (!x2 && E && Lo(r) && !Pn(E, r)) {
            Le2 = r;
            let I2 = Ve2(y2);
            if (I2 && I2.isConnected) {
              var _2;
              i.current = I2, (_2 = i.current) === null || _2 === void 0 || _2.focus();
            } else Le2.current && Hs2(Le2.current);
          }
        });
      };
      return d.addEventListener("keydown", f2, false), d.addEventListener("focusin", m2, false), c == null || c.forEach((y2) => y2.addEventListener("focusin", m2, false)), c == null || c.forEach((y2) => y2.addEventListener("focusout", v, false)), () => {
        d.removeEventListener("keydown", f2, false), d.removeEventListener("focusin", m2, false), c == null || c.forEach((y2) => y2.removeEventListener("focusin", m2, false)), c == null || c.forEach((y2) => y2.removeEventListener("focusout", v, false));
      };
    }, [r, l2]), Xe(() => () => {
  ...
  function Ct(r, l2) {
    return !r || !l2 ? false : l2.some((i) => i.contains(r));
  }
  function Pn(r, l2 = null) {
    if (r instanceof Element && r.closest("[data-react-aria-top-layer]")) return true;
    for (let { scopeRef: i } of Be2.traverse(Be2.getTreeNode(l2))) if (i && Ct(r, i.current)) return true;
    return false;
  }
  function Ky(r) {
    return Pn(r, Le2);
  ...
  function fi2(r, l2) {
    var i;
    let s = (i = Be2.getTreeNode(l2)) === null || i === void 0 ? void 0 : i.parent;
    for (; s; ) {
  ...
  function om(r, l2 = true) {
    let i = r[0].previousElementSibling, s = Qn2(r), c = Tn2(s, { tabbable: l2 }, r);
    c.currentNode = i;
    let d = c.nextNode();
    return l2 && !d && (s = Qn2(r), c = Tn2(s, { tabbable: false }, r), c.currentNode = i, d = c.nextNode()), d;
  }
  function Hs2(r, l2 = true) {
    tn2(om(r, l2));
  }
  function Qy(r, l2) {
    const i = Re2.useRef(l2);
    S.useEffect(() => {
      if (i.current) {
        Le2 = r;
  ...
  function Yy(r, l2, i) {
    Xe(() => {
      ...
      let d = (f2) => {
        let m2 = Ve2(f2);
        Ct(m2, r.current) ? Le2 = r : rm(m2) || (Le2 = null);
      };
      return c.addEventListener("focusin", d, false), s == null || s.forEach((f2) => f2.addEventListener("focusin", d, false)), () => {
        c.removeEventListener("focusin", d, false), s == null || s.forEach((f2) => f2.removeEventListener("focusin", d, false));
      };
    }, [r, l2, i]);
  }
  function Yf(r) {
    let l2 = Be2.getTreeNode(Le2);
    for (; l2 && l2.scopeRef !== r; ) {
      if (l2.nodeToRestore) return false;
      l2 = l2.parent;
    }
    return (l2 == null ? void 0 : l2.scopeRef) === r;
  }
  function Xy(r, l2, i) {
    ...
    Xe(() => {
      ...
      return d.addEventListener("focusin", f2, false), c == null || c.forEach((m2) => m2.addEventListener("focusin", f2, false)), () => {
        d.removeEventListener("focusin", f2, false), c == null || c.forEach((m2) => m2.removeEventListener("focusin", f2, false));
      };
    }, [r, i]), Xe(() => {
      const c = Te2(r.current ? r.current[0] : void 0);
      if (!l2) return;
      let d = (f2) => {
        if (f2.key !== "Tab" || f2.altKey || f2.ctrlKey || f2.metaKey || !Lo(r) || f2.isComposing) return;
        let m2 = c.activeElement;
        if (!Pn(m2, r) || !Yf(r)) return;
        let v = Be2.getTreeNode(r);
        if (!v) return;
        let y2 = v.nodeToRestore, g = Tn2(c.body, { tabbable: true });
        g.currentNode = m2;
        let x2 = f2.shiftKey ? g.previousNode() : g.nextNode();
        if ((!y2 || !y2.isConnected || y2 === c.body) && (y2 = void 0, v.nodeToRestore = void 0), (!x2 || !Pn(x2, r)) && y2) {
          g.currentNode = y2;
          do
            x2 = f2.shiftKey ? g.previousNode() : g.nextNode();
          while (Pn(x2, r));
          f2.preventDefault(), f2.stopPropagation(), x2 ? tn2(x2, true) : rm(y2) ? tn2(y2, true) : m2.blur();
        }
      };
      ...
      if (d) {
        var f2;
        return d.nodeToRestore = (f2 = s.current) !== null && f2 !== void 0 ? f2 : void 0, () => {
          let m2 = Be2.getTreeNode(r);
          if (!m2) return;
          let v = m2.nodeToRestore, y2 = mt2(c);
          if (l2 && v && (y2 && Pn(y2, r) || y2 === c.body && Yf(r))) {
            let g = Be2.clone();
            requestAnimationFrame(() => {
              if (c.activeElement === c.body) {
                let x2 = g.getTreeNode(r);
                for (; x2; ) {
                  if (x2.nodeToRestore && x2.nodeToRestore.isConnected) {
                    Xf(x2.nodeToRestore);
                    return;
                  }
                  x2 = x2.parent;
                }
                for (x2 = g.getTreeNode(r); x2; ) {
                  if (x2.scopeRef && x2.scopeRef.current && Be2.getTreeNode(x2.scopeRef)) {
                    let E = om(x2.scopeRef.current, true);
                    Xf(E);
                    return;
                  }
                  x2 = x2.parent;
  ...
  function Tn2(r, l2, i) {
    let s = l2 != null && l2.tabbable ? yy : Vp, c = (r == null ? void 0 : r.nodeType) === Node.ELEMENT_NODE ? r : null, d = Te2(c), f2 = B0(d, r || d, NodeFilter.SHOW_ELEMENT, { acceptNode(m2) {
      var v;
      return !(l2 == null || (v = l2.from) === null || v === void 0) && v.contains(m2) || l2 != null && l2.tabbable && m2.tagName === "INPUT" && m2.getAttribute("type") === "radio" && (!Wy(m2) || f2.currentNode.tagName === "INPUT" && f2.currentNode.type === "radio" && f2.currentNode.name === m2.name) ? NodeFilter.FILTER_REJECT : s(m2) && (!i || Ct(m2, i)) && (!(l2 != null && l2.accept) || l2.accept(m2)) ? NodeFilter.FILTER_ACCEPT : NodeFilter.FILTER_SKIP;
    } });
    return l2 != null && l2.from && (f2.currentNode = l2.from), f2;
  }
  function lm(r = {}) {
    let { autoFocus: l2 = false, isTextInput: i, within: s } = r, c = S.useRef({ isFocused: false, isFocusVisible: l2 || Jp() }), [d, f2] = S.useState(false), [m2, v] = S.useState(() => c.current.isFocused && c.current.isFocusVisible), y2 = S.useCallback(() => v(c.current.isFocused && c.current.isFocusVisible), []), g = S.useCallback((_2) => {
      c.current.isFocused = _2, f2(_2), y2();
    }, [y2]);
    zy((_2) => {
      c.current.isFocusVisible = _2, y2();
    }, [], { isTextInput: i });
    let { focusProps: x2 } = tm({ isDisabled: s, onFocusChange: g }), { focusWithinProps: E } = cu({ isDisabled: !s, onFocusWithinChange: g });
    return { isFocused: d, isFocusVisible: m2, focusProps: s ? E : x2 };
  }
  function Zy(r, l2) {
    let { elementType: i = "a", onPress: s, onPressStart: c, onPressEnd: d, onClick: f2, isDisabled: m2, ...v } = r, y2 = {};
    i !== "a" && (y2 = { role: "link", tabIndex: m2 ? void 0 : 0 });
    let { focusableProps: g } = nm(r, l2), { pressProps: x2, isPressed: E } = Kp({ onClick: f2, onPress: s, onPressStart: c, onPressEnd: d, isDisabled: m2, ref: l2 }), _2 = eu(v, { labelable: true, isLink: i === "a" }), I2 = nn2(g, x2), F = Fp(), A2 = iy(r);
    return { isPressed: E, linkProps: nn2(_2, A2, { ...I2, ...y2, "aria-disabled": m2 || void 0, "aria-current": r["aria-current"], onClick: (te2) => {
      var re2;
      (re2 = x2.onClick) == null || re2.call(x2, te2), ay(te2, F, r.href, r.routerOptions);
    } }) };
  }
  function fu(r = {}) {
    const { strict: l2 = true, errorMessage: i = "useContext: `context` is undefined. Seems you forgot to wrap component within the Provider", name: s } = r, c = S.createContext(void 0);
    c.displayName = s;
    function d() {
      var f2;
      const m2 = S.useContext(c);
      if (!m2 && l2) {
        const v = new Error(i);
        throw v.name = "ContextError", (f2 = Error.captureStackTrace) == null || f2.call(Error, v, d), v;
      }
      return m2;
    }
  ...
  function Ar2(r) {
    const l2 = S.useRef(null);
    return S.useImperativeHandle(r, () => l2.current), l2;
  }
  function qf(r, l2 = {}) {
    let { labelable: i = true, enabled: s = true, propNames: c, omitPropNames: d, omitEventNames: f2, omitDataProps: m2, omitEventProps: v } = l2, y2 = {};
    if (!s) return r;
    for (const g in r) d != null && d.has(g) || f2 != null && f2.has(g) && ri2.test(g) || ri2.test(g) && !e1.has(g) || m2 && Zf.test(g) || v && ri2.test(g) || (Object.prototype.hasOwnProperty.call(r, g) && (Jy.has(g) || i && t1.test(g) || c != null && c.has(g) || Zf.test(g)) || ri2.test(g)) && (y2[g] = r[g]);
    return y2;
  }
  function o1(r) {
    if (Intl.Locale) {
  ...
  function Jf() {
    Us2 = im();
    for (let r of _o) r(Us2);
  }
  function i1() {
    let r = Js2(), [l2, i] = S.useState(Us2);
    return S.useEffect(() => (_o.size === 0 && window.addEventListener("languagechange", Jf), _o.add(i), () => {
      _o.delete(i), _o.size === 0 && window.removeEventListener("languagechange", Jf);
    }), []), r ? { locale: "en-US", direction: "ltr" } : l2;
  }
  function s1() {
    let r = i1();
    return S.useContext(a1) || r;
  }
  function d1(r, l2, i = "en-US") {
    if (l2[r]) return l2[r];
    let s = f1(r);
    if (l2[s]) return l2[s];
    for (let c in l2) if (c.startsWith(s + "-")) return l2[c];
    return l2[i];
  }
  function f1(r) {
  ...
  function m1(r) {
    let l2 = np.get(r);
    return l2 || (l2 = new bi2(r), np.set(r, l2)), l2;
  }
  function v1(r, l2) {
    return l2 && bi2.getGlobalDictionaryForPackage(l2) || m1(r);
  }
  function h1(r, l2) {
    let { locale: i } = s1(), s = v1(r, l2);
    return S.useMemo(() => new p1(i, s), [i, s]);
  }
  function pu(r) {
    const l2 = S.useRef(null);
    return l2.current === null && (l2.current = r()), l2.current;
  }
  function y1(r) {
  ...
  function $1({ children: r, isPresent: l2, anchorX: i, root: s }) {
    const c = S.useId(), d = S.useRef(null), f2 = S.useRef({ width: 0, height: 0, top: 0, left: 0, right: 0 }), { nonce: m2 } = S.useContext(vu);
    return S.useInsertionEffect(() => {
      const { width: v, height: y2, top: g, left: x2, right: E } = f2.current;
      if (l2 || !d.current || !v || !y2) return;
      const _2 = i === "left" ? `left: ${x2}` : `right: ${E}`;
    ...
    }, [l2]), Y2.jsx(E1, { isPresent: l2, childRef: d, sizeRef: f2, children: S.cloneElement(r, { ref: d }) });
  }
  function P1() {
    return /* @__PURE__ */ new Map();
  }
  function T1(r = true) {
    const l2 = S.useContext(xi2);
    if (l2 === null) return [true, null];
    const { isPresent: i, onExitComplete: s, register: c } = l2, d = S.useId();
    S.useEffect(() => {
      if (r) return c(d);
    }, [r]);
    const f2 = S.useCallback(() => r && s && s(d), [d, s, r]);
    return !i && s ? [false, f2] : [true];
  }
  function lp(r) {
    const l2 = [];
    return S.Children.forEach(r, (i) => {
      S.isValidElement(i) && l2.push(i);
    }), l2;
  }
  function Gs2(r) {
    for (const l2 in r) pi[l2] = { ...pi[l2], ...r[l2] };
  }
  function gu({ children: r, features: l2, strict: i = false }) {
    const [, s] = S.useState(!Es2(l2)), c = S.useRef(void 0);
    if (!Es2(l2)) {
      const { renderer: d, ...f2 } = l2;
      c.current = d, Gs2(f2);
    }
    return S.useEffect(() => {
      Es2(l2) && l2().then(({ renderer: d, ...f2 }) => {
        Gs2(f2), c.current = d, s(true);
      });
    }, []), Y2.jsx(hu.Provider, { value: { renderer: c.current, strict: i }, children: r });
  }
  function Es2(r) {
  ...
  function L1(r) {
    typeof r == "function" && (vm = (l2) => l2.startsWith("on") ? !mi2(l2) : r(l2));
  }
  function _1(r, l2, i) {
    const s = {};
    for (const c in r) c === "values" && typeof r.values == "object" || (vm(c) || i === true && mi2(c) || !l2 && !mi2(c) || r.draggable && c.startsWith("onDrag")) && (s[c] = r[c]);
    return s;
  }
  function hm(r) {
  ...
  function yu(r) {
    return hm(r.animate) || R1.some((l2) => Ks(r[l2]));
  }
  function z1(r) {
  ...
  function I1(r, l2) {
    ...
    return r.inherit !== false ? l2 : {};
  }
  function F1(r) {
    const { initial: l2, animate: i } = I1(r, S.useContext(Si2));
    return S.useMemo(() => ({ initial: l2, animate: i }), [ap(l2), ap(i)]);
  }
  function ap(r) {
    return Array.isArray(r) ? r.join(" ") : r;
  }
  function gm(r, { layout: l2, layoutId: i }) {
    return dm.has(r) || r.startsWith("origin") || (l2 || i !== void 0) && (!!A1[r] || r === "opacity");
  }
  function j1(r, l2, i) {
    let s = "", c = true;
    for (let d = 0; d < D1; d++) {
      const f2 = ki[d], m2 = r[f2];
      if (m2 === void 0) continue;
      let v = true;
      if (typeof m2 == "number" ? v = m2 === (f2.startsWith("scale") ? 1 : 0) : v = parseFloat(m2) === 0, !v || i) {
        const y2 = pm(m2, fm[f2]);
        if (!v) {
          c = false;
          const g = O1[f2] || f2;
          s += `${g}(${y2}) `;
    ...
    return s = s.trim(), i ? s = i(l2, c ? "" : s) : c && (s = "none"), s;
  }
  function ym(r, l2, i) {
    ...
    for (const v in l2) {
      ...
      if (dm.has(v)) {
        ...
        const g = pm(y2, fm[v]);
        v.startsWith("origin") ? (m2 = true, d[v] = g) : s[v] = g;
      }
    }
    if (l2.transform || (f2 || i ? s.transform = j1(l2, r.transform, i) : s.transform && (s.transform = "none")), m2) {
      const { originX: v = "50%", originY: y2 = "50%", originZ: g = 0 } = d;
      s.transformOrigin = `${v} ${y2} ${g}`;
    }
  }
  function wm(r, l2, i) {
    for (const s in l2) !Zn(l2[s]) && !gm(s, i) && (r[s] = l2[s]);
  }
  function V1({ transformTemplate: r }, l2) {
    return S.useMemo(() => {
      const i = wu();
      return ym(i, l2, r), Object.assign({}, i.vars, i.style);
    }, [l2]);
  }
  function H1(r, l2) {
    const i = r.style || {}, s = {};
    return wm(s, i, r), Object.assign(s, V1(r, l2)), s;
  }
  function B1(r, l2) {
    const i = {}, s = H1(r, l2);
  ...
  function G1(r, l2, i = 1, s = 0, c = true) {
    r.pathLength = 1;
    const d = c ? U1 : W1;
    r[d.offset] = he.transform(-s);
    const f2 = he.transform(l2), m2 = he.transform(i);
    r[d.array] = `${f2} ${m2}`;
  }
  function K1(r, { attrX: l2, attrY: i, attrScale: s, pathLength: c, pathSpacing: d = 1, pathOffset: f2 = 0, ...m2 }, v, y2, g) {
    if (ym(r, m2, y2), v) {
      r.style.viewBox && (r.attrs.viewBox = r.style.viewBox);
      return;
    }
    r.attrs = r.style, r.style = {};
    const { attrs: x2, style: E } = r;
    x2.transform && (E.transform = x2.transform, delete x2.transform), (E.transform || x2.transformOrigin) && (E.transformOrigin = x2.transformOrigin ?? "50% 50%", delete x2.transformOrigin), E.transform && (E.transformBox = (g == null ? void 0 : g.transformBox) ?? "fill-box", delete x2.transformBox), l2 !== void 0 && (x2.x = l2), i !== void 0 && (x2.y = i), s !== void 0 && (x2.scale = s), c !== void 0 && G1(x2, c, d, f2, false);
  }
  function Y1(r, l2, i, s) {
    const c = S.useMemo(() => {
      const d = bm();
      return K1(d, l2, Q1(s), r.transformTemplate, r.style), { ...d.attrs, style: { ...d.style } };
    }, [l2]);
    if (r.style) {
      const d = {};
  ...
  function Z1(r, l2, i, { latestValues: s }, c, d = false) {
    const m2 = (xm(r) ? Y1 : B1)(l2, s, c, r), v = _1(l2, typeof r == "string", d), y2 = r !== S.Fragment ? { ...v, ...m2, ref: i } : {}, { children: g } = l2, x2 = S.useMemo(() => Zn(g) ? g.get() : g, [g]);
    return S.createElement(r, { ...y2, children: x2 });
  }
  function sp(r) {
    const l2 = [{}, {}];
    return r == null || r.values.forEach((i, s) => {
      l2[0][s] = i.get(), l2[1][s] = i.getVelocity();
    }), l2;
  }
  function q1(r, l2, i, s) {
    if (typeof l2 == "function") {
      const [c, d] = sp(s);
      l2 = l2(i !== void 0 ? i : r.custom, c, d);
    }
    if (typeof l2 == "string" && (l2 = r.variants && r.variants[l2]), typeof l2 == "function") {
      const [c, d] = sp(s);
      l2 = l2(i !== void 0 ? i : r.custom, c, d);
    }
    return l2;
  ...
  function ew({ scrapeMotionValuesFromProps: r, createRenderState: l2 }, i, s, c) {
    return { latestValues: tw(i, s, c, r), renderState: l2() };
  }
  function tw(r, l2, i, s) {
    const c = {}, d = s(r, {});
    for (const E in d) c[E] = J1(d[E]);
    let { initial: f2, animate: m2 } = r;
    const v = yu(r), y2 = z1(r);
    l2 && y2 && !v && r.inherit !== false && (f2 === void 0 && (f2 = l2.initial), m2 === void 0 && (m2 = l2.animate));
    let g = i ? i.initial === false : false;
    g = g || f2 === false;
    const x2 = g ? m2 : f2;
    if (x2 && typeof x2 != "boolean" && !hm(x2)) {
      const E = Array.isArray(x2) ? x2 : [x2];
  ...
  function Sm(r, l2, i) {
    var d;
    const { style: s } = r, c = {};
    for (const f2 in s) (Zn(s[f2]) || l2.style && Zn(l2.style[f2]) || gm(f2, r) || ((d = i == null ? void 0 : i.getValue(f2)) == null ? void 0 : d.liveStyle) !== void 0) && (c[f2] = s[f2]);
    return c;
  }
  function rw(r, l2, i) {
    const s = Sm(r, l2, i);
    for (const c in r) if (Zn(r[c]) || Zn(l2[c])) {
  ...
  function iw(r, l2, i) {
    return S.useCallback((s) => {
      s && r.onMount && r.onMount(s), l2 && (s ? l2.mount(s) : l2.unmount()), i && (typeof i == "function" ? i(s) : Em(i) && (i.current = s));
    }, [l2]);
  }
  function dw(r, l2, i, s, c) {
    var F, A2;
    const { visualElement: d } = S.useContext(Si2), f2 = S.useContext(hu), m2 = S.useContext(xi2), v = S.useContext(vu).reducedMotion, y2 = S.useRef(null);
    s = s || f2.renderer, !y2.current && s && (y2.current = s(r, { visualState: l2, parent: d, props: i, presenceContext: m2, blockInitialAnimation: m2 ? m2.initial === false : false, reducedMotionConfig: v }));
    const g = y2.current, x2 = S.useContext(cw);
    g && !g.projection && c && (g.type === "html" || g.type === "svg") && fw(y2.current, i, c, x2);
    const E = S.useRef(false);
    S.useInsertionEffect(() => {
      g && E.current && g.update(i, m2);
    });
    const _2 = i[uw], I2 = S.useRef(!!_2 && !((F = window.MotionHandoffIsComplete) != null && F.call(window, _2)) && ((A2 = window.MotionHasOptimisedAnimation) == null ? void 0 : A2.call(window, _2)));
    return um(() => {
      ...
      g && (!I2.current && g.animationState && g.animationState.animateChanges(), I2.current && (queueMicrotask(() => {
        var te2;
        (te2 = window.MotionHandoffMarkAsComplete) == null || te2.call(window, _2);
      }), I2.current = false), g.enteringChildren = void 0);
    }), g;
  }
  function fw(r, l2, i, s) {
    const { layoutId: c, layout: d, drag: f2, dragConstraints: m2, layoutScroll: v, layoutRoot: y2, layoutCrossfade: g } = l2;
    r.projection = new i(r.latestValues, l2["data-framer-portal-id"] ? void 0 : $m(r.parent)), r.projection.setOptions({ layoutId: c, layout: d, alwaysMeasureLayout: !!f2 || m2 && Em(m2), visualElement: r, animationType: typeof d == "string" ? d : "both", initialPromotionConfig: s, crossfade: g, layoutScroll: v, layoutRoot: y2 });
  }
  function $m(r) {
    if (r) return r.options.allowProjection !== false ? r.projection : $m(r.parent);
  }
  function $s2(r, { forwardMotionProps: l2 = false } = {}, i, s) {
    i && Gs2(i);
    const c = xm(r) ? ow : nw;
    function d(m2, v) {
      let y2;
      const g = { ...S.useContext(vu), ...m2, layoutId: pw(m2) }, { isStatic: x2 } = g, E = F1(m2), _2 = c(m2, x2);
      if (!x2 && sm) {
        mw();
        const I2 = vw(g);
        y2 = I2.MeasureLayout, E.visualElement = dw(r, _2, g, s, I2.ProjectionNode);
      }
      return Y2.jsxs(Si2.Provider, { value: E, children: [y2 && E.visualElement ? Y2.jsx(y2, { visualElement: E.visualElement, ...g }) : null, Z1(r, m2, iw(_2, E.visualElement, v), _2, x2, l2)] });
    }
    d.displayName = `motion.${typeof r == "string" ? r : `create(${r.displayName ?? r.name ?? ""})`}`;
    const f2 = S.forwardRef(d);
    return f2[lw] = r, f2;
  }
  function pw({ layoutId: r }) {
    const l2 = S.useContext(am).id;
    return l2 && r !== void 0 ? l2 + "-" + r : r;
  }
  function mw(r, l2) {
    S.useContext(hu).strict;
  }
  function vw(r) {
    const { drag: l2, layout: i } = pi;
    if (!l2 && !i) return {};
    const s = { ...l2, ...i };
    return { MeasureLayout: l2 != null && l2.isEnabled(r) || i != null && i.isEnabled(r) ? s.MeasureLayout : void 0, ProjectionNode: s.ProjectionNode };
  }
  function hw(r, l2) {
    if (typeof Proxy > "u") return $s2;
    const i = /* @__PURE__ */ new Map(), s = (d, f2) => $s2(d, f2, r, l2), c = (d, f2) => s(d, f2);
    return new Proxy(c, { get: (d, f2) => f2 === "create" ? s : (i.has(f2) || i.set(f2, $s2(f2, void 0, r, l2)), i.get(f2)) });
  }
  function yw(r = {}) {
    let { isDisabled: l2 } = r;
    Xe(() => {
      if (!l2) return ii2++, ii2 === 1 && (yi2() ? Ps2 = bw() : Ps2 = ww()), () => {
        ii2--, ii2 === 0 && Ps2();
      };
    }, [l2]);
  }
  ...
  function bw() {
    let r, l2, i = (y2) => {
      r = Dp(y2.target, true), !(r === document.documentElement && r === document.body) && r instanceof HTMLElement && window.getComputedStyle(r).overscrollBehavior === "auto" && (l2 = Yn2(r, "overscrollBehavior", "contain"));
    }, s = (y2) => {
      if (!r || r === document.documentElement || r === document.body) {
        y2.preventDefault();
        return;
      }
      r.scrollHeight === r.clientHeight && r.scrollWidth === r.clientWidth && y2.preventDefault();
    }, c = () => {
      l2 && l2();
    }, d = (y2) => {
      let g = y2.target;
      xw(g) && (m2(), g.style.transform = "translateY(-2000px)", requestAnimationFrame(() => {
      ...
      let y2 = () => {
        window.scrollTo(0, 0);
      }, g = window.pageXOffset, x2 = window.pageYOffset;
      f2 = Ro(Po(window, "scroll", y2), Yn2(document.documentElement, "paddingRight", `${window.innerWidth - document.documentElement.clientWidth}px`), Yn2(document.documentElement, "overflow", "hidden"), Yn2(document.body, "marginTop", `-${x2}px`), () => {
        window.scrollTo(g, x2);
      }), window.scrollTo(0, 0);
  ...
  function Po(r, l2, i, s) {
    return r.addEventListener(l2, i, s), () => {
      r.removeEventListener(l2, i, s);
    };
  }
  function up(r) {
    let l2 = document.scrollingElement || document.documentElement, i = r;
    for (; i && i !== l2; ) {
      let s = Dp(i);
  ...
  function Ew(r = {}) {
    let { style: l2, isFocusable: i } = r, [s, c] = S.useState(false), { focusWithinProps: d } = cu({ isDisabled: !i, onFocusWithinChange: (m2) => c(m2) }), f2 = S.useMemo(() => s ? l2 : l2 ? { ...cp, ...l2 } : cp, [s]);
    return { visuallyHiddenProps: { ...d, style: f2 } };
  }
  function $w(r) {
    let { children: l2, elementType: i = "div", isFocusable: s, style: c, ...d } = r, { visuallyHiddenProps: f2 } = Ew(r);
    return Re2.createElement(i, nn2(d, f2), l2);
  }
  function Cw(r) {
    return r && r.__esModule ? r.default : r;
  }
  function cb(r) {
    let { onDismiss: l2, ...i } = r, s = h1(Cw(iv), "@react-aria/overlays"), c = uy(i, s.format("dismiss")), d = () => {
      l2 && l2();
    };
    return Re2.createElement($w, null, Re2.createElement("button", { ...c, tabIndex: -1, onClick: d, style: { width: 1, height: 1 } }));
  }
  function dp(r) {
    let l2 = Js2(), { portalContainer: i = l2 ? null : document.body, isExiting: s } = r, [c, d] = S.useState(false), f2 = S.useMemo(() => ({ contain: c, setContain: d }), [c, d]), { getContainer: m2 } = Sw();
    if (!r.portalContainer && m2 && (i = m2()), !i) return null;
    let v = r.children;
    return r.disableFocusManagement || (v = Re2.createElement(By, { restoreFocus: true, contain: (r.shouldContainFocus || c) && !s }, v)), v = Re2.createElement(av.Provider, { value: f2 }, Re2.createElement(Oy, null, v)), fy.createPortal(v, i);
  }
  function Pw() {
    let r = S.useContext(av), l2 = r == null ? void 0 : r.setContain;
    Xe(() => {
      l2 == null || l2(true);
    }, [l2]);
  }
  ...
  function Tw(r) {
    var l2, i, s, c;
    const d = wi2(), [f2, m2] = xu(r, Mf.variantKeys), { ref: v, as: y2, children: g, anchorIcon: x2, isExternal: E = false, showAnchorIcon: _2 = false, autoFocus: I2 = false, className: F, onPress: A2, onPressStart: te2, onPressEnd: re2, onClick: pe2, ...K2 } = f2, ye = y2 || "a", ie2 = Ar2(v), ae2 = (i = (l2 = r == null ? void 0 : r.disableAnimation) != null ? l2 : d == null ? void 0 : d.disableAnimation) != null ? i : false, { linkProps: W } = Zy({ ...K2, onPress: A2, onPressStart: te2, onPressEnd: re2, onClick: pe2, isDisabled: r.isDisabled, elementType: `${y2}` }, ie2), { isFocused: we2, isFocusVisible: Ce2, focusProps: R3 } = lm({ autoFocus: I2 });
    E && (K2.rel = (s = K2.rel) != null ? s : "noopener noreferrer", K2.target = (c = K2.target) != null ? c : "_blank");
    const X2 = S.useMemo(() => Mf({ ...m2, disableAnimation: ae2, className: F }), [qs2(m2), ae2, F]), ve2 = S.useCallback(() => ({ ref: ie2, className: X2, "data-focus": lt2(we2), "data-disabled": lt2(r.isDisabled), "data-focus-visible": lt2(Ce2), ...Io(R3, W, K2) }), [X2, we2, Ce2, R3, W, K2]);
    return { Component: ye, children: g, anchorIcon: x2, showAnchorIcon: _2, getLinkProps: ve2 };
  }
  function pp(r) {
  ...
  function jw(r) {
    const { ref: l2, box: i, onResize: s } = r;
    S.useEffect(() => {
      let c = l2 == null ? void 0 : l2.current;
      if (c) if (Dw()) {
        const d = new window.ResizeObserver((f2) => {
          f2.length && s();
        });
  ...
  function Vw(r) {
    var l2, i;
    const s = wi2(), [c, d] = xu(r, Rf.variantKeys), { ref: f2, as: m2, parentRef: v, height: y2 = "4rem", shouldHideOnScroll: g = false, disableScrollHandler: x2 = false, shouldBlockScroll: E = true, onScrollPositionChange: _2, isMenuOpen: I2, isMenuDefaultOpen: F, onMenuOpenChange: A2 = () => {
    }, motionProps: te2, className: re2, classNames: pe2, ...K2 } = c, ye = m2 || "nav", ie2 = (i = (l2 = r.disableAnimation) != null ? l2 : s == null ? void 0 : s.disableAnimation) != null ? i : false, ae2 = Ar2(f2), W = S.useRef(0), we2 = S.useRef(0), [Ce2, R3] = S.useState(false), X2 = S.useCallback((z2) => {
      A2(z2 || false);
    }, [A2]), [ve2, M] = Bp(I2, F ?? false, X2), G2 = () => {
      if (ae2.current) {
    ...
    yw({ isDisabled: !(E && ve2) }), jw({ ref: ae2, onResize: () => {
      var z2;
      const b2 = (z2 = ae2.current) == null ? void 0 : z2.offsetWidth, N3 = window.innerWidth - document.documentElement.clientWidth;
      b2 && b2 + N3 == W.current || b2 !== W.current && (G2(), M(false));
    } }), S.useEffect(() => {
      var z2;
      G2(), we2.current = ((z2 = ae2.current) == null ? void 0 : z2.offsetHeight) || 0;
    }, []);
    const L3 = S.useMemo(() => Rf({ ...d, disableAnimation: ie2, hideOnScroll: g }), [qs2(d), ie2, g]), H2 = Nn(pe2 == null ? void 0 : pe2.base, re2);
    return Ow({ elementRef: v, isEnabled: g || !x2, callback: ({ prevPos: z2, currPos: b2 }) => {
      _2 == null || _2(b2.y), g && R3((N3) => {
        const U3 = b2.y > z2.y && b2.y > we2.current;
        return U3 !== N3 ? U3 : N3;
      });
    } }), { Component: ye, slots: L3, domRef: ae2, height: y2, isHidden: Ce2, disableAnimation: ie2, shouldHideOnScroll: g, isMenuOpen: ve2, classNames: pe2, setIsMenuOpen: M, motionProps: te2, getBaseProps: (z2 = {}) => ({ ...Io(K2, z2), "data-hidden": lt2(Ce2), "data-menu-open": lt2(ve2), ref: ae2, className: L3.base({ class: Nn(H2, z2 == null ? void 0 : z2.className) }), style: { "--navbar-height": typeof y2 == "number" ? `${y2}px` : y2, ...K2 == null ? void 0 : K2.style, ...z2 == null ? void 0 : z2.style } }), getWrapperProps: (z2 = {}) => ({ ...z2, "data-menu-open": lt2(ve2), className: L3.wrapper({ class: Nn(pe2 == null ? void 0 : pe2.wrapper, z2 == null ? void 0 : z2.className) }) }) };
  }
  function Uw(r, l2) {
    let { elementType: i = "button", isDisabled: s, onPress: c, onPressStart: d, onPressEnd: f2, onPressUp: m2, onPressChange: v, preventFocusOnPress: y2, allowFocusWhenDisabled: g, onClick: x2, href: E, target: _2, rel: I2, type: F = "button", allowTextSelectionOnPress: A2 } = r, te2;
    i === "button" ? te2 = { type: F, disabled: s } : te2 = { role: "button", href: i === "a" && !s ? E : void 0, target: i === "a" ? _2 : void 0, type: i === "input" ? F : void 0, disabled: i === "input" ? s : void 0, "aria-disabled": !s || i === "input" ? void 0 : s, rel: i === "a" ? I2 : void 0 };
    let { pressProps: re2, isPressed: pe2 } = Kp({ onClick: x2, onPressStart: d, onPressEnd: f2, onPressUp: m2, onPressChange: v, onPress: c, isDisabled: s, preventFocusOnPress: y2, allowTextSelectionOnPress: A2, ref: l2 }), { focusableProps: K2 } = nm(r, l2);
  ...
  function Kw(r = {}) {
    const [l2, i] = S.useState([]), s = S.useCallback((d) => {
      const f2 = d.target, m2 = Math.max(f2.clientWidth, f2.clientHeight);
      i((v) => [...v, { key: S0(v.length.toString()), size: m2, x: d.x - m2 / 2, y: d.y - m2 / 2 }]);
    }, []), c = S.useCallback((d) => {
      i((f2) => f2.filter((m2) => m2.key !== d));
    }, []);
    return { ripples: l2, onClear: c, onPress: s, ...r };
  }
  function Qw(r) {
    var l2, i, s, c, d, f2, m2, v, y2;
    const g = Bw(), x2 = wi2(), E = !!g, { ref: _2, as: I2, children: F, startContent: A2, endContent: te2, autoFocus: re2, className: pe2, spinner: K2, isLoading: ye = false, disableRipple: ie2 = false, fullWidth: ae2 = (l2 = g == null ? void 0 : g.fullWidth) != null ? l2 : false, radius: W = g == null ? void 0 : g.radius, size: we2 = (i = g == null ? void 0 : g.size) != null ? i : "md", color: Ce2 = (s = g == null ? void 0 : g.color) != null ? s : "default", variant: R3 = (c = g == null ? void 0 : g.variant) != null ? c : "solid", disableAnimation: X2 = (f2 = (d = g == null ? void 0 : g.disableAnimation) != null ? d : x2 == null ? void 0 : x2.disableAnimation) != null ? f2 : false, isDisabled: ve2 = (m2 = g == null ? void 0 : g.isDisabled) != null ? m2 : false, isIconOnly: M = (v = g == null ? void 0 : g.isIconOnly) != null ? v : false, spinnerPlacement: G2 = "start", onPress: L3, onClick: H2, ...$ } = r, D2 = I2 || "button", z2 = typeof D2 == "string", b2 = Ar2(_2), N3 = (y2 = ie2 || (x2 == null ? void 0 : x2.disableRipple)) != null ? y2 : X2, { isFocusVisible: U3, isFocused: ne2, focusProps: se } = lm({ autoFocus: re2 }), ue2 = ve2 || ye, ce2 = S.useMemo(() => k0({ size: we2, color: Ce2, variant: R3, radius: W, fullWidth: ae2, isDisabled: ue2, isInGroup: E, disableAnimation: X2, isIconOnly: M, className: pe2 }), [we2, Ce2, R3, W, ae2, ue2, E, M, X2, pe2]), { onPress: ke, onClear: Ee2, ripples: Oe2 } = Kw(), Ft = S.useCallback((Pt) => {
      N3 || ue2 || X2 || b2.current && ke(Pt);
    }, [N3, ue2, X2, b2, ke]), { buttonProps: At2, isPressed: Ln } = Uw({ elementType: I2, isDisabled: ue2, onPress: Np(L3, Ft), onClick: H2, ...$ }, b2), { isHovered: Jn2, hoverProps: Or3 } = Vy({ isDisabled: ue2 }), Ao = S.useCallback((Pt = {}) => ({ "data-disabled": lt2(ue2), "data-focus": lt2(ne2), "data-pressed": lt2(Ln), "data-focus-visible": lt2(U3), "data-hover": lt2(Jn2), "data-loading": lt2(ye), ...Io(At2, se, Or3, qf($, { enabled: z2 }), qf(Pt)), className: ce2 }), [ye, ue2, ne2, Ln, z2, U3, Jn2, At2, se, Or3, $, ce2]), er2 = (Pt) => S.isValidElement(Pt) ? S.cloneElement(Pt, { "aria-hidden": true, focusable: false }) : null, Oo = er2(A2), Dr2 = er2(te2), _n = S.useMemo(() => ({ sm: "sm", md: "sm", lg: "md" })[we2], [we2]), on3 = S.useCallback(() => ({ ripples: Oe2, onClear: Ee2 }), [Oe2, Ee2]);
    return { Component: D2, children: F, domRef: b2, spinner: K2, styles: ce2, startContent: Oo, endContent: Dr2, isLoading: ye, spinnerPlacement: G2, spinnerSize: _n, disableRipple: N3, getButtonProps: Ao, getRippleProps: on3, isIconOnly: M };
  }
  function Yw(r) {
    var l2, i;
    const [s, c] = xu(r, _f.variantKeys), d = wi2(), f2 = (i = (l2 = r == null ? void 0 : r.variant) != null ? l2 : d == null ? void 0 : d.spinnerVariant) != null ? i : "default", { children: m2, className: v, classNames: y2, label: g, ...x2 } = s, E = S.useMemo(() => _f({ ...c }), [qs2(c)]), _2 = Nn(y2 == null ? void 0 : y2.base, v), I2 = g || m2, F = S.useMemo(() => I2 && typeof I2 == "string" ? I2 : x2["aria-label"] ? "" : "Loading", [m2, I2, x2["aria-label"]]), A2 = S.useCallback(() => ({ "aria-label": F, className: E.base({ class: _2 }), ...x2 }), [F, E, _2, x2]);
    return { label: I2, slots: E, classNames: y2, variant: f2, getSpinnerProps: A2 };
  }
  function Sb(r, l2) {
    ...
    return S.useEffect(() => {
      if (l2.current && !l2.current.contains(document.activeElement)) {
        di2(l2.current);
        let d = setTimeout(() => {
          (document.activeElement === l2.current || document.activeElement === document.body) && (c.current = true, l2.current && (l2.current.blur(), di2(l2.current)), c.current = false);
        }, 500);
        return () => {
          clearTimeout(d);
        };
      }
    }, [l2]), Pw(), { dialogProps: { ...eu(r, { labelable: true }), role: i, tabIndex: -1, "aria-labelledby": r["aria-labelledby"] || s, onBlur: (d) => {
      c.current && d.stopPropagation();
    } }, titleProps: { id: s } };
  }
  function Eb(r, l2) {
    const { disableOutsideEvents: i = true, isDismissable: s = false, isKeyboardDismissDisabled: c = false, isOpen: d, onClose: f2, shouldCloseOnBlur: m2, shouldCloseOnInteractOutside: v } = r;
    S.useEffect(() => {
      if (d && !Ut2.includes(l2)) return Ut2.push(l2), () => {
        let A2 = Ut2.indexOf(l2);
        A2 >= 0 && Ut2.splice(A2, 1);
      };
    }, [d, l2]);
    const y2 = () => {
      Ut2[Ut2.length - 1] === l2 && f2 && f2();
    }, g = (A2) => {
      (!v || v(A2.target)) && (Ut2[Ut2.length - 1] === l2 && i && (A2.stopPropagation(), A2.preventDefault()), F(l2) !== "pressEnd" && y2());
    }, x2 = (A2) => {
      (!v || v(A2.target)) && (Ut2[Ut2.length - 1] === l2 && i && (A2.stopPropagation(), A2.preventDefault()), y2());
    }, E = (A2) => {
      A2.key === "Escape" && !c && !A2.nativeEvent.isComposing && (A2.stopPropagation(), A2.preventDefault(), y2());
    };
    Hy({ isDisabled: !(s && d), onInteractOutside: s && d ? x2 : void 0, onInteractOutsideStart: g, ref: l2 });
    const { focusWithinProps: _2 } = cu({ isDisabled: !m2, onBlurWithin: (A2) => {
      !A2.relatedTarget || Ky(A2.relatedTarget) || (!v || v(A2.relatedTarget)) && y2();
    } }), I2 = (A2) => {
    ...
    return { overlayProps: { onKeyDown: E, ..._2 }, underlayProps: { onPointerDown: I2 } };
  }
  function $b(r) {
    let [l2, i] = Bp(r.isOpen, r.defaultOpen || false, r.onOpenChange);
    ...
    return { isOpen: l2, setOpen: i, open: s, close: c, toggle: d };
  }
  var __vite__mapDeps, ps2, $o, ms2, xe2, vf, hf, gf, yf, Y2, S, Re2, Kl, vs2, dt2, hs2, gs2, wf, bf, xf, kf, Sf, wg, Zw, bg, xg, kg, Sg, Eg, $g, Cg, ge, Pg, Tg, Ng, Lg, Bt2, _g, Mg, Ql, Ef, Rg, Ts2, si2, $f, ft2, zg, Cf, vp, hp, Ns2, Ig, en2, Ag, Xs2, Og, gp, Pf, Dg, jg, Ls2, Tf, Vg, Hg, _s2, Ms2, Bg, Ug, Wg, Gg, Kg, Qg, Yg, yp, Ge2, wp, bp, Zg, qg, Jg, e0, t0, n0, $r, be2, $n, ys2, Jt2, r0, o0, xp, l0, i0, a0, s0, J2, Wn, ws2, Nf, u0, Yl, ee, Co, c0, Lf, d0, f0, Xl, zr, Ir2, kp, Sp, Ep, $p, p0, m0, Cp, zs2, v0, To, Zl, ql, Pp, h0, g0, y0, w0, b0, zo, _f, Zs2, Cr2, Mf, x0, Rf, k0, lt2, zf, Xe, bs2, C0, Lp, _p, T0, xs2, M0, F0, Nr2, No, Te2, It2, V0, mt2, H0, W0, G0, K0, Q0, Ff, Y0, Jl, Mr2, J0, zp, yi2, lb, ey, Ip, nu, ty, ny, Cn, Is2, dy, fy, py, lu, hy, gy, ui2, Tr2, Fs2, ai2, au, ei2, ti2, Vf, Hf, Bf, Ty, Fr2, As2, Mo, Xn2, Os2, Ny, qp, My, Fy, js2, ni2, Qf, Vs2, Le2, du, Bs2, Be2, qy, Jy, e1, Zf, t1, ri2, ib, wi2, n1, r1, l1, Us2, _o, a1, u1, c1, Pr2, bi2, ep, tp, p1, np, am, sm, um, xi2, g1, cm, w1, b1, ab, x1, mu, Ws, oi2, Fo, Kn, Ss, he, sb, ub, rp, ki, dm, op, k1, fm, pm, Zn, vu, E1, C1, li2, mm, hu, ip, pi, N1, vm, Si2, M1, R1, A1, O1, D1, wu, U1, W1, bm, Q1, X1, km, nw, ow, lw, aw, sw, uw, cw, bu, Cs2, gw, ii2, Ps2, kw, Cm, Pm, Tm, Nm, Lm, _m, Mm, Rm, zm, Im, Fm, Am, Om, Dm, jm, Vm, Hm, Bm, Um, Wm, Gm, Km, Qm, Ym, Xm, Zm, qm, Jm, ev, tv, nv, rv, ov, lv, iv, cp, av, xu, Nw, sv, db, Lw, _w, fp, ku, Mw, Su, Rw, zw, uv, Iw, vi2, fb, Fw, Aw, Ow, Hw, cv, pb, dv, mb, fv, vb, hb, Bw, Ww, pv, Gw, mv, Xw, vv, gb, yb, wb, bb, Ut2;
  var init_useOverlayTriggerState_chunk = __esm({
    "dist/useOverlayTriggerState-chunk.js"() {
      "use strict";
      __vite__mapDeps = (i, m2 = __vite__mapDeps, d = m2.f || (m2.f = ["index-chunk.js", "index-chunk2.js"])) => i.map((i2) => d[i2]);
      ps2 = { exports: {} };
      $o = {};
      ms2 = { exports: {} };
      xe2 = {};
      ...
      si2 = (...r) => {
        let l2 = [], i = (s) => {
          ...
          if (Array.isArray(s)) {
            for (let d = 0, f2 = s.length; d < f2; d++) i(s[d]);
            return;
          }
          let c = typeof s;
          if (c === "string" || c === "number" || c === "bigint") {
            ...
            let d = Object.keys(s);
            for (let f2 = 0, m2 = d.length; f2 < m2; f2++) {
              let v = d[f2];
              s[v] && l2.push(v);
            }
          }
        ...
        return l2.length > 0 ? Ts2(l2.join(" ")) : void 0;
      };
      $f = (r) => r === false ? "false" : r === true ? "true" : r === 0 ? "0" : r;
      ft2 = (r) => {
        if (!r || typeof r != "object") return true;
        for (let l2 in r) return false;
        return true;
      };
      zg = (r, l2) => {
        if (r === l2) return true;
        if (!r || !l2) return false;
        let i = Object.keys(r), s = Object.keys(l2);
        if (i.length !== s.length) return false;
        for (let c = 0; c < i.length; c++) {
          let d = i[c];
          if (!s.includes(d) || r[d] !== l2[d]) return false;
        }
        return true;
      };
      Cf = (r, l2) => {
        for (let i in l2) if (Object.prototype.hasOwnProperty.call(l2, i)) {
          let s = l2[i];
      ...
      vp = (r, l2) => {
        for (let i = 0; i < r.length; i++) {
          let s = r[i];
          Array.isArray(s) ? vp(s, l2) : s && l2.push(s);
        }
      };
      hp = (...r) => {
        let l2 = [];
        vp(r, l2);
        let i = [];
        for (let s = 0; s < l2.length; s++) l2[s] && i.push(l2[s]);
        return i;
      };
      Ns2 = (r, l2) => {
        let i = {};
        ...
        for (let s in l2) s in r || (i[s] = l2[s]);
        return i;
      };
      ...
      Ag = (r) => {
        let l2 = (i, s) => {
          let { extend: c = null, slots: d = {}, variants: f2 = {}, compoundVariants: m2 = [], compoundSlots: v = [], defaultVariants: y2 = {} } = i, g = { ...Ig, ...s }, x2 = c != null && c.base ? si2(c.base, i == null ? void 0 : i.base) : i == null ? void 0 : i.base, E = c != null && c.variants && !ft2(c.variants) ? Ns2(f2, c.variants) : f2, _2 = c != null && c.defaultVariants && !ft2(c.defaultVariants) ? { ...c.defaultVariants, ...y2 } : y2;
          ...
          let I2 = ft2(c == null ? void 0 : c.slots), F = ft2(d) ? {} : { base: si2(i == null ? void 0 : i.base, I2 && (c == null ? void 0 : c.base)), ...d }, A2 = I2 ? F : Cf({ ...c == null ? void 0 : c.slots }, ft2(F) ? { base: i == null ? void 0 : i.base } : F), te2 = ft2(c == null ? void 0 : c.compoundVariants) ? m2 : hp(c == null ? void 0 : c.compoundVariants, m2), re2 = (K2) => {
            if (ft2(E) && ft2(d) && I2) return r(x2, K2 == null ? void 0 : K2.class, K2 == null ? void 0 : K2.className)(g);
            ...
            let ye = (M, G2, L3 = [], H2) => {
              ...
              if (typeof G2 == "string") {
                let D2 = Ts2(G2).split(" ");
                for (let z2 = 0; z2 < D2.length; z2++) $.push(`${M}:${D2[z2]}`);
              } else if (Array.isArray(G2)) for (let D2 = 0; D2 < G2.length; D2++) $.push(`${M}:${G2[D2]}`);
              else if (typeof G2 == "object" && typeof H2 == "string" && H2 in G2) {
                let D2 = G2[H2];
                if (D2 && typeof D2 == "string") {
                  let z2 = Ts2(D2).split(" "), b2 = [];
                  for (let N3 = 0; N3 < z2.length; N3++) b2.push(`${M}:${z2[N3]}`);
                  $[H2] = $[H2] ? $[H2].concat(b2) : b2;
                } else if (Array.isArray(D2) && D2.length > 0) {
                  let z2 = [];
                  for (let b2 = 0; b2 < D2.length; b2++) z2.push(`${M}:${D2[b2]}`);
                  $[H2] = z2;
                }
              }
              return $;
            }, ie2 = (M, G2 = E, L3 = null, H2 = null) => {
              let $ = G2[M];
              if (!$ || ft2($)) return null;
              let D2 = (H2 == null ? void 0 : H2[M]) ?? (K2 == null ? void 0 : K2[M]);
              if (D2 === null) return null;
              let z2 = $f(D2), b2 = Array.isArray(g.responsiveVariants) && g.responsiveVariants.length > 0 || g.responsiveVariants === true, N3 = _2 == null ? void 0 : _2[M], U3 = [];
              if (typeof z2 == "object" && b2) for (let [ue2, ce2] of Object.entries(z2)) {
                let ke = $[ce2];
                if (ue2 === "initial") {
                  N3 = ce2;
                  continue;
              ...
              let ne2 = z2 != null && typeof z2 != "object" ? z2 : $f(N3), se = $[ne2 || "false"];
              return typeof U3 == "object" && typeof L3 == "string" && U3[L3] ? Cf(U3, se) : U3.length > 0 ? (U3.push(se), L3 === "base" ? U3.join(" ") : U3) : se;
            }, ae2 = () => {
              if (!E) return null;
              let M = Object.keys(E), G2 = [];
              for (let L3 = 0; L3 < M.length; L3++) {
                let H2 = ie2(M[L3], E);
                H2 && G2.push(H2);
              }
              return G2;
              ...
              let L3 = [];
              for (let H2 in E) {
                let $ = ie2(H2, E, M, G2), D2 = M === "base" && typeof $ == "string" ? $ : $ && $[M];
                D2 && L3.push(D2);
              }
              return L3;
            }, we2 = {};
            ...
            let Ce2 = (M, G2) => {
              var H2;
              let L3 = typeof (K2 == null ? void 0 : K2[M]) == "object" ? { [M]: (H2 = K2[M]) == null ? void 0 : H2.initial } : {};
              return { ..._2, ...we2, ...L3, ...G2 };
            }, R3 = (M = [], G2) => {
              let L3 = [], H2 = M.length;
              for (let $ = 0; $ < H2; $++) {
                let { class: D2, className: z2, ...b2 } = M[$], N3 = true, U3 = Ce2(null, G2);
                for (let ne2 in b2) {
                  let se = b2[ne2], ue2 = U3[ne2];
                  if (Array.isArray(se)) {
                    if (!se.includes(ue2)) {
                      N3 = false;
                      break;
              ...
              for (let $ = 0; $ < G2.length; $++) {
                let D2 = G2[$];
                if (typeof D2 == "string") L3.base = H2(L3.base, D2)(g);
                else if (typeof D2 == "object") for (let z2 in D2) L3[z2] = H2(L3[z2], D2[z2])(g);
              }
              return L3;
            }, ve2 = (M) => {
              if (v.length < 1) return null;
              let G2 = {}, L3 = Ce2(null, M);
              for (let H2 = 0; H2 < v.length; H2++) {
                let { slots: $ = [], class: D2, className: z2, ...b2 } = v[H2];
                if (!ft2(b2)) {
                  let N3 = true;
                  for (let U3 in b2) {
                    let ne2 = L3[U3], se = b2[U3];
            ...
            if (!ft2(d) || !I2) {
              ...
              if (typeof A2 == "object" && !ft2(A2)) {
                let G2 = r;
                for (let L3 in A2) M[L3] = (H2) => {
                  let $ = X2(H2), D2 = ve2(H2);
                  return G2(A2[L3], W(L3, H2), $ ? $[L3] : void 0, D2 ? D2[L3] : void 0, H2 == null ? void 0 : H2.class, H2 == null ? void 0 : H2.className)(g);
                };
              }
              return M;
            }
            return r(x2, ae2(), R3(te2), K2 == null ? void 0 : K2.class, K2 == null ? void 0 : K2.className)(g);
          }, pe2 = () => {
            if (!(!E || typeof E != "object")) return Object.keys(E);
          };
          return re2.variantKeys = pe2(), re2.extend = c, re2.base = x2, re2.slots = A2, re2.variants = E, re2.defaultVariants = _2, re2.compoundSlots = v, re2.compoundVariants = te2, re2;
        };
        return { tv: l2, createTV: (i) => (s, c) => l2(s, c ? Ns2(i, c) : i) };
      };
      Xs2 = "-";
      Og = (r) => {
        const l2 = jg(r), { conflictingClassGroups: i, conflictingClassGroupModifiers: s } = r;
        return { getClassGroupId: (f2) => {
          const m2 = f2.split(Xs2);
          return m2[0] === "" && m2.length !== 1 && m2.shift(), gp(m2, l2) || Dg(f2);
        }, getConflictingClassGroupIds: (f2, m2) => {
          const v = i[f2] || [];
          return m2 && s[f2] ? [...v, ...s[f2]] : v;
        } };
      };
      gp = (r, l2) => {
        var f2;
        if (r.length === 0) return l2.classGroupId;
        const i = r[0], s = l2.nextPart.get(i), c = s ? gp(r.slice(1), s) : void 0;
        if (c) return c;
        if (l2.validators.length === 0) return;
        const d = r.join(Xs2);
        return (f2 = l2.validators.find(({ validator: m2 }) => m2(d))) == null ? void 0 : f2.classGroupId;
      };
      Pf = /^\[(.+)\]$/;
      Dg = (r) => {
        if (Pf.test(r)) {
          const l2 = Pf.exec(r)[1], i = l2 == null ? void 0 : l2.substring(0, l2.indexOf(":"));
          if (i) return "arbitrary.." + i;
        }
      };
      jg = (r) => {
        const { theme: l2, classGroups: i } = r, s = { nextPart: /* @__PURE__ */ new Map(), validators: [] };
        for (const c in i) Ls2(i[c], s, c, l2);
        return s;
      };
      Ls2 = (r, l2, i, s) => {
        r.forEach((c) => {
          if (typeof c == "string") {
            const d = c === "" ? l2 : Tf(l2, c);
            d.classGroupId = i;
            return;
          }
          if (typeof c == "function") {
            ...
            l2.validators.push({ validator: c, classGroupId: i });
            return;
          }
          Object.entries(c).forEach(([d, f2]) => {
            Ls2(f2, Tf(l2, d), i, s);
          });
        });
      };
      ...
      Hg = (r) => {
        ...
        let l2 = 0, i = /* @__PURE__ */ new Map(), s = /* @__PURE__ */ new Map();
        const c = (d, f2) => {
          i.set(d, f2), l2++, l2 > r && (l2 = 0, s = i, i = /* @__PURE__ */ new Map());
        };
        return { get(d) {
          let f2 = i.get(d);
          if (f2 !== void 0) return f2;
          if ((f2 = s.get(d)) !== void 0) return c(d, f2), f2;
        }, set(d, f2) {
          i.has(d) ? i.set(d, f2) : c(d, f2);
        } };
      };
      _s2 = "!";
      Ms2 = ":";
      Bg = Ms2.length;
      Ug = (r) => {
        const { prefix: l2, experimentalParseClassName: i } = r;
        let s = (c) => {
          const d = [];
          let f2 = 0, m2 = 0, v = 0, y2;
          ...
          const g = d.length === 0 ? c : c.substring(v), x2 = Wg(g), E = x2 !== g, _2 = y2 && y2 > v ? y2 - v : void 0;
          return { modifiers: d, hasImportantModifier: E, baseClassName: x2, maybePostfixModifierPosition: _2 };
        };
        if (l2) {
          const c = l2 + Ms2, d = s;
          s = (f2) => f2.startsWith(c) ? d(f2.substring(c.length)) : { isExternal: true, modifiers: [], hasImportantModifier: false, baseClassName: f2, maybePostfixModifierPosition: void 0 };
        }
        if (i) {
          const c = s;
      ...
      Wg = (r) => r.endsWith(_s2) ? r.substring(0, r.length - 1) : r.startsWith(_s2) ? r.substring(1) : r;
      Gg = (r) => {
        const l2 = Object.fromEntries(r.orderSensitiveModifiers.map((s) => [s, true]));
        return (s) => {
          if (s.length <= 1) return s;
          const c = [];
          let d = [];
          return s.forEach((f2) => {
            f2[0] === "[" || l2[f2] ? (c.push(...d.sort(), f2), d = []) : d.push(f2);
          }), c.push(...d.sort()), c;
        };
      };
      ...
      Qg = /\s+/;
      Yg = (r, l2) => {
        const { parseClassName: i, getClassGroupId: s, getConflictingClassGroupIds: c, sortModifiers: d } = l2, f2 = [], m2 = r.trim().split(Qg);
        let v = "";
        for (let y2 = m2.length - 1; y2 >= 0; y2 -= 1) {
          const g = m2[y2], { isExternal: x2, modifiers: E, hasImportantModifier: _2, baseClassName: I2, maybePostfixModifierPosition: F } = i(g);
          if (x2) {
            v = g + (v.length > 0 ? " " + v : v);
            continue;
          }
          ...
          const re2 = d(E).join(":"), pe2 = _2 ? re2 + _s2 : re2, K2 = pe2 + te2;
          if (f2.includes(K2)) continue;
          f2.push(K2);
          const ye = c(te2, A2);
      ...
      yp = (r) => {
        ...
        let l2, i = "";
        for (let s = 0; s < r.length; s++) r[s] && (l2 = yp(r[s])) && (i && (i += " "), i += l2);
        return i;
      };
      Ge2 = (r) => {
        const l2 = (i) => i[r] || [];
        return l2.isThemeGetter = true, l2;
      };
      wp = /^\[(?:(\w[\w-]*):)?(.+)\]$/i;
      bp = /^\((?:(\w[\w-]*):)?(.+)\)$/i;
      Zg = /^\d+\/\d+$/;
      ...
      zr = (r, l2, i) => {
        const s = wp.exec(r);
        return s ? s[1] ? l2(s[1]) : i(s[2]) : false;
      };
      Ir2 = (r, l2, i = false) => {
        const s = bp.exec(r);
        return s ? s[1] ? l2(s[1]) : i : false;
      };
      ...
      Cp = (r) => r === "shadow";
      zs2 = () => {
        const r = Ge2("color"), l2 = Ge2("font"), i = Ge2("text"), s = Ge2("font-weight"), c = Ge2("tracking"), d = Ge2("leading"), f2 = Ge2("breakpoint"), m2 = Ge2("container"), v = Ge2("spacing"), y2 = Ge2("radius"), g = Ge2("shadow"), x2 = Ge2("inset-shadow"), E = Ge2("text-shadow"), _2 = Ge2("drop-shadow"), I2 = Ge2("blur"), F = Ge2("perspective"), A2 = Ge2("aspect"), te2 = Ge2("ease"), re2 = Ge2("animate"), pe2 = () => ["auto", "avoid", "all", "avoid-page", "page", "left", "right", "column"], K2 = () => ["center", "top", "bottom", "left", "right", "top-left", "left-top", "top-right", "right-top", "bottom-right", "right-bottom", "bottom-left", "left-bottom"], ye = () => [...K2(), ee, J2], ie2 = () => ["auto", "hidden", "clip", "visible", "scroll"], ae2 = () => ["auto", "contain", "none"], W = () => [ee, J2, v], we2 = () => [$r, "full", "auto", ...W()], Ce2 = () => [$n, "none", "subgrid", ee, J2], R3 = () => ["auto", { span: ["full", $n, ee, J2] }, $n, ee, J2], X2 = () => [$n, "auto", ee, J2], ve2 = () => ["auto", "min", "max", "fr", ee, J2], M = () => ["start", "end", "center", "between", "around", "evenly", "stretch", "baseline", "center-safe", "end-safe"], G2 = () => ["start", "end", "center", "stretch", "center-safe", "end-safe"], L3 = () => ["auto", ...W()], H2 = () => [$r, "auto", "full", "dvw", "dvh", "lvw", "lvh", "svw", "svh", "min", "max", "fit", ...W()], $ = () => [r, ee, J2], D2 = () => [...K2(), Lf, Nf, { position: [ee, J2] }], z2 = () => ["no-repeat", { repeat: ["", "x", "y", "space", "round"] }], b2 = () => ["auto", "cover", "contain", d0, s0, { size: [ee, J2] }], N3 = () => [ys2, Co, Wn], U3 = () => ["", "none", "full", y2, ee, J2], ne2 = () => ["", be2, Co, Wn], se = () => ["solid", "dashed", "dotted", "double"], ue2 = () => ["normal", "multiply", "screen", "overlay", "darken", "lighten", "color-dodge", "color-burn", "hard-light", "soft-light", "difference", "exclusion", "hue", "saturation", "color", "luminosity"], ce2 = () => [be2, ys2, Lf, Nf], ke = () => ["", "none", I2, ee, J2], Ee2 = () => ["none", be2, ee, J2], Oe2 = () => ["none", be2, ee, J2], Ft = () => [be2, ee, J2], At2 = () => [$r, "full", ...W()];
        return { cacheSize: 500, theme: { animate: ["spin", "ping", "pulse", "bounce"], aspect: ["video"], blur: [Jt2], breakpoint: [Jt2], color: [r0], container: [Jt2], "drop-shadow": [Jt2], ease: ["in", "out", "in-out"], font: [a0], "font-weight": ["thin", "extralight", "light", "normal", "medium", "semibold", "bold", "extrabold", "black"], "inset-shadow": [Jt2], leading: ["none", "tight", "snug", "normal", "relaxed", "loose"], perspective: ["dramatic", "near", "normal", "midrange", "distant", "none"], radius: [Jt2], shadow: [Jt2], spacing: ["px", be2], text: [Jt2], "text-shadow": [Jt2], tracking: ["tighter", "tight", "normal", "wide", "wider", "widest"] }, classGroups: { aspect: [{ aspect: ["auto", "square", $r, J2, ee, A2] }], container: ["container"], columns: [{ columns: [be2, J2, ee, m2] }], "break-after": [{ "break-after": pe2() }], "break-before": [{ "break-before": pe2() }], "break-inside": [{ "break-inside": ["auto", "avoid", "avoid-page", "avoid-column"] }], "box-decoration": [{ "box-decoration": ["slice", "clone"] }], box: [{ box: ["border", "content"] }], display: ["block", "inline-block", "inline", "flex", "inline-flex", "table", "inline-table", "table-caption", "table-cell", "table-column", "table-column-group", "table-footer-group", "table-header-group", "table-row-group", "table-row", "flow-root", "grid", "inline-grid", "contents", "list-item", "hidden"], sr: ["sr-only", "not-sr-only"], float: [{ float: ["right", "left", "none", "start", "end"] }], clear: [{ clear: ["left", "right", "both", "none", "start", "end"] }], isolation: ["isolate", "isolation-auto"], "object-fit": [{ object: ["contain", "cover", "fill", "none", "scale-down"] }], "object-position": [{ object: ye() }], overflow: [{ overflow: ie2() }], "overflow-x": [{ "overflow-x": ie2() }], "overflow-y": [{ "overflow-y": ie2() }], overscroll: [{ overscroll: ae2() }], "overscroll-x": [{ "overscroll-x": ae2() }], "overscroll-y": [{ "overscroll-y": ae2() }], position: ["static", "fixed", "absolute", "relative", "sticky"], inset: [{ inset: we2() }], "inset-x": [{ "inset-x": we2() }], "inset-y": [{ "inset-y": we2() }], start: [{ start: we2() }], end: [{ end: we2() }], top: [{ top: we2() }], right: [{ right: we2() }], bottom: [{ bottom: we2() }], left: [{ left: we2() }], visibility: ["visible", "invisible", "collapse"], z: [{ z: [$n, "auto", ee, J2] }], basis: [{ basis: [$r, "full", "auto", m2, ...W()] }], "flex-direction": [{ flex: ["row", "row-reverse", "col", "col-reverse"] }], "flex-wrap": [{ flex: ["nowrap", "wrap", "wrap-reverse"] }], flex: [{ flex: [be2, $r, "auto", "initial", "none", J2] }], grow: [{ grow: ["", be2, ee, J2] }], shrink: [{ shrink: ["", be2, ee, J2] }], order: [{ order: [$n, "first", "last", "none", ee, J2] }], "grid-cols": [{ "grid-cols": Ce2() }], "col-start-end": [{ col: R3() }], "col-start": [{ "col-start": X2() }], "col-end": [{ "col-end": X2() }], "grid-rows": [{ "grid-rows": Ce2() }], "row-start-end": [{ row: R3() }], "row-start": [{ "row-start": X2() }], "row-end": [{ "row-end": X2() }], "grid-flow": [{ "grid-flow": ["row", "col", "dense", "row-dense", "col-dense"] }], "auto-cols": [{ "auto-cols": ve2() }], "auto-rows": [{ "auto-rows": ve2() }], gap: [{ gap: W() }], "gap-x": [{ "gap-x": W() }], "gap-y": [{ "gap-y": W() }], "justify-content": [{ justify: [...M(), "normal"] }], "justify-items": [{ "justify-items": [...G2(), "normal"] }], "justify-self": [{ "justify-self": ["auto", ...G2()] }], "align-content": [{ content: ["normal", ...M()] }], "align-items": [{ items: [...G2(), { baseline: ["", "last"] }] }], "align-self": [{ self: ["auto", ...G2(), { baseline: ["", "last"] }] }], "place-content": [{ "place-content": M() }], "place-items": [{ "place-items": [...G2(), "baseline"] }], "place-self": [{ "place-self": ["auto", ...G2()] }], p: [{ p: W() }], px: [{ px: W() }], py: [{ py: W() }], ps: [{ ps: W() }], pe: [{ pe: W() }], pt: [{ pt: W() }], pr: [{ pr: W() }], pb: [{ pb: W() }], pl: [{ pl: W() }], m: [{ m: L3() }], mx: [{ mx: L3() }], my: [{ my: L3() }], ms: [{ ms: L3() }], me: [{ me: L3() }], mt: [{ mt: L3() }], mr: [{ mr: L3() }], mb: [{ mb: L3() }], ml: [{ ml: L3() }], "space-x": [{ "space-x": W() }], "space-x-reverse": ["space-x-reverse"], "space-y": [{ "space-y": W() }], "space-y-reverse": ["space-y-reverse"], size: [{ size: H2() }], w: [{ w: [m2, "screen", ...H2()] }], "min-w": [{ "min-w": [m2, "screen", "none", ...H2()] }], "max-w": [{ "max-w": [m2, "screen", "none", "prose", { screen: [f2] }, ...H2()] }], h: [{ h: ["screen", "lh", ...H2()] }], "min-h": [{ "min-h": ["screen", "lh", "none", ...H2()] }], "max-h": [{ "max-h": ["screen", "lh", ...H2()] }], "font-size": [{ text: ["base", i, Co, Wn] }], "font-smoothing": ["antialiased", "subpixel-antialiased"], "font-style": ["italic", "not-italic"], "font-weight": [{ font: [s, ee, ws2] }], "font-stretch": [{ "font-stretch": ["ultra-condensed", "extra-condensed", "condensed", "semi-condensed", "normal", "semi-expanded", "expanded", "extra-expanded", "ultra-expanded", ys2, J2] }], "font-family": [{ font: [c0, J2, l2] }], "fvn-normal": ["normal-nums"], "fvn-ordinal": ["ordinal"], "fvn-slashed-zero": ["slashed-zero"], "fvn-figure": ["lining-nums", "oldstyle-nums"], "fvn-spacing": ["proportional-nums", "tabular-nums"], "fvn-fraction": ["diagonal-fractions", "stacked-fractions"], tracking: [{ tracking: [c, ee, J2] }], "line-clamp": [{ "line-clamp": [be2, "none", ee, ws2] }], leading: [{ leading: [d, ...W()] }], "list-image": [{ "list-image": ["none", ee, J2] }], "list-style-position": [{ list: ["inside", "outside"] }], "list-style-type": [{ list: ["disc", "decimal", "none", ee, J2] }], "text-alignment": [{ text: ["left", "center", "right", "justify", "start", "end"] }], "placeholder-color": [{ placeholder: $() }], "text-color": [{ text: $() }], "text-decoration": ["underline", "overline", "line-through", "no-underline"], "text-decoration-style": [{ decoration: [...se(), "wavy"] }], "text-decoration-thickness": [{ decoration: [be2, "from-font", "auto", ee, Wn] }], "text-decoration-color": [{ decoration: $() }], "underline-offset": [{ "underline-offset": [be2, "auto", ee, J2] }], "text-transform": ["uppercase", "lowercase", "capitalize", "normal-case"], "text-overflow": ["truncate", "text-ellipsis", "text-clip"], "text-wrap": [{ text: ["wrap", "nowrap", "balance", "pretty"] }], indent: [{ indent: W() }], "vertical-align": [{ align: ["baseline", "top", "middle", "bottom", "text-top", "text-bottom", "sub", "super", ee, J2] }], whitespace: [{ whitespace: ["normal", "nowrap", "pre", "pre-line", "pre-wrap", "break-spaces"] }], break: [{ break: ["normal", "words", "all", "keep"] }], wrap: [{ wrap: ["break-word", "anywhere", "normal"] }], hyphens: [{ hyphens: ["none", "manual", "auto"] }], content: [{ content: ["none", ee, J2] }], "bg-attachment": [{ bg: ["fixed", "local", "scroll"] }], "bg-clip": [{ "bg-clip": ["border", "padding", "content", "text"] }], "bg-origin": [{ "bg-origin": ["border", "padding", "content"] }], "bg-position": [{ bg: D2() }], "bg-repeat": [{ bg: z2() }], "bg-size": [{ bg: b2() }], "bg-image": [{ bg: ["none", { linear: [{ to: ["t", "tr", "r", "br", "b", "bl", "l", "tl"] }, $n, ee, J2], radial: ["", ee, J2], conic: [$n, ee, J2] }, f0, u0] }], "bg-color": [{ bg: $() }], "gradient-from-pos": [{ from: N3() }], "gradient-via-pos": [{ via: N3() }], "gradient-to-pos": [{ to: N3() }], "gradient-from": [{ from: $() }], "gradient-via": [{ via: $() }], "gradient-to": [{ to: $() }], rounded: [{ rounded: U3() }], "rounded-s": [{ "rounded-s": U3() }], "rounded-e": [{ "rounded-e": U3() }], "rounded-t": [{ "rounded-t": U3() }], "rounded-r": [{ "rounded-r": U3() }], "rounded-b": [{ "rounded-b": U3() }], "rounded-l": [{ "rounded-l": U3() }], "rounded-ss": [{ "rounded-ss": U3() }], "rounded-se": [{ "rounded-se": U3() }], "rounded-ee": [{ "rounded-ee": U3() }], "rounded-es": [{ "rounded-es": U3() }], "rounded-tl": [{ "rounded-tl": U3() }], "rounded-tr": [{ "rounded-tr": U3() }], "rounded-br": [{ "rounded-br": U3() }], "rounded-bl": [{ "rounded-bl": U3() }], "border-w": [{ border: ne2() }], "border-w-x": [{ "border-x": ne2() }], "border-w-y": [{ "border-y": ne2() }], "border-w-s": [{ "border-s": ne2() }], "border-w-e": [{ "border-e": ne2() }], "border-w-t": [{ "border-t": ne2() }], "border-w-r": [{ "border-r": ne2() }], "border-w-b": [{ "border-b": ne2() }], "border-w-l": [{ "border-l": ne2() }], "divide-x": [{ "divide-x": ne2() }], "divide-x-reverse": ["divide-x-reverse"], "divide-y": [{ "divide-y": ne2() }], "divide-y-reverse": ["divide-y-reverse"], "border-style": [{ border: [...se(), "hidden", "none"] }], "divide-style": [{ divide: [...se(), "hidden", "none"] }], "border-color": [{ border: $() }], "border-color-x": [{ "border-x": $() }], "border-color-y": [{ "border-y": $() }], "border-color-s": [{ "border-s": $() }], "border-color-e": [{ "border-e": $() }], "border-color-t": [{ "border-t": $() }], "border-color-r": [{ "border-r": $() }], "border-color-b": [{ "border-b": $() }], "border-color-l": [{ "border-l": $() }], "divide-color": [{ divide: $() }], "outline-style": [{ outline: [...se(), "none", "hidden"] }], "outline-offset": [{ "outline-offset": [be2, ee, J2] }], "outline-w": [{ outline: ["", be2, Co, Wn] }], "outline-color": [{ outline: $() }], shadow: [{ shadow: ["", "none", g, Xl, Yl] }], "shadow-color": [{ shadow: $() }], "inset-shadow": [{ "inset-shadow": ["none", x2, Xl, Yl] }], "inset-shadow-color": [{ "inset-shadow": $() }], "ring-w": [{ ring: ne2() }], "ring-w-inset": ["ring-inset"], "ring-color": [{ ring: $() }], "ring-offset-w": [{ "ring-offset": [be2, Wn] }], "ring-offset-color": [{ "ring-offset": $() }], "inset-ring-w": [{ "inset-ring": ne2() }], "inset-ring-color": [{ "inset-ring": $() }], "text-shadow": [{ "text-shadow": ["none", E, Xl, Yl] }], "text-shadow-color": [{ "text-shadow": $() }], opacity: [{ opacity: [be2, ee, J2] }], "mix-blend": [{ "mix-blend": [...ue2(), "plus-darker", "plus-lighter"] }], "bg-blend": [{ "bg-blend": ue2() }], "mask-clip": [{ "mask-clip": ["border", "padding", "content", "fill", "stroke", "view"] }, "mask-no-clip"], "mask-composite": [{ mask: ["add", "subtract", "intersect", "exclude"] }], "mask-image-linear-pos": [{ "mask-linear": [be2] }], "mask-image-linear-from-pos": [{ "mask-linear-from": ce2() }], "mask-image-linear-to-pos": [{ "mask-linear-to": ce2() }], "mask-image-linear-from-color": [{ "mask-linear-from": $() }], "mask-image-linear-to-color": [{ "mask-linear-to": $() }], "mask-image-t-from-pos": [{ "mask-t-from": ce2() }], "mask-image-t-to-pos": [{ "mask-t-to": ce2() }], "mask-image-t-from-color": [{ "mask-t-from": $() }], "mask-image-t-to-color": [{ "mask-t-to": $() }], "mask-image-r-from-pos": [{ "mask-r-from": ce2() }], "mask-image-r-to-pos": [{ "mask-r-to": ce2() }], "mask-image-r-from-color": [{ "mask-r-from": $() }], "mask-image-r-to-color": [{ "mask-r-to": $() }], "mask-image-b-from-pos": [{ "mask-b-from": ce2() }], "mask-image-b-to-pos": [{ "mask-b-to": ce2() }], "mask-image-b-from-color": [{ "mask-b-from": $() }], "mask-image-b-to-color": [{ "mask-b-to": $() }], "mask-image-l-from-pos": [{ "mask-l-from": ce2() }], "mask-image-l-to-pos": [{ "mask-l-to": ce2() }], "mask-image-l-from-color": [{ "mask-l-from": $() }], "mask-image-l-to-color": [{ "mask-l-to": $() }], "mask-image-x-from-pos": [{ "mask-x-from": ce2() }], "mask-image-x-to-pos": [{ "mask-x-to": ce2() }], "mask-image-x-from-color": [{ "mask-x-from": $() }], "mask-image-x-to-color": [{ "mask-x-to": $() }], "mask-image-y-from-pos": [{ "mask-y-from": ce2() }], "mask-image-y-to-pos": [{ "mask-y-to": ce2() }], "mask-image-y-from-color": [{ "mask-y-from": $() }], "mask-image-y-to-color": [{ "mask-y-to": $() }], "mask-image-radial": [{ "mask-radial": [ee, J2] }], "mask-image-radial-from-pos": [{ "mask-radial-from": ce2() }], "mask-image-radial-to-pos": [{ "mask-radial-to": ce2() }], "mask-image-radial-from-color": [{ "mask-radial-from": $() }], "mask-image-radial-to-color": [{ "mask-radial-to": $() }], "mask-image-radial-shape": [{ "mask-radial": ["circle", "ellipse"] }], "mask-image-radial-size": [{ "mask-radial": [{ closest: ["side", "corner"], farthest: ["side", "corner"] }] }], "mask-image-radial-pos": [{ "mask-radial-at": K2() }], "mask-image-conic-pos": [{ "mask-conic": [be2] }], "mask-image-conic-from-pos": [{ "mask-conic-from": ce2() }], "mask-image-conic-to-pos": [{ "mask-conic-to": ce2() }], "mask-image-conic-from-color": [{ "mask-conic-from": $() }], "mask-image-conic-to-color": [{ "mask-conic-to": $() }], "mask-mode": [{ mask: ["alpha", "luminance", "match"] }], "mask-origin": [{ "mask-origin": ["border", "padding", "content", "fill", "stroke", "view"] }], "mask-position": [{ mask: D2() }], "mask-repeat": [{ mask: z2() }], "mask-size": [{ mask: b2() }], "mask-type": [{ "mask-type": ["alpha", "luminance"] }], "mask-image": [{ mask: ["none", ee, J2] }], filter: [{ filter: ["", "none", ee, J2] }], blur: [{ blur: ke() }], brightness: [{ brightness: [be2, ee, J2] }], contrast: [{ contrast: [be2, ee, J2] }], "drop-shadow": [{ "drop-shadow": ["", "none", _2, Xl, Yl] }], "drop-shadow-color": [{ "drop-shadow": $() }], grayscale: [{ grayscale: ["", be2, ee, J2] }], "hue-rotate": [{ "hue-rotate": [be2, ee, J2] }], invert: [{ invert: ["", be2, ee, J2] }], saturate: [{ saturate: [be2, ee, J2] }], sepia: [{ sepia: ["", be2, ee, J2] }], "backdrop-filter": [{ "backdrop-filter": ["", "none", ee, J2] }], "backdrop-blur": [{ "backdrop-blur": ke() }], "backdrop-brightness": [{ "backdrop-brightness": [be2, ee, J2] }], "backdrop-contrast": [{ "backdrop-contrast": [be2, ee, J2] }], "backdrop-grayscale": [{ "backdrop-grayscale": ["", be2, ee, J2] }], "backdrop-hue-rotate": [{ "backdrop-hue-rotate": [be2, ee, J2] }], "backdrop-invert": [{ "backdrop-invert": ["", be2, ee, J2] }], "backdrop-opacity": [{ "backdrop-opacity": [be2, ee, J2] }], "backdrop-saturate": [{ "backdrop-saturate": [be2, ee, J2] }], "backdrop-sepia": [{ "backdrop-sepia": ["", be2, ee, J2] }], "border-collapse": [{ border: ["collapse", "separate"] }], "border-spacing": [{ "border-spacing": W() }], "border-spacing-x": [{ "border-spacing-x": W() }], "border-spacing-y": [{ "border-spacing-y": W() }], "table-layout": [{ table: ["auto", "fixed"] }], caption: [{ caption: ["top", "bottom"] }], transition: [{ transition: ["", "all", "colors", "opacity", "shadow", "transform", "none", ee, J2] }], "transition-behavior": [{ transition: ["normal", "discrete"] }], duration: [{ duration: [be2, "initial", ee, J2] }], ease: [{ ease: ["linear", "initial", te2, ee, J2] }], delay: [{ delay: [be2, ee, J2] }], animate: [{ animate: ["none", re2, ee, J2] }], backface: [{ backface: ["hidden", "visible"] }], perspective: [{ perspective: [F, ee, J2] }], "perspective-origin": [{ "perspective-origin": ye() }], rotate: [{ rotate: Ee2() }], "rotate-x": [{ "rotate-x": Ee2() }], "rotate-y": [{ "rotate-y": Ee2() }], "rotate-z": [{ "rotate-z": Ee2() }], scale: [{ scale: Oe2() }], "scale-x": [{ "scale-x": Oe2() }], "scale-y": [{ "scale-y": Oe2() }], "scale-z": [{ "scale-z": Oe2() }], "scale-3d": ["scale-3d"], skew: [{ skew: Ft() }], "skew-x": [{ "skew-x": Ft() }], "skew-y": [{ "skew-y": Ft() }], transform: [{ transform: [ee, J2, "", "none", "gpu", "cpu"] }], "transform-origin": [{ origin: ye() }], "transform-style": [{ transform: ["3d", "flat"] }], translate: [{ translate: At2() }], "translate-x": [{ "translate-x": At2() }], "translate-y": [{ "translate-y": At2() }], "translate-z": [{ "translate-z": At2() }], "translate-none": ["translate-none"], accent: [{ accent: $() }], appearance: [{ appearance: ["none", "auto"] }], "caret-color": [{ caret: $() }], "color-scheme": [{ scheme: ["normal", "dark", "light", "light-dark", "only-dark", "only-light"] }], cursor: [{ cursor: ["auto", "default", "pointer", "wait", "text", "move", "help", "not-allowed", "none", "context-menu", "progress", "cell", "crosshair", "vertical-text", "alias", "copy", "no-drop", "grab", "grabbing", "all-scroll", "col-resize", "row-resize", "n-resize", "e-resize", "s-resize", "w-resize", "ne-resize", "nw-resize", "se-resize", "sw-resize", "ew-resize", "ns-resize", "nesw-resize", "nwse-resize", "zoom-in", "zoom-out", ee, J2] }], "field-sizing": [{ "field-sizing": ["fixed", "content"] }], "pointer-events": [{ "pointer-events": ["auto", "none"] }], resize: [{ resize: ["none", "", "y", "x"] }], "scroll-behavior": [{ scroll: ["auto", "smooth"] }], "scroll-m": [{ "scroll-m": W() }], "scroll-mx": [{ "scroll-mx": W() }], "scroll-my": [{ "scroll-my": W() }], "scroll-ms": [{ "scroll-ms": W() }], "scroll-me": [{ "scroll-me": W() }], "scroll-mt": [{ "scroll-mt": W() }], "scroll-mr": [{ "scroll-mr": W() }], "scroll-mb": [{ "scroll-mb": W() }], "scroll-ml": [{ "scroll-ml": W() }], "scroll-p": [{ "scroll-p": W() }], "scroll-px": [{ "scroll-px": W() }], "scroll-py": [{ "scroll-py": W() }], "scroll-ps": [{ "scroll-ps": W() }], "scroll-pe": [{ "scroll-pe": W() }], "scroll-pt": [{ "scroll-pt": W() }], "scroll-pr": [{ "scroll-pr": W() }], "scroll-pb": [{ "scroll-pb": W() }], "scroll-pl": [{ "scroll-pl": W() }], "snap-align": [{ snap: ["start", "end", "center", "align-none"] }], "snap-stop": [{ snap: ["normal", "always"] }], "snap-type": [{ snap: ["none", "x", "y", "both"] }], "snap-strictness": [{ snap: ["mandatory", "proximity"] }], touch: [{ touch: ["auto", "none", "manipulation"] }], "touch-x": [{ "touch-pan": ["x", "left", "right"] }], "touch-y": [{ "touch-pan": ["y", "up", "down"] }], "touch-pz": ["touch-pinch-zoom"], select: [{ select: ["none", "text", "all", "auto"] }], "will-change": [{ "will-change": ["auto", "scroll", "contents", "transform", ee, J2] }], fill: [{ fill: ["none", ...$()] }], "stroke-w": [{ stroke: [be2, Co, Wn, ws2] }], stroke: [{ stroke: ["none", ...$()] }], "forced-color-adjust": [{ "forced-color-adjust": ["auto", "none"] }] }, conflictingClassGroups: { overflow: ["overflow-x", "overflow-y"], overscroll: ["overscroll-x", "overscroll-y"], inset: ["inset-x", "inset-y", "start", "end", "top", "right", "bottom", "left"], "inset-x": ["right", "left"], "inset-y": ["top", "bottom"], flex: ["basis", "grow", "shrink"], gap: ["gap-x", "gap-y"], p: ["px", "py", "ps", "pe", "pt", "pr", "pb", "pl"], px: ["pr", "pl"], py: ["pt", "pb"], m: ["mx", "my", "ms", "me", "mt", "mr", "mb", "ml"], mx: ["mr", "ml"], my: ["mt", "mb"], size: ["w", "h"], "font-size": ["leading"], "fvn-normal": ["fvn-ordinal", "fvn-slashed-zero", "fvn-figure", "fvn-spacing", "fvn-fraction"], "fvn-ordinal": ["fvn-normal"], "fvn-slashed-zero": ["fvn-normal"], "fvn-figure": ["fvn-normal"], "fvn-spacing": ["fvn-normal"], "fvn-fraction": ["fvn-normal"], "line-clamp": ["display", "overflow"], rounded: ["rounded-s", "rounded-e", "rounded-t", "rounded-r", "rounded-b", "rounded-l", "rounded-ss", "rounded-se", "rounded-ee", "rounded-es", "rounded-tl", "rounded-tr", "rounded-br", "rounded-bl"], "rounded-s": ["rounded-ss", "rounded-es"], "rounded-e": ["rounded-se", "rounded-ee"], "rounded-t": ["rounded-tl", "rounded-tr"], "rounded-r": ["rounded-tr", "rounded-br"], "rounded-b": ["rounded-br", "rounded-bl"], "rounded-l": ["rounded-tl", "rounded-bl"], "border-spacing": ["border-spacing-x", "border-spacing-y"], "border-w": ["border-w-x", "border-w-y", "border-w-s", "border-w-e", "border-w-t", "border-w-r", "border-w-b", "border-w-l"], "border-w-x": ["border-w-r", "border-w-l"], "border-w-y": ["border-w-t", "border-w-b"], "border-color": ["border-color-x", "border-color-y", "border-color-s", "border-color-e", "border-color-t", "border-color-r", "border-color-b", "border-color-l"], "border-color-x": ["border-color-r", "border-color-l"], "border-color-y": ["border-color-t", "border-color-b"], translate: ["translate-x", "translate-y", "translate-none"], "translate-none": ["translate", "translate-x", "translate-y", "translate-z"], "scroll-m": ["scroll-mx", "scroll-my", "scroll-ms", "scroll-me", "scroll-mt", "scroll-mr", "scroll-mb", "scroll-ml"], "scroll-mx": ["scroll-mr", "scroll-ml"], "scroll-my": ["scroll-mt", "scroll-mb"], "scroll-p": ["scroll-px", "scroll-py", "scroll-ps", "scroll-pe", "scroll-pt", "scroll-pr", "scroll-pb", "scroll-pl"], "scroll-px": ["scroll-pr", "scroll-pl"], "scroll-py": ["scroll-pt", "scroll-pb"], touch: ["touch-x", "touch-y", "touch-pz"], "touch-x": ["touch"], "touch-y": ["touch"], "touch-pz": ["touch"] }, conflictingClassGroupModifiers: { "font-size": ["leading"] }, orderSensitiveModifiers: ["*", "**", "after", "backdrop", "before", "details-content", "file", "first-letter", "first-line", "marker", "placeholder", "selection"] };
      };
      v0 = (r, { cacheSize: l2, prefix: i, experimentalParseClassName: s, extend: c = {}, override: d = {} }) => (To(r, "cacheSize", l2), To(r, "prefix", i), To(r, "experimentalParseClassName", s), Zl(r.theme, d.theme), Zl(r.classGroups, d.classGroups), Zl(r.conflictingClassGroups, d.conflictingClassGroups), Zl(r.conflictingClassGroupModifiers, d.conflictingClassGroupModifiers), To(r, "orderSensitiveModifiers", d.orderSensitiveModifiers), ql(r.theme, c.theme), ql(r.classGroups, c.classGroups), ql(r.conflictingClassGroups, c.conflictingClassGroups), ql(r.conflictingClassGroupModifiers, c.conflictingClassGroupModifiers), Pp(r, c, "orderSensitiveModifiers"), r);
      To = (r, l2, i) => {
        i !== void 0 && (r[l2] = i);
      };
      Zl = (r, l2) => {
        if (l2) for (const i in l2) To(r, i, l2[i]);
      };
      ql = (r, l2) => {
        if (l2) for (const i in l2) Pp(r, l2, i);
      };
      Pp = (r, l2, i) => {
        const s = l2[i];
        s !== void 0 && (r[i] = r[i] ? r[i].concat(s) : s);
      };
      h0 = (r, ...l2) => typeof r == "function" ? Rs2(zs2, r, ...l2) : Rs2(() => v0(zs2(), r), ...l2);
      g0 = Rs2(zs2);
      ...
      _p = Re2.createContext(Lp);
      T0 = Re2.createContext(false);
      xs2 = /* @__PURE__ */ new WeakMap();
      M0 = typeof Re2.useId == "function" ? _0 : L0;
      ...
      Te2 = (r) => {
        var l2;
        return (l2 = r == null ? void 0 : r.ownerDocument) !== null && l2 !== void 0 ? l2 : document;
      };
      ...
      mt2 = (r = document) => {
        ...
        for (; i && "shadowRoot" in i && (!((l2 = i.shadowRoot) === null || l2 === void 0) && l2.activeElement); ) i = i.shadowRoot.activeElement;
        return i;
      };
      H0 = class {
        get currentNode() {
        ...
        set currentNode(l2) {
          if (!pt2(this.root, l2)) throw new Error("Cannot set currentNode to a node that is not contained by the root node.");
          const i = [];
          let s = l2, c = l2;
          for (this._currentNode = l2; s && s !== this.root; ) if (s.nodeType === Node.DOCUMENT_FRAGMENT_NODE) {
            const f2 = s, m2 = this._doc.createTreeWalker(f2, this.whatToShow, { acceptNode: this._acceptNode });
            i.push(m2), m2.currentNode = c, this._currentSetFor.add(m2), s = c = f2.host;
          } else s = s.parentNode;
        ...
        firstChild() {
          let l2 = this.currentNode, i = this.nextNode();
          return pt2(l2, i) ? (i && (this.currentNode = i), i) : (this.currentNode = l2, null);
        }
        lastChild() {
        ...
        nextNode() {
          const l2 = this._walkerStack[0].nextNode();
          if (l2) {
            if (l2.shadowRoot) {
              var i;
              let c;
              if (typeof this.filter == "function" ? c = this.filter(l2) : !((i = this.filter) === null || i === void 0) && i.acceptNode && (c = this.filter.acceptNode(l2)), c === NodeFilter.FILTER_ACCEPT) return this.currentNode = l2, l2;
              let d = this.nextNode();
              return d && (this.currentNode = d), d;
            }
            return l2 && (this.currentNode = l2), l2;
        ...
        previousNode() {
          const l2 = this._walkerStack[0];
          if (l2.currentNode === l2.root) {
            if (this._currentSetFor.has(l2)) if (this._currentSetFor.delete(l2), this._walkerStack.length > 1) {
              this._walkerStack.shift();
          ...
          if (i) {
            if (i.shadowRoot) {
              ...
              let f2 = this.lastChild();
              return f2 && (this.currentNode = f2), f2;
            }
            return i && (this.currentNode = i), i;
          } else if (this._walkerStack.length > 1) {
            this._walkerStack.shift();
        ...
        constructor(l2, i, s, c) {
          this._walkerStack = [], this._currentSetFor = /* @__PURE__ */ new Set(), this._acceptNode = (f2) => {
            if (f2.nodeType === Node.ELEMENT_NODE) {
              const v = f2.shadowRoot;
              if (v) {
                const y2 = this._doc.createTreeWalker(v, this.whatToShow, { acceptNode: this._acceptNode });
                return this._walkerStack.unshift(y2), NodeFilter.FILTER_ACCEPT;
              } else {
                var m2;
                if (typeof this.filter == "function") return this.filter(f2);
                if (!((m2 = this.filter) === null || m2 === void 0) && m2.acceptNode) return this.filter.acceptNode(f2);
                if (this.filter === null) return NodeFilter.FILTER_ACCEPT;
              }
            }
            return NodeFilter.FILTER_SKIP;
          }, this._doc = l2, this.root = i, this.filter = c ?? null, this.whatToShow = s ?? NodeFilter.SHOW_ALL, this._currentNode = i, this._walkerStack.unshift(l2.createTreeWalker(i, s, this._acceptNode));
          const d = i.shadowRoot;
          if (d) {
            const f2 = this._doc.createTreeWalker(d, this.whatToShow, { acceptNode: this._acceptNode });
            this._walkerStack.unshift(f2);
          }
        }
      };
      ...
      zp = rn2(function() {
        return tu(/^iPad/i) || Mr2() && navigator.maxTouchPoints > 1;
      });
      yi2 = rn2(function() {
        return J0() || zp();
      });
      ...
      ti2 = class {
        ...
        constructor(l2, i, s, c) {
          ...
          var d;
          let f2 = (d = c == null ? void 0 : c.target) !== null && d !== void 0 ? d : s.currentTarget;
          const m2 = f2 == null ? void 0 : f2.getBoundingClientRect();
          let v, y2 = 0, g, x2 = null;
          s.clientX != null && s.clientY != null && (g = s.clientX, x2 = s.clientY), m2 && (g != null && x2 != null ? (v = g - m2.left, y2 = x2 - m2.top) : (v = m2.width / 2, y2 = m2.height / 2)), this.type = l2, this.pointerType = i, this.target = s.currentTarget, this.shiftKey = s.shiftKey, this.metaKey = s.metaKey, this.ctrlKey = s.ctrlKey, this.altKey = s.altKey, this.x = v, this.y = y2;
        }
      };
      ...
      qp = (r, l2) => {
        ...
        l2 && s.removeEventListener("DOMContentLoaded", l2), Mo.has(i) && (i.HTMLElement.prototype.focus = Mo.get(i).focus, s.removeEventListener("keydown", ci2, true), s.removeEventListener("keyup", ci2, true), s.removeEventListener("click", Yp, true), i.removeEventListener("focus", Xp, true), i.removeEventListener("blur", Zp, false), typeof PointerEvent < "u" && (s.removeEventListener("pointerdown", Lr, true), s.removeEventListener("pointermove", Lr, true), s.removeEventListener("pointerup", Lr, true)), Mo.delete(i));
      };
      typeof document < "u" && _y();
      My = /* @__PURE__ */ new Set(["checkbox", "radio", "range", "color", "file", "image", "button", "submit", "reset"]);
      ...
      du = class _du {
        ...
        getTreeNode(l2) {
          return this.fastMap.get(l2);
        }
        addTreeNode(l2, i, s) {
          let c = this.fastMap.get(i ?? null);
          if (!c) return;
          let d = new Bs2({ scopeRef: l2 });
          c.addChild(d), d.parent = c, this.fastMap.set(l2, d), s && (d.nodeToRestore = s);
        }
        addNode(l2) {
          this.fastMap.set(l2.scopeRef, l2);
        }
        removeTreeNode(l2) {
          if (l2 === null) return;
          let i = this.fastMap.get(l2);
          if (!i) return;
          let s = i.parent;
        ...
        *traverse(l2 = this.root) {
          if (l2.scopeRef != null && (yield l2), l2.children.size > 0) for (let i of l2.children) yield* this.traverse(i);
        }
        clone() {
          var l2;
          let i = new _du();
          var s;
          for (let c of this.traverse()) i.addTreeNode(c.scopeRef, (s = (l2 = c.parent) === null || l2 === void 0 ? void 0 : l2.scopeRef) !== null && s !== void 0 ? s : null, c.nodeToRestore);
          return i;
        }
        constructor() {
      ...
      Bs2 = class {
        addChild(l2) {
          this.children.add(l2), l2.parent = this;
        }
        removeChild(l2) {
          this.children.delete(l2), l2.parent = void 0;
        }
        constructor(l2) {
          this.children = /* @__PURE__ */ new Set(), this.contain = false, this.scopeRef = l2.scopeRef;
        }
      };
      Be2 = new du();
      qy = (r, l2) => {
        var i;
        let s = [];
        const c = (i = S.Children.map(r, (f2) => S.isValidElement(f2) && f2.type === l2 ? (s.push(f2), null) : f2)) == null ? void 0 : i.filter(Boolean), d = s.length >= 0 ? s : void 0;
        return [c, d];
      };
      ...
      t1 = /^(aria-.*)$/;
      ri2 = /^(on[A-Z].*)$/;
      [ib, wi2] = fu({ name: "ProviderContext", strict: false });
      ...
      bi2 = class _bi {
        getStringForLocale(l2, i) {
          let c = this.getStringsForLocale(i)[l2];
          if (!c) throw new Error(`Could not find intl message ${l2} in ${i} locale`);
          return c;
        }
        getStringsForLocale(l2) {
          let i = this.strings[l2];
          return i || (i = d1(l2, this.strings, this.defaultLocale), this.strings[l2] = i), i;
        }
        static getGlobalDictionaryForPackage(l2) {
          ...
          let s = Pr2 == null ? void 0 : Pr2[l2];
          if (!s) throw new Error(`Strings for package "${l2}" were not included by LocalizedStringProvider. Please add it to the list passed to createLocalizedStringDictionary.`);
          return s;
        }
        constructor(l2, i = "en-US") {
          this.strings = Object.fromEntries(Object.entries(l2).filter(([, s]) => s)), this.defaultLocale = i;
        }
      };
      ep = /* @__PURE__ */ new Map();
      tp = /* @__PURE__ */ new Map();
      p1 = class {
        format(l2, i) {
          let s = this.strings.getStringForLocale(l2, this.locale);
          return typeof s == "function" ? s(i, this) : s;
        }
        plural(l2, i, s = "cardinal") {
          let c = i["=" + l2];
          if (c) return typeof c == "function" ? c() : c;
          let d = this.locale + ":" + s, f2 = ep.get(d);
          f2 || (f2 = new Intl.PluralRules(this.locale, { type: s }), ep.set(d, f2));
          let m2 = f2.select(l2);
          return c = i[m2] || i.other, typeof c == "function" ? c() : c;
        }
        number(l2) {
          let i = tp.get(this.locale);
          return i || (i = new Intl.NumberFormat(this.locale), tp.set(this.locale, i)), i.format(l2);
        }
        select(l2, i) {
          let s = l2[i] || l2.other;
      ...
      g1 = (r, l2, i) => i > l2 ? l2 : i < r ? r : i;
      cm = (r) => (l2) => typeof l2 == "string" && l2.startsWith(r);
      w1 = cm("--");
      b1 = cm("var(--");
      ab = (r) => b1(r) ? x1.test(r.split("/*")[0].trim()) : false;
      x1 = /var\(--(?:[\w-]+\s*|[\w-]+\s*,(?:\s*[^)(\s]|\s*\((?:[^)(]|\([^)(]*\))*\))+\s*)\)$/iu;
      mu = { test: (r) => typeof r == "number", parse: parseFloat, transform: (r) => r };
      Ws = { ...mu, transform: (r) => g1(0, 1, r) };
      oi2 = { ...mu, default: 1 };
      Fo = (r) => ({ test: (l2) => typeof l2 == "string" && l2.endsWith(r) && l2.split(" ").length === 1, parse: parseFloat, transform: (l2) => `${l2}${r}` });
      Kn = Fo("deg");
      Ss = Fo("%");
      he = Fo("px");
      sb = Fo("vh");
      ...
      pm = (r, l2) => l2 && typeof r == "number" ? l2.transform(r) : r;
      ...
      E1 = class extends S.Component {
        getSnapshotBeforeUpdate(l2) {
          const i = this.props.childRef.current;
          if (i && l2.isPresent && !this.props.isPresent) {
      ...
      C1 = ({ children: r, initial: l2, isPresent: i, onExitComplete: s, custom: c, presenceAffectsLayout: d, mode: f2, anchorX: m2, root: v }) => {
        const y2 = pu(P1), g = S.useId();
        let x2 = true, E = S.useMemo(() => (x2 = false, { id: g, initial: l2, isPresent: i, custom: c, onExitComplete: (_2) => {
          y2.set(_2, true);
          for (const I2 of y2.values()) if (!I2) return;
          s && s();
        }, register: (_2) => (y2.set(_2, false), () => y2.delete(_2)) }), [i, y2, s]);
        return d && x2 && (E = { ...E }), S.useMemo(() => {
          y2.forEach((_2, I2) => y2.set(I2, false));
        }, [i]), S.useEffect(() => {
          !i && !y2.size && s && s();
        }, [i]), f2 === "popLayout" && (r = Y2.jsx($1, { isPresent: i, anchorX: m2, root: v, children: r })), Y2.jsx(xi2.Provider, { value: E, children: r });
      };
      li2 = (r) => r.key || "";
      mm = ({ children: r, custom: l2, initial: i = true, onExitComplete: s, presenceAffectsLayout: c = true, mode: d = "sync", propagate: f2 = false, anchorX: m2 = "left", root: v }) => {
        const [y2, g] = T1(f2), x2 = S.useMemo(() => lp(r), [r]), E = f2 && !y2 ? [] : x2.map(li2), _2 = S.useRef(true), I2 = S.useRef(x2), F = pu(() => /* @__PURE__ */ new Map()), [A2, te2] = S.useState(x2), [re2, pe2] = S.useState(x2);
        um(() => {
          _2.current = false, I2.current = x2;
        ...
        if (x2 !== A2) {
          ...
          return d === "wait" && K2.length && (ie2 = K2), pe2(lp(ie2)), te2(x2), null;
        }
        const { forceRender: ye } = S.useContext(am);
        return Y2.jsx(Y2.Fragment, { children: re2.map((ie2) => {
          const ae2 = li2(ie2), W = f2 && !y2 ? false : x2 === re2 || E.includes(ae2), we2 = () => {
            if (F.has(ae2)) F.set(ae2, true);
            else return;
            let Ce2 = true;
            F.forEach((R3) => {
              R3 || (Ce2 = false);
            }), Ce2 && (ye == null || ye(), pe2(I2.current), f2 && (g == null || g()), s && s());
          };
          return Y2.jsx(C1, { isPresent: W, initial: !_2.current || i ? void 0 : false, custom: l2, presenceAffectsLayout: c, mode: d, root: v, onExitComplete: W ? void 0 : we2, anchorX: m2, children: ie2 }, ae2);
        }) });
      };
      ...
      pi = {};
      for (const r in ip) pi[r] = { isEnabled: (l2) => ip[r].some((i) => !!l2[i]) };
      ...
      Si2 = S.createContext({});
      M1 = ["animate", "whileInView", "whileFocus", "whileHover", "whileTap", "whileDrag", "exit"];
      R1 = ["initial", ...M1];
      A1 = {};
      ...
      km = (r) => (l2, i) => {
        const s = S.useContext(Si2), c = S.useContext(xi2), d = () => ew(r, l2, s, c);
        return i ? d() : pu(d);
      };
      ...
      lv = { dismiss: "\u95DC\u9589" };
      iv = {};
      iv = { "ar-AE": Cm, "bg-BG": Pm, "cs-CZ": Tm, "da-DK": Nm, "de-DE": Lm, "el-GR": _m, "en-US": Mm, "es-ES": Rm, "et-EE": zm, "fi-FI": Im, "fr-FR": Fm, "he-IL": Am, "hr-HR": Om, "hu-HU": Dm, "it-IT": jm, "ja-JP": Vm, "ko-KR": Hm, "lt-LT": Bm, "lv-LV": Um, "nb-NO": Wm, "nl-NL": Gm, "pl-PL": Km, "pt-BR": Qm, "pt-PT": Ym, "ro-RO": Xm, "ru-RU": Zm, "sk-SK": qm, "sl-SI": Jm, "sr-SP": ev, "sv-SE": tv, "tr-TR": nv, "uk-UA": rv, "zh-CN": ov, "zh-TW": lv };
      ...
      xu = (r, l2, i = true) => {
        if (!l2) return [r, {}];
        const s = l2.reduce((c, d) => d in r ? { ...c, [d]: r[d] } : c, {});
        return i ? [Object.keys(r).filter((d) => !l2.includes(d)).reduce((d, f2) => ({ ...d, [f2]: r[f2] }), {}), s] : [r, s];
      };
      Nw = (r) => Y2.jsxs("svg", { "aria-hidden": "true", fill: "none", focusable: "false", height: "1em", shapeRendering: "geometricPrecision", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5", viewBox: "0 0 24 24", width: "1em", ...r, children: [Y2.jsx("path", { d: "M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6" }), Y2.jsx("path", { d: "M15 3h6v6" }), Y2.jsx("path", { d: "M10 14L21 3" })] });
      sv = qn2((r, l2) => {
        const { Component: i, children: s, showAnchorIcon: c, anchorIcon: d = Y2.jsx(Nw, { className: x0 }), getLinkProps: f2 } = Tw({ ref: l2, ...r });
        return Y2.jsx(i, { ...f2(), children: Y2.jsxs(Y2.Fragment, { children: [s, c && d] }) });
      });
      ...
      ku = function(l2, i, s) {
        ...
        if (i && i.length > 0) {
          let f2 = function(y2) {
            return Promise.all(y2.map((g) => Promise.resolve(g).then((x2) => ({ status: "fulfilled", value: x2 }), (x2) => ({ status: "rejected", reason: x2 }))));
          };
          document.getElementsByTagName("link");
          const m2 = document.querySelector("meta[property=csp-nonce]"), v = (m2 == null ? void 0 : m2.nonce) || (m2 == null ? void 0 : m2.getAttribute("nonce"));
          c = f2(i.map((y2) => {
            if (y2 = _w(y2), y2 in fp) return;
            fp[y2] = true;
            const g = y2.endsWith(".css"), x2 = g ? '[rel="stylesheet"]' : "";
            if (document.querySelector(`link[href="${y2}"]${x2}`)) return;
            const E = document.createElement("link");
            if (E.rel = g ? "stylesheet" : Lw, g || (E.as = "script"), E.crossOrigin = "", E.href = y2, v && E.setAttribute("nonce", v), document.head.appendChild(E), g) return new Promise((_2, I2) => {
              E.addEventListener("load", _2), E.addEventListener("error", () => I2(new Error(`Unable to preload CSS for ${y2}`)));
            });
          }));
        }
        function d(f2) {
          const m2 = new Event("vite:preloadError", { cancelable: true });
          if (m2.payload = f2, window.dispatchEvent(m2), !m2.defaultPrevented) throw f2;
        }
        return c.then((f2) => {
          for (const m2 of f2 || []) m2.status === "rejected" && d(m2.reason);
          return l2().catch(d);
        });
      };
      [Mw, Su] = fu({ name: "NavbarContext", strict: true, errorMessage: "useNavbarContext: `context` is undefined. Seems you forgot to wrap component within <Navbar />" });
      ...
      uv = qn2((r, l2) => {
        var i, s;
        const { className: c, children: d, portalContainer: f2, motionProps: m2, style: v, ...y2 } = r, g = Ar2(l2), { slots: x2, isMenuOpen: E, height: _2, disableAnimation: I2, classNames: F } = Su(), A2 = Nn(F == null ? void 0 : F.menu, c);
        return I2 ? E ? Y2.jsx(dp, { portalContainer: f2, children: Y2.jsx("ul", { ref: g, className: (i = x2.menu) == null ? void 0 : i.call(x2, { class: A2 }), "data-open": lt2(E), style: { "--navbar-height": typeof _2 == "number" ? `${_2}px` : _2 }, ...y2, children: d }) }) : null : Y2.jsx(mm, { mode: "wait", children: E ? Y2.jsx(dp, { portalContainer: f2, children: Y2.jsx(gu, { features: zw, children: Y2.jsx(bu.ul, { ref: g, layoutScroll: true, animate: "enter", className: (s = x2.menu) == null ? void 0 : s.call(x2, { class: A2 }), "data-open": lt2(E), exit: "exit", initial: "exit", style: { "--navbar-height": typeof _2 == "number" ? `${_2}px` : _2, ...v }, variants: Rw, ...Io(m2, y2), children: d }) }) }) : null });
      });
      uv.displayName = "HeroUI.NavbarMenu";
      Iw = uv;
      vi2 = { ease: [0.36, 0.66, 0.4, 1], easeIn: [0.4, 0, 1, 1], easeOut: [0, 0, 0.2, 1] };
      fb = { scaleSpringOpacity: { initial: { opacity: 0, transform: "scale(0.8)" }, enter: { opacity: 1, transform: "scale(1)", transition: { type: "spring", bounce: 0, duration: 0.3 } }, exit: { opacity: 0, transform: "scale(0.96)", transition: { type: "easeOut", bounce: 0, duration: 0.15 } } }, fade: { enter: { opacity: 1, transition: { duration: 0.4, ease: vi2.ease } }, exit: { opacity: 0, transition: { duration: 0.3, ease: vi2.ease } } }, collapse: { enter: { opacity: 1, height: "auto", transition: { height: { type: "spring", bounce: 0, duration: 0.3 }, opacity: { easings: "ease", duration: 0.4 } } }, exit: { opacity: 0, height: 0, transition: { easings: "ease", duration: 0.3 } } } };
      Fw = { visible: { y: 0, transition: { ease: vi2.easeOut } }, hidden: { y: "-100%", transition: { ease: vi2.easeIn } } };
      Aw = typeof window < "u";
      Ow = (r) => {
        const { elementRef: l2, delay: i = 30, callback: s, isEnabled: c } = r, d = S.useRef(c ? pp(l2 == null ? void 0 : l2.current) : { x: 0, y: 0 }), f2 = S.useRef(null), m2 = S.useCallback(() => {
          const v = pp(l2 == null ? void 0 : l2.current);
          typeof s == "function" && s({ prevPos: d.current, currPos: v }), d.current = v, f2.current = null;
        }, [s, l2]);
        return S.useEffect(() => {
          if (!c) return;
          const v = () => {
            i ? (f2.current && clearTimeout(f2.current), f2.current = setTimeout(m2, i)) : m2();
          }, y2 = (l2 == null ? void 0 : l2.current) || window;
          return y2.addEventListener("scroll", v), () => {
            y2.removeEventListener("scroll", v), f2.current && (clearTimeout(f2.current), f2.current = null);
          };
        }, [l2 == null ? void 0 : l2.current, i, m2, c]), d.current;
      };
      Hw = () => ku(() => Promise.resolve().then(() => (init_index_chunk(), index_chunk_exports)), __vite__mapDeps([0, 1])).then((r) => r.default);
      cv = qn2((r, l2) => {
        const { children: i, ...s } = r, c = Vw({ ...s, ref: l2 }), d = c.Component, [f2, m2] = qy(i, Iw), v = Y2.jsxs(Y2.Fragment, { children: [Y2.jsx("header", { ...c.getWrapperProps(), children: f2 }), m2] });
        return Y2.jsx(Mw, { value: c, children: c.shouldHideOnScroll ? Y2.jsx(gu, { features: Hw, children: Y2.jsx(bu.nav, { animate: c.isHidden ? "hidden" : "visible", initial: false, variants: Fw, ...Io(c.getBaseProps(), c.motionProps), children: v }) }) : Y2.jsx(d, { ...c.getBaseProps(), children: v }) });
      });
      cv.displayName = "HeroUI.Navbar";
      pb = cv;
      dv = qn2((r, l2) => {
        var i;
        const { as: s, className: c, children: d, justify: f2 = "start", ...m2 } = r, v = s || "ul", y2 = Ar2(l2), { slots: g, classNames: x2 } = Su(), E = Nn(x2 == null ? void 0 : x2.content, c);
        return Y2.jsx(v, { ref: y2, className: (i = g.content) == null ? void 0 : i.call(g, { class: E }), "data-justify": f2, ...m2, children: d });
      });
      dv.displayName = "HeroUI.NavbarContent";
      mb = dv;
      fv = qn2((r, l2) => {
        var i;
        const { as: s, className: c, children: d, isActive: f2, ...m2 } = r, v = s || "li", y2 = Ar2(l2), { slots: g, classNames: x2 } = Su(), E = Nn(x2 == null ? void 0 : x2.item, c);
        return Y2.jsx(v, { ref: y2, className: (i = g.item) == null ? void 0 : i.call(g, { class: E }), "data-active": lt2(f2), ...m2, children: d });
      });
      fv.displayName = "HeroUI.NavbarItem";
      vb = fv;
      [hb, Bw] = fu({ name: "ButtonGroupContext", strict: false });
      Ww = () => ku(() => Promise.resolve().then(() => (init_index_chunk(), index_chunk_exports)), __vite__mapDeps([0, 1])).then((r) => r.default);
      pv = (r) => {
        const { ripples: l2 = [], motionProps: i, color: s = "currentColor", style: c, onClear: d } = r;
        return Y2.jsx(Y2.Fragment, { children: l2.map((f2) => {
          const m2 = E0(0.01 * f2.size, 0.2, f2.size > 100 ? 0.75 : 0.5);
          return Y2.jsx(gu, { features: Ww, children: Y2.jsx(mm, { mode: "popLayout", children: Y2.jsx(bu.span, { animate: { transform: "scale(2)", opacity: 0 }, className: "heroui-ripple", exit: { opacity: 0 }, initial: { transform: "scale(0)", opacity: 0.35 }, style: { position: "absolute", backgroundColor: s, borderRadius: "100%", transformOrigin: "center", pointerEvents: "none", overflow: "hidden", inset: 0, zIndex: 0, top: f2.y, left: f2.x, width: `${f2.size}px`, height: `${f2.size}px`, ...c }, transition: { duration: m2 }, onAnimationComplete: () => {
            d(f2.key);
          }, ...i }) }) }, f2.key);
        }) });
      };
      ...
      Gw = pv;
      mv = qn2((r, l2) => {
        const { slots: i, classNames: s, label: c, variant: d, getSpinnerProps: f2 } = Yw({ ...r });
        return d === "wave" || d === "dots" ? Y2.jsxs("div", { ref: l2, ...f2(), children: [Y2.jsx("div", { className: i.wrapper({ class: s == null ? void 0 : s.wrapper }), children: [...new Array(3)].map((m2, v) => Y2.jsx("i", { className: i.dots({ class: s == null ? void 0 : s.dots }), style: { "--dot-index": v } }, `dot-${v}`)) }), c && Y2.jsx("span", { className: i.label({ class: s == null ? void 0 : s.label }), children: c })] }) : d === "simple" ? Y2.jsxs("div", { ref: l2, ...f2(), children: [Y2.jsxs("svg", { className: i.wrapper({ class: s == null ? void 0 : s.wrapper }), fill: "none", viewBox: "0 0 24 24", children: [Y2.jsx("circle", { className: i.circle1({ class: s == null ? void 0 : s.circle1 }), cx: "12", cy: "12", r: "10", stroke: "currentColor", strokeWidth: "4" }), Y2.jsx("path", { className: i.circle2({ class: s == null ? void 0 : s.circle2 }), d: "M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z", fill: "currentColor" })] }), c && Y2.jsx("span", { className: i.label({ class: s == null ? void 0 : s.label }), children: c })] }) : d === "spinner" ? Y2.jsxs("div", { ref: l2, ...f2(), children: [Y2.jsx("div", { className: i.wrapper({ class: s == null ? void 0 : s.wrapper }), children: [...new Array(12)].map((m2, v) => Y2.jsx("i", { className: i.spinnerBars({ class: s == null ? void 0 : s.spinnerBars }), style: { "--bar-index": v } }, `star-${v}`)) }), c && Y2.jsx("span", { className: i.label({ class: s == null ? void 0 : s.label }), children: c })] }) : Y2.jsxs("div", { ref: l2, ...f2(), children: [Y2.jsxs("div", { className: i.wrapper({ class: s == null ? void 0 : s.wrapper }), children: [Y2.jsx("i", { className: i.circle1({ class: s == null ? void 0 : s.circle1 }) }), Y2.jsx("i", { className: i.circle2({ class: s == null ? void 0 : s.circle2 }) })] }), c && Y2.jsx("span", { className: i.label({ class: s == null ? void 0 : s.label }), children: c })] });
      });
      mv.displayName = "HeroUI.Spinner";
      Xw = mv;
      vv = qn2((r, l2) => {
        const { Component: i, domRef: s, children: c, spinnerSize: d, spinner: f2 = Y2.jsx(Xw, { color: "current", size: d }), spinnerPlacement: m2, startContent: v, endContent: y2, isLoading: g, disableRipple: x2, getButtonProps: E, getRippleProps: _2, isIconOnly: I2 } = Qw({ ...r, ref: l2 });
        return Y2.jsxs(i, { ref: s, ...E(), children: [v, g && m2 === "start" && f2, g && I2 ? null : c, g && m2 === "end" && f2, y2, !x2 && Y2.jsx(Gw, { ..._2() })] });
      });
      vv.displayName = "HeroUI.Button";
      gb = vv;
      yb = globalThis != null && globalThis.document ? S.useLayoutEffect : S.useEffect;
      wb = ({ size: r = 24, width: l2, height: i, ...s }) => Y2.jsxs("svg", { fill: "none", width: l2 || r, height: i || r, viewBox: "0 0 32 32", ...s, children: [Y2.jsx("path", { clipRule: "evenodd", fillRule: "evenodd", fill: "currentColor", d: "M24.87,14.87a.4.4,0,0,0-.35-.23.59.59,0,0,0-.47.27,14.33,14.33,0,0,1-1.27,1.52,1.3,1.3,0,0,1-.82.47c-.33,0-.5-.26-.5-.77a14.41,14.41,0,0,1,.33-2.19,17.3,17.3,0,0,0,.38-2.7c0-.83-.37-1.24-1.12-1.24a2.37,2.37,0,0,0-1.25.44,5.09,5.09,0,0,0-1.39,1.47,11.37,11.37,0,0,0-1.28,2.68c.05-.56.1-1,.17-1.42s.16-.83.28-1.34a8.29,8.29,0,0,0,.26-1.37.41.41,0,0,0-.14-.36.82.82,0,0,0-.48-.1,1.7,1.7,0,0,0-1,.26,1.5,1.5,0,0,0-.51.81,17.16,17.16,0,0,0-.62,4.29,5.94,5.94,0,0,1-1.32,1.13,3.51,3.51,0,0,1-1.77.6,1.65,1.65,0,0,1-1.64-.88,6,6,0,0,0,2.9-1.5,3.31,3.31,0,0,0,.85-2.26,2.55,2.55,0,0,0-.6-1.79A2.09,2.09,0,0,0,11.9,10a3.22,3.22,0,0,0-2,.67,4.43,4.43,0,0,0-1.39,1.8A6.11,6.11,0,0,0,8,14.93a4.23,4.23,0,0,0,1,3A3.62,3.62,0,0,0,11.81,19a4.6,4.6,0,0,0,2.5-.73,7.82,7.82,0,0,0,.89-.64,5.61,5.61,0,0,0,.14.61,1,1,0,0,0,.93.76.93.93,0,0,0,.78-.32,3,3,0,0,0,.44-1.21,14.32,14.32,0,0,1,.68-2.22A11.59,11.59,0,0,1,19,13.56c.27-.42.48-.64.63-.64s.19.11.19.31a10.53,10.53,0,0,1-.22,1.66,13.37,13.37,0,0,0-.24,1.91,2.58,2.58,0,0,0,.45,1.64,1.59,1.59,0,0,0,1.32.56,3.16,3.16,0,0,0,1.95-.65,7.9,7.9,0,0,0,1.59-1.66A1.89,1.89,0,0,0,25,15.5,1.28,1.28,0,0,0,24.87,14.87Zm-14.78-.19a4.21,4.21,0,0,1,.44-2,1.27,1.27,0,0,1,1.08-.82.63.63,0,0,1,.49.22.9.9,0,0,1,.18.59,1.65,1.65,0,0,1-.59,1.24,3.82,3.82,0,0,1-1.6.8Z" }), Y2.jsx("path", { clipRule: "evenodd", fillRule: "evenodd", fill: "currentColor", d: "M26.57,32a4.89,4.89,0,0,1-2.35-.68l-7.31-4.06a2.15,2.15,0,0,0-1.82,0L7.78,31.32a4,4,0,0,1-4,.22A4,4,0,0,1,2,27.91V6.79A6.79,6.79,0,0,1,8.78,0H23.21A6.81,6.81,0,0,1,30,6.78V27.91a4,4,0,0,1-1.76,3.65A3.31,3.31,0,0,1,26.57,32ZM16,25.06a3.81,3.81,0,0,1,1.89.46l7.3,4.05a2.12,2.12,0,0,0,2,.26A2.15,2.15,0,0,0,28,27.91V6.79A4.81,4.81,0,0,0,23.21,2H8.78A4.79,4.79,0,0,0,4,6.79V27.91a2.13,2.13,0,0,0,.77,1.91,2.12,2.12,0,0,0,2-.25l7.3-4.06A4,4,0,0,1,16,25.06Z" })] });
      bb = ({ size: r = 24, width: l2, height: i, ...s }) => Y2.jsxs("svg", { fill: "none", width: l2 || r, height: i || r, viewBox: "0 0 16 16", ...s, children: [Y2.jsx("path", { clipRule: "evenodd", fillRule: "evenodd", fill: "currentColor", d: "M4.545 6.714 4.11 8H3l1.862-5h1.284L8 8H6.833l-.435-1.286H4.545zm1.634-.736L5.5 3.956h-.049l-.679 2.022H6.18z" }), Y2.jsx("path", { clipRule: "evenodd", fillRule: "evenodd", fill: "currentColor", d: "M0 2a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v3h3a2 2 0 0 1 2 2v7a2 2 0 0 1-2 2H7a2 2 0 0 1-2-2v-3H2a2 2 0 0 1-2-2V2zm2-1a1 1 0 0 0-1 1v7a1 1 0 0 0 1 1h7a1 1 0 0 0 1-1V2a1 1 0 0 0-1-1H2zm7.138 9.995c.193.301.402.583.63.846-.748.575-1.673 1.001-2.768 1.292.178.217.451.635.555.867 1.125-.359 2.08-.844 2.886-1.494.777.665 1.739 1.165 2.93 1.472.133-.254.414-.673.629-.89-1.125-.253-2.057-.694-2.82-1.284.681-.747 1.222-1.651 1.621-2.757H14V8h-3v1.047h.765c-.318.844-.74 1.546-1.272 2.13a6.066 6.066 0 0 1-.415-.492 1.988 1.988 0 0 1-.94.31z" })] });
      Ut2 = [];
    }
  });
  ...
  function Rr3(o, e, a, n) {
    let i = $t2(a), u = a == null;
    S.useEffect(() => {
      if (u || !o.current) return;
      let h = o.current;
      return h.addEventListener(e, i, n), () => {
        h.removeEventListener(e, i, n);
      };
    }, [o, e, n, u, i]);
  }
  function Vo(o, e) {
    let a = oo(o, e, "left"), n = oo(o, e, "top"), i = e.offsetWidth, u = e.offsetHeight, h = o.scrollLeft, v = o.scrollTop, { borderTopWidth: g, borderLeftWidth: b2, scrollPaddingTop: y2, scrollPaddingRight: _2, scrollPaddingBottom: K2, scrollPaddingLeft: R3 } = getComputedStyle(o), F = h + parseInt(b2, 10), I2 = v + parseInt(g, 10), w2 = F + o.clientWidth, z2 = I2 + o.clientHeight, E = parseInt(y2, 10) || 0, M = parseInt(K2, 10) || 0, L3 = parseInt(_2, 10) || 0, H2 = parseInt(R3, 10) || 0;
    a <= h + H2 ? h = a - parseInt(b2, 10) - H2 : a + i > w2 - L3 && (h += a + i - w2 + L3), n <= I2 + E ? v = n - parseInt(g, 10) - E : n + u > z2 - M && (v += n + u - z2 + M), o.scrollLeft = h, o.scrollTop = v;
  }
  function oo(o, e, a) {
    const n = a === "left" ? "offsetLeft" : "offsetTop";
    let i = 0;
    for (; e.offsetParent && (i += e[n], e.offsetParent !== o); ) {
  ...
  function no(o, e) {
    if (o && document.contains(o)) {
      ...
      if (window.getComputedStyle(h).overflow === "hidden") {
        let g = il(o);
        for (let b2 of g) Vo(b2, o);
      } else {
        var a;
        let { left: g, top: b2 } = o.getBoundingClientRect();
        o == null || (a = o.scrollIntoView) === null || a === void 0 || a.call(o, { block: "nearest" });
        let { left: y2, top: _2 } = o.getBoundingClientRect();
        if (Math.abs(g - y2) > 1 || Math.abs(b2 - _2) > 1) {
          var n, i, u;
          e == null || (i = e.containingElement) === null || i === void 0 || (n = i.scrollIntoView) === null || n === void 0 || n.call(i, { block: "center", inline: "center" }), (u = o.scrollIntoView) === null || u === void 0 || u.call(o, { block: "nearest" });
        }
      }
    }
  }
  var sl = "react-aria-clear-focus";
  var cl = "react-aria-focus";
  function tr2(o) {
    return Mr2() ? o.metaKey : o.ctrlKey;
  }
  function Ca(o, e = -1 / 0, a = 1 / 0) {
    return Math.min(Math.max(o, e), a);
  }
  function dl(o) {
    let e = pl(Te2(o));
    e !== o && (e && ul(e, o), o && Uo(o, e));
  }
  function ul(o, e) {
  ...
  function fl(o) {
    let { locale: e } = s1(), a = e + (o ? Object.entries(o).sort((i, u) => i[0] < u[0] ? -1 : 1).join() : "");
    if (ua.has(a)) return ua.get(a);
    let n = new Intl.Collator(e, o);
    return ua.set(a, n), n;
  }
  var hl = /* @__PURE__ */ new Set(["opacity", "clipPath", "filter", "transform"]);
  ...
  function bl() {
    const o = vl(), [e, a] = S.useState(0), n = S.useCallback(() => {
      o.current && a(e + 1);
    }, [e]);
    return [S.useCallback(() => O.postRender(n), [n]), e];
  }
  var wl = (o) => !o.isLayoutDirty && o.willUpdate(false);
  function lo() {
    const o = /* @__PURE__ */ new Set(), e = /* @__PURE__ */ new WeakMap(), a = () => o.forEach(wl);
    return { add: (n) => {
  ...
  var Wo = (o) => o === true;
  var ml = (o) => Wo(o === true) || o === "id";
  var xl = ({ children: o, id: e, inherit: a = true }) => {
    const n = S.useContext(am), i = S.useContext(gl), [u, h] = bl(), v = S.useRef(null), g = n.id || i;
    v.current === null && (ml(a) && g && (e = e ? g + "-" + e : g), v.current = { id: e, group: Wo(a) && n.group || lo() });
    const b2 = S.useMemo(() => ({ ...v.current, forceRender: u }), [h]);
    return Y2.jsx(am.Provider, { value: b2, children: o });
  };
  var yl = class extends z {
    ...
    add(e) {
      (dm.has(e) || hl.has(e)) && (this.isEnabled = true, this.update());
    }
    update() {
  ...
  function kl() {
    return pu(() => new yl("auto"));
  }
  var tt2 = { top: "top", bottom: "top", left: "left", right: "left" };
  var Or2 = { top: "bottom", bottom: "top", left: "right", right: "left" };
  var Sl = { top: "left", left: "top" };
  var Ea = { top: "height", left: "width" };
  var qo = { width: "totalWidth", height: "totalHeight" };
  var Kr = {};
  var Ke = typeof document < "u" ? window.visualViewport : null;
  function io(o) {
    let e = 0, a = 0, n = 0, i = 0, u = 0, h = 0, v = {};
    var g;
    let b2 = ((g = Ke == null ? void 0 : Ke.scale) !== null && g !== void 0 ? g : 1) > 1;
    if (o.tagName === "BODY") {
      let F = document.documentElement;
      n = F.clientWidth, i = F.clientHeight;
      var y2;
      e = (y2 = Ke == null ? void 0 : Ke.width) !== null && y2 !== void 0 ? y2 : n;
      var _2;
      a = (_2 = Ke == null ? void 0 : Ke.height) !== null && _2 !== void 0 ? _2 : i, v.top = F.scrollTop || o.scrollTop, v.left = F.scrollLeft || o.scrollLeft, Ke && (u = Ke.offsetTop, h = Ke.offsetLeft);
    } else ({ width: e, height: a, top: u, left: h } = At(o)), v.top = o.scrollTop, v.left = o.scrollLeft, n = e, i = a;
    if (ey() && (o.tagName === "BODY" || o.tagName === "HTML") && b2) {
      v.top = 0, v.left = 0;
      var K2;
      u = (K2 = Ke == null ? void 0 : Ke.pageTop) !== null && K2 !== void 0 ? K2 : 0;
      var R3;
      h = (R3 = Ke == null ? void 0 : Ke.pageLeft) !== null && R3 !== void 0 ? R3 : 0;
    }
    return { width: e, height: a, totalWidth: n, totalHeight: i, scroll: v, top: u, left: h };
  }
  function Cl(o) {
    return { top: o.scrollTop, left: o.scrollLeft, width: o.scrollWidth, height: o.scrollHeight };
  }
  function so(o, e, a, n, i, u, h) {
    var v;
    let g = (v = i.scroll[o]) !== null && v !== void 0 ? v : 0, b2 = n[Ea[o]], y2 = n.scroll[tt2[o]] + u, _2 = b2 + n.scroll[tt2[o]] - u, K2 = e - g + h[o] - n[tt2[o]], R3 = e - g + a + h[o] - n[tt2[o]];
    return K2 < y2 ? y2 - K2 : R3 > _2 ? Math.max(_2 - R3, y2 - K2) : 0;
  }
  function El(o) {
  ...
  function co(o) {
    if (Kr[o]) return Kr[o];
    let [e, a] = o.split(" "), n = tt2[e] || "right", i = Sl[n];
    tt2[a] || (a = "center");
    let u = Ea[n], h = Ea[i];
    return Kr[o] = { placement: e, crossPlacement: a, axis: n, crossAxis: i, size: u, crossSize: h }, Kr[o];
  }
  function pa(o, e, a, n, i, u, h, v, g, b2) {
    let { placement: y2, crossPlacement: _2, axis: K2, crossAxis: R3, size: F, crossSize: I2 } = n, w2 = {};
    var z2;
    w2[R3] = (z2 = o[R3]) !== null && z2 !== void 0 ? z2 : 0;
    var E, M, L3, H2;
    _2 === "center" ? w2[R3] += (((E = o[I2]) !== null && E !== void 0 ? E : 0) - ((M = a[I2]) !== null && M !== void 0 ? M : 0)) / 2 : _2 !== R3 && (w2[R3] += ((L3 = o[I2]) !== null && L3 !== void 0 ? L3 : 0) - ((H2 = a[I2]) !== null && H2 !== void 0 ? H2 : 0)), w2[R3] += u;
    const N3 = o[R3] - a[I2] + g + b2, B2 = o[R3] + o[I2] - g - b2;
    if (w2[R3] = Ca(w2[R3], N3, B2), y2 === K2) {
      const ae2 = v ? h[F] : e[qo[F]];
      w2[Or2[K2]] = Math.floor(ae2 - o[K2] + i);
    } else w2[K2] = Math.floor(o[K2] + o[F] + i);
    return w2;
  }
  function _l(o, e, a, n, i, u, h, v) {
    const g = n ? a.height : e[qo.height];
    var b2;
    let y2 = o.top != null ? a.top + o.top : a.top + (g - ((b2 = o.bottom) !== null && b2 !== void 0 ? b2 : 0) - h);
    var _2, K2, R3, F, I2, w2;
    let z2 = v !== "top" ? Math.max(0, e.height + e.top + ((_2 = e.scroll.top) !== null && _2 !== void 0 ? _2 : 0) - y2 - (((K2 = i.top) !== null && K2 !== void 0 ? K2 : 0) + ((R3 = i.bottom) !== null && R3 !== void 0 ? R3 : 0) + u)) : Math.max(0, y2 + h - (e.top + ((F = e.scroll.top) !== null && F !== void 0 ? F : 0)) - (((I2 = i.top) !== null && I2 !== void 0 ? I2 : 0) + ((w2 = i.bottom) !== null && w2 !== void 0 ? w2 : 0) + u));
    return Math.min(e.height - u * 2, z2);
  }
  function uo(o, e, a, n, i, u) {
    let { placement: h, axis: v, size: g } = u;
    var b2, y2;
    if (h === v) return Math.max(0, a[v] - o[v] - ((b2 = o.scroll[v]) !== null && b2 !== void 0 ? b2 : 0) + e[v] - ((y2 = n[v]) !== null && y2 !== void 0 ? y2 : 0) - n[Or2[v]] - i);
    var _2;
    return Math.max(0, o[g] + o[v] + o.scroll[v] - e[v] - a[v] - a[g] - ((_2 = n[v]) !== null && _2 !== void 0 ? _2 : 0) - n[Or2[v]] - i);
  }
  function Pl(o, e, a, n, i, u, h, v, g, b2, y2, _2, K2, R3, F, I2) {
    let w2 = co(o), { size: z2, crossAxis: E, crossSize: M, placement: L3, crossPlacement: H2 } = w2, N3 = pa(e, v, a, w2, y2, _2, b2, K2, F, I2), B2 = y2, ae2 = uo(v, b2, e, i, u + y2, w2);
    if (h && n[z2] > ae2) {
      let Ee2 = co(`${Or2[L3]} ${H2}`), _e2 = pa(e, v, a, Ee2, y2, _2, b2, K2, F, I2);
      uo(v, b2, e, i, u + y2, Ee2) > ae2 && (w2 = Ee2, N3 = _e2, B2 = y2);
    }
    let re2 = "bottom";
    w2.axis === "top" ? w2.placement === "top" ? re2 = "top" : w2.placement === "bottom" && (re2 = "bottom") : w2.crossAxis === "top" && (w2.crossPlacement === "top" ? re2 = "bottom" : w2.crossPlacement === "bottom" && (re2 = "top"));
    let ne2 = so(E, N3[E], a[M], v, g, u, b2);
    N3[E] += ne2;
    let le2 = _l(N3, v, b2, K2, i, u, a.height, re2);
    R3 && R3 < le2 && (le2 = R3), a.height = Math.min(a.height, le2), N3 = pa(e, v, a, w2, B2, _2, b2, K2, F, I2), ne2 = so(E, N3[E], a[M], v, g, u, b2), N3[E] += ne2;
    let J3 = {}, ie2 = e[E] - N3[E] - i[tt2[E]], ge2 = ie2 + 0.5 * e[M];
    const ue2 = F / 2 + I2;
    var Se2, A2, W, V2;
    const q3 = tt2[E] === "left" ? ((Se2 = i.left) !== null && Se2 !== void 0 ? Se2 : 0) + ((A2 = i.right) !== null && A2 !== void 0 ? A2 : 0) : ((W = i.top) !== null && W !== void 0 ? W : 0) + ((V2 = i.bottom) !== null && V2 !== void 0 ? V2 : 0), U3 = a[M] - q3 - F / 2 - I2, se = e[E] + F / 2 - (N3[E] + i[tt2[E]]), ce2 = e[E] + e[M] - F / 2 - (N3[E] + i[tt2[E]]), ee2 = Ca(ge2, se, ce2);
    J3[E] = Ca(ee2, ue2, U3), { placement: L3, crossPlacement: H2 } = w2, F ? ie2 = J3[E] : H2 === "right" ? ie2 += e[M] : H2 === "center" && (ie2 += e[M] / 2);
    let we2 = L3 === "left" || L3 === "top" ? a[z2] : 0, Fe2 = { x: L3 === "top" || L3 === "bottom" ? ie2 : we2, y: L3 === "left" || L3 === "right" ? ie2 : we2 };
    return { position: N3, maxHeight: le2, arrowOffsetLeft: J3.left, arrowOffsetTop: J3.top, placement: L3, triggerAnchorPoint: Fe2 };
  }
  function zl(o) {
    let { placement: e, targetNode: a, overlayNode: n, scrollNode: i, padding: u, shouldFlip: h, boundaryElement: v, offset: g, crossOffset: b2, maxHeight: y2, arrowSize: _2 = 0, arrowBoundaryOffset: K2 = 0 } = o, R3 = n instanceof HTMLElement ? $l(n) : document.documentElement, F = R3 === document.documentElement;
    const I2 = window.getComputedStyle(R3).position;
    let w2 = !!I2 && I2 !== "static", z2 = F ? At(a) : po(a, R3);
    if (!F) {
      let { marginTop: J3, marginLeft: ie2 } = window.getComputedStyle(a);
      z2.top += parseInt(J3, 10) || 0, z2.left += parseInt(ie2, 10) || 0;
    }
    let E = At(n), M = El(n);
    var L3, H2;
    E.width += ((L3 = M.left) !== null && L3 !== void 0 ? L3 : 0) + ((H2 = M.right) !== null && H2 !== void 0 ? H2 : 0);
    var N3, B2;
    E.height += ((N3 = M.top) !== null && N3 !== void 0 ? N3 : 0) + ((B2 = M.bottom) !== null && B2 !== void 0 ? B2 : 0);
    let ae2 = Cl(i), re2 = io(v), ne2 = io(R3), le2 = v.tagName === "BODY" ? At(R3) : po(R3, v);
    return R3.tagName === "HTML" && v.tagName === "BODY" && (ne2.scroll.top = 0, ne2.scroll.left = 0), Pl(e, z2, E, ae2, M, u, h, re2, ne2, le2, g, b2, w2, y2, _2, K2);
  }
  function At(o) {
    let { top: e, left: a, width: n, height: i } = o.getBoundingClientRect(), { scrollTop: u, scrollLeft: h, clientTop: v, clientLeft: g } = document.documentElement;
    return { top: e + u - v, left: a + h - g, width: n, height: i };
  }
  function po(o, e) {
    let a = window.getComputedStyle(o), n;
    if (a.position === "fixed") {
      let { top: i, left: u, width: h, height: v } = o.getBoundingClientRect();
      n = { top: i, left: u, width: h, height: v };
    } else {
      n = At(o);
      let i = At(e), u = window.getComputedStyle(e);
      i.top += (parseInt(u.borderTopWidth, 10) || 0) - e.scrollTop, i.left += (parseInt(u.borderLeftWidth, 10) || 0) - e.scrollLeft, n.top -= i.top, n.left -= i.left;
    }
    return n.top -= parseInt(a.marginTop, 10) || 0, n.left -= parseInt(a.marginLeft, 10) || 0, n;
  }
  function $l(o) {
    let e = o.offsetParent;
    if (e && e === document.body && window.getComputedStyle(e).position === "static" && !fo(e) && (e = document.documentElement), e == null) for (e = o.parentElement; e && !fo(e); ) e = e.parentElement;
  ...
  function Tl(o) {
    ...
    S.useEffect(() => {
      ...
      let i = (u) => {
        ...
        let v = n || Zo.get(e.current);
        v && v();
      };
      return window.addEventListener("scroll", i, true), () => {
  ...
  function Fl(o) {
    let { direction: e } = s1(), { arrowSize: a, targetRef: n, overlayRef: i, arrowRef: u, scrollRef: h = i, placement: v = "bottom", containerPadding: g = 12, shouldFlip: b2 = true, boundaryElement: y2 = typeof document < "u" ? document.body : null, offset: _2 = 0, crossOffset: K2 = 0, shouldUpdatePosition: R3 = true, isOpen: F = true, onClose: I2, maxHeight: w2, arrowBoundaryOffset: z2 = 0 } = o, [E, M] = S.useState(null), L3 = [R3, v, i.current, n.current, u == null ? void 0 : u.current, h.current, g, b2, y2, _2, K2, F, e, w2, z2, a], H2 = S.useRef(ze2 == null ? void 0 : ze2.scale);
    S.useEffect(() => {
      F && (H2.current = ze2 == null ? void 0 : ze2.scale);
    }, [F]);
    let N3 = S.useCallback(() => {
      var J3, ie2, ge2;
      if (R3 === false || !F || !i.current || !n.current || !y2 || (ze2 == null ? void 0 : ze2.scale) !== H2.current || i.current.querySelector("[data-react-aria-incomplete]") || ((J3 = (ie2 = i.current).getAnimations) === null || J3 === void 0 ? void 0 : J3.call(ie2).length) > 0) return;
      let ue2 = null;
      if (h.current && h.current.contains(document.activeElement)) {
        ...
        if (ue2 = { type: "top", offset: ((A2 = ee2 == null ? void 0 : ee2.top) !== null && A2 !== void 0 ? A2 : 0) - we2.top }, ue2.offset > we2.height / 2) {
          ue2.type = "bottom";
          var W;
          ue2.offset = ((W = ee2 == null ? void 0 : ee2.bottom) !== null && W !== void 0 ? W : 0) - we2.bottom;
        }
      }
      let V2 = i.current;
      if (!w2 && i.current) {
        ...
        var U3;
        V2.style.maxHeight = ((U3 = (q3 = window.visualViewport) === null || q3 === void 0 ? void 0 : q3.height) !== null && U3 !== void 0 ? U3 : window.innerHeight) + "px";
      }
      var se;
      let ce2 = zl({ placement: Kl2(v, e), overlayNode: i.current, targetNode: n.current, scrollNode: h.current || i.current, padding: g, shouldFlip: b2, boundaryElement: y2, offset: _2, crossOffset: K2, maxHeight: w2, arrowSize: (se = a ?? (u == null || (ge2 = u.current) === null || ge2 === void 0 ? void 0 : ge2.getBoundingClientRect().width)) !== null && se !== void 0 ? se : 0, arrowBoundaryOffset: z2 });
      if (ce2.position) {
        if (V2.style.top = "", V2.style.bottom = "", V2.style.left = "", V2.style.right = "", Object.keys(ce2.position).forEach((ee2) => V2.style[ee2] = ce2.position[ee2] + "px"), V2.style.maxHeight = ce2.maxHeight != null ? ce2.maxHeight + "px" : "", ue2 && document.activeElement && h.current) {
          let ee2 = document.activeElement.getBoundingClientRect(), we2 = h.current.getBoundingClientRect(), Fe2 = ee2[ue2.type] - we2[ue2.type];
          h.current.scrollTop += Fe2 - ue2.offset;
        }
        M(ce2);
      }
    }, L3);
    Xe(N3, L3), Rl(N3), ao({ ref: i, onResize: N3 }), ao({ ref: n, onResize: N3 });
    ...
    let ae2 = S.useCallback(() => {
      B2.current || I2 == null || I2();
    }, [I2, B2]);
    Tl({ triggerRef: n, isOpen: F, onClose: I2 && ae2 });
    var re2, ne2, le2;
    return { overlayProps: { style: { position: E ? "absolute" : "fixed", top: E ? void 0 : 0, left: E ? void 0 : 0, zIndex: 1e5, ...E == null ? void 0 : E.position, maxHeight: (re2 = E == null ? void 0 : E.maxHeight) !== null && re2 !== void 0 ? re2 : "100vh" } }, placement: (ne2 = E == null ? void 0 : E.placement) !== null && ne2 !== void 0 ? ne2 : null, triggerAnchorPoint: (le2 = E == null ? void 0 : E.triggerAnchorPoint) !== null && le2 !== void 0 ? le2 : null, arrowProps: { "aria-hidden": "true", role: "presentation", style: { left: E == null ? void 0 : E.arrowOffsetLeft, top: E == null ? void 0 : E.arrowOffsetTop } }, updatePosition: N3 };
  }
  function Rl(o) {
  ...
  function Ml(o, e, a) {
    let { type: n } = o, { isOpen: i } = e;
    S.useEffect(() => {
      a && a.current && Zo.set(a.current, e.close);
    });
    let u;
    n === "menu" ? u = true : n === "listbox" && (u = "listbox");
    let h = Mp();
    return { triggerProps: { "aria-haspopup": u, "aria-expanded": i, "aria-controls": i ? h : void 0, onPress: e.toggle }, overlayProps: { id: h } };
  }
  var ho = (o) => Y2.jsx("svg", { "aria-hidden": "true", fill: "none", focusable: "false", height: "1em", role: "presentation", viewBox: "0 0 24 24", width: "1em", ...o, children: Y2.jsx("path", { d: "M15.5 19l-7-7 7-7", stroke: "currentColor", strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: "1.5" }) });
  function Il(o, e) {
    let { elementType: a = "button", isDisabled: n, onPress: i, onPressStart: u, onPressEnd: h, onPressUp: v, onPressChange: g, preventFocusOnPress: b2, allowFocusWhenDisabled: y2, onClick: _2, href: K2, target: R3, rel: F, type: I2 = "button" } = o, w2;
    a === "button" ? w2 = { type: I2, disabled: n, form: o.form, formAction: o.formAction, formEncType: o.formEncType, formMethod: o.formMethod, formNoValidate: o.formNoValidate, formTarget: o.formTarget, name: o.name, value: o.value } : w2 = { role: "button", href: a === "a" && !n ? K2 : void 0, target: a === "a" ? R3 : void 0, type: a === "input" ? I2 : void 0, disabled: a === "input" ? n : void 0, "aria-disabled": !n || a === "input" ? void 0 : n, rel: a === "a" ? F : void 0 };
    let { pressProps: z2, isPressed: E } = Kp({ onPressStart: u, onPressEnd: h, onPressChange: g, onPress: i, onPressUp: v, onClick: _2, isDisabled: n, preventFocusOnPress: b2, ref: e }), { focusableProps: M } = nm(o, e);
    y2 && (M.tabIndex = n ? -1 : M.tabIndex);
    let L3 = nn2(M, z2, eu(o, { labelable: true }));
    return { isPressed: E, buttonProps: nn2(w2, L3, { "aria-haspopup": o["aria-haspopup"], "aria-expanded": o["aria-expanded"], "aria-controls": o["aria-controls"], "aria-pressed": o["aria-pressed"], "aria-current": o["aria-current"], "aria-disabled": o["aria-disabled"] }) };
  }
  var ht2 = {};
  var Et2 = {};
  var go;
  function jl() {
    ...
    var o = Ys2();
    function e(t) {
      for (var s = "https://reactjs.org/docs/error-decoder.html?invariant=" + t, d = 1; d < arguments.length; d++) s += "&args[]=" + encodeURIComponent(arguments[d]);
    ...
    var a = Object.prototype.hasOwnProperty, n = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, i = {}, u = {};
    function h(t) {
      return a.call(u, t) ? true : a.call(i, t) ? false : n.test(t) ? u[t] = true : (i[t] = true, false);
    }
    function v(t, s, d, f2, C, m2, $) {
      this.acceptsBooleans = s === 2 || s === 3 || s === 4, this.attributeName = f2, this.attributeNamespace = C, this.mustUseProperty = d, this.propertyName = t, this.type = s, this.sanitizeURL = m2, this.removeEmptyString = $;
    }
    var g = {};
    "children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(t) {
      ...
      var s = t[0];
      g[s] = new v(s, 1, false, t[1], null, false, false);
    ...
    "accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(t) {
      var s = t.replace(b2, y2);
      g[s] = new v(s, 1, false, t, null, false, false);
    }), "xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(t) {
      var s = t.replace(b2, y2);
      g[s] = new v(s, 1, false, t, "http://www.w3.org/1999/xlink", false, false);
    }), ["xml:base", "xml:lang", "xml:space"].forEach(function(t) {
      var s = t.replace(b2, y2);
      g[s] = new v(s, 1, false, t, "http://www.w3.org/XML/1998/namespace", false, false);
    ...
    var _2 = { animationIterationCount: true, aspectRatio: true, borderImageOutset: true, borderImageSlice: true, borderImageWidth: true, boxFlex: true, boxFlexGroup: true, boxOrdinalGroup: true, columnCount: true, columns: true, flex: true, flexGrow: true, flexPositive: true, flexShrink: true, flexNegative: true, flexOrder: true, gridArea: true, gridRow: true, gridRowEnd: true, gridRowSpan: true, gridRowStart: true, gridColumn: true, gridColumnEnd: true, gridColumnSpan: true, gridColumnStart: true, fontWeight: true, lineClamp: true, lineHeight: true, opacity: true, order: true, orphans: true, tabSize: true, widows: true, zIndex: true, zoom: true, fillOpacity: true, floodOpacity: true, stopOpacity: true, strokeDasharray: true, strokeDashoffset: true, strokeMiterlimit: true, strokeOpacity: true, strokeWidth: true }, K2 = ["Webkit", "ms", "Moz", "O"];
    Object.keys(_2).forEach(function(t) {
      K2.forEach(function(s) {
        s = s + t.charAt(0).toUpperCase() + t.substring(1), _2[s] = _2[t];
      });
    });
    var R3 = /["'&<>]/;
    function F(t) {
      ...
      if (s) {
        var d = "", f2, C = 0;
        for (f2 = s.index; f2 < t.length; f2++) {
          switch (t.charCodeAt(f2)) {
            case 34:
              s = "&quot;";
              break;
            case 38:
          ...
          C !== f2 && (d += t.substring(C, f2)), C = f2 + 1, d += s;
        }
        t = C !== f2 ? d + t.substring(C, f2) : d;
      }
      return t;
    }
    var I2 = /([A-Z])/g, w2 = /^ms-/, z2 = Array.isArray;
    function E(t, s) {
      return { insertionMode: t, selectedValue: s };
    }
    function M(t, s, d) {
      switch (s) {
        case "select":
      ...
      return 4 <= t.insertionMode || t.insertionMode === 0 ? E(1, null) : t;
    }
    var L3 = /* @__PURE__ */ new Map();
    function H2(t, s, d) {
      if (typeof d != "object") throw Error(e(62));
      s = true;
      for (var f2 in d) if (a.call(d, f2)) {
        var C = d[f2];
        if (C != null && typeof C != "boolean" && C !== "") {
          if (f2.indexOf("--") === 0) {
            ...
            m2 = f2;
            var $ = L3.get(m2);
            $ !== void 0 || ($ = F(m2.replace(I2, "-$1").toLowerCase().replace(w2, "-ms-")), L3.set(m2, $)), m2 = $, C = typeof C == "number" ? C === 0 || a.call(_2, f2) ? "" + C : C + "px" : F(("" + C).trim());
          }
          s ? (s = false, t.push(' style="', m2, ":", C)) : t.push(";", m2, ":", C);
        }
      }
      s || t.push('"');
    }
    function N3(t, s, d, f2) {
      switch (d) {
        case "style":
          H2(t, s, f2);
          return;
      ...
      if (!(2 < d.length) || d[0] !== "o" && d[0] !== "O" || d[1] !== "n" && d[1] !== "N") {
        if (s = g.hasOwnProperty(d) ? g[d] : null, s !== null) {
          ...
          switch (d = s.attributeName, s.type) {
            case 3:
              f2 && t.push(" ", d, '=""');
              break;
            case 4:
              f2 === true ? t.push(" ", d, '=""') : f2 !== false && t.push(" ", d, '="', F(f2), '"');
              break;
            case 5:
              isNaN(f2) || t.push(" ", d, '="', F(f2), '"');
              break;
            case 6:
              !isNaN(f2) && 1 <= f2 && t.push(" ", d, '="', F(f2), '"');
              break;
            default:
              s.sanitizeURL && (f2 = "" + f2), t.push(" ", d, '="', F(f2), '"');
          }
        } else if (h(d)) {
          switch (typeof f2) {
            case "function":
    ...
    function re2(t, s, d, f2) {
      t.push(J3(d));
      var C = d = null, m2;
      for (m2 in s) if (a.call(s, m2)) {
        var $ = s[m2];
        if ($ != null) switch (m2) {
          case "children":
            d = $;
      ...
      return t.push(">"), B2(t, C, d), typeof d == "string" ? (t.push(F(d)), null) : d;
    }
    ...
    function ie2(t, s, d, f2, C) {
      switch (s) {
        case "select":
          t.push(J3("select"));
          var m2 = null, $ = null;
          for (Q2 in d) if (a.call(d, Q2)) {
            var D2 = d[Q2];
            if (D2 != null) switch (Q2) {
              case "children":
                m2 = D2;
                break;
              case "dangerouslySetInnerHTML":
          ...
          return t.push(">"), B2(t, $, m2), m2;
        case "option":
          $ = C.selectedValue, t.push(J3("option"));
          var Z2 = D2 = null, G2 = null, Q2 = null;
          for (m2 in d) if (a.call(d, m2)) {
            var ke = d[m2];
            if (ke != null) switch (m2) {
              case "children":
                D2 = ke;
                break;
              case "selected":
          ...
          if ($ != null) if (d = Z2 !== null ? "" + Z2 : ae2(D2), z2($)) {
            for (f2 = 0; f2 < $.length; f2++) if ("" + $[f2] === d) {
              t.push(' selected=""');
              break;
            }
          } else "" + $ === d && t.push(' selected=""');
          else G2 && t.push(' selected=""');
          return t.push(">"), B2(t, Q2, D2), D2;
        case "textarea":
          t.push(J3("textarea")), Q2 = $ = m2 = null;
          ...
          if (m2 === null && $ !== null && (m2 = $), t.push(">"), Q2 != null) {
            if (m2 != null) throw Error(e(92));
            if (z2(Q2) && 1 < Q2.length) throw Error(e(93));
            m2 = "" + Q2;
          }
          return typeof m2 == "string" && m2[0] === `
` && t.push(`
`), m2 !== null && t.push(F("" + m2)), null;
        case "input":
          t.push(J3("input")), Z2 = Q2 = D2 = m2 = null;
          for ($ in d) if (a.call(d, $) && (G2 = d[$], G2 != null)) switch ($) {
            case "children":
            case "dangerouslySetInnerHTML":
          ...
          return Q2 !== null ? N3(t, f2, "checked", Q2) : Z2 !== null && N3(t, f2, "checked", Z2), m2 !== null ? N3(t, f2, "value", m2) : D2 !== null && N3(t, f2, "value", D2), t.push("/>"), null;
        case "menuitem":
          t.push(J3("menuitem"));
          for (var qe in d) if (a.call(d, qe) && (m2 = d[qe], m2 != null)) switch (qe) {
            case "children":
            case "dangerouslySetInnerHTML":
              throw Error(e(400));
            default:
          ...
          return t.push(">"), null;
        case "title":
          t.push(J3("title")), m2 = null;
          for (ke in d) if (a.call(d, ke) && ($ = d[ke], $ != null)) switch (ke) {
            case "children":
              m2 = $;
              break;
            case "dangerouslySetInnerHTML":
        ...
        case "pre":
          ...
          if (t.push(">"), $ != null) {
            if (m2 != null) throw Error(e(60));
            if (typeof $ != "object" || !("__html" in $)) throw Error(e(61));
...
`), m2;
        ...
        case "wbr":
          t.push(J3(s));
          for (var Ze in d) if (a.call(d, Ze) && (m2 = d[Ze], m2 != null)) switch (Ze) {
            case "children":
            case "dangerouslySetInnerHTML":
              throw Error(e(399, s));
            default:
        ...
        case "missing-glyph":
          return re2(t, d, s, f2);
        case "html":
          return C.insertionMode === 0 && t.push("<!DOCTYPE html>"), re2(t, d, s, f2);
        default:
          if (s.indexOf("-") === -1 && typeof d.is != "string") return re2(t, d, s, f2);
          t.push(J3(s)), $ = m2 = null;
          for (G2 in d) if (a.call(d, G2) && (D2 = d[G2], D2 != null)) switch (G2) {
            ...
            case "suppressHydrationWarning":
              break;
            default:
              h(G2) && typeof D2 != "function" && typeof D2 != "symbol" && t.push(" ", G2, '="', F(D2), '"');
          }
          return t.push(">"), B2(t, $, m2), m2;
      }
    }
    ...
    function ue2(t, s, d, f2) {
      switch (d.insertionMode) {
        case 0:
        case 1:
          return t.push('<div hidden id="'), t.push(s.segmentPrefix), s = f2.toString(16), t.push(s), t.push('">');
        case 2:
          return t.push('<svg aria-hidden="true" style="display:none" id="'), t.push(s.segmentPrefix), s = f2.toString(16), t.push(s), t.push('">');
        case 3:
          return t.push('<math aria-hidden="true" style="display:none" id="'), t.push(s.segmentPrefix), s = f2.toString(16), t.push(s), t.push('">');
        case 4:
          return t.push('<table hidden id="'), t.push(s.segmentPrefix), s = f2.toString(16), t.push(s), t.push('">');
        case 5:
          return t.push('<table hidden><tbody id="'), t.push(s.segmentPrefix), s = f2.toString(16), t.push(s), t.push('">');
        case 6:
          return t.push('<table hidden><tr id="'), t.push(s.segmentPrefix), s = f2.toString(16), t.push(s), t.push('">');
        case 7:
          return t.push('<table hidden><colgroup id="'), t.push(s.segmentPrefix), s = f2.toString(16), t.push(s), t.push('">');
        default:
          throw Error(e(397));
      }
    }
    ...
    var A2 = /[<\u2028\u2029]/g;
    function W(t) {
      return JSON.stringify(t).replace(A2, function(s) {
        switch (s) {
          case "<":
            return "\\u003c";
          case "\u2028":
    ...
    function V2(t, s) {
      return s = s === void 0 ? "" : s, { bootstrapChunks: [], startInlineScript: "<script>", placeholderPrefix: s + "P:", segmentPrefix: s + "S:", boundaryPrefix: s + "B:", idPrefix: s, nextSuspenseID: 0, sentCompleteSegmentFunction: false, sentCompleteBoundaryFunction: false, sentClientRenderFunction: false, generateStaticMarkup: t };
    }
    function q3(t, s, d, f2) {
      return d.generateStaticMarkup ? (t.push(F(s)), false) : (s === "" ? t = f2 : (f2 && t.push("<!-- -->"), t.push(F(s)), t = true), t);
    }
    var U3 = Object.assign, se = Symbol.for("react.element"), ce2 = Symbol.for("react.portal"), ee2 = Symbol.for("react.fragment"), we2 = Symbol.for("react.strict_mode"), Fe2 = Symbol.for("react.profiler"), Ee2 = Symbol.for("react.provider"), _e2 = Symbol.for("react.context"), pe2 = Symbol.for("react.forward_ref"), ye = Symbol.for("react.suspense"), de2 = Symbol.for("react.suspense_list"), O3 = Symbol.for("react.memo"), fe2 = Symbol.for("react.lazy"), he3 = Symbol.for("react.scope"), Oe2 = Symbol.for("react.debug_trace_mode"), X2 = Symbol.for("react.legacy_hidden"), $e2 = Symbol.for("react.default_value"), He2 = Symbol.iterator;
    function Ve3(t) {
      ...
      if (typeof t == "object") switch (t.$$typeof) {
        ...
        case O3:
          return s = t.displayName || null, s !== null ? s : Ve3(t.type) || "Memo";
        case fe2:
    ...
    var Me2 = {};
    function it2(t, s) {
      if (t = t.contextTypes, !t) return Me2;
      var d = {}, f2;
      for (f2 in t) d[f2] = s[f2];
      return d;
    }
    var je2 = null;
    function Re3(t, s) {
    ...
    function ct2(t) {
      var s = t.parent;
      s !== null && ct2(s), t.context._currentValue2 = t.value;
    }
    function Pe2(t, s) {
      if (t.context._currentValue2 = t.parentValue, t = t.parent, t === null) throw Error(e(402));
      t.depth === s.depth ? Re3(t, s) : Pe2(t, s);
    }
    function rt2(t, s) {
      var d = s.parent;
      if (d === null) throw Error(e(402));
      t.depth === d.depth ? Re3(t, d) : rt2(t, d), s.context._currentValue2 = s.value;
    }
    function Ue2(t) {
      var s = je2;
      s !== t && (s === null ? ct2(t) : t === null ? st2(s) : s.depth === t.depth ? Re3(s, t) : s.depth > t.depth ? Pe2(s, t) : rt2(s, t), je2 = t);
    }
    var Ce2 = { isMounted: function() {
      return false;
    }, enqueueSetState: function(t, s) {
      t = t._reactInternals, t.queue !== null && t.queue.push(s);
    }, enqueueReplaceState: function(t, s) {
      t = t._reactInternals, t.replace = true, t.queue = [s];
    }, enqueueForceUpdate: function() {
    } };
    function We2(t, s, d, f2) {
      var C = t.state !== void 0 ? t.state : null;
      t.updater = Ce2, t.props = d, t.state = C;
      var m2 = { queue: [], replace: false };
      t._reactInternals = m2;
      var $ = s.contextType;
      if (t.context = typeof $ == "object" && $ !== null ? $._currentValue2 : f2, $ = s.getDerivedStateFromProps, typeof $ == "function" && ($ = $(d, C), C = $ == null ? C : U3({}, C, $), t.state = C), typeof s.getDerivedStateFromProps != "function" && typeof t.getSnapshotBeforeUpdate != "function" && (typeof t.UNSAFE_componentWillMount == "function" || typeof t.componentWillMount == "function")) if (s = t.state, typeof t.componentWillMount == "function" && t.componentWillMount(), typeof t.UNSAFE_componentWillMount == "function" && t.UNSAFE_componentWillMount(), s !== t.state && Ce2.enqueueReplaceState(t, t.state, null), m2.queue !== null && 0 < m2.queue.length) if (s = m2.queue, $ = m2.replace, m2.queue = null, m2.replace = false, $ && s.length === 1) t.state = s[0];
      else {
        for (m2 = $ ? s[0] : t.state, C = true, $ = $ ? 1 : 0; $ < s.length; $++) {
          var D2 = s[$];
          D2 = typeof D2 == "function" ? D2.call(t, m2, d, f2) : D2, D2 != null && (C ? (C = false, m2 = U3({}, m2, D2)) : U3(m2, D2));
        }
        t.state = m2;
      }
      else m2.queue = null;
    ...
    function gt2(t, s, d) {
      ...
      if (30 < m2) {
        var $ = C - C % 5;
        return m2 = (f2 & (1 << $) - 1).toString(32), f2 >>= $, C -= $, { id: 1 << 32 - _t2(s) + C | d << C | f2, overflow: m2 + t };
      }
      return { id: 1 << m2 | d << C | f2, overflow: t };
    }
    var _t2 = Math.clz32 ? Math.clz32 : Yr, qr = Math.log, Zr = Math.LN2;
    function Yr(t) {
      return t >>>= 0, t === 0 ? 32 : 31 - (qr(t) / Zr | 0) | 0;
    }
    function Xr(t, s) {
      return t === s && (t !== 0 || 1 / t === 1 / s) || t !== t && s !== s;
    }
    var Gr = typeof Object.is == "function" ? Object.is : Xr, Be3 = null, Dt = null, Pt = null, ve2 = null, vt2 = false, zt2 = false, bt2 = 0, et2 = null, $t3 = 0;
    function ot2() {
    ...
    function Lt2() {
      return ve2 === null ? Pt === null ? (vt2 = false, Pt = ve2 = lr2()) : (vt2 = true, ve2 = Pt) : ve2.next === null ? (vt2 = false, ve2 = ve2.next = lr2()) : (vt2 = true, ve2 = ve2.next), ve2;
    }
    function Nt2() {
      Dt = Be3 = null, zt2 = false, Pt = null, $t3 = 0, ve2 = et2 = null;
    }
    function ir2(t, s) {
      return typeof s == "function" ? s(t) : s;
    }
    function sr2(t, s, d) {
      if (Be3 = ot2(), ve2 = Lt2(), vt2) {
        var f2 = ve2.queue;
        if (s = f2.dispatch, et2 !== null && (d = et2.get(f2), d !== void 0)) {
          et2.delete(f2), f2 = ve2.memoizedState;
          do
            f2 = t(f2, d.action), d = d.next;
          while (d !== null);
          return ve2.memoizedState = f2, [f2, s];
        }
        return [ve2.memoizedState, s];
      }
      return t = t === ir2 ? typeof s == "function" ? s() : s : d !== void 0 ? d(s) : s, ve2.memoizedState = t, t = ve2.queue = { last: null, dispatch: null }, t = t.dispatch = Jr.bind(null, Be3, t), [ve2.memoizedState, t];
    }
    function cr2(t, s) {
      if (Be3 = ot2(), ve2 = Lt2(), s = s === void 0 ? null : s, ve2 !== null) {
        var d = ve2.memoizedState;
        if (d !== null && s !== null) {
          var f2 = d[1];
          e: if (f2 === null) f2 = false;
          else {
            for (var C = 0; C < f2.length && C < s.length; C++) if (!Gr(s[C], f2[C])) {
              f2 = false;
              break e;
            }
            f2 = true;
      ...
      return t = t(), ve2.memoizedState = [t, s], t;
    }
    function Jr(t, s, d) {
      if (25 <= $t3) throw Error(e(301));
      if (t === Be3) if (zt2 = true, t = { action: d, next: null }, et2 === null && (et2 = /* @__PURE__ */ new Map()), d = et2.get(s), d === void 0) et2.set(s, t);
      else {
    ...
    var dr2 = { readContext: function(t) {
      ...
      Be3 = ot2(), ve2 = Lt2();
      var s = ve2.memoizedState;
      return s === null ? (t = { current: t }, ve2.memoizedState = t) : s;
    }, useState: function(t) {
      return sr2(ir2, t);
      ...
      var t = Dt.treeContext, s = t.overflow;
      t = t.id, t = (t & ~(1 << 32 - _t2(t) - 1)).toString(32) + s;
      var d = Ft;
      if (d === null) throw Error(e(404));
      return s = bt2++, t = ":" + d.idPrefix + "R" + t, 0 < s && (t += "H" + s.toString(32)), t + ":";
    }, useMutableSource: function(t, s) {
      return ot2(), s(t._source);
    }, useSyncExternalStore: function(t, s, d) {
      if (d === void 0) throw Error(e(407));
      return d();
    } }, Ft = null, Ot2 = o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;
    function ea(t) {
      return console.error(t), null;
    }
    function wt() {
    }
    function ta(t, s, d, f2, C, m2, $, D2, Z2) {
      var G2 = [], Q2 = /* @__PURE__ */ new Set();
      return s = { destination: null, responseState: s, progressiveChunkSize: f2 === void 0 ? 12800 : f2, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: Q2, pingedTasks: G2, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: C === void 0 ? ea : C, onAllReady: wt, onShellReady: $ === void 0 ? wt : $, onShellError: wt, onFatalError: wt }, d = Rt2(s, 0, null, d, false, false), d.parentFlushed = true, t = Bt3(s, t, null, d, Q2, Me2, null, at2), G2.push(t), s;
    }
    function Bt3(t, s, d, f2, C, m2, $, D2) {
      t.allPendingTasks++, d === null ? t.pendingRootTasks++ : d.pendingTasks++;
      var Z2 = { node: s, ping: function() {
        var G2 = t.pingedTasks;
        G2.push(Z2), G2.length === 1 && vr2(t);
      }, blockedBoundary: d, blockedSegment: f2, abortSet: C, legacyContext: m2, context: $, treeContext: D2 };
      return C.add(Z2), Z2;
    }
    function Rt2(t, s, d, f2, C, m2) {
      return { status: 0, id: -1, index: s, parentFlushed: false, chunks: [], children: [], formatContext: f2, boundary: d, lastPushedText: C, textEmbedded: m2 };
    }
    function mt3(t, s) {
      if (t = t.onError(s), t != null && typeof t != "string") throw Error('onError returned something with a type other than "string". onError should return a string and may return null or undefined but must not return anything else. It received something of type "' + typeof t + '" instead');
      return t;
    }
    function Kt2(t, s) {
      var d = t.onShellError;
      d(s), d = t.onFatalError, d(s), t.destination !== null ? (t.status = 2, t.destination.destroy(s)) : (t.status = 1, t.fatalError = s);
    }
    function ur2(t, s, d, f2, C) {
      for (Be3 = {}, Dt = s, bt2 = 0, t = d(f2, C); zt2; ) zt2 = false, bt2 = 0, $t3 += 1, ve2 = null, t = d(f2, C);
      return Nt2(), t;
    }
    function pr2(t, s, d, f2) {
      var C = d.render(), m2 = f2.childContextTypes;
      if (m2 != null) {
        var $ = s.legacyContext;
        if (typeof d.getChildContext != "function") f2 = $;
        else {
          d = d.getChildContext();
          for (var D2 in d) if (!(D2 in m2)) throw Error(e(108, Ve3(f2) || "Unknown", D2));
          f2 = U3({}, $, d);
        }
        s.legacyContext = f2, Ie2(t, s, C), s.legacyContext = $;
      } else Ie2(t, s, C);
    }
    function fr2(t, s) {
      if (t && t.defaultProps) {
        s = U3({}, s), t = t.defaultProps;
        for (var d in t) s[d] === void 0 && (s[d] = t[d]);
        return s;
      }
      return s;
    }
    function Ht2(t, s, d, f2, C) {
      if (typeof d == "function") if (d.prototype && d.prototype.isReactComponent) {
        C = it2(d, s.legacyContext);
        var m2 = d.contextType;
        m2 = new d(f2, typeof m2 == "object" && m2 !== null ? m2._currentValue2 : C), We2(m2, d, f2, C), pr2(t, s, m2, d);
      } else {
        m2 = it2(d, s.legacyContext), C = ur2(t, s, d, f2, m2);
        var $ = bt2 !== 0;
        if (typeof C == "object" && C !== null && typeof C.render == "function" && C.$$typeof === void 0) We2(C, d, f2, m2), pr2(t, s, C, d);
        else if ($) {
          f2 = s.treeContext, s.treeContext = gt2(f2, 1, 0);
          try {
            Ie2(t, s, C);
          } finally {
            s.treeContext = f2;
        ...
        switch (C = s.blockedSegment, m2 = ie2(C.chunks, d, f2, t.responseState, C.formatContext), C.lastPushedText = false, $ = C.formatContext, C.formatContext = M($, d, f2), Vt2(t, s, m2), C.formatContext = $, d) {
          case "area":
          case "base":
          case "br":
          case "col":
        ...
        switch (d) {
          ...
          case ye:
            e: {
              d = s.blockedBoundary, C = s.blockedSegment, m2 = f2.fallback, f2 = f2.children, $ = /* @__PURE__ */ new Set();
              var D2 = { id: null, rootSegmentID: -1, parentFlushed: false, pendingTasks: 0, forceClientRender: false, completedSegments: [], byteSize: 0, fallbackAbortableTasks: $, errorDigest: null }, Z2 = Rt2(t, C.chunks.length, D2, C.formatContext, false, false);
              C.children.push(Z2), C.lastPushedText = false;
              var G2 = Rt2(t, 0, null, C.formatContext, false, false);
              G2.parentFlushed = true, s.blockedBoundary = D2, s.blockedSegment = G2;
              try {
                if (Vt2(t, s, f2), t.responseState.generateStaticMarkup || G2.lastPushedText && G2.textEmbedded && G2.chunks.push("<!-- -->"), G2.status = 1, dt3(D2, G2), D2.pendingTasks === 0) break e;
              } catch (Q2) {
                G2.status = 4, D2.forceClientRender = true, D2.errorDigest = mt3(t, Q2);
              } finally {
                s.blockedBoundary = d, s.blockedSegment = C;
              }
              s = Bt3(t, m2, d, Z2, $, s.legacyContext, s.context, s.treeContext), t.pingedTasks.push(s);
            }
            return;
        }
        if (typeof d == "object" && d !== null) switch (d.$$typeof) {
          case pe2:
            if (f2 = ur2(t, s, d.render, f2, C), bt2 !== 0) {
              d = s.treeContext, s.treeContext = gt2(d, 1, 0);
              try {
                Ie2(t, s, f2);
              } finally {
                s.treeContext = d;
            ...
            return;
          case O3:
            d = d.type, f2 = fr2(d, f2), Ht2(t, s, d, f2, C);
            return;
          case Ee2:
            if (C = f2.children, d = d._context, f2 = f2.value, m2 = d._currentValue2, d._currentValue2 = f2, $ = je2, je2 = f2 = { parent: $, depth: $ === null ? 0 : $.depth + 1, context: d, parentValue: m2, value: f2 }, s.context = f2, Ie2(t, s, C), t = je2, t === null) throw Error(e(403));
            f2 = t.parentValue, t.context._currentValue2 = f2 === $e2 ? t.context._defaultValue : f2, t = je2 = t.parent, s.context = t;
            return;
          case _e2:
            f2 = f2.children, f2 = f2(d._currentValue2), Ie2(t, s, f2);
            return;
          case fe2:
            C = d._init, d = C(d._payload), f2 = fr2(d, f2), Ht2(t, s, d, f2, void 0);
            return;
        }
    ...
    function Ie2(t, s, d) {
      if (s.node = d, typeof d == "object" && d !== null) {
        switch (d.$$typeof) {
          case se:
            Ht2(t, s, d.type, d.props, d.ref);
            return;
          case ce2:
            throw Error(e(257));
          case fe2:
            var f2 = d._init;
            d = f2(d._payload), Ie2(t, s, d);
            return;
        }
        if (z2(d)) {
          hr2(t, s, d);
        ...
        if (d === null || typeof d != "object" ? f2 = null : (f2 = He2 && d[He2] || d["@@iterator"], f2 = typeof f2 == "function" ? f2 : null), f2 && (f2 = f2.call(d))) {
          if (d = f2.next(), !d.done) {
            var C = [];
            do
              C.push(d.value), d = f2.next();
            while (!d.done);
            hr2(t, s, C);
          }
          return;
      ...
      typeof d == "string" ? (f2 = s.blockedSegment, f2.lastPushedText = q3(s.blockedSegment.chunks, d, t.responseState, f2.lastPushedText)) : typeof d == "number" && (f2 = s.blockedSegment, f2.lastPushedText = q3(s.blockedSegment.chunks, "" + d, t.responseState, f2.lastPushedText));
    }
    function hr2(t, s, d) {
      for (var f2 = d.length, C = 0; C < f2; C++) {
        var m2 = s.treeContext;
        s.treeContext = gt2(m2, f2, C);
        try {
          Vt2(t, s, d[C]);
        } finally {
          s.treeContext = m2;
    ...
    function Vt2(t, s, d) {
      var f2 = s.blockedSegment.formatContext, C = s.legacyContext, m2 = s.context;
      try {
        return Ie2(t, s, d);
      } catch (Z2) {
        if (Nt2(), typeof Z2 == "object" && Z2 !== null && typeof Z2.then == "function") {
          d = Z2;
          var $ = s.blockedSegment, D2 = Rt2(t, $.chunks.length, null, $.formatContext, $.lastPushedText, true);
          $.children.push(D2), $.lastPushedText = false, t = Bt3(t, s.node, s.blockedBoundary, D2, s.abortSet, s.legacyContext, s.context, s.treeContext).ping, d.then(t, t), s.blockedSegment.formatContext = f2, s.legacyContext = C, s.context = m2, Ue2(m2);
        } else throw s.blockedSegment.formatContext = f2, s.legacyContext = C, s.context = m2, Ue2(m2), Z2;
      }
    }
    function Ut3(t) {
      var s = t.blockedBoundary;
      t = t.blockedSegment, t.status = 3, ut2(this, s, t);
    }
    function gr2(t, s, d) {
      var f2 = t.blockedBoundary;
      t.blockedSegment.status = 3, f2 === null ? (s.allPendingTasks--, s.status !== 2 && (s.status = 2, s.destination !== null && s.destination.push(null))) : (f2.pendingTasks--, f2.forceClientRender || (f2.forceClientRender = true, t = d === void 0 ? Error(e(432)) : d, f2.errorDigest = s.onError(t), f2.parentFlushed && s.clientRenderedBoundaries.push(f2)), f2.fallbackAbortableTasks.forEach(function(C) {
        return gr2(C, s, d);
      }), f2.fallbackAbortableTasks.clear(), s.allPendingTasks--, s.allPendingTasks === 0 && (f2 = s.onAllReady, f2()));
    }
    function dt3(t, s) {
      if (s.chunks.length === 0 && s.children.length === 1 && s.children[0].boundary === null) {
        var d = s.children[0];
        d.id = s.id, d.parentFlushed = true, d.status === 1 && dt3(t, d);
      } else t.completedSegments.push(s);
    }
    function ut2(t, s, d) {
      if (s === null) {
        if (d.parentFlushed) {
        ...
        t.pendingRootTasks--, t.pendingRootTasks === 0 && (t.onShellError = wt, s = t.onShellReady, s());
      } else s.pendingTasks--, s.forceClientRender || (s.pendingTasks === 0 ? (d.parentFlushed && d.status === 1 && dt3(s, d), s.parentFlushed && t.completedBoundaries.push(s), s.fallbackAbortableTasks.forEach(Ut3, t), s.fallbackAbortableTasks.clear()) : d.parentFlushed && d.status === 1 && (dt3(s, d), s.completedSegments.length === 1 && s.parentFlushed && t.partialBoundaries.push(s)));
      t.allPendingTasks--, t.allPendingTasks === 0 && (t = t.onAllReady, t());
    }
    function vr2(t) {
      if (t.status !== 2) {
        var s = je2, d = Ot2.current;
        Ot2.current = dr2;
        var f2 = Ft;
        Ft = t.responseState;
        try {
          var C = t.pingedTasks, m2;
          for (m2 = 0; m2 < C.length; m2++) {
            var $ = C[m2], D2 = t, Z2 = $.blockedSegment;
            if (Z2.status === 0) {
              Ue2($.context);
              try {
                Ie2(D2, $, $.node), D2.responseState.generateStaticMarkup || Z2.lastPushedText && Z2.textEmbedded && Z2.chunks.push("<!-- -->"), $.abortSet.delete($), Z2.status = 1, ut2(D2, $.blockedBoundary, Z2);
              } catch (De2) {
                if (Nt2(), typeof De2 == "object" && De2 !== null && typeof De2.then == "function") {
                  var G2 = $.ping;
                  De2.then(G2, G2);
                } else {
                  $.abortSet.delete($), Z2.status = 4;
                  var Q2 = $.blockedBoundary, ke = De2, qe = mt3(D2, ke);
                  if (Q2 === null ? Kt2(D2, ke) : (Q2.pendingTasks--, Q2.forceClientRender || (Q2.forceClientRender = true, Q2.errorDigest = qe, Q2.parentFlushed && D2.clientRenderedBoundaries.push(Q2))), D2.allPendingTasks--, D2.allPendingTasks === 0) {
          ...
          C.splice(0, m2), t.destination !== null && Mt(t, t.destination);
        } catch (De2) {
          mt3(t, De2), Kt2(t, De2);
        } finally {
          Ft = f2, Ot2.current = d, d === dr2 && Ue2(s);
        }
      }
    }
    function xt(t, s, d) {
      switch (d.parentFlushed = true, d.status) {
        case 0:
          var f2 = d.id = t.nextSegmentId++;
          return d.lastPushedText = false, d.textEmbedded = false, t = t.responseState, s.push('<template id="'), s.push(t.placeholderPrefix), t = f2.toString(16), s.push(t), s.push('"></template>');
        case 1:
          d.status = 2;
          var C = true;
          f2 = d.chunks;
          ...
          d = d.children;
          for (var $ = 0; $ < d.length; $++) {
            for (C = d[$]; m2 < C.index; m2++) s.push(f2[m2]);
            C = yt2(t, s, C);
          }
          for (; m2 < f2.length - 1; m2++) s.push(f2[m2]);
          return m2 < f2.length && (C = s.push(f2[m2])), C;
        default:
          throw Error(e(390));
      }
    }
    function yt2(t, s, d) {
      var f2 = d.boundary;
      if (f2 === null) return xt(t, s, d);
      if (f2.parentFlushed = true, f2.forceClientRender) return t.responseState.generateStaticMarkup || (f2 = f2.errorDigest, s.push("<!--$!-->"), s.push("<template"), f2 && (s.push(' data-dgst="'), f2 = F(f2), s.push(f2), s.push('"')), s.push("></template>")), xt(t, s, d), t = t.responseState.generateStaticMarkup ? true : s.push("<!--/$-->"), t;
      if (0 < f2.pendingTasks) {
        f2.rootSegmentID = t.nextSegmentId++, 0 < f2.completedSegments.length && t.partialBoundaries.push(f2);
        var C = t.responseState, m2 = C.nextSuspenseID++;
        return C = C.boundaryPrefix + m2.toString(16), f2 = f2.id = C, ge2(s, t.responseState, f2), xt(t, s, d), s.push("<!--/$-->");
      }
      if (f2.byteSize > t.progressiveChunkSize) return f2.rootSegmentID = t.nextSegmentId++, t.completedBoundaries.push(f2), ge2(s, t.responseState, f2.id), xt(t, s, d), s.push("<!--/$-->");
      if (t.responseState.generateStaticMarkup || s.push("<!--$-->"), d = f2.completedSegments, d.length !== 1) throw Error(e(391));
      return yt2(t, s, d[0]), t = t.responseState.generateStaticMarkup ? true : s.push("<!--/$-->"), t;
    }
    function Wt2(t, s, d) {
      return ue2(s, t.responseState, d.formatContext, d.id), yt2(t, s, d), Se2(s, d.formatContext);
    }
    function qt2(t, s, d) {
      for (var f2 = d.completedSegments, C = 0; C < f2.length; C++) Zt2(t, s, d, f2[C]);
      if (f2.length = 0, t = t.responseState, f2 = d.id, d = d.rootSegmentID, s.push(t.startInlineScript), t.sentCompleteBoundaryFunction ? s.push('$RC("') : (t.sentCompleteBoundaryFunction = true, s.push('function $RC(a,b){a=document.getElementById(a);b=document.getElementById(b);b.parentNode.removeChild(b);if(a){a=a.previousSibling;var f=a.parentNode,c=a.nextSibling,e=0;do{if(c&&8===c.nodeType){var d=c.data;if("/$"===d)if(0===e)break;else e--;else"$"!==d&&"$?"!==d&&"$!"!==d||e++}d=c.nextSibling;f.removeChild(c);c=d}while(c);for(;b.firstChild;)f.insertBefore(b.firstChild,c);a.data="$";a._reactRetry&&a._reactRetry()}};$RC("')), f2 === null) throw Error(e(395));
      return d = d.toString(16), s.push(f2), s.push('","'), s.push(t.segmentPrefix), s.push(d), s.push('")<\/script>');
    }
    function Zt2(t, s, d, f2) {
      if (f2.status === 2) return true;
      var C = f2.id;
      if (C === -1) {
        if ((f2.id = d.rootSegmentID) === -1) throw Error(e(392));
        return Wt2(t, s, f2);
      }
      return Wt2(t, s, f2), t = t.responseState, s.push(t.startInlineScript), t.sentCompleteSegmentFunction ? s.push('$RS("') : (t.sentCompleteSegmentFunction = true, s.push('function $RS(a,b){a=document.getElementById(a);b=document.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)};$RS("')), s.push(t.segmentPrefix), C = C.toString(16), s.push(C), s.push('","'), s.push(t.placeholderPrefix), s.push(C), s.push('")<\/script>');
    }
    function Mt(t, s) {
      try {
        var d = t.completedRootSegment;
        if (d !== null && t.pendingRootTasks === 0) {
          yt2(t, s, d), t.completedRootSegment = null;
          var f2 = t.responseState.bootstrapChunks;
          for (d = 0; d < f2.length - 1; d++) s.push(f2[d]);
          d < f2.length && s.push(f2[d]);
        }
        var C = t.clientRenderedBoundaries, m2;
        for (m2 = 0; m2 < C.length; m2++) {
          var $ = C[m2];
          f2 = s;
          var D2 = t.responseState, Z2 = $.id, G2 = $.errorDigest, Q2 = $.errorMessage, ke = $.errorComponentStack;
          if (f2.push(D2.startInlineScript), D2.sentClientRenderFunction ? f2.push('$RX("') : (D2.sentClientRenderFunction = true, f2.push('function $RX(b,c,d,e){var a=document.getElementById(b);a&&(b=a.previousSibling,b.data="$!",a=a.dataset,c&&(a.dgst=c),d&&(a.msg=d),e&&(a.stck=e),b._reactRetry&&b._reactRetry())};$RX("')), Z2 === null) throw Error(e(395));
          if (f2.push(Z2), f2.push('"'), G2 || Q2 || ke) {
            f2.push(",");
            var qe = W(G2 || "");
            f2.push(qe);
          }
          ...
          if (!f2.push(")<\/script>")) {
            t.destination = null, m2++, C.splice(0, m2);
            return;
          }
        }
        C.splice(0, m2);
        var kt2 = t.completedBoundaries;
        for (m2 = 0; m2 < kt2.length; m2++) if (!qt2(t, s, kt2[m2])) {
          t.destination = null, m2++, kt2.splice(0, m2);
          return;
        }
        kt2.splice(0, m2);
        var nt2 = t.partialBoundaries;
        for (m2 = 0; m2 < nt2.length; m2++) {
          var Xt2 = nt2[m2];
          e: {
            C = t, $ = s;
            var St = Xt2.completedSegments;
            for (D2 = 0; D2 < St.length; D2++) if (!Zt2(C, $, Xt2, St[D2])) {
              D2++, St.splice(0, D2);
              var mr2 = false;
              break e;
            }
          ...
          if (!mr2) {
            t.destination = null, m2++, nt2.splice(0, m2);
            return;
          }
        }
        nt2.splice(0, m2);
        var pt3 = t.completedBoundaries;
        for (m2 = 0; m2 < pt3.length; m2++) if (!qt2(t, s, pt3[m2])) {
          t.destination = null, m2++, pt3.splice(0, m2);
          return;
        }
        pt3.splice(0, m2);
      } finally {
        t.allPendingTasks === 0 && t.pingedTasks.length === 0 && t.clientRenderedBoundaries.length === 0 && t.completedBoundaries.length === 0 && s.push(null);
      }
    }
    function br2(t, s) {
      try {
        ...
        d.forEach(function(f2) {
          return gr2(f2, t, s);
        }), d.clear(), t.destination !== null && Mt(t, t.destination);
      } catch (f2) {
        mt3(t, f2), Kt2(t, f2);
      }
    }
    ...
    function Yt2(t, s, d, f2) {
      var C = false, m2 = null, $ = "", D2 = { push: function(G2) {
        return G2 !== null && ($ += G2), true;
      }, destroy: function(G2) {
        C = true, m2 = G2;
      } }, Z2 = false;
      if (t = ta(t, V2(d, s ? s.identifierPrefix : void 0), { insertionMode: 1, selectedValue: null }, 1 / 0, wr2, void 0, function() {
        Z2 = true;
      }), vr2(t), br2(t, f2), t.status === 1) t.status = 2, D2.destroy(t.fatalError);
    ...
    return Et2.renderToNodeStream = function() {
      throw Error(e(207));
    }, Et2.renderToStaticMarkup = function(t, s) {
      return Yt2(t, s, true, 'The server used "renderToStaticMarkup" which does not support Suspense. If you intended to have the server wait for the suspended component please switch to "renderToReadableStream" which supports Suspense on the server');
    }, Et2.renderToStaticNodeStream = function() {
      throw Error(e(208));
    }, Et2.renderToString = function(t, s) {
      return Yt2(t, s, false, 'The server used "renderToString" which does not support Suspense. If you intended for this Suspense boundary to render the fallback content on the server consider throwing an Error somewhere within the Suspense boundary. If you intended to have the server wait for the suspended component please switch to "renderToReadableStream" which supports Suspense on the server');
  ...
  function Al() {
    ...
    var o = Ys2();
    function e(r) {
      for (var l2 = "https://reactjs.org/docs/error-decoder.html?invariant=" + r, c = 1; c < arguments.length; c++) l2 += "&args[]=" + encodeURIComponent(arguments[c]);
      return "Minified React error #" + r + "; visit " + l2 + " for the full message or use the non-minified dev environment for full errors and additional helpful warnings.";
    }
    var a = null, n = 0;
    function i(r, l2) {
      if (l2.length !== 0) if (512 < l2.length) 0 < n && (r.enqueue(new Uint8Array(a.buffer, 0, n)), a = new Uint8Array(512), n = 0), r.enqueue(l2);
      else {
        var c = a.length - n;
        c < l2.length && (c === 0 ? r.enqueue(a) : (a.set(l2.subarray(0, c), n), r.enqueue(a), l2 = l2.subarray(c)), a = new Uint8Array(512), n = 0), a.set(l2, n), n += l2.length;
      }
    }
    function u(r, l2) {
      return i(r, l2), true;
    ...
    function y2(r, l2) {
      typeof r.error == "function" ? r.error(l2) : r.close();
    }
    var _2 = Object.prototype.hasOwnProperty, K2 = /^[:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD][:A-Z_a-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\-.0-9\u00B7\u0300-\u036F\u203F-\u2040]*$/, R3 = {}, F = {};
    function I2(r) {
      return _2.call(F, r) ? true : _2.call(R3, r) ? false : K2.test(r) ? F[r] = true : (R3[r] = true, false);
    }
    function w2(r, l2, c, p, k2, x2, T) {
      this.acceptsBooleans = l2 === 2 || l2 === 3 || l2 === 4, this.attributeName = p, this.attributeNamespace = k2, this.mustUseProperty = c, this.propertyName = r, this.type = l2, this.sanitizeURL = x2, this.removeEmptyString = T;
    }
    var z2 = {};
    "children dangerouslySetInnerHTML defaultValue defaultChecked innerHTML suppressContentEditableWarning suppressHydrationWarning style".split(" ").forEach(function(r) {
      z2[r] = new w2(r, 0, false, r, null, false, false);
    }), [["acceptCharset", "accept-charset"], ["className", "class"], ["htmlFor", "for"], ["httpEquiv", "http-equiv"]].forEach(function(r) {
      var l2 = r[0];
      z2[l2] = new w2(l2, 1, false, r[1], null, false, false);
    }), ["contentEditable", "draggable", "spellCheck", "value"].forEach(function(r) {
      z2[r] = new w2(r, 2, false, r.toLowerCase(), null, false, false);
    }), ["autoReverse", "externalResourcesRequired", "focusable", "preserveAlpha"].forEach(function(r) {
      z2[r] = new w2(r, 2, false, r, null, false, false);
    }), "allowFullScreen async autoFocus autoPlay controls default defer disabled disablePictureInPicture disableRemotePlayback formNoValidate hidden loop noModule noValidate open playsInline readOnly required reversed scoped seamless itemScope".split(" ").forEach(function(r) {
      z2[r] = new w2(r, 3, false, r.toLowerCase(), null, false, false);
    }), ["checked", "multiple", "muted", "selected"].forEach(function(r) {
      z2[r] = new w2(r, 3, true, r, null, false, false);
    }), ["capture", "download"].forEach(function(r) {
      z2[r] = new w2(r, 4, false, r, null, false, false);
    }), ["cols", "rows", "size", "span"].forEach(function(r) {
      z2[r] = new w2(r, 6, false, r, null, false, false);
    }), ["rowSpan", "start"].forEach(function(r) {
      z2[r] = new w2(r, 5, false, r.toLowerCase(), null, false, false);
    });
    var E = /[\-:]([a-z])/g;
    function M(r) {
    ...
    "accent-height alignment-baseline arabic-form baseline-shift cap-height clip-path clip-rule color-interpolation color-interpolation-filters color-profile color-rendering dominant-baseline enable-background fill-opacity fill-rule flood-color flood-opacity font-family font-size font-size-adjust font-stretch font-style font-variant font-weight glyph-name glyph-orientation-horizontal glyph-orientation-vertical horiz-adv-x horiz-origin-x image-rendering letter-spacing lighting-color marker-end marker-mid marker-start overline-position overline-thickness paint-order panose-1 pointer-events rendering-intent shape-rendering stop-color stop-opacity strikethrough-position strikethrough-thickness stroke-dasharray stroke-dashoffset stroke-linecap stroke-linejoin stroke-miterlimit stroke-opacity stroke-width text-anchor text-decoration text-rendering underline-position underline-thickness unicode-bidi unicode-range units-per-em v-alphabetic v-hanging v-ideographic v-mathematical vector-effect vert-adv-y vert-origin-x vert-origin-y word-spacing writing-mode xmlns:xlink x-height".split(" ").forEach(function(r) {
      var l2 = r.replace(E, M);
      z2[l2] = new w2(l2, 1, false, r, null, false, false);
    }), "xlink:actuate xlink:arcrole xlink:role xlink:show xlink:title xlink:type".split(" ").forEach(function(r) {
      var l2 = r.replace(E, M);
      z2[l2] = new w2(l2, 1, false, r, "http://www.w3.org/1999/xlink", false, false);
    }), ["xml:base", "xml:lang", "xml:space"].forEach(function(r) {
      var l2 = r.replace(E, M);
      z2[l2] = new w2(l2, 1, false, r, "http://www.w3.org/XML/1998/namespace", false, false);
    }), ["tabIndex", "crossOrigin"].forEach(function(r) {
      z2[r] = new w2(r, 1, false, r.toLowerCase(), null, false, false);
    }), z2.xlinkHref = new w2("xlinkHref", 1, false, "xlink:href", "http://www.w3.org/1999/xlink", true, false), ["src", "href", "action", "formAction"].forEach(function(r) {
      z2[r] = new w2(r, 1, false, r.toLowerCase(), null, true, true);
    });
    var L3 = { animationIterationCount: true, aspectRatio: true, borderImageOutset: true, borderImageSlice: true, borderImageWidth: true, boxFlex: true, boxFlexGroup: true, boxOrdinalGroup: true, columnCount: true, columns: true, flex: true, flexGrow: true, flexPositive: true, flexShrink: true, flexNegative: true, flexOrder: true, gridArea: true, gridRow: true, gridRowEnd: true, gridRowSpan: true, gridRowStart: true, gridColumn: true, gridColumnEnd: true, gridColumnSpan: true, gridColumnStart: true, fontWeight: true, lineClamp: true, lineHeight: true, opacity: true, order: true, orphans: true, tabSize: true, widows: true, zIndex: true, zoom: true, fillOpacity: true, floodOpacity: true, stopOpacity: true, strokeDasharray: true, strokeDashoffset: true, strokeMiterlimit: true, strokeOpacity: true, strokeWidth: true }, H2 = ["Webkit", "ms", "Moz", "O"];
    Object.keys(L3).forEach(function(r) {
      H2.forEach(function(l2) {
        l2 = l2 + r.charAt(0).toUpperCase() + r.substring(1), L3[l2] = L3[r];
      });
    });
    var N3 = /["'&<>]/;
    function B2(r) {
      ...
      if (l2) {
        ...
        for (p = l2.index; p < r.length; p++) {
          ...
          k2 !== p && (c += r.substring(k2, p)), k2 = p + 1, c += l2;
        }
        r = k2 !== p ? c + r.substring(k2, p) : c;
      }
      return r;
    }
    var ae2 = /([A-Z])/g, re2 = /^ms-/, ne2 = Array.isArray, le2 = b2("<script>"), J3 = b2("<\/script>"), ie2 = b2('<script src="'), ge2 = b2('<script type="module" src="'), ue2 = b2('" async=""><\/script>'), Se2 = /(<\/|<)(s)(cript)/gi;
    function A2(r, l2, c, p) {
      return "" + l2 + (c === "s" ? "\\u0073" : "\\u0053") + p;
    }
    function W(r, l2, c, p, k2) {
      r = r === void 0 ? "" : r, l2 = l2 === void 0 ? le2 : b2('<script nonce="' + B2(l2) + '">');
      var x2 = [];
      if (c !== void 0 && x2.push(l2, g(("" + c).replace(Se2, A2)), J3), p !== void 0) for (c = 0; c < p.length; c++) x2.push(ie2, g(B2(p[c])), ue2);
      if (k2 !== void 0) for (p = 0; p < k2.length; p++) x2.push(ge2, g(B2(k2[p])), ue2);
      return { bootstrapChunks: x2, startInlineScript: l2, placeholderPrefix: b2(r + "P:"), segmentPrefix: b2(r + "S:"), boundaryPrefix: r + "B:", idPrefix: r, nextSuspenseID: 0, sentCompleteSegmentFunction: false, sentCompleteBoundaryFunction: false, sentClientRenderFunction: false };
    }
    function V2(r, l2) {
      return { insertionMode: r, selectedValue: l2 };
    }
    function q3(r) {
    ...
    var se = b2("<!-- -->");
    function ce2(r, l2, c, p) {
      return l2 === "" ? p : (p && r.push(se), r.push(g(B2(l2))), true);
    }
    var ee2 = /* @__PURE__ */ new Map(), we2 = b2(' style="'), Fe2 = b2(":"), Ee2 = b2(";");
    function _e2(r, l2, c) {
      if (typeof c != "object") throw Error(e(62));
      l2 = true;
      for (var p in c) if (_2.call(c, p)) {
        var k2 = c[p];
        if (k2 != null && typeof k2 != "boolean" && k2 !== "") {
          if (p.indexOf("--") === 0) {
            var x2 = g(B2(p));
            k2 = g(B2(("" + k2).trim()));
          } else {
            x2 = p;
            var T = ee2.get(x2);
            T !== void 0 || (T = b2(B2(x2.replace(ae2, "-$1").toLowerCase().replace(re2, "-ms-"))), ee2.set(x2, T)), x2 = T, k2 = typeof k2 == "number" ? k2 === 0 || _2.call(L3, p) ? g("" + k2) : g(k2 + "px") : g(B2(("" + k2).trim()));
          }
          l2 ? (l2 = false, r.push(we2, x2, Fe2, k2)) : r.push(Ee2, x2, Fe2, k2);
        }
      }
      l2 || r.push(de2);
    }
    var pe2 = b2(" "), ye = b2('="'), de2 = b2('"'), O3 = b2('=""');
    function fe2(r, l2, c, p) {
      switch (c) {
        case "style":
          _e2(r, l2, p);
          return;
      ...
      if (!(2 < c.length) || c[0] !== "o" && c[0] !== "O" || c[1] !== "n" && c[1] !== "N") {
        if (l2 = z2.hasOwnProperty(c) ? z2[c] : null, l2 !== null) {
          switch (typeof p) {
            case "function":
            case "symbol":
              return;
            case "boolean":
              if (!l2.acceptsBooleans) return;
          }
          switch (c = g(l2.attributeName), l2.type) {
            case 3:
              p && r.push(pe2, c, O3);
              break;
            case 4:
              p === true ? r.push(pe2, c, O3) : p !== false && r.push(pe2, c, ye, g(B2(p)), de2);
              break;
            case 5:
              isNaN(p) || r.push(pe2, c, ye, g(B2(p)), de2);
              break;
            case 6:
              !isNaN(p) && 1 <= p && r.push(pe2, c, ye, g(B2(p)), de2);
              break;
            default:
              l2.sanitizeURL && (p = "" + p), r.push(pe2, c, ye, g(B2(p)), de2);
          }
        } else if (I2(c)) {
          switch (typeof p) {
            case "function":
            case "symbol":
              return;
            case "boolean":
              if (l2 = c.toLowerCase().slice(0, 5), l2 !== "data-" && l2 !== "aria-") return;
          }
          r.push(pe2, g(c), ye, g(B2(p)), de2);
        }
      }
    }
    var he3 = b2(">"), Oe2 = b2("/>");
    function X2(r, l2, c) {
      if (l2 != null) {
        ...
        if (typeof l2 != "object" || !("__html" in l2)) throw Error(e(61));
        l2 = l2.__html, l2 != null && r.push(g("" + l2));
      }
    }
    function $e2(r) {
      var l2 = "";
    ...
    var He2 = b2(' selected=""');
    function Ve3(r, l2, c, p) {
      r.push(Re3(c));
      var k2 = c = null, x2;
      for (x2 in l2) if (_2.call(l2, x2)) {
        var T = l2[x2];
        if (T != null) switch (x2) {
          case "children":
            c = T;
      ...
      return r.push(he3), X2(r, k2, c), typeof c == "string" ? (r.push(g(B2(c))), null) : c;
    }
    var Me2 = b2(`
`), it2 = /^[a-zA-Z][a-zA-Z:_\.\-\d]*$/, je2 = /* @__PURE__ */ new Map();
    function Re3(r) {
      ...
      if (l2 === void 0) {
        ...
        l2 = b2("<" + r), je2.set(r, l2);
      }
      return l2;
    }
    var st2 = b2("<!DOCTYPE html>");
    function ct2(r, l2, c, p, k2) {
      switch (l2) {
        case "select":
          r.push(Re3("select"));
          var x2 = null, T = null;
          for (te2 in c) if (_2.call(c, te2)) {
            var j2 = c[te2];
            if (j2 != null) switch (te2) {
              case "children":
                x2 = j2;
                break;
              case "dangerouslySetInnerHTML":
          ...
          return r.push(he3), X2(r, T, x2), x2;
        case "option":
          T = k2.selectedValue, r.push(Re3("option"));
          var Y3 = j2 = null, oe = null, te2 = null;
          for (x2 in c) if (_2.call(c, x2)) {
            var me2 = c[x2];
            if (me2 != null) switch (x2) {
              case "children":
                j2 = me2;
                break;
              case "selected":
          ...
          if (T != null) if (c = Y3 !== null ? "" + Y3 : $e2(j2), ne2(T)) {
          ...
          return r.push(he3), X2(r, te2, j2), j2;
        case "textarea":
          r.push(Re3("textarea")), te2 = T = x2 = null;
          for (j2 in c) if (_2.call(c, j2) && (Y3 = c[j2], Y3 != null)) switch (j2) {
            case "children":
              te2 = Y3;
              break;
            case "value":
          ...
          if (x2 === null && T !== null && (x2 = T), r.push(he3), te2 != null) {
            if (x2 != null) throw Error(e(92));
            if (ne2(te2) && 1 < te2.length) throw Error(e(93));
            x2 = "" + te2;
          }
          return typeof x2 == "string" && x2[0] === `
` && r.push(Me2), x2 !== null && r.push(g(B2("" + x2))), null;
        case "input":
          r.push(Re3("input")), Y3 = te2 = j2 = x2 = null;
          for (T in c) if (_2.call(c, T) && (oe = c[T], oe != null)) switch (T) {
            case "children":
            case "dangerouslySetInnerHTML":
              throw Error(e(399, "input"));
            case "defaultChecked":
          ...
          return te2 !== null ? fe2(r, p, "checked", te2) : Y3 !== null && fe2(r, p, "checked", Y3), x2 !== null ? fe2(r, p, "value", x2) : j2 !== null && fe2(r, p, "value", j2), r.push(Oe2), null;
        case "menuitem":
          r.push(Re3("menuitem"));
          for (var Ne2 in c) if (_2.call(c, Ne2) && (x2 = c[Ne2], x2 != null)) switch (Ne2) {
            case "children":
            case "dangerouslySetInnerHTML":
              throw Error(e(400));
            default:
        ...
        case "title":
          r.push(Re3("title")), x2 = null;
          for (me2 in c) if (_2.call(c, me2) && (T = c[me2], T != null)) switch (me2) {
            case "children":
              x2 = T;
              break;
            case "dangerouslySetInnerHTML":
          ...
          return r.push(he3), x2;
        case "listing":
        case "pre":
          r.push(Re3(l2)), T = x2 = null;
          for (Y3 in c) if (_2.call(c, Y3) && (j2 = c[Y3], j2 != null)) switch (Y3) {
            case "children":
              x2 = j2;
              break;
            case "dangerouslySetInnerHTML":
...
` && r.push(Me2), x2;
        ...
        case "wbr":
          r.push(Re3(l2));
          for (var Ye2 in c) if (_2.call(c, Ye2) && (x2 = c[Ye2], x2 != null)) switch (Ye2) {
            case "children":
            case "dangerouslySetInnerHTML":
              throw Error(e(399, l2));
            default:
              fe2(r, p, Ye2, x2);
          }
          return r.push(Oe2), null;
        case "annotation-xml":
        case "color-profile":
        case "font-face":
        case "font-face-src":
        ...
        case "missing-glyph":
          return Ve3(r, c, l2, p);
        case "html":
          return k2.insertionMode === 0 && r.push(st2), Ve3(r, c, l2, p);
        default:
          if (l2.indexOf("-") === -1 && typeof c.is != "string") return Ve3(r, c, l2, p);
          r.push(Re3(l2)), T = x2 = null;
          for (oe in c) if (_2.call(c, oe) && (j2 = c[oe], j2 != null)) switch (oe) {
            case "children":
              x2 = j2;
              break;
            case "dangerouslySetInnerHTML":
            ...
            case "suppressHydrationWarning":
              break;
            default:
              I2(oe) && typeof j2 != "function" && typeof j2 != "symbol" && r.push(pe2, g(oe), ye, g(B2(j2)), de2);
          }
          return r.push(he3), X2(r, T, x2), x2;
      }
    }
    var Pe2 = b2("</"), rt2 = b2(">"), Ue2 = b2('<template id="'), Ce2 = b2('"></template>'), We2 = b2("<!--$-->"), at2 = b2('<!--$?--><template id="'), gt2 = b2('"></template>'), _t2 = b2("<!--$!-->"), qr = b2("<!--/$-->"), Zr = b2("<template"), Yr = b2('"'), Xr = b2(' data-dgst="');
    b2(' data-msg="'), b2(' data-stck="');
    var Gr = b2("></template>");
    function Be3(r, l2, c) {
      if (i(r, at2), c === null) throw Error(e(395));
      return i(r, c), u(r, gt2);
    }
    var Dt = b2('<div hidden id="'), Pt = b2('">'), ve2 = b2("</div>"), vt2 = b2('<svg aria-hidden="true" style="display:none" id="'), zt2 = b2('">'), bt2 = b2("</svg>"), et2 = b2('<math aria-hidden="true" style="display:none" id="'), $t3 = b2('">'), ot2 = b2("</math>"), lr2 = b2('<table hidden id="'), Lt2 = b2('">'), Nt2 = b2("</table>"), ir2 = b2('<table hidden><tbody id="'), sr2 = b2('">'), cr2 = b2("</tbody></table>"), Jr = b2('<table hidden><tr id="'), Qr = b2('">'), Tt2 = b2("</tr></table>"), dr2 = b2('<table hidden><colgroup id="'), Ft = b2('">'), Ot2 = b2("</colgroup></table>");
    function ea(r, l2, c, p) {
      switch (c.insertionMode) {
        case 0:
        case 1:
          return i(r, Dt), i(r, l2.segmentPrefix), i(r, g(p.toString(16))), u(r, Pt);
        case 2:
          return i(r, vt2), i(r, l2.segmentPrefix), i(r, g(p.toString(16))), u(r, zt2);
        case 3:
          return i(r, et2), i(r, l2.segmentPrefix), i(r, g(p.toString(16))), u(r, $t3);
        case 4:
          return i(r, lr2), i(r, l2.segmentPrefix), i(r, g(p.toString(16))), u(r, Lt2);
        case 5:
          return i(r, ir2), i(r, l2.segmentPrefix), i(r, g(p.toString(16))), u(r, sr2);
        case 6:
          return i(r, Jr), i(r, l2.segmentPrefix), i(r, g(p.toString(16))), u(r, Qr);
        case 7:
          return i(r, dr2), i(r, l2.segmentPrefix), i(r, g(p.toString(16))), u(r, Ft);
        default:
          throw Error(e(397));
      }
    }
    function wt(r, l2) {
      switch (l2.insertionMode) {
        case 0:
        case 1:
          return u(r, ve2);
        case 2:
    ...
    var ta = b2('function $RS(a,b){a=document.getElementById(a);b=document.getElementById(b);for(a.parentNode.removeChild(a);a.firstChild;)b.parentNode.insertBefore(a.firstChild,b);b.parentNode.removeChild(b)};$RS("'), Bt3 = b2('$RS("'), Rt2 = b2('","'), mt3 = b2('")<\/script>'), Kt2 = b2('function $RC(a,b){a=document.getElementById(a);b=document.getElementById(b);b.parentNode.removeChild(b);if(a){a=a.previousSibling;var f=a.parentNode,c=a.nextSibling,e=0;do{if(c&&8===c.nodeType){var d=c.data;if("/$"===d)if(0===e)break;else e--;else"$"!==d&&"$?"!==d&&"$!"!==d||e++}d=c.nextSibling;f.removeChild(c);c=d}while(c);for(;b.firstChild;)f.insertBefore(b.firstChild,c);a.data="$";a._reactRetry&&a._reactRetry()}};$RC("'), ur2 = b2('$RC("'), pr2 = b2('","'), fr2 = b2('")<\/script>'), Ht2 = b2('function $RX(b,c,d,e){var a=document.getElementById(b);a&&(b=a.previousSibling,b.data="$!",a=a.dataset,c&&(a.dgst=c),d&&(a.msg=d),e&&(a.stck=e),b._reactRetry&&b._reactRetry())};$RX("'), Ie2 = b2('$RX("'), hr2 = b2('"'), Vt2 = b2(")<\/script>"), Ut3 = b2(","), gr2 = /[<\u2028\u2029]/g;
    function dt3(r) {
      return JSON.stringify(r).replace(gr2, function(l2) {
        switch (l2) {
          case "<":
            return "\\u003c";
          case "\u2028":
    ...
    var ut2 = Object.assign, vr2 = Symbol.for("react.element"), xt = Symbol.for("react.portal"), yt2 = Symbol.for("react.fragment"), Wt2 = Symbol.for("react.strict_mode"), qt2 = Symbol.for("react.profiler"), Zt2 = Symbol.for("react.provider"), Mt = Symbol.for("react.context"), br2 = Symbol.for("react.forward_ref"), wr2 = Symbol.for("react.suspense"), Yt2 = Symbol.for("react.suspense_list"), t = Symbol.for("react.memo"), s = Symbol.for("react.lazy"), d = Symbol.for("react.scope"), f2 = Symbol.for("react.debug_trace_mode"), C = Symbol.for("react.legacy_hidden"), m2 = Symbol.for("react.default_value"), $ = Symbol.iterator;
    function D2(r) {
      ...
      if (typeof r == "object") switch (r.$$typeof) {
        ...
        case br2:
          var l2 = r.render;
          return r = r.displayName, r || (r = l2.displayName || l2.name || "", r = r !== "" ? "ForwardRef(" + r + ")" : "ForwardRef"), r;
        case t:
          return l2 = r.displayName || null, l2 !== null ? l2 : D2(r.type) || "Memo";
        case s:
          l2 = r._payload, r = r._init;
          try {
            return D2(r(l2));
          } catch {
          }
    ...
    function ke(r, l2) {
      if (r !== l2) {
        ...
        l2.context._currentValue = l2.value;
      }
    }
    function qe(r) {
      r.context._currentValue = r.parentValue, r = r.parent, r !== null && qe(r);
    }
    function Ze(r) {
      var l2 = r.parent;
      l2 !== null && Ze(l2), r.context._currentValue = r.value;
    }
    function De2(r, l2) {
      if (r.context._currentValue = r.parentValue, r = r.parent, r === null) throw Error(e(402));
      r.depth === l2.depth ? ke(r, l2) : De2(r, l2);
    }
    function kt2(r, l2) {
      var c = l2.parent;
      if (c === null) throw Error(e(402));
      r.depth === c.depth ? ke(r, c) : kt2(r, c), l2.context._currentValue = l2.value;
    }
    function nt2(r) {
      var l2 = Q2;
      l2 !== r && (l2 === null ? Ze(r) : r === null ? qe(l2) : l2.depth === r.depth ? ke(l2, r) : l2.depth > r.depth ? De2(l2, r) : kt2(l2, r), Q2 = r);
    }
    var Xt2 = { isMounted: function() {
      return false;
    }, enqueueSetState: function(r, l2) {
      r = r._reactInternals, r.queue !== null && r.queue.push(l2);
    }, enqueueReplaceState: function(r, l2) {
      r = r._reactInternals, r.replace = true, r.queue = [l2];
    }, enqueueForceUpdate: function() {
    } };
    function St(r, l2, c, p) {
      var k2 = r.state !== void 0 ? r.state : null;
      r.updater = Xt2, r.props = c, r.state = k2;
      var x2 = { queue: [], replace: false };
      r._reactInternals = x2;
      var T = l2.contextType;
      if (r.context = typeof T == "object" && T !== null ? T._currentValue : p, T = l2.getDerivedStateFromProps, typeof T == "function" && (T = T(c, k2), k2 = T == null ? k2 : ut2({}, k2, T), r.state = k2), typeof l2.getDerivedStateFromProps != "function" && typeof r.getSnapshotBeforeUpdate != "function" && (typeof r.UNSAFE_componentWillMount == "function" || typeof r.componentWillMount == "function")) if (l2 = r.state, typeof r.componentWillMount == "function" && r.componentWillMount(), typeof r.UNSAFE_componentWillMount == "function" && r.UNSAFE_componentWillMount(), l2 !== r.state && Xt2.enqueueReplaceState(r, r.state, null), x2.queue !== null && 0 < x2.queue.length) if (l2 = x2.queue, T = x2.replace, x2.queue = null, x2.replace = false, T && l2.length === 1) r.state = l2[0];
      else {
        for (x2 = T ? l2[0] : r.state, k2 = true, T = T ? 1 : 0; T < l2.length; T++) {
          var j2 = l2[T];
          j2 = typeof j2 == "function" ? j2.call(r, x2, c, p) : j2, j2 != null && (k2 ? (k2 = false, x2 = ut2({}, x2, j2)) : ut2(x2, j2));
        }
        r.state = x2;
      }
      else x2.queue = null;
    ...
    function pt3(r, l2, c) {
      ...
      if (30 < x2) {
        var T = k2 - k2 % 5;
        return x2 = (p & (1 << T) - 1).toString(32), p >>= T, k2 -= T, { id: 1 << 32 - xr2(l2) + k2 | c << k2 | p, overflow: x2 + r };
      }
      return { id: 1 << x2 | c << k2 | p, overflow: r };
    }
    var xr2 = Math.clz32 ? Math.clz32 : gn2, fn2 = Math.log, hn2 = Math.LN2;
    function gn2(r) {
      return r >>>= 0, r === 0 ? 32 : 31 - (fn2(r) / hn2 | 0) | 0;
    }
    function vn2(r, l2) {
      return r === l2 && (r !== 0 || 1 / r === 1 / l2) || r !== r && l2 !== l2;
    }
    var bn2 = typeof Object.is == "function" ? Object.is : vn2, lt3 = null, ra = null, yr2 = null, be3 = null, Gt2 = false, kr = false, Jt3 = 0, ft3 = null, Sr2 = 0;
    function Ct2() {
    ...
    function aa() {
      return be3 === null ? yr2 === null ? (Gt2 = false, yr2 = be3 = Ka()) : (Gt2 = true, be3 = yr2) : be3.next === null ? (Gt2 = false, be3 = be3.next = Ka()) : (Gt2 = true, be3 = be3.next), be3;
    }
    function oa() {
      ra = lt3 = null, kr = false, yr2 = null, Sr2 = 0, be3 = ft3 = null;
    }
    function Ma(r, l2) {
      return typeof l2 == "function" ? l2(r) : l2;
    }
    function Ia(r, l2, c) {
      if (lt3 = Ct2(), be3 = aa(), Gt2) {
        var p = be3.queue;
        if (l2 = p.dispatch, ft3 !== null && (c = ft3.get(p), c !== void 0)) {
          ft3.delete(p), p = be3.memoizedState;
          do
            p = r(p, c.action), c = c.next;
          while (c !== null);
          return be3.memoizedState = p, [p, l2];
        }
        return [be3.memoizedState, l2];
      }
      return r = r === Ma ? typeof l2 == "function" ? l2() : l2 : c !== void 0 ? c(l2) : l2, be3.memoizedState = r, r = be3.queue = { last: null, dispatch: null }, r = r.dispatch = wn2.bind(null, lt3, r), [be3.memoizedState, r];
    }
    function ja(r, l2) {
      if (lt3 = Ct2(), be3 = aa(), l2 = l2 === void 0 ? null : l2, be3 !== null) {
        var c = be3.memoizedState;
        if (c !== null && l2 !== null) {
          var p = c[1];
          e: if (p === null) p = false;
          else {
            for (var k2 = 0; k2 < p.length && k2 < l2.length; k2++) if (!bn2(l2[k2], p[k2])) {
              p = false;
              break e;
            }
            p = true;
      ...
      return r = r(), be3.memoizedState = [r, l2], r;
    }
    function wn2(r, l2, c) {
      if (25 <= Sr2) throw Error(e(301));
      if (r === lt3) if (kr = true, r = { action: c, next: null }, ft3 === null && (ft3 = /* @__PURE__ */ new Map()), c = ft3.get(l2), c === void 0) ft3.set(l2, r);
      else {
        for (l2 = c; l2.next !== null; ) l2 = l2.next;
        l2.next = r;
      }
    }
    function mn2() {
    ...
    var Aa = { readContext: function(r) {
      return r._currentValue;
    }, useContext: function(r) {
      return Ct2(), r._currentValue;
    }, useMemo: ja, useReducer: Ia, useRef: function(r) {
      lt3 = Ct2(), be3 = aa();
      var l2 = be3.memoizedState;
      return l2 === null ? (r = { current: r }, be3.memoizedState = r) : l2;
    }, useState: function(r) {
      return Ia(Ma, r);
    }, useInsertionEffect: Cr3, useLayoutEffect: function() {
    }, useCallback: function(r, l2) {
      return ja(function() {
        return r;
      }, l2);
      ...
      return Ct2(), [false, mn2];
    }, useId: function() {
      var r = ra.treeContext, l2 = r.overflow;
      r = r.id, r = (r & ~(1 << 32 - xr2(r) - 1)).toString(32) + l2;
      var c = Er;
      if (c === null) throw Error(e(404));
      return l2 = Jt3++, r = ":" + c.idPrefix + "R" + r, 0 < l2 && (r += "H" + l2.toString(32)), r + ":";
    }, useMutableSource: function(r, l2) {
      return Ct2(), l2(r._source);
    }, useSyncExternalStore: function(r, l2, c) {
      if (c === void 0) throw Error(e(407));
      return c();
    } }, Er = null, na = o.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentDispatcher;
    function xn(r) {
      return console.error(r), null;
    }
    function Qt2() {
    }
    function yn2(r, l2, c, p, k2, x2, T, j2, Y3) {
      var oe = [], te2 = /* @__PURE__ */ new Set();
      return l2 = { destination: null, responseState: l2, progressiveChunkSize: p === void 0 ? 12800 : p, status: 0, fatalError: null, nextSegmentId: 0, allPendingTasks: 0, pendingRootTasks: 0, completedRootSegment: null, abortableTasks: te2, pingedTasks: oe, clientRenderedBoundaries: [], completedBoundaries: [], partialBoundaries: [], onError: k2 === void 0 ? xn : k2, onAllReady: x2 === void 0 ? Qt2 : x2, onShellReady: T === void 0 ? Qt2 : T, onShellError: j2 === void 0 ? Qt2 : j2, onFatalError: Y3 === void 0 ? Qt2 : Y3 }, c = _r2(l2, 0, null, c, false, false), c.parentFlushed = true, r = la(l2, r, null, c, te2, Z2, null, mr2), oe.push(r), l2;
    }
    function la(r, l2, c, p, k2, x2, T, j2) {
      r.allPendingTasks++, c === null ? r.pendingRootTasks++ : c.pendingTasks++;
      var Y3 = { node: l2, ping: function() {
        var oe = r.pingedTasks;
        oe.push(Y3), oe.length === 1 && Va(r);
      }, blockedBoundary: c, blockedSegment: p, abortSet: k2, legacyContext: x2, context: T, treeContext: j2 };
      return k2.add(Y3), Y3;
    }
    function _r2(r, l2, c, p, k2, x2) {
      return { status: 0, id: -1, index: l2, parentFlushed: false, chunks: [], children: [], formatContext: p, boundary: c, lastPushedText: k2, textEmbedded: x2 };
    }
    function er2(r, l2) {
      if (r = r.onError(l2), r != null && typeof r != "string") throw Error('onError returned something with a type other than "string". onError should return a string and may return null or undefined but must not return anything else. It received something of type "' + typeof r + '" instead');
      return r;
    }
    function Pr3(r, l2) {
      var c = r.onShellError;
      c(l2), c = r.onFatalError, c(l2), r.destination !== null ? (r.status = 2, y2(r.destination, l2)) : (r.status = 1, r.fatalError = l2);
    }
    function Da(r, l2, c, p, k2) {
      for (lt3 = {}, ra = l2, Jt3 = 0, r = c(p, k2); kr; ) kr = false, Jt3 = 0, Sr2 += 1, be3 = null, r = c(p, k2);
      return oa(), r;
    }
    function La(r, l2, c, p) {
      var k2 = c.render(), x2 = p.childContextTypes;
      if (x2 != null) {
        var T = l2.legacyContext;
        if (typeof c.getChildContext != "function") p = T;
        else {
          c = c.getChildContext();
          for (var j2 in c) if (!(j2 in x2)) throw Error(e(108, D2(p) || "Unknown", j2));
          p = ut2({}, T, c);
        }
        l2.legacyContext = p, Le3(r, l2, k2), l2.legacyContext = T;
      } else Le3(r, l2, k2);
    }
    function Na(r, l2) {
      if (r && r.defaultProps) {
        l2 = ut2({}, l2), r = r.defaultProps;
        for (var c in r) l2[c] === void 0 && (l2[c] = r[c]);
        return l2;
      }
      return l2;
    }
    function ia(r, l2, c, p, k2) {
      if (typeof c == "function") if (c.prototype && c.prototype.isReactComponent) {
        k2 = G2(c, l2.legacyContext);
        var x2 = c.contextType;
        x2 = new c(p, typeof x2 == "object" && x2 !== null ? x2._currentValue : k2), St(x2, c, p, k2), La(r, l2, x2, c);
      } else {
        x2 = G2(c, l2.legacyContext), k2 = Da(r, l2, c, p, x2);
        var T = Jt3 !== 0;
        if (typeof k2 == "object" && k2 !== null && typeof k2.render == "function" && k2.$$typeof === void 0) St(k2, c, p, x2), La(r, l2, k2, c);
        else if (T) {
          p = l2.treeContext, l2.treeContext = pt3(p, 1, 0);
          try {
            Le3(r, l2, k2);
          } finally {
            l2.treeContext = p;
        ...
        switch (k2 = l2.blockedSegment, x2 = ct2(k2.chunks, c, p, r.responseState, k2.formatContext), k2.lastPushedText = false, T = k2.formatContext, k2.formatContext = U3(T, c, p), sa(r, l2, x2), k2.formatContext = T, c) {
          case "area":
          case "base":
          case "br":
          case "col":
        ...
        switch (c) {
          ...
          case wr2:
            e: {
              c = l2.blockedBoundary, k2 = l2.blockedSegment, x2 = p.fallback, p = p.children, T = /* @__PURE__ */ new Set();
              var j2 = { id: null, rootSegmentID: -1, parentFlushed: false, pendingTasks: 0, forceClientRender: false, completedSegments: [], byteSize: 0, fallbackAbortableTasks: T, errorDigest: null }, Y3 = _r2(r, k2.chunks.length, j2, k2.formatContext, false, false);
              k2.children.push(Y3), k2.lastPushedText = false;
              var oe = _r2(r, 0, null, k2.formatContext, false, false);
              oe.parentFlushed = true, l2.blockedBoundary = j2, l2.blockedSegment = oe;
              try {
                if (sa(r, l2, p), oe.lastPushedText && oe.textEmbedded && oe.chunks.push(se), oe.status = 1, zr2(j2, oe), j2.pendingTasks === 0) break e;
              } catch (te2) {
                oe.status = 4, j2.forceClientRender = true, j2.errorDigest = er2(r, te2);
              } finally {
                l2.blockedBoundary = c, l2.blockedSegment = k2;
              }
              l2 = la(r, x2, c, Y3, T, l2.legacyContext, l2.context, l2.treeContext), r.pingedTasks.push(l2);
            }
            return;
        }
        if (typeof c == "object" && c !== null) switch (c.$$typeof) {
          case br2:
            if (p = Da(r, l2, c.render, p, k2), Jt3 !== 0) {
              c = l2.treeContext, l2.treeContext = pt3(c, 1, 0);
              try {
                Le3(r, l2, p);
              } finally {
                l2.treeContext = c;
            ...
            return;
          case t:
            c = c.type, p = Na(c, p), ia(r, l2, c, p, k2);
            return;
          case Zt2:
            if (k2 = p.children, c = c._context, p = p.value, x2 = c._currentValue, c._currentValue = p, T = Q2, Q2 = p = { parent: T, depth: T === null ? 0 : T.depth + 1, context: c, parentValue: x2, value: p }, l2.context = p, Le3(r, l2, k2), r = Q2, r === null) throw Error(e(403));
            p = r.parentValue, r.context._currentValue = p === m2 ? r.context._defaultValue : p, r = Q2 = r.parent, l2.context = r;
            return;
          case Mt:
            p = p.children, p = p(c._currentValue), Le3(r, l2, p);
            return;
          case s:
            k2 = c._init, c = k2(c._payload), p = Na(c, p), ia(r, l2, c, p, void 0);
            return;
        }
    ...
    function Le3(r, l2, c) {
      if (l2.node = c, typeof c == "object" && c !== null) {
        switch (c.$$typeof) {
          case vr2:
            ia(r, l2, c.type, c.props, c.ref);
            return;
          case xt:
            throw Error(e(257));
          case s:
            var p = c._init;
            c = p(c._payload), Le3(r, l2, c);
            return;
        }
        if (ne2(c)) {
          Oa(r, l2, c);
        ...
        if (c === null || typeof c != "object" ? p = null : (p = $ && c[$] || c["@@iterator"], p = typeof p == "function" ? p : null), p && (p = p.call(c))) {
          if (c = p.next(), !c.done) {
            var k2 = [];
            do
              k2.push(c.value), c = p.next();
            while (!c.done);
            Oa(r, l2, k2);
          }
          return;
      ...
      typeof c == "string" ? (p = l2.blockedSegment, p.lastPushedText = ce2(l2.blockedSegment.chunks, c, r.responseState, p.lastPushedText)) : typeof c == "number" && (p = l2.blockedSegment, p.lastPushedText = ce2(l2.blockedSegment.chunks, "" + c, r.responseState, p.lastPushedText));
    }
    function Oa(r, l2, c) {
      for (var p = c.length, k2 = 0; k2 < p; k2++) {
        var x2 = l2.treeContext;
        l2.treeContext = pt3(x2, p, k2);
        try {
          sa(r, l2, c[k2]);
        } finally {
          l2.treeContext = x2;
    ...
    function sa(r, l2, c) {
      var p = l2.blockedSegment.formatContext, k2 = l2.legacyContext, x2 = l2.context;
      try {
        return Le3(r, l2, c);
      } catch (Y3) {
        if (oa(), typeof Y3 == "object" && Y3 !== null && typeof Y3.then == "function") {
          c = Y3;
          var T = l2.blockedSegment, j2 = _r2(r, T.chunks.length, null, T.formatContext, T.lastPushedText, true);
          T.children.push(j2), T.lastPushedText = false, r = la(r, l2.node, l2.blockedBoundary, j2, l2.abortSet, l2.legacyContext, l2.context, l2.treeContext).ping, c.then(r, r), l2.blockedSegment.formatContext = p, l2.legacyContext = k2, l2.context = x2, nt2(x2);
        } else throw l2.blockedSegment.formatContext = p, l2.legacyContext = k2, l2.context = x2, nt2(x2), Y3;
      }
    }
    function kn(r) {
      var l2 = r.blockedBoundary;
      r = r.blockedSegment, r.status = 3, Ha(this, l2, r);
    }
    function Ba(r, l2, c) {
      var p = r.blockedBoundary;
      r.blockedSegment.status = 3, p === null ? (l2.allPendingTasks--, l2.status !== 2 && (l2.status = 2, l2.destination !== null && l2.destination.close())) : (p.pendingTasks--, p.forceClientRender || (p.forceClientRender = true, r = c === void 0 ? Error(e(432)) : c, p.errorDigest = l2.onError(r), p.parentFlushed && l2.clientRenderedBoundaries.push(p)), p.fallbackAbortableTasks.forEach(function(k2) {
        return Ba(k2, l2, c);
      }), p.fallbackAbortableTasks.clear(), l2.allPendingTasks--, l2.allPendingTasks === 0 && (p = l2.onAllReady, p()));
    }
    function zr2(r, l2) {
      if (l2.chunks.length === 0 && l2.children.length === 1 && l2.children[0].boundary === null) {
        var c = l2.children[0];
        c.id = l2.id, c.parentFlushed = true, c.status === 1 && zr2(r, c);
      } else r.completedSegments.push(l2);
    }
    function Ha(r, l2, c) {
      if (l2 === null) {
        if (c.parentFlushed) {
        ...
        r.pendingRootTasks--, r.pendingRootTasks === 0 && (r.onShellError = Qt2, l2 = r.onShellReady, l2());
      } else l2.pendingTasks--, l2.forceClientRender || (l2.pendingTasks === 0 ? (c.parentFlushed && c.status === 1 && zr2(l2, c), l2.parentFlushed && r.completedBoundaries.push(l2), l2.fallbackAbortableTasks.forEach(kn, r), l2.fallbackAbortableTasks.clear()) : c.parentFlushed && c.status === 1 && (zr2(l2, c), l2.completedSegments.length === 1 && l2.parentFlushed && r.partialBoundaries.push(l2)));
      r.allPendingTasks--, r.allPendingTasks === 0 && (r = r.onAllReady, r());
    }
    function Va(r) {
      if (r.status !== 2) {
        var l2 = Q2, c = na.current;
        na.current = Aa;
        var p = Er;
        Er = r.responseState;
        try {
          var k2 = r.pingedTasks, x2;
          for (x2 = 0; x2 < k2.length; x2++) {
            var T = k2[x2], j2 = r, Y3 = T.blockedSegment;
            if (Y3.status === 0) {
              nt2(T.context);
              try {
                Le3(j2, T, T.node), Y3.lastPushedText && Y3.textEmbedded && Y3.chunks.push(se), T.abortSet.delete(T), Y3.status = 1, Ha(j2, T.blockedBoundary, Y3);
              } catch (Xe2) {
                if (oa(), typeof Xe2 == "object" && Xe2 !== null && typeof Xe2.then == "function") {
                  var oe = T.ping;
                  Xe2.then(oe, oe);
                } else {
                  T.abortSet.delete(T), Y3.status = 4;
                  var te2 = T.blockedBoundary, me2 = Xe2, Ne2 = er2(j2, me2);
                  if (te2 === null ? Pr3(j2, me2) : (te2.pendingTasks--, te2.forceClientRender || (te2.forceClientRender = true, te2.errorDigest = Ne2, te2.parentFlushed && j2.clientRenderedBoundaries.push(te2))), j2.allPendingTasks--, j2.allPendingTasks === 0) {
                    var Ye2 = j2.onAllReady;
                    Ye2();
                  }
                }
              } finally {
          ...
          k2.splice(0, x2), r.destination !== null && ca(r, r.destination);
        } catch (Xe2) {
          er2(r, Xe2), Pr3(r, Xe2);
        } finally {
          Er = p, na.current = c, c === Aa && nt2(l2);
        }
      }
    }
    function $r2(r, l2, c) {
      switch (c.parentFlushed = true, c.status) {
        case 0:
          ...
          return c.lastPushedText = false, c.textEmbedded = false, r = r.responseState, i(l2, Ue2), i(l2, r.placeholderPrefix), r = g(p.toString(16)), i(l2, r), u(l2, Ce2);
        case 1:
          c.status = 2;
          var k2 = true;
          p = c.chunks;
          ...
          for (var T = 0; T < c.length; T++) {
            for (k2 = c[T]; x2 < k2.index; x2++) i(l2, p[x2]);
            k2 = Tr3(r, l2, k2);
          }
          for (; x2 < p.length - 1; x2++) i(l2, p[x2]);
          return x2 < p.length && (k2 = u(l2, p[x2])), k2;
        default:
          throw Error(e(390));
      }
    }
    function Tr3(r, l2, c) {
      var p = c.boundary;
      if (p === null) return $r2(r, l2, c);
      if (p.parentFlushed = true, p.forceClientRender) p = p.errorDigest, u(l2, _t2), i(l2, Zr), p && (i(l2, Xr), i(l2, g(B2(p))), i(l2, Yr)), u(l2, Gr), $r2(r, l2, c);
      else if (0 < p.pendingTasks) {
        p.rootSegmentID = r.nextSegmentId++, 0 < p.completedSegments.length && r.partialBoundaries.push(p);
        var k2 = r.responseState, x2 = k2.nextSuspenseID++;
        k2 = b2(k2.boundaryPrefix + x2.toString(16)), p = p.id = k2, Be3(l2, r.responseState, p), $r2(r, l2, c);
      } else if (p.byteSize > r.progressiveChunkSize) p.rootSegmentID = r.nextSegmentId++, r.completedBoundaries.push(p), Be3(l2, r.responseState, p.id), $r2(r, l2, c);
      else {
        if (u(l2, We2), c = p.completedSegments, c.length !== 1) throw Error(e(391));
        Tr3(r, l2, c[0]);
      }
      return u(l2, qr);
    }
    function Ua(r, l2, c) {
      return ea(l2, r.responseState, c.formatContext, c.id), Tr3(r, l2, c), wt(l2, c.formatContext);
    }
    function Wa(r, l2, c) {
      for (var p = c.completedSegments, k2 = 0; k2 < p.length; k2++) qa(r, l2, c, p[k2]);
      if (p.length = 0, r = r.responseState, p = c.id, c = c.rootSegmentID, i(l2, r.startInlineScript), r.sentCompleteBoundaryFunction ? i(l2, ur2) : (r.sentCompleteBoundaryFunction = true, i(l2, Kt2)), p === null) throw Error(e(395));
      return c = g(c.toString(16)), i(l2, p), i(l2, pr2), i(l2, r.segmentPrefix), i(l2, c), u(l2, fr2);
    }
    function qa(r, l2, c, p) {
      ...
      return Ua(r, l2, p), r = r.responseState, i(l2, r.startInlineScript), r.sentCompleteSegmentFunction ? i(l2, Bt3) : (r.sentCompleteSegmentFunction = true, i(l2, ta)), i(l2, r.segmentPrefix), k2 = g(k2.toString(16)), i(l2, k2), i(l2, Rt2), i(l2, r.placeholderPrefix), i(l2, k2), u(l2, mt3);
    }
    function ca(r, l2) {
      ...
      try {
        ...
        if (c !== null && r.pendingRootTasks === 0) {
          Tr3(r, l2, c), r.completedRootSegment = null;
          var p = r.responseState.bootstrapChunks;
          for (c = 0; c < p.length - 1; c++) i(l2, p[c]);
          c < p.length && u(l2, p[c]);
        }
        var k2 = r.clientRenderedBoundaries, x2;
        for (x2 = 0; x2 < k2.length; x2++) {
          var T = k2[x2];
          p = l2;
          var j2 = r.responseState, Y3 = T.id, oe = T.errorDigest, te2 = T.errorMessage, me2 = T.errorComponentStack;
          if (i(p, j2.startInlineScript), j2.sentClientRenderFunction ? i(p, Ie2) : (j2.sentClientRenderFunction = true, i(p, Ht2)), Y3 === null) throw Error(e(395));
          i(p, Y3), i(p, hr2), (oe || te2 || me2) && (i(p, Ut3), i(p, g(dt3(oe || "")))), (te2 || me2) && (i(p, Ut3), i(p, g(dt3(te2 || "")))), me2 && (i(p, Ut3), i(p, g(dt3(me2)))), u(p, Vt2);
        }
        k2.splice(0, x2);
        var Ne2 = r.completedBoundaries;
        for (x2 = 0; x2 < Ne2.length; x2++) Wa(r, l2, Ne2[x2]);
        Ne2.splice(0, x2), h(l2), a = new Uint8Array(512), n = 0;
        var Ye2 = r.partialBoundaries;
        for (x2 = 0; x2 < Ye2.length; x2++) {
          var Xe2 = Ye2[x2];
          e: {
            k2 = r, T = l2;
            var Fr3 = Xe2.completedSegments;
            for (j2 = 0; j2 < Fr3.length; j2++) if (!qa(k2, T, Xe2, Fr3[j2])) {
              j2++, Fr3.splice(0, j2);
              var Ya = false;
              break e;
            }
            Fr3.splice(0, j2), Ya = true;
          }
          if (!Ya) {
            r.destination = null, x2++, Ye2.splice(0, x2);
            return;
          }
        }
        Ye2.splice(0, x2);
        var da = r.completedBoundaries;
        for (x2 = 0; x2 < da.length; x2++) Wa(r, l2, da[x2]);
        da.splice(0, x2);
      } finally {
        h(l2), r.allPendingTasks === 0 && r.pingedTasks.length === 0 && r.clientRenderedBoundaries.length === 0 && r.completedBoundaries.length === 0 && l2.close();
      }
    }
    function Za(r, l2) {
      try {
        ...
        c.forEach(function(p) {
          return Ba(p, r, l2);
        }), c.clear(), r.destination !== null && ca(r, r.destination);
      } catch (p) {
        er2(r, p), Pr3(r, p);
      }
    }
    return Mr3.renderToReadableStream = function(r, l2) {
      return new Promise(function(c, p) {
        var k2, x2, T = new Promise(function(te2, me2) {
          x2 = te2, k2 = me2;
        }), j2 = yn2(r, W(l2 ? l2.identifierPrefix : void 0, l2 ? l2.nonce : void 0, l2 ? l2.bootstrapScriptContent : void 0, l2 ? l2.bootstrapScripts : void 0, l2 ? l2.bootstrapModules : void 0), q3(l2 ? l2.namespaceURI : void 0), l2 ? l2.progressiveChunkSize : void 0, l2 ? l2.onError : void 0, x2, function() {
          var te2 = new ReadableStream({ type: "bytes", pull: function(me2) {
            if (j2.status === 1) j2.status = 2, y2(me2, j2.fatalError);
            else if (j2.status !== 2 && j2.destination === null) {
              j2.destination = me2;
              try {
                ca(j2, me2);
              } catch (Ne2) {
                er2(j2, Ne2), Pr3(j2, Ne2);
              }
            }
          }, cancel: function() {
            Za(j2);
        ...
        if (l2 && l2.signal) {
          var Y3 = l2.signal, oe = function() {
            Za(j2, Y3.reason), Y3.removeEventListener("abort", oe);
          };
          Y3.addEventListener("abort", oe);
        }
        Va(j2);
      });
    }, Mr3.version = "18.3.1", Mr3;
  }
  var bo;
  function Dl() {
    if (bo) return ht2;
    bo = 1;
    var o, e;
    return o = jl(), e = Al(), ht2.version = o.version, ht2.renderToString = o.renderToString, ht2.renderToStaticMarkup = o.renderToStaticMarkup, ht2.renderToNodeStream = o.renderToNodeStream, ht2.renderToStaticNodeStream = o.renderToStaticNodeStream, ht2.renderToReadableStream = e.renderToReadableStream, ht2;
  }
  var Ll = Dl();
  var fa = { exports: {} };
  var ha;
  ...
  function Ol() {
    ...
    return a.resetWarningCache = e, ga = function() {
      function n(h, v, g, b2, y2, _2) {
        if (_2 !== o) {
          var K2 = new Error("Calling PropTypes validators directly is not supported by the `prop-types` package. Use PropTypes.checkPropTypes() to call them. Read more at http://fb.me/use-check-prop-types");
          throw K2.name = "Invariant Violation", K2;
        }
      }
      n.isRequired = n;
      function i() {
      ...
      var u = { array: n, bigint: n, bool: n, func: n, number: n, object: n, string: n, symbol: n, any: n, arrayOf: i, element: n, elementType: n, instanceOf: i, node: n, objectOf: i, oneOf: i, oneOfType: i, shape: i, exact: i, checkPropTypes: a, resetWarningCache: e };
      return u.PropTypes = u, u;
    }, ga;
  }
  var xo;
  function Bl() {
    return xo || (xo = 1, fa.exports = Ol()()), fa.exports;
  }
  var Hl = Bl();
  var Je = Qs2(Hl);
  ...
  var Ul = Yo((function(o) {
    (function(e) {
      var a = function(w2, z2, E) {
        if (!g(z2) || y2(z2) || _2(z2) || K2(z2) || v(z2)) return z2;
        var M, L3 = 0, H2 = 0;
        if (b2(z2)) for (M = [], H2 = z2.length; L3 < H2; L3++) M.push(a(w2, z2[L3], E));
        else for (var N3 in M = {}, z2) Object.prototype.hasOwnProperty.call(z2, N3) && (M[w2(N3, E)] = a(w2, z2[N3], E));
        return M;
      }, n = function(w2) {
        return R3(w2) ? w2 : (w2 = w2.replace(/[\-_\s]+(.)?/g, (function(z2, E) {
          return E ? E.toUpperCase() : "";
        }))).substr(0, 1).toLowerCase() + w2.substr(1);
      }, i = function(w2) {
        var z2 = n(w2);
        return z2.substr(0, 1).toUpperCase() + z2.substr(1);
      }, u = function(w2, z2) {
        return (function(E, M) {
          var L3 = (M = M || {}).separator || "_", H2 = M.split || /(?=[A-Z])/;
          return E.split(H2).join(L3);
        })(w2, z2).toLowerCase();
      }, h = Object.prototype.toString, v = function(w2) {
        return typeof w2 == "function";
      }, g = function(w2) {
        return w2 === Object(w2);
      }, b2 = function(w2) {
        return h.call(w2) == "[object Array]";
      }, y2 = function(w2) {
        return h.call(w2) == "[object Date]";
      }, _2 = function(w2) {
        return h.call(w2) == "[object RegExp]";
      }, K2 = function(w2) {
        return h.call(w2) == "[object Boolean]";
      }, R3 = function(w2) {
        return (w2 -= 0) == w2;
      }, F = function(w2, z2) {
        var E = z2 && "process" in z2 ? z2.process : z2;
        return typeof E != "function" ? w2 : function(M, L3) {
          return E(M, w2, L3);
        };
      }, I2 = { camelize: n, decamelize: u, pascalize: i, depascalize: u, camelizeKeys: function(w2, z2) {
        return a(F(n, z2), w2);
      }, decamelizeKeys: function(w2, z2) {
        return a(F(u, z2), w2, z2);
      }, pascalizeKeys: function(w2, z2) {
        return a(F(i, z2), w2);
      }, depascalizeKeys: function() {
        return this.decamelizeKeys.apply(this, arguments);
      } };
      o.exports ? o.exports = I2 : e.humps = I2;
    })(Vl);
  })).decamelize;
  var Wl = function(o) {
  ...
  var ql2 = function(o, e) {
    if (typeof Symbol < "u" && Symbol.iterator in Object(o)) {
      var a = [], n = true, i = false, u = void 0;
      try {
        for (var h, v = o[Symbol.iterator](); !(n = (h = v.next()).done) && (a.push(h.value), !e || a.length !== e); n = true) ;
      } catch (g) {
        i = true, u = g;
      } finally {
        try {
  ...
  var Zl2 = function(o, e) {
    if (o) {
      ...
      return a === "Object" && o.constructor && (a = o.constructor.name), a === "Map" || a === "Set" ? Array.from(o) : a === "Arguments" || /^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(a) ? yo(o, e) : void 0;
    }
  };
  var Yl2 = function() {
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
  ...
  var Xl2 = function(o, e) {
    return Wl(o) || ql2(o, e) || Zl2(o, e) || Yl2();
  };
  var Xo = Yo((function(o) {
    function e() {
  ...
  var Gl = function(o, e) {
    if (o == null) return {};
    var a, n, i = {}, u = Object.keys(o);
    for (n = 0; n < u.length; n++) a = u[n], e.indexOf(a) >= 0 || (i[a] = o[a]);
    return i;
  };
  var Go = function(o, e) {
    if (o == null) return {};
    ...
    if (Object.getOwnPropertySymbols) {
      ...
      for (n = 0; n < u.length; n++) a = u[n], e.indexOf(a) >= 0 || Object.prototype.propertyIsEnumerable.call(o, a) && (i[a] = o[a]);
    }
    return i;
  };
  var Jo = S.createContext(null);
  function Qo(o) {
    var e = o.children, a = e === void 0 ? "" : e, n = Go(o, ["children"]);
    return typeof a != "string" && (a = Ll.renderToString(a)), Re2.createElement("template", Xo({}, n, { dangerouslySetInnerHTML: { __html: a } }));
  }
  function en3(o) {
  ...
  function Jl2(o) {
    var e = S.forwardRef((function(a, n) {
      var i, u, h = a.mode, v = h === void 0 ? "open" : h, g = a.delegatesFocus, b2 = g !== void 0 && g, y2 = a.styleSheets, _2 = y2 === void 0 ? [] : y2, K2 = a.ssr, R3 = K2 !== void 0 && K2, F = a.children, I2 = Go(a, ["mode", "delegatesFocus", "styleSheets", "ssr", "children"]), w2 = (u = S.useRef((i = n) && i.current), S.useEffect((function() {
        i && (i.current = u.current);
      }), [i]), u), z2 = S.useState(null), E = Xl2(z2, 2), M = E[0], L3 = E[1], H2 = "node_".concat(v).concat(b2);
      return S.useLayoutEffect((function() {
        if (w2.current) try {
          if (typeof n == "function" && n(w2.current), R3) {
            var N3 = w2.current.shadowRoot;
            return void L3(N3);
          }
          var B2 = w2.current.attachShadow({ mode: v, delegatesFocus: b2 });
          _2.length > 0 && (B2.adoptedStyleSheets = _2), L3(B2);
        } catch (ae2) {
          (function(re2) {
          ...
          })({ error: ae2, styleSheets: _2, root: M });
        }
      }), [n, w2, _2]), Re2.createElement(Re2.Fragment, null, Re2.createElement(o.tag, Xo({ key: H2, ref: w2 }, I2), (M || R3) && Re2.createElement(Jo.Provider, { value: M }, R3 ? Re2.createElement(Qo, { shadowroot: v, shadowrootmode: v }, o.render({ root: M, ssr: R3, children: F })) : Re2.createElement(en3, { root: M }, o.render({ root: M, ssr: R3, children: F })))));
    }));
  ...
  Qo.propTypes = { children: Je.oneOfType([Je.string, Je.node]) }, en3.propTypes = { root: Je.object.isRequired, children: Je.node };
  ...
  function ei3() {
    ...
    return new Proxy(o, { get: function(n, i) {
      var u = Ul(i, { separator: "-" }), h = "".concat(e, "-").concat(u);
      return va.has(h) || va.set(h, Jl2({ tag: u, render: a })), va.get(h);
    } });
  }
  var ti3 = ei3();
  var ba;
  ...
  function ri3() {
    ...
    ba = function(_2) {
      var K2 = [];
      return o.forEach(function(R3) {
        var F = g(R3);
        function I2(w2) {
          for (var z2 = w2.path || w2.composedPath && w2.composedPath() || b2(w2.target), E = 0; E < z2.length; E++) {
            var M = z2[E], L3 = null, H2 = i(M), N3 = n(M);
            if (N3 ? L3 = N3 : L3 = h(H2), H2 && L3 && v(w2, R3, L3), H2 && L3 && a[R3] && v(w2, a[R3], L3), w2.cancelBubble || M === _2) break;
          }
        }
        _2.addEventListener(F, I2, false), K2.push(function() {
          _2.removeEventListener(F, I2, false);
        });
      }), function() {
        K2.forEach(function(R3) {
          R3();
        });
      };
    };
    function n(y2) {
      return u(y2, "__reactEventHandlers");
    }
    function i(y2) {
      return u(y2, "_reactInternal");
    }
    function u(y2, _2) {
      for (var K2 in y2) if (y2.hasOwnProperty(K2) && K2.indexOf(_2) !== -1) return y2[K2];
    }
    function h(y2) {
      if (y2) {
        if (y2.memoizedProps) return y2.memoizedProps;
        if (y2._currentElement && y2._currentElement.props) return y2._currentElement.props;
      }
    }
    function v(y2, _2, K2) {
      y2.persist = function() {
        y2.isPersistent = function() {
          return true;
        };
      }, K2[_2] && K2[_2](y2);
    }
    function g(y2) {
      return e[y2] ? e[y2] : y2.replace(/^on/, "").toLowerCase();
    }
    function b2(y2) {
      for (var _2 = []; y2; ) {
        if (_2.push(y2), y2.tagName === "HTML") return _2.push(document), _2.push(window), _2;
        y2 = y2.parentElement;
      }
    }
    return ba;
  ...
  var di3 = class {
    build(e, a) {
      return this.context = a, So(() => this.iterateCollection(e));
    }
    *iterateCollection(e) {
      ...
      if (Re2.isValidElement(a) && a.type === Re2.Fragment) yield* this.iterateCollection({ children: a.props.children, items: n });
        ...
        let i = 0;
        for (let u of n) yield* this.getFullNode({ value: u, index: i }, { renderer: a }), i++;
      } else {
        let i = [];
        ...
        let u = 0;
        for (let h of i) {
          let v = this.getFullNode({ element: h, index: u }, {});
          for (let g of v) u++, yield g;
        }
      }
    }
    getKey(e, a, n, i) {
      if (e.key != null) return e.key;
      if (a.type === "cell" && a.key != null) return `${i}${a.key}`;
      let u = a.value;
      if (u != null) {
        var h;
        let v = (h = u.key) !== null && h !== void 0 ? h : u.id;
        if (v == null) throw new Error("No key found for item");
        return v;
      }
      return i ? `${i}.${a.index}` : `$.${a.index}`;
    }
    getChildState(e, a) {
    ...
    *getFullNode(e, a, n, i) {
      if (Re2.isValidElement(e.element) && e.element.type === Re2.Fragment) {
        let w2 = [];
        Re2.Children.forEach(e.element.props.children, (E) => {
          w2.push(E);
        });
        var u;
        let z2 = (u = e.index) !== null && u !== void 0 ? u : 0;
        for (const E of w2) yield* this.getFullNode({ element: E, index: z2++ }, a, n, i);
        return;
      }
      let h = e.element;
      if (!h && e.value && a && a.renderer) {
        let w2 = this.cache.get(e.value);
        if (w2 && (!w2.shouldInvalidate || !w2.shouldInvalidate(this.context))) {
          w2.index = e.index, w2.parentKey = i ? i.key : null, yield w2;
          return;
        }
      ...
      if (Re2.isValidElement(h)) {
        let w2 = h.type;
        if (typeof w2 != "function" && typeof w2.getCollectionNode != "function") {
          let L3 = h.type;
          throw new Error(`Unknown element <${L3}> in collection.`);
        }
        let z2 = w2.getCollectionNode(h.props, this.context);
        var v;
        let E = (v = e.index) !== null && v !== void 0 ? v : 0, M = z2.next();
        for (; !M.done && M.value; ) {
          let L3 = M.value;
          e.index = E;
          var g;
          let H2 = (g = L3.key) !== null && g !== void 0 ? g : null;
          H2 == null && (H2 = L3.element ? null : this.getKey(h, e, a, n));
          let B2 = [...this.getFullNode({ ...L3, key: H2, index: E, wrapper: ui3(e.wrapper, L3.wrapper) }, this.getChildState(a, L3), n ? `${n}${h.key}` : h.key, i)];
          for (let ae2 of B2) {
            var b2, y2;
            ae2.value = (y2 = (b2 = L3.value) !== null && b2 !== void 0 ? b2 : e.value) !== null && y2 !== void 0 ? y2 : null, ae2.value && this.cache.set(ae2.value, ae2);
            var _2;
            if (e.type && ae2.type !== e.type) throw new Error(`Unsupported type <${wa(ae2.type)}> in <${wa((_2 = i == null ? void 0 : i.type) !== null && _2 !== void 0 ? _2 : "unknown parent type")}>. Only <${wa(e.type)}> is supported.`);
            E++, yield ae2;
          }
          M = z2.next(B2);
        }
      ...
      let K2 = this;
      var R3, F;
      let I2 = { type: e.type, props: e.props, key: e.key, parentKey: i ? i.key : null, value: (R3 = e.value) !== null && R3 !== void 0 ? R3 : null, level: i ? i.level + 1 : 0, index: e.index, rendered: e.rendered, textValue: (F = e.textValue) !== null && F !== void 0 ? F : "", "aria-label": e["aria-label"], wrapper: e.wrapper, shouldInvalidate: e.shouldInvalidate, hasChildNodes: e.hasChildNodes || false, childNodes: So(function* () {
        if (!e.hasChildNodes || !e.childNodes) return;
        let w2 = 0;
        for (let z2 of e.childNodes()) {
          z2.key != null && (z2.key = `${I2.key}${z2.key}`);
          let E = K2.getFullNode({ ...z2, index: w2 }, K2.getChildState(a, z2), I2.key, I2);
          for (let M of E) w2++, yield M;
        }
      }) };
      yield I2;
    }
  ...
  function pi3(o, e, a) {
    let n = S.useMemo(() => new di3(), []), { children: i, items: u, collection: h } = o;
    return S.useMemo(() => {
      if (h) return h;
      let g = n.build({ children: i, items: u }, a);
      return e(g);
    }, [n, i, u, h, a, e]);
  }
  function fi3(o, e) {
  ...
  function ma(o, e, a) {
    ...
    let n = [...Co2(o, e), e], i = [...Co2(o, a), a], u = n.slice(0, i.length).findIndex((h, v) => h !== i[v]);
    return u !== -1 ? (e = n[u], a = i[u], e.index - a.index) : n.findIndex((h) => h === a) >= 0 ? 1 : (i.findIndex((h) => h === e) >= 0, -1);
  }
  function Co2(o, e) {
    let a = [], n = e;
  ...
  var bi3 = (o) => ({ top: "top", bottom: "bottom", left: "left", right: "right", "top-start": "top start", "top-end": "top end", "bottom-start": "bottom start", "bottom-end": "bottom end", "left-start": "left top", "left-end": "left bottom", "right-start": "right top", "right-end": "right bottom" })[o];
  var wi3 = (o, e) => {
    if (e.includes("-")) {
      const [a] = e.split("-");
  ...
  var Ae2 = [];
  function mi3(o, e = document.body) {
    let a = new Set(o), n = /* @__PURE__ */ new Set(), i = (g) => {
      for (let K2 of g.querySelectorAll("[data-live-announcer], [data-react-aria-top-layer]")) a.add(K2);
      let b2 = (K2) => {
        if (a.has(K2) || K2.parentElement && n.has(K2.parentElement) && K2.parentElement.getAttribute("role") !== "row") return NodeFilter.FILTER_REJECT;
        for (let R3 of a) if (K2.contains(R3)) return NodeFilter.FILTER_SKIP;
        return NodeFilter.FILTER_ACCEPT;
      }, y2 = document.createTreeWalker(g, NodeFilter.SHOW_ELEMENT, { acceptNode: b2 }), _2 = b2(g);
      if (_2 === NodeFilter.FILTER_ACCEPT && u(g), _2 !== NodeFilter.FILTER_REJECT) {
        let K2 = y2.nextNode();
        for (; K2 != null; ) u(K2), K2 = y2.nextNode();
      }
    }, u = (g) => {
      var b2;
      let y2 = (b2 = rr2.get(g)) != null ? b2 : 0;
      g.getAttribute("aria-hidden") === "true" && y2 === 0 || (y2 === 0 && g.setAttribute("aria-hidden", "true"), n.add(g), rr2.set(g, y2 + 1));
    };
    Ae2.length && Ae2[Ae2.length - 1].disconnect(), i(e);
    let h = new MutationObserver((g) => {
      for (let b2 of g) if (!(b2.type !== "childList" || b2.addedNodes.length === 0) && ![...a, ...n].some((y2) => y2.contains(b2.target))) {
        for (let y2 of b2.removedNodes) y2 instanceof Element && (a.delete(y2), n.delete(y2));
        for (let y2 of b2.addedNodes) (y2 instanceof HTMLElement || y2 instanceof SVGElement) && (y2.dataset.liveAnnouncer === "true" || y2.dataset.reactAriaTopLayer === "true") ? a.add(y2) : y2 instanceof Element && i(y2);
      }
    });
    h.observe(e, { childList: true, subtree: true });
    let v = { visibleNodes: a, hiddenNodes: n, observe() {
      h.observe(e, { childList: true, subtree: true });
    }, disconnect() {
      h.disconnect();
    } };
    return Ae2.push(v), () => {
      ...
      for (let g of n) {
        let b2 = rr2.get(g);
        b2 != null && (b2 === 1 ? (g.removeAttribute("aria-hidden"), rr2.delete(g)) : rr2.set(g, b2 - 1));
      }
      v === Ae2[Ae2.length - 1] ? (Ae2.pop(), Ae2.length && Ae2[Ae2.length - 1].observe()) : Ae2.splice(Ae2.indexOf(v), 1);
    };
  }
  function xi3(o) {
  ...
  function yi3(o, e) {
    const { groupRef: a, triggerRef: n, popoverRef: i, showArrow: u, offset: h = 7, crossOffset: v = 0, scrollRef: g, shouldFlip: b2, boundaryElement: y2, isDismissable: _2 = true, shouldCloseOnBlur: K2 = true, shouldCloseOnScroll: R3 = true, placement: F = "top", containerPadding: I2, shouldCloseOnInteractOutside: w2, isNonModal: z2, isKeyboardDismissDisabled: E, updatePositionDeps: M = [], ...L3 } = o, H2 = z2 ?? true, N3 = L3.trigger === "SubmenuTrigger", { overlayProps: B2, underlayProps: ae2 } = Eb({ isOpen: e.isOpen, onClose: e.close, shouldCloseOnBlur: K2, isDismissable: _2 || N3, isKeyboardDismissDisabled: E, shouldCloseOnInteractOutside: w2 || ((ge2) => {
      var ue2;
      return !((ue2 = n.current) != null && ue2.contains(ge2));
    }), disableOutsideEvents: !H2 }, i), { overlayProps: re2, arrowProps: ne2, placement: le2, updatePosition: J3, triggerAnchorPoint: ie2 } = Fl({ ...L3, shouldFlip: b2, crossOffset: v, targetRef: n, overlayRef: i, isOpen: e.isOpen, scrollRef: g, boundaryElement: y2, containerPadding: I2, placement: bi3(F), offset: u ? h + 3 : h, onClose: H2 && !N3 && R3 ? e.close : () => {
    } });
    return yb(() => {
      M.length && J3();
    }, M), S.useEffect(() => {
      var ge2, ue2;
      if (e.isOpen && i.current) return H2 ? xi3((ge2 = a == null ? void 0 : a.current) != null ? ge2 : i.current) : mi3([(ue2 = a == null ? void 0 : a.current) != null ? ue2 : i.current]);
    }, [H2, e.isOpen, i, a]), { popoverProps: Io(B2, re2), arrowProps: ne2, underlayProps: ae2, placement: le2, triggerAnchorPoint: ie2 };
  }
  var ki3 = "top";
  function Si3(o) {
    var e, a, n;
    const i = wi2(), [u, h] = xu(o, to.variantKeys), { as: v, ref: g, children: b2, state: y2, triggerRef: _2, scrollRef: K2, defaultOpen: R3, onOpenChange: F, isOpen: I2, isNonModal: w2 = true, shouldFlip: z2 = true, containerPadding: E = 12, shouldBlockScroll: M = false, isDismissable: L3 = true, shouldCloseOnBlur: H2, portalContainer: N3, updatePositionDeps: B2, dialogProps: ae2, placement: re2 = ki3, triggerType: ne2 = "dialog", showArrow: le2 = false, offset: J3 = 7, crossOffset: ie2 = 0, boundaryElement: ge2, isKeyboardDismissDisabled: ue2, shouldCloseOnInteractOutside: Se2, shouldCloseOnScroll: A2, triggerAnchorPoint: W, motionProps: V2, className: q3, classNames: U3, onClose: se, ...ce2 } = u, ee2 = v || "div", we2 = Ar2(g), Fe2 = S.useRef(null), Ee2 = S.useRef(false), _e2 = _2 || Fe2, pe2 = (a = (e = o.disableAnimation) != null ? e : i == null ? void 0 : i.disableAnimation) != null ? a : false, ye = $b({ isOpen: I2, defaultOpen: R3, onOpenChange: (Ce2) => {
      F == null || F(Ce2), Ce2 || se == null || se();
    } }), de2 = y2 || ye, { popoverProps: O3, underlayProps: fe2, placement: he3 } = yi3({ triggerRef: _e2, isNonModal: w2, popoverRef: we2, placement: re2, offset: J3, scrollRef: K2, isDismissable: L3, shouldCloseOnBlur: H2, boundaryElement: ge2, crossOffset: ie2, shouldFlip: z2, containerPadding: E, updatePositionDeps: B2, isKeyboardDismissDisabled: ue2, shouldCloseOnScroll: A2, shouldCloseOnInteractOutside: Se2, triggerAnchorPoint: W }, de2), Oe2 = S.useMemo(() => he3 ? wi3(he3, re2) ? he3 : re2 : null, [he3, re2]), { triggerProps: X2 } = Ml({ type: ne2 }, de2, _e2), { isFocusVisible: $e2, isFocused: He2, focusProps: Ve3 } = lm(), Me2 = S.useMemo(() => to({ ...h }), [qs2(h)]), it2 = Nn(U3 == null ? void 0 : U3.base, q3), je2 = { "--trigger-anchor-point": W ? `${W.x}px ${W.y}px` : void 0 };
    yw({ isDisabled: !(M && de2.isOpen) });
    const Re3 = (Ce2 = {}) => ({ ref: we2, ...Io(O3, ce2, Ce2), style: Io(O3.style, ce2.style, Ce2.style) }), st2 = (Ce2 = {}) => ({ "data-slot": "base", "data-open": lt2(de2.isOpen), "data-focus": lt2(He2), "data-arrow": lt2(le2), "data-focus-visible": lt2($e2), "data-placement": he3 ? Eo(he3, re2) : void 0, ...Io(Ve3, ae2, Ce2), className: Me2.base({ class: Nn(it2) }), style: { outline: "none", ...je2 } }), ct2 = S.useCallback((Ce2 = {}) => ({ "data-slot": "content", "data-open": lt2(de2.isOpen), "data-arrow": lt2(le2), "data-placement": he3 ? Eo(he3, re2) : void 0, className: Me2.content({ class: Nn(U3 == null ? void 0 : U3.content, Ce2.className) }) }), [Me2, de2.isOpen, le2, Oe2, re2, U3, he3]), Pe2 = S.useCallback((Ce2) => {
      var We2;
      let at2;
      return Ce2.pointerType === "touch" && ((o == null ? void 0 : o.backdrop) === "blur" || (o == null ? void 0 : o.backdrop) === "opaque") ? at2 = setTimeout(() => {
        Ee2.current = true;
      }, 100) : Ee2.current = true, (We2 = X2.onPress) == null || We2.call(X2, Ce2), () => {
        clearTimeout(at2);
      };
    }, [X2 == null ? void 0 : X2.onPress]), rt2 = S.useCallback((Ce2 = {}, We2 = null) => {
      const { isDisabled: at2, ...gt2 } = Ce2;
      return { "data-slot": "trigger", ...Io({ "aria-haspopup": "dialog" }, X2, gt2), onPress: Pe2, isDisabled: at2, className: Me2.trigger({ class: Nn(U3 == null ? void 0 : U3.trigger, Ce2.className), isTriggerDisabled: at2 }), ref: ob(We2, _e2) };
    }, [de2, X2, Pe2, _e2]), Ue2 = S.useCallback((Ce2 = {}) => ({ "data-slot": "backdrop", className: Me2.backdrop({ class: U3 == null ? void 0 : U3.backdrop }), onClick: (We2) => {
      if (!Ee2.current) {
        We2.preventDefault();
        return;
      }
      de2.close(), Ee2.current = false;
    }, ...fe2, ...Ce2 }), [Me2, de2.isOpen, U3, fe2]);
    return { state: de2, Component: ee2, children: b2, classNames: U3, showArrow: le2, triggerRef: _e2, placement: Oe2, isNonModal: w2, popoverRef: we2, portalContainer: N3, isOpen: de2.isOpen, onClose: de2.close, disableAnimation: pe2, shouldBlockScroll: M, backdrop: (n = o.backdrop) != null ? n : "transparent", motionProps: V2, getBackdropProps: Ue2, getPopoverProps: Re3, getTriggerProps: rt2, getDialogProps: st2, getContentProps: ct2 };
  }
  var [Ci2, an2] = fu({ name: "PopoverContext", errorMessage: "usePopoverContext: `context` is undefined. Seems you forgot to wrap all popover components within `<Popover />`" });
  var _o2 = () => ku(() => Promise.resolve().then(() => (init_index_chunk(), index_chunk_exports)), __vite__mapDeps2([0, 1, 2])).then((o) => o.default);
  var on2 = (o) => {
    const { as: e, children: a, className: n, ...i } = o, { Component: u, placement: h, backdrop: v, motionProps: g, disableAnimation: b2, getPopoverProps: y2, getDialogProps: _2, getBackdropProps: K2, getContentProps: R3, isNonModal: F, onClose: I2 } = an2(), w2 = S.useRef(null), { dialogProps: z2, titleProps: E } = Sb({}, w2), M = _2({ ref: w2, ...z2, ...i }), L3 = e || u || "div", H2 = a && Y2.jsxs(Y2.Fragment, { children: [!F && Y2.jsx(cb, { onDismiss: I2 }), Y2.jsx(L3, { ...M, children: Y2.jsx("div", { ...R3({ className: n }), children: typeof a == "function" ? a(E) : a }) }), Y2.jsx(cb, { onDismiss: I2 })] }), N3 = S.useMemo(() => v === "transparent" ? null : b2 ? Y2.jsx("div", { ...K2() }) : Y2.jsx(gu, { features: _o2, children: Y2.jsx(bu.div, { animate: "enter", exit: "exit", initial: "exit", variants: fb.fade, ...K2() }) }), [v, b2, K2]), B2 = h ? vi3(h === "center" ? "top" : h) : void 0, ae2 = Y2.jsx(Y2.Fragment, { children: b2 ? H2 : Y2.jsx(gu, { features: _o2, children: Y2.jsx(bu.div, { animate: "enter", exit: "exit", initial: "initial", style: B2, variants: fb.scaleSpringOpacity, ...g, children: H2 }) }) });
    return Y2.jsxs("div", { ...y2(), children: [N3, ae2] });
  };
  on2.displayName = "HeroUI.PopoverContent";
  var Ei2 = on2;
  var nn3 = (o) => {
    var e;
    const { triggerRef: a, getTriggerProps: n } = an2(), { children: i, ...u } = o, h = S.useMemo(() => typeof i == "string" ? Y2.jsx("p", { children: i }) : S.Children.only(i), [i]), v = (e = h.props.ref) != null ? e : h.ref, { onPress: g, isDisabled: b2, ...y2 } = S.useMemo(() => n(Io(u, h.props), v), [n, h.props, u, v]), [, _2] = qy(i, gb), { buttonProps: K2 } = Uw({ onPress: g, isDisabled: b2 }, a), R3 = S.useMemo(() => (_2 == null ? void 0 : _2[0]) !== void 0, [_2]);
    return R3 || delete y2.preventFocusOnPress, S.cloneElement(h, Io(y2, R3 ? { onPress: g, isDisabled: b2 } : K2));
  };
  nn3.displayName = "HeroUI.PopoverTrigger";
  var _i2 = nn3;
  var ln2 = qn2((o, e) => {
    const { children: a, ...n } = o, i = Si3({ ...n, ref: e }), [u, h] = S.Children.toArray(a), v = Y2.jsx(dp, { portalContainer: i.portalContainer, children: h });
    return Y2.jsxs(Ci2, { value: i, children: [u, i.disableAnimation && i.isOpen ? v : Y2.jsx(mm, { children: i.isOpen ? v : null })] });
  });
  ln2.displayName = "HeroUI.Popover";
  var Pi2 = ln2;
  function zi2(o, e, a) {
    let { item: n, isDisabled: i } = o, u = n.key, h = e.selectionManager, v = S.useId(), g = S.useId(), b2 = e.disabledKeys.has(n.key) || i;
    S.useEffect(() => {
      u === e.focusedKey && document.activeElement !== a.current && a.current && di2(a.current);
    }, [a, u, e.focusedKey]);
    let y2 = S.useCallback((I2) => {
      h.canSelectItem(u) && (h.select(u, I2), e.toggleKey(u));
    }, [u, h]);
    const _2 = S.useCallback((I2) => {
      h.selectionBehavior === "replace" && h.extendSelection(I2), h.setFocusedKey(I2);
    }, [h]), K2 = S.useCallback((I2) => {
      const z2 = { ArrowDown: () => {
        const E = e.collection.getKeyAfter(u);
        if (E && e.disabledKeys.has(E)) {
          const M = e.collection.getKeyAfter(E);
          M && _2(M);
        } else E && _2(E);
      }, ArrowUp: () => {
        const E = e.collection.getKeyBefore(u);
        if (E && e.disabledKeys.has(E)) {
          const M = e.collection.getKeyBefore(E);
          M && _2(M);
        } else E && _2(E);
      }, Home: () => {
        const E = e.collection.getFirstKey();
        E && _2(E);
      }, End: () => {
        const E = e.collection.getLastKey();
        E && _2(E);
      } }[I2.key];
      z2 && (I2.preventDefault(), h.canSelectItem(u) && z2(I2));
    }, [u, h]);
    let { buttonProps: R3 } = Il({ id: v, elementType: "button", isDisabled: b2, onKeyDown: K2, onPress: y2 }, a), F = e.selectionManager.isSelected(n.key);
    return { buttonProps: { ...R3, "aria-expanded": F, "aria-controls": F ? g : void 0 }, regionProps: { id: g, role: "region", "aria-labelledby": v } };
  }
  function Po2(o) {
    return lb() ? o.altKey : o.ctrlKey;
  }
  function jr(o, e) {
    var a, n;
    let i = `[data-key="${CSS.escape(String(e))}"]`, u = (a = o.current) === null || a === void 0 ? void 0 : a.dataset.collection;
    return u && (i = `[data-collection="${CSS.escape(u)}"]${i}`), (n = o.current) === null || n === void 0 ? void 0 : n.querySelector(i);
  }
  ...
  var Fi2 = 1e3;
  function Ri2(o) {
    let { keyboardDelegate: e, selectionManager: a, onTypeSelect: n } = o, i = S.useRef({ search: "", timeout: void 0 }).current, u = (h) => {
      let v = Ki2(h.key);
      if (!(!v || h.ctrlKey || h.metaKey || !h.currentTarget.contains(h.target) || i.search.length === 0 && v === " ")) {
        if (v === " " && i.search.trim().length > 0 && (h.preventDefault(), "continuePropagation" in h || h.stopPropagation()), i.search += v, e.getKeyForSearch != null) {
          let g = e.getKeyForSearch(i.search, a.focusedKey);
          g == null && (g = e.getKeyForSearch(i.search)), g != null && (a.setFocusedKey(g), n && n(g));
        }
  ...
  function Mi2(o) {
    let { selectionManager: e, keyboardDelegate: a, ref: n, autoFocus: i = false, shouldFocusWrap: u = false, disallowEmptySelection: h = false, disallowSelectAll: v = false, escapeKeyBehavior: g = "clearSelection", selectOnFocus: b2 = e.selectionBehavior === "replace", disallowTypeAhead: y2 = false, shouldUseVirtualFocus: _2, allowsTabNavigation: K2 = false, isVirtualized: R3, scrollRef: F = n, linkBehavior: I2 = "action" } = o, { direction: w2 } = s1(), z2 = Fp(), E = (A2) => {
      var W;
      if (A2.altKey && A2.key === "Tab" && A2.preventDefault(), !(!((W = n.current) === null || W === void 0) && W.contains(A2.target))) return;
      const V2 = (O3, fe2) => {
        if (O3 != null) {
          if (e.isLink(O3) && I2 === "selection" && b2 && !Po2(A2)) {
            dy.flushSync(() => {
              e.setFocusedKey(O3, fe2);
            });
            let he3 = jr(n, O3), Oe2 = e.getItemProps(O3);
            he3 && z2.open(he3, A2, Oe2.href, Oe2.routerOptions);
            return;
          }
          if (e.setFocusedKey(O3, fe2), e.isLink(O3) && I2 === "override") return;
          A2.shiftKey && e.selectionMode === "multiple" ? e.extendSelection(O3) : b2 && !Po2(A2) && e.replaceSelection(O3);
        }
      };
      switch (A2.key) {
        case "ArrowDown":
          if (a.getKeyBelow) {
            var q3, U3, se;
            let O3 = e.focusedKey != null ? (q3 = a.getKeyBelow) === null || q3 === void 0 ? void 0 : q3.call(a, e.focusedKey) : (U3 = a.getFirstKey) === null || U3 === void 0 ? void 0 : U3.call(a);
            O3 == null && u && (O3 = (se = a.getFirstKey) === null || se === void 0 ? void 0 : se.call(a, e.focusedKey)), O3 != null && (A2.preventDefault(), V2(O3));
          }
          break;
        case "ArrowUp":
          if (a.getKeyAbove) {
            var ce2, ee2, we2;
            let O3 = e.focusedKey != null ? (ce2 = a.getKeyAbove) === null || ce2 === void 0 ? void 0 : ce2.call(a, e.focusedKey) : (ee2 = a.getLastKey) === null || ee2 === void 0 ? void 0 : ee2.call(a);
            O3 == null && u && (O3 = (we2 = a.getLastKey) === null || we2 === void 0 ? void 0 : we2.call(a, e.focusedKey)), O3 != null && (A2.preventDefault(), V2(O3));
          }
          break;
        case "ArrowLeft":
          if (a.getKeyLeftOf) {
            var Fe2, Ee2, _e2;
            let O3 = e.focusedKey != null ? (Fe2 = a.getKeyLeftOf) === null || Fe2 === void 0 ? void 0 : Fe2.call(a, e.focusedKey) : null;
            O3 == null && u && (O3 = w2 === "rtl" ? (Ee2 = a.getFirstKey) === null || Ee2 === void 0 ? void 0 : Ee2.call(a, e.focusedKey) : (_e2 = a.getLastKey) === null || _e2 === void 0 ? void 0 : _e2.call(a, e.focusedKey)), O3 != null && (A2.preventDefault(), V2(O3, w2 === "rtl" ? "first" : "last"));
          }
          break;
        case "ArrowRight":
          if (a.getKeyRightOf) {
            var pe2, ye, de2;
            let O3 = e.focusedKey != null ? (pe2 = a.getKeyRightOf) === null || pe2 === void 0 ? void 0 : pe2.call(a, e.focusedKey) : null;
            O3 == null && u && (O3 = w2 === "rtl" ? (ye = a.getLastKey) === null || ye === void 0 ? void 0 : ye.call(a, e.focusedKey) : (de2 = a.getFirstKey) === null || de2 === void 0 ? void 0 : de2.call(a, e.focusedKey)), O3 != null && (A2.preventDefault(), V2(O3, w2 === "rtl" ? "last" : "first"));
          }
          break;
        case "Home":
          if (a.getFirstKey) {
            ...
            A2.preventDefault();
            let O3 = a.getFirstKey(e.focusedKey, tr2(A2));
            e.setFocusedKey(O3), O3 != null && (tr2(A2) && A2.shiftKey && e.selectionMode === "multiple" ? e.extendSelection(O3) : b2 && e.replaceSelection(O3));
          }
          break;
        case "End":
          if (a.getLastKey) {
            if (e.focusedKey === null && A2.shiftKey) return;
            A2.preventDefault();
            let O3 = a.getLastKey(e.focusedKey, tr2(A2));
            e.setFocusedKey(O3), O3 != null && (tr2(A2) && A2.shiftKey && e.selectionMode === "multiple" ? e.extendSelection(O3) : b2 && e.replaceSelection(O3));
          }
          break;
        case "PageDown":
          if (a.getKeyPageBelow && e.focusedKey != null) {
            let O3 = a.getKeyPageBelow(e.focusedKey);
            O3 != null && (A2.preventDefault(), V2(O3));
          }
          break;
        case "PageUp":
          if (a.getKeyPageAbove && e.focusedKey != null) {
            let O3 = a.getKeyPageAbove(e.focusedKey);
            O3 != null && (A2.preventDefault(), V2(O3));
          }
          break;
        case "a":
          tr2(A2) && e.selectionMode === "multiple" && v !== true && (A2.preventDefault(), e.selectAll());
          break;
        case "Escape":
          g === "clearSelection" && !h && e.selectedKeys.size !== 0 && (A2.stopPropagation(), A2.preventDefault(), e.clearSelection());
          break;
        case "Tab":
          if (!K2) {
            if (A2.shiftKey) n.current.focus();
            else {
              let O3 = Tn2(n.current, { tabbable: true }), fe2, he3;
              do
                he3 = O3.lastChild(), he3 && (fe2 = he3);
              while (he3);
              fe2 && !fe2.contains(document.activeElement) && _r(fe2);
            }
            break;
          }
      }
    }, M = S.useRef({ top: 0, left: 0 });
    Rr3(F, "scroll", R3 ? void 0 : () => {
      var A2, W, V2, q3;
      M.current = { top: (V2 = (A2 = F.current) === null || A2 === void 0 ? void 0 : A2.scrollTop) !== null && V2 !== void 0 ? V2 : 0, left: (q3 = (W = F.current) === null || W === void 0 ? void 0 : W.scrollLeft) !== null && q3 !== void 0 ? q3 : 0 };
    });
    let L3 = (A2) => {
      if (e.isFocused) {
      ...
      if (A2.currentTarget.contains(A2.target)) {
        if (e.setFocused(true), e.focusedKey == null) {
          var W, V2;
          let se = (ee2) => {
            ee2 != null && (e.setFocusedKey(ee2), b2 && !e.isSelected(ee2) && e.replaceSelection(ee2));
          }, ce2 = A2.relatedTarget;
          var q3, U3;
          ce2 && A2.currentTarget.compareDocumentPosition(ce2) & Node.DOCUMENT_POSITION_FOLLOWING ? se((q3 = e.lastSelectedKey) !== null && q3 !== void 0 ? q3 : (W = a.getLastKey) === null || W === void 0 ? void 0 : W.call(a)) : se((U3 = e.firstSelectedKey) !== null && U3 !== void 0 ? U3 : (V2 = a.getFirstKey) === null || V2 === void 0 ? void 0 : V2.call(a));
        } else !R3 && F.current && (F.current.scrollTop = M.current.top, F.current.scrollLeft = M.current.left);
        if (e.focusedKey != null && F.current) {
          let se = jr(n, e.focusedKey);
          se instanceof HTMLElement && (!se.contains(document.activeElement) && !_2 && _r(se), em() === "keyboard" && no(se, { containingElement: n.current }));
        }
      }
    }, H2 = (A2) => {
    ...
    Rr3(n, cl, _2 ? (A2) => {
      let { detail: W } = A2;
      A2.stopPropagation(), e.setFocused(true), (W == null ? void 0 : W.focusStrategy) === "first" && (N3.current = true);
    } : void 0);
    let B2 = $t2(() => {
      var A2, W;
      let V2 = (W = (A2 = a.getFirstKey) === null || A2 === void 0 ? void 0 : A2.call(a)) !== null && W !== void 0 ? W : null;
      if (V2 == null) {
        let q3 = mt2();
        dl(n.current), Uo(q3, null), e.collection.size > 0 && (N3.current = false);
      } else e.setFocusedKey(V2), N3.current = false;
    });
    ro(() => {
      N3.current && B2();
    }, [e.collection, B2]);
    let ae2 = $t2(() => {
      e.collection.size > 0 && (N3.current = false);
    });
    ro(() => {
      ae2();
    }, [e.focusedKey, ae2]), Rr3(n, sl, _2 ? (A2) => {
      var W;
      A2.stopPropagation(), e.setFocused(false), !((W = A2.detail) === null || W === void 0) && W.clearFocusKey && e.setFocusedKey(null);
    } : void 0);
    const re2 = S.useRef(i), ne2 = S.useRef(false);
    S.useEffect(() => {
      if (re2.current) {
        var A2, W;
        let U3 = null;
        var V2;
        i === "first" && (U3 = (V2 = (A2 = a.getFirstKey) === null || A2 === void 0 ? void 0 : A2.call(a)) !== null && V2 !== void 0 ? V2 : null);
        var q3;
        i === "last" && (U3 = (q3 = (W = a.getLastKey) === null || W === void 0 ? void 0 : W.call(a)) !== null && q3 !== void 0 ? q3 : null);
        ...
        e.setFocused(true), e.setFocusedKey(U3), U3 == null && !_2 && n.current && di2(n.current), e.collection.size > 0 && (re2.current = false, ne2.current = true);
      }
    });
    let le2 = S.useRef(e.focusedKey), J3 = S.useRef(null);
    S.useEffect(() => {
      if (e.isFocused && e.focusedKey != null && (e.focusedKey !== le2.current || ne2.current) && F.current && n.current) {
        let A2 = em(), W = jr(n, e.focusedKey);
        ...
        (A2 === "keyboard" || ne2.current) && (J3.current && cancelAnimationFrame(J3.current), J3.current = requestAnimationFrame(() => {
          F.current && (Vo(F.current, W), A2 !== "virtual" && no(W, { containingElement: n.current }));
        }));
      }
      !_2 && e.isFocused && e.focusedKey == null && le2.current != null && n.current && di2(n.current), le2.current = e.focusedKey, ne2.current = false;
    }), S.useEffect(() => () => {
      J3.current && cancelAnimationFrame(J3.current);
    }, []), Rr3(n, "react-aria-focus-scope-restore", (A2) => {
      A2.preventDefault(), e.setFocused(true);
    });
    let ie2 = { onKeyDown: E, onFocus: L3, onBlur: H2, onMouseDown(A2) {
      F.current === A2.target && A2.preventDefault();
    } }, { typeSelectProps: ge2 } = Ri2({ keyboardDelegate: a, selectionManager: e });
    y2 || (ie2 = nn2(ge2, ie2));
    let ue2;
    _2 || (ue2 = e.focusedKey == null ? 0 : -1);
    let Se2 = Ti2(e.collection);
  ...
  var zo2 = class {
    getItemRect(e) {
      ...
      if (!n) return null;
      let i = a.getBoundingClientRect(), u = n.getBoundingClientRect();
      return { x: u.left - i.left + a.scrollLeft, y: u.top - i.top + a.scrollTop, width: u.width, height: u.height };
    }
    getContentSize() {
    ...
    getVisibleRect() {
      let e = this.ref.current;
      var a, n, i, u;
      return { x: (a = e == null ? void 0 : e.scrollLeft) !== null && a !== void 0 ? a : 0, y: (n = e == null ? void 0 : e.scrollTop) !== null && n !== void 0 ? n : 0, width: (i = e == null ? void 0 : e.offsetWidth) !== null && i !== void 0 ? i : 0, height: (u = e == null ? void 0 : e.offsetHeight) !== null && u !== void 0 ? u : 0 };
    }
    constructor(e) {
      this.ref = e;
    }
  ...
  var Ii2 = class {
    ...
    findNextNonDisabled(e, a) {
      ...
      for (; n != null; ) {
        ...
        if ((i == null ? void 0 : i.type) === "item" && !this.isDisabled(i)) return n;
        n = a(n);
      }
      return null;
    }
    ...
    findKey(e, a, n) {
      let i = e, u = this.layoutDelegate.getItemRect(i);
      if (!u || i == null) return null;
      let h = u;
      do {
        if (i = a(i), i == null) break;
        u = this.layoutDelegate.getItemRect(i);
      } while (u && n(h, u) && i != null);
      return i;
    }
    isSameRow(e, a) {
    ...
    getKeyPageAbove(e) {
      ...
      if (this.orientation === "horizontal") {
        ...
        for (; n && n.x > u && i != null; ) i = this.getKeyAbove(i), n = i == null ? null : this.layoutDelegate.getItemRect(i);
      } else {
        let u = Math.max(0, n.y + n.height - this.layoutDelegate.getVisibleRect().height);
        for (; n && n.y > u && i != null; ) i = this.getKeyAbove(i), n = i == null ? null : this.layoutDelegate.getItemRect(i);
      }
    ...
    getKeyPageBelow(e) {
      ...
      if (this.orientation === "horizontal") {
        ...
        for (; n && n.x < u && i != null; ) i = this.getKeyBelow(i), n = i == null ? null : this.layoutDelegate.getItemRect(i);
      } else {
        let u = Math.min(this.layoutDelegate.getContentSize().height, n.y - n.height + this.layoutDelegate.getVisibleRect().height);
        for (; n && n.y < u && i != null; ) i = this.getKeyBelow(i), n = i == null ? null : this.layoutDelegate.getItemRect(i);
      }
      return i ?? this.getLastKey();
    }
    getKeyForSearch(e, a) {
      if (!this.collator) return null;
      let n = this.collection, i = a || this.getFirstKey();
      for (; i != null; ) {
        let u = n.getItem(i);
        if (!u) return null;
        let h = u.textValue.slice(0, e.length);
        if (u.textValue && this.collator.compare(h, e) === 0) return i;
        i = this.getNextKey(i);
      }
      return null;
    }
    constructor(...e) {
      if (e.length === 1) {
        let a = e[0];
        this.collection = a.collection, this.ref = a.ref, this.collator = a.collator, this.disabledKeys = a.disabledKeys || /* @__PURE__ */ new Set(), this.disabledBehavior = a.disabledBehavior || "all", this.orientation = a.orientation || "vertical", this.direction = a.direction, this.layout = a.layout || "stack", this.layoutDelegate = a.layoutDelegate || new zo2(a.ref);
      } else this.collection = e[0], this.disabledKeys = e[1], this.ref = e[2], this.collator = e[3], this.layout = "stack", this.orientation = "vertical", this.disabledBehavior = "all", this.layoutDelegate = new zo2(this.ref);
      this.layout === "stack" && this.orientation === "vertical" && (this.getKeyLeftOf = void 0, this.getKeyRightOf = void 0);
    }
  };
  function ji2(o) {
    let { selectionManager: e, collection: a, disabledKeys: n, ref: i, keyboardDelegate: u, layoutDelegate: h } = o, v = fl({ usage: "search", sensitivity: "base" }), g = e.disabledBehavior, b2 = S.useMemo(() => u || new Ii2({ collection: a, disabledKeys: n, disabledBehavior: g, ref: i, collator: v, layoutDelegate: h }), [u, h, a, n, i, v, g]), { collectionProps: y2 } = Mi2({ ...o, ref: i, selectionManager: e, keyboardDelegate: b2 });
    return { listProps: y2 };
  }
  function Ai2(o, e, a) {
    let { listProps: n } = ji2({ ...o, ...e, allowsTabNavigation: true, disallowSelectAll: true, ref: a });
    return delete n.onKeyDownCapture, { accordionProps: { ...n, tabIndex: void 0 } };
  }
  function Di2(o) {
    var e, a;
    const n = wi2(), { ref: i, as: u, item: h, onFocusChange: v } = o, { state: g, className: b2, indicator: y2, children: _2, title: K2, subtitle: R3, startContent: F, motionProps: I2, focusedKey: w2, variant: z2, isCompact: E = false, classNames: M = {}, isDisabled: L3 = false, hideIndicator: H2 = false, disableAnimation: N3 = (e = n == null ? void 0 : n.disableAnimation) != null ? e : false, keepContentMounted: B2 = false, disableIndicatorAnimation: ae2 = false, HeadingComponent: re2 = u || "h2", onPress: ne2, onPressStart: le2, onPressEnd: J3, onPressChange: ie2, onPressUp: ge2, onClick: ue2, ...Se2 } = o, A2 = u || "div", W = typeof A2 == "string", V2 = Ar2(i), q3 = g.disabledKeys.has(h.key) || L3, U3 = g.selectionManager.isSelected(h.key), { buttonProps: se, regionProps: ce2 } = zi2({ item: h, isDisabled: q3 }, { ...g, focusedKey: w2 }, V2), { onFocus: ee2, onBlur: we2, ...Fe2 } = se, { isFocused: Ee2, isFocusVisible: _e2, focusProps: pe2 } = lm({ autoFocus: (a = h.props) == null ? void 0 : a.autoFocus }), { isHovered: ye, hoverProps: de2 } = Vy({ isDisabled: q3 }), { pressProps: O3, isPressed: fe2 } = Kp({ ref: V2, isDisabled: q3, onPress: ne2, onPressStart: le2, onPressEnd: J3, onPressChange: ie2, onPressUp: ge2 }), he3 = S.useCallback(() => {
      v == null || v(true, h.key);
    }, []), Oe2 = S.useCallback(() => {
      v == null || v(false, h.key);
    }, []), X2 = S.useMemo(() => ({ ...M }), [qs2(M)]), $e2 = S.useMemo(() => nl({ isCompact: E, isDisabled: q3, hideIndicator: H2, disableAnimation: N3, disableIndicatorAnimation: ae2, variant: z2 }), [E, q3, H2, N3, ae2, z2]), He2 = Nn(X2 == null ? void 0 : X2.base, b2), Ve3 = S.useCallback((Pe2 = {}) => ({ "data-open": lt2(U3), "data-disabled": lt2(q3), "data-slot": "base", className: $e2.base({ class: He2 }), ...Io(qf(Se2, { enabled: W }), Pe2) }), [He2, W, Se2, $e2, h.props, U3, q3]), Me2 = (Pe2 = {}) => {
      var rt2, Ue2;
      return { ref: V2, "data-open": lt2(U3), "data-focus": lt2(Ee2), "data-focus-visible": lt2(_e2), "data-disabled": lt2(q3), "data-hover": lt2(ye), "data-pressed": lt2(fe2), "data-slot": "trigger", className: $e2.trigger({ class: X2 == null ? void 0 : X2.trigger }), onFocus: rb(he3, ee2, pe2.onFocus, Se2.onFocus, (rt2 = h.props) == null ? void 0 : rt2.onFocus), onBlur: rb(Oe2, we2, pe2.onBlur, Se2.onBlur, (Ue2 = h.props) == null ? void 0 : Ue2.onBlur), ...Io(Fe2, de2, O3, Pe2, { onClick: Np(O3.onClick, ue2) }) };
    }, it2 = S.useCallback((Pe2 = {}) => ({ "data-open": lt2(U3), "data-disabled": lt2(q3), "data-slot": "content", className: $e2.content({ class: X2 == null ? void 0 : X2.content }), ...Io(ce2, Pe2) }), [$e2, X2, ce2, U3, q3, X2 == null ? void 0 : X2.content]), je2 = S.useCallback((Pe2 = {}) => ({ "aria-hidden": lt2(true), "data-open": lt2(U3), "data-disabled": lt2(q3), "data-slot": "indicator", className: $e2.indicator({ class: X2 == null ? void 0 : X2.indicator }), ...Pe2 }), [$e2, X2 == null ? void 0 : X2.indicator, U3, q3, X2 == null ? void 0 : X2.indicator]), Re3 = S.useCallback((Pe2 = {}) => ({ "data-open": lt2(U3), "data-disabled": lt2(q3), "data-slot": "heading", className: $e2.heading({ class: X2 == null ? void 0 : X2.heading }), ...Pe2 }), [$e2, X2 == null ? void 0 : X2.heading, U3, q3, X2 == null ? void 0 : X2.heading]), st2 = S.useCallback((Pe2 = {}) => ({ "data-open": lt2(U3), "data-disabled": lt2(q3), "data-slot": "title", className: $e2.title({ class: X2 == null ? void 0 : X2.title }), ...Pe2 }), [$e2, X2 == null ? void 0 : X2.title, U3, q3, X2 == null ? void 0 : X2.title]), ct2 = S.useCallback((Pe2 = {}) => ({ "data-open": lt2(U3), "data-disabled": lt2(q3), "data-slot": "subtitle", className: $e2.subtitle({ class: X2 == null ? void 0 : X2.subtitle }), ...Pe2 }), [$e2, X2, U3, q3, X2 == null ? void 0 : X2.subtitle]);
    return { Component: A2, HeadingComponent: re2, item: h, slots: $e2, classNames: X2, domRef: V2, indicator: y2, children: _2, title: K2, subtitle: R3, startContent: F, isOpen: U3, isDisabled: q3, hideIndicator: H2, keepContentMounted: B2, disableAnimation: N3, motionProps: I2, getBaseProps: Ve3, getHeadingProps: Re3, getButtonProps: Me2, getContentProps: it2, getIndicatorProps: je2, getTitleProps: st2, getSubtitleProps: ct2 };
  }
  var $o2 = () => ku(() => Promise.resolve().then(() => (init_index_chunk(), index_chunk_exports)), __vite__mapDeps2([0, 1, 2])).then((o) => o.default);
  var sn2 = qn2((o, e) => {
    const { Component: a, HeadingComponent: n, classNames: i, slots: u, indicator: h, children: v, title: g, subtitle: b2, startContent: y2, isOpen: _2, isDisabled: K2, hideIndicator: R3, keepContentMounted: F, disableAnimation: I2, motionProps: w2, getBaseProps: z2, getHeadingProps: E, getButtonProps: M, getTitleProps: L3, getSubtitleProps: H2, getContentProps: N3, getIndicatorProps: B2 } = Di2({ ...o, ref: e }), ae2 = kl(), ne2 = S.useMemo(() => typeof h == "function" ? h({ indicator: Y2.jsx(ho, {}), isOpen: _2, isDisabled: K2 }) : h || null, [h, _2, K2]) || Y2.jsx(ho, {}), le2 = S.useMemo(() => {
      if (I2) return F ? Y2.jsx("div", { ...N3(), children: v }) : _2 && Y2.jsx("div", { ...N3(), children: v });
      const J3 = { exit: { ...fb.collapse.exit, overflowY: "hidden" }, enter: { ...fb.collapse.enter, overflowY: "unset" } };
      return F ? Y2.jsx(gu, { features: $o2, children: Y2.jsx(bu.section, { animate: _2 ? "enter" : "exit", exit: "exit", initial: "exit", style: { willChange: ae2 }, variants: J3, onKeyDown: (ie2) => {
        ie2.stopPropagation();
      }, ...w2, children: Y2.jsx("div", { ...N3(), children: v }) }, "accordion-content") }) : Y2.jsx(mm, { initial: false, children: _2 && Y2.jsx(gu, { features: $o2, children: Y2.jsx(bu.section, { animate: "enter", exit: "exit", initial: "exit", style: { willChange: ae2 }, variants: J3, onKeyDown: (ie2) => {
        ie2.stopPropagation();
      }, ...w2, children: Y2.jsx("div", { ...N3(), children: v }) }, "accordion-content") }) });
    }, [_2, I2, F, v, w2]);
    return Y2.jsxs(a, { ...z2(), children: [Y2.jsx(n, { ...E(), children: Y2.jsxs("button", { ...M(), children: [y2 && Y2.jsx("div", { className: u.startContent({ class: i == null ? void 0 : i.startContent }), children: y2 }), Y2.jsxs("div", { className: u.titleWrapper({ class: i == null ? void 0 : i.titleWrapper }), children: [g && Y2.jsx("span", { ...L3(), children: g }), b2 && Y2.jsx("span", { ...H2(), children: b2 })] }), !R3 && ne2 && Y2.jsx("span", { ...B2(), children: ne2 })] }) }), le2] });
  });
  sn2.displayName = "HeroUI.AccordionItem";
  var Li2 = sn2;
  var Ni2 = class {
    *[Symbol.iterator]() {
      yield* this.iterable;
    ...
    constructor(e, { expandedKeys: a } = {}) {
      ...
      let n = (v) => {
        if (this.keyMap.set(v.key, v), v.childNodes && (v.type === "section" || a.has(v.key))) for (let g of v.childNodes) n(g);
      };
      for (let v of e) n(v);
      let i = null, u = 0;
      for (let [v, g] of this.keyMap) i ? (i.nextKey = v, g.prevKey = i.key) : (this.firstKey = v, g.prevKey = void 0), g.type === "item" && (g.index = u++), i = g, i.nextKey = void 0;
      var h;
      this.lastKey = (h = i == null ? void 0 : i.key) !== null && h !== void 0 ? h : null;
    }
  };
  ...
  function Bi2(o) {
    let { selectionMode: e = "none", disallowEmptySelection: a = false, allowDuplicateSelectionEvents: n, selectionBehavior: i = "toggle", disabledBehavior: u = "all" } = o, h = S.useRef(false), [, v] = S.useState(false), g = S.useRef(null), b2 = S.useRef(null), [, y2] = S.useState(null), _2 = S.useMemo(() => To2(o.selectedKeys), [o.selectedKeys]), K2 = S.useMemo(() => To2(o.defaultSelectedKeys, new Ge3()), [o.defaultSelectedKeys]), [R3, F] = Bp(_2, K2, o.onSelectionChange), I2 = S.useMemo(() => o.disabledKeys ? new Set(o.disabledKeys) : /* @__PURE__ */ new Set(), [o.disabledKeys]), [w2, z2] = S.useState(i);
    i === "replace" && w2 === "toggle" && typeof R3 == "object" && R3.size === 0 && z2("replace");
    let E = S.useRef(i);
    return S.useEffect(() => {
      i !== E.current && (z2(i), E.current = i);
    }, [i]), { selectionMode: e, disallowEmptySelection: a, selectionBehavior: w2, setSelectionBehavior: z2, get isFocused() {
      return h.current;
    }, setFocused(M) {
      h.current = M, v(M);
    }, get focusedKey() {
      ...
      return b2.current;
    }, setFocusedKey(M, L3 = "first") {
      g.current = M, b2.current = L3, y2(M);
    }, selectedKeys: R3, setSelectedKeys(M) {
      (n || !Oi2(M, R3)) && F(M);
    }, disabledKeys: I2, disabledBehavior: u };
  }
  function To2(o, e) {
  ...
  var Ta = class _Ta {
    ...
    get firstSelectedKey() {
      ...
      for (let n of this.state.selectedKeys) {
        let i = this.collection.getItem(n);
        (!e || i && ma(this.collection, i, e) < 0) && (e = i);
      }
      var a;
    ...
    extendSelection(e) {
      ...
      if (this.state.selectedKeys === "all") n = new Ge3([a], a, a);
        ...
        var i;
        let v = (i = h.anchorKey) !== null && i !== void 0 ? i : a;
        n = new Ge3(h, v, a);
        var u;
        for (let g of this.getKeyRange(v, (u = h.currentKey) !== null && u !== void 0 ? u : a)) n.delete(g);
        for (let g of this.getKeyRange(a, v)) this.canSelectItem(g) && n.add(g);
      }
      this.state.setSelectedKeys(n);
    }
    getKeyRange(e, a) {
      let n = this.collection.getItem(e), i = this.collection.getItem(a);
      return n && i ? ma(this.collection, n, i) <= 0 ? this.getKeyRangeInternal(e, a) : this.getKeyRangeInternal(a, e) : [];
    }
    getKeyRangeInternal(e, a) {
      ...
      for (; u != null; ) {
        ...
        if (h && (h.type === "item" || h.type === "cell" && this.allowsCellSelection) && i.push(u), u === a) return i;
    ...
    setSelectedKeys(e) {
      ...
      for (let n of e) {
        let i = this.getKey(n);
        if (i != null && (a.add(i), this.selectionMode === "single")) break;
      }
      ...
      let e = [], a = (n) => {
        for (; n != null; ) {
          if (this.canSelectItem(n)) {
            ...
            var u;
            h != null && h.hasChildNodes && (this.allowsCellSelection || h.type !== "item") && a((u = (i = hi3(fi3(h, this.collection))) === null || i === void 0 ? void 0 : i.key) !== null && u !== void 0 ? u : null);
          }
    ...
    withCollection(e) {
      return new _Ta(e, this.state, { allowsCellSelection: this.allowsCellSelection, layoutDelegate: this.layoutDelegate || void 0 });
    }
    constructor(e, a, n) {
      this.collection = e, this.state = a;
      var i;
      this.allowsCellSelection = (i = n == null ? void 0 : n.allowsCellSelection) !== null && i !== void 0 ? i : false, this._isSelectAll = null, this.layoutDelegate = (n == null ? void 0 : n.layoutDelegate) || null;
    }
  };
  function Hi2(o) {
    let { onExpandedChange: e } = o, [a, n] = Bp(o.expandedKeys ? new Set(o.expandedKeys) : void 0, o.defaultExpandedKeys ? new Set(o.defaultExpandedKeys) : /* @__PURE__ */ new Set(), e), i = Bi2(o), u = S.useMemo(() => o.disabledKeys ? new Set(o.disabledKeys) : /* @__PURE__ */ new Set(), [o.disabledKeys]), h = pi3(o, S.useCallback((g) => new Ni2(g, { expandedKeys: a }), [a]), null);
    return S.useEffect(() => {
      i.focusedKey != null && !h.getItem(i.focusedKey) && i.setFocusedKey(null);
    }, [h, i.focusedKey]), { collection: h, expandedKeys: a, disabledKeys: u, toggleKey: (g) => {
      n(Vi2(a, g));
    }, setExpandedKeys: n, selectionManager: new Ta(h, i) };
  }
  function Vi2(o, e) {
    let a = new Set(o);
  ...
  function Ui2(o) {
    var e;
    const a = wi2(), { ref: n, as: i, className: u, items: h, variant: v, motionProps: g, expandedKeys: b2, disabledKeys: y2, selectedKeys: _2, children: K2, defaultExpandedKeys: R3, selectionMode: F = "single", selectionBehavior: I2 = "toggle", keepContentMounted: w2 = false, disallowEmptySelection: z2, defaultSelectedKeys: E, onExpandedChange: M, onSelectionChange: L3, dividerProps: H2 = {}, isCompact: N3 = false, isDisabled: B2 = false, showDivider: ae2 = true, hideIndicator: re2 = false, disableAnimation: ne2 = (e = a == null ? void 0 : a.disableAnimation) != null ? e : false, disableIndicatorAnimation: le2 = false, itemClasses: J3, ...ie2 } = o, [ge2, ue2] = S.useState(null), Se2 = i || "div", A2 = typeof Se2 == "string", W = Ar2(n), V2 = S.useMemo(() => ol({ variant: v, className: u }), [v, u]), U3 = { children: S.useMemo(() => {
      let pe2 = [];
      return Re2.Children.map(K2, (ye) => {
        var de2;
        if (Re2.isValidElement(ye) && typeof ((de2 = ye.props) == null ? void 0 : de2.children) != "string") {
          const O3 = Re2.cloneElement(ye, { hasChildItems: false });
          pe2.push(O3);
        } else pe2.push(ye);
      }), pe2;
    }, [K2]), items: h }, se = { expandedKeys: b2, defaultExpandedKeys: R3, onExpandedChange: M }, ce2 = { disabledKeys: y2, selectedKeys: _2, selectionMode: F, selectionBehavior: I2, disallowEmptySelection: z2, defaultSelectedKeys: E ?? R3, onSelectionChange: L3, ...U3, ...se }, ee2 = Hi2(ce2);
    ee2.selectionManager.setFocusedKey = (pe2) => {
      ue2(pe2);
    };
    const { accordionProps: we2 } = Ai2({ ...U3, ...se }, ee2, W), Fe2 = S.useMemo(() => ({ state: ee2, focusedKey: ge2, motionProps: g, isCompact: N3, isDisabled: B2, hideIndicator: re2, disableAnimation: ne2, keepContentMounted: w2, disableIndicatorAnimation: le2 }), [ge2, N3, B2, re2, _2, ne2, w2, ee2 == null ? void 0 : ee2.expandedKeys.values, le2, ee2.expandedKeys.size, ee2.disabledKeys.size, g]), Ee2 = S.useCallback((pe2 = {}) => ({ ref: W, className: V2, "data-orientation": "vertical", ...Io(we2, qf(ie2, { enabled: A2 }), pe2) }), []), _e2 = S.useCallback((pe2, ye) => {
      pe2 && ue2(ye);
    }, []);
    return { Component: Se2, values: Fe2, state: ee2, focusedKey: ge2, getBaseProps: Ee2, isSplitted: v === "splitted", classNames: V2, showDivider: ae2, dividerProps: H2, disableAnimation: ne2, handleFocusChanged: _e2, itemClasses: J3 };
  }
  function Wi2(o) {
  ...
  function qi2(o) {
    const { as: e, className: a, orientation: n, ...i } = o;
    let u = e || "hr";
    u === "hr" && n === "vertical" && (u = "div");
    const { separatorProps: h } = Wi2({ elementType: typeof u == "string" ? u : "hr", orientation: n }), v = S.useMemo(() => al({ orientation: n, className: a }), [n, a]), g = S.useCallback((b2 = {}) => ({ className: v, role: "separator", "data-orientation": n, ...h, ...i, ...b2 }), [v, n, h, i]);
    return { Component: u, getDividerProps: g };
  }
  var cn2 = qn2((o, e) => {
    const { Component: a, getDividerProps: n } = qi2({ ...o });
    return Y2.jsx(a, { ref: e, ...n() });
  });
  cn2.displayName = "HeroUI.Divider";
  var Zi2 = cn2;
  var dn2 = qn2((o, e) => {
    const { Component: a, values: n, state: i, isSplitted: u, showDivider: h, getBaseProps: v, disableAnimation: g, handleFocusChanged: b2, itemClasses: y2, dividerProps: _2 } = Ui2({ ...o, ref: e }), K2 = S.useCallback((F, I2) => b2(F, I2), [b2]), R3 = S.useMemo(() => [...i.collection].map((F, I2) => {
      const w2 = { ...y2, ...F.props.classNames || {} };
      return Y2.jsxs(S.Fragment, { children: [Y2.jsx(Li2, { item: F, variant: o.variant, onFocusChange: K2, ...n, ...F.props, classNames: w2 }), !F.props.hidden && !u && h && I2 < i.collection.size - 1 && Y2.jsx(Zi2, { ..._2 })] }, F.key);
    }), [n, y2, K2, u, h, i.collection]);
    return Y2.jsx(a, { ...v(), children: g ? R3 : Y2.jsx(xl, { children: R3 }) });
  });
  dn2.displayName = "HeroUI.Accordion";
  var Yi2 = dn2;
  var Xi2 = ci3;
  var Gi2 = Xi2;
  var un2 = ({ items: o, isCompact: e, variant: a, defaultSelectedKeys: n, className: i, hideIndicator: u = true }) => {
    const h = S.useRef([]), [v, g] = S.useState(n ?? []), b2 = (y2) => {
      g((_2) => _2.includes(y2) ? _2.filter((K2) => K2 !== y2) : [..._2, y2]);
    };
    return S.useEffect(() => {
      h.current.forEach((y2, _2) => {
        if (y2) {
          const K2 = String(_2), R3 = () => b2(K2);
          return y2.addEventListener("click", R3), () => {
            y2.removeEventListener("click", R3);
          };
        }
      });
    }, []), Y2.jsx(Yi2, { isCompact: e, variant: a, selectedKeys: v, className: i, hideIndicator: u, children: o.map((y2, _2) => Y2.jsx(Gi2, { "aria-label": y2.label ? y2.label : `Accordion ${_2 + 1}`, title: Y2.jsx("div", { ref: (K2) => h.current[_2] = K2, children: y2.title }), hideIndicator: u, className: "w-full", children: y2.content }, _2)) });
  };
  var Fa = ((o) => (o.None = "auto", o.ZH_CN = "zh-CN", o.EN_US = "en-US", o.EN_GB = "en-GB", o.JA_JP = "ja-JP", o.KO_KR = "ko-KR", o.ES_ES = "es-ES", o.FR_FR = "fr-FR", o.DE_DE = "de-DE", o.RU_RU = "ru-RU", o.IT_IT = "it-IT", o.PT_PT = "pt-PT", o.PT_BR = "pt-BR", o.AR_SA = "ar-SA", o.HI_IN = "hi-IN", o))(Fa || {});
  var Ji2 = "https://translate.googleapis.com/translate_a/single";
  function Qi2(o, e, a, n) {
    const i = ["t", "bd", "ex", "qc", "rm", "ss", "md", "at"], h = [...Object.entries({ dj: "1", client: "gtx", hl: o, sl: e, tl: a, q: n }).map(([v, g]) => `${v}=${encodeURIComponent(g)}`), ...i.map((v) => `dt=${v}`)].join("&");
    return `${Ji2}?${h}`;
  }
  var es2 = (o) => {
  ...
  var rs2 = (o) => {
    if (o && o.sentences && o.sentences.length > 0) return o.sentences.filter((e) => e.orig && e.trans).map((e) => ({ origin: e.orig, translation: e.trans }));
  };
  var as2 = (o) => o.replace(/^([a-z])/, (e, a) => a.toUpperCase()).replace(/^<b>([a-z])/, (e, a) => "<b>" + a.toUpperCase());
  var os2 = (o) => {
    if (o && o.examples && o.examples.example && Array.isArray(o.examples.example) && o.examples.example.length > 0) return o.examples.example.map((e) => as2(e.text));
  };
  var ns2 = (o) => {
  ...
  var Ir3 = window.speechSynthesis;
  var Ra = () => {
    async function o(i, u, h) {
      const v = Qi2("en_US", h, u, i), g = await fetch(v, { method: "GET", headers: { Accept: "application/json" } });
      if (!g.ok) throw new Error(`Google Translate request failed: ${g.status} ${g.statusText}`);
      return await g.json();
    }
    async function e(i, u, h = "auto") {
      let v;
      i = i.trim();
      const g = /^[A-Za-z]+$/.test(i) && i.indexOf(" ") === -1, b2 = ls2(i);
      if (g && b2) {
        const y2 = i.toLowerCase();
        v = await o(y2, u, h), v.dict || (v = await o(i, u, h));
      } else v = await o(i, u, h);
      return { text: i, isWord: !!v.dict, phonetic: es2(v), dictionary: ts2(v), examples: os2(v), translation: ns2(v), sentences: rs2(v), raw: v };
    }
    function a(i, u, h = 1, v = 1) {
      if (!("speechSynthesis" in window)) throw new Error("SpeechSynthesis is not supported in this browser.");
      Ir3.speaking && Ir3.cancel();
      const g = new SpeechSynthesisUtterance(i);
      g.lang = u, g.rate = h, g.pitch = v, Ir3.speak(g);
    }
    function n() {
      Ir3.cancel();
    }
    return { translate: e, speakText: a, destroy: n };
  };
  var Br = Fa.EN_GB;
  var Hr = Fa.JA_JP;
  var is2 = ({ translateResult: o }) => {
    var n;
    const e = Ra(), a = (i, u) => {
      console.log("playTts");
      try {
        ...
        console.error("play TTS failed:", h);
      }
    };
    return S.useEffect(() => () => {
      console.log("Translation Component destoried"), e.destroy();
    }, []), Y2.jsxs(Y2.Fragment, { children: [o != null && o.translation ? Y2.jsx("div", { className: "rd-words-translation flex flex-col gap-3 overflow-hidden", children: Y2.jsx("div", { className: "rd-words-translation-item flex flex-row gap-2", children: Y2.jsxs("span", { className: "w-max text-lg font-bold", children: [(n = o.translation) == null ? void 0 : n.text, Y2.jsx("span", { className: "icon-voice stop inline-flex align-middle cursor-pointer ml-2 text-foreground", onClick: () => {
      var i;
      return a(((i = o.translation) == null ? void 0 : i.text) ?? "", Hr);
    }, children: Y2.jsx("svg", { width: "16", height: "16", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: Y2.jsx("path", { d: "M13 7.22049L9.60282 10H6V14H9.60282L13 16.7795V7.22049ZM8.88889 16H5C4.44772 16 4 15.5523 4 15V9.00001C4 8.44772 4.44772 8.00001 5 8.00001H8.88889L14.1834 3.66815C14.3971 3.49329 14.7121 3.52479 14.887 3.73851C14.9601 3.82784 15 3.93971 15 4.05513V19.9449C15 20.221 14.7761 20.4449 14.5 20.4449C14.3846 20.4449 14.2727 20.405 14.1834 20.3319L8.88889 16ZM18.8631 16.5911L17.4411 15.169C18.3892 14.4376 19 13.2901 19 12C19 10.5697 18.2493 9.31469 17.1203 8.6076L18.5589 7.169C20.0396 8.2616 21 10.0187 21 12C21 13.8422 20.1698 15.4904 18.8631 16.5911Z" }) }) })] }) }) }) : null, o != null && o.phonetic ? Y2.jsxs("div", { className: "rd-words-phonetic flex flex-row items-center gap-3 text-sm text-[hsl(var(--en-foreground-500))]", children: [Y2.jsx("div", { className: "pronuntion leading-3.5 border-1 border-solid border-gray-500 rounded-[20%] px-0.5", children: Y2.jsx("span", { children: "us" }) }), Y2.jsxs("div", { className: "phonetic flex flex-row items-center gap-3", children: ["/", o.phonetic, "/"] })] }) : null, o != null && o.dictionary ? o.dictionary.map((i) => Y2.jsxs("div", { className: "rd-words-translation flex flex-row gap-3", children: [Y2.jsx("div", { className: "rd-words-translation-item flex", children: Y2.jsx("span", { className: "text-success-600", children: i.pos }) }), Y2.jsx("div", { className: "rd-words-translation-item w-max", children: i.translation })] })) : null, o != null && o.examples ? Y2.jsx("div", { className: "rd-words-phonetic text-medium text-[hsl(var(--en-foreground-500))] overflow-clip", children: Y2.jsx(un2, { isCompact: true, variant: "bordered", className: "px-0", items: [{ title: "Examples", content: Y2.jsx("div", { className: "bg-background/20 rounded-xl flex flex-col gap-3 max-h-[28em] p-4 overflow-y-auto", children: o.examples.map((i, u) => Y2.jsxs("p", { children: [Y2.jsx("span", { children: u + 1 + ". " }), Y2.jsx("span", { className: "first-letter:uppercase text-foreground/90", dangerouslySetInnerHTML: { __html: i.replace("<b>", '<span class="font-bold">').replace("</b>", "</span>") } }), Y2.jsx("span", { className: "icon-voice stop inline-flex align-middle cursor-pointer ml-2 text-foreground", onClick: () => a(i.replace("<b>", "").replace("</b>", ""), Br), children: Y2.jsx("svg", { width: "16", height: "16", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: Y2.jsx("path", { d: "M13 7.22049L9.60282 10H6V14H9.60282L13 16.7795V7.22049ZM8.88889 16H5C4.44772 16 4 15.5523 4 15V9.00001C4 8.44772 4.44772 8.00001 5 8.00001H8.88889L14.1834 3.66815C14.3971 3.49329 14.7121 3.52479 14.887 3.73851C14.9601 3.82784 15 3.93971 15 4.05513V19.9449C15 20.221 14.7761 20.4449 14.5 20.4449C14.3846 20.4449 14.2727 20.405 14.1834 20.3319L8.88889 16ZM18.8631 16.5911L17.4411 15.169C18.3892 14.4376 19 13.2901 19 12C19 10.5697 18.2493 9.31469 17.1203 8.6076L18.5589 7.169C20.0396 8.2616 21 10.0187 21 12C21 13.8422 20.1698 15.4904 18.8631 16.5911Z" }) }) })] }, u)) }) }] }) }) : null] });
  };
  var ss2 = ({ translateResult: o }) => {
    var n;
    const e = Ra(), a = (i, u) => {
      console.log("playTts");
      try {
    ...
    return S.useEffect(() => () => {
      console.log("Translation Component destoried"), e.destroy();
    }, []), o ? Y2.jsxs("div", { className: "rd-words-translation flex flex-col gap-3 overflow-hidden", children: [Y2.jsx("div", { className: "rd-words-translation-item flex flex-row gap-2", children: Y2.jsxs("span", { className: "text-current/60 dark:text-current/75", children: [o.text, Y2.jsx("span", { className: "icon-voice stop inline-flex align-middle cursor-pointer ml-2 text-foreground", onClick: () => a(o.text, Br), children: Y2.jsx("svg", { width: "16", height: "16", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: Y2.jsx("path", { d: "M13 7.22049L9.60282 10H6V14H9.60282L13 16.7795V7.22049ZM8.88889 16H5C4.44772 16 4 15.5523 4 15V9.00001C4 8.44772 4.44772 8.00001 5 8.00001H8.88889L14.1834 3.66815C14.3971 3.49329 14.7121 3.52479 14.887 3.73851C14.9601 3.82784 15 3.93971 15 4.05513V19.9449C15 20.221 14.7761 20.4449 14.5 20.4449C14.3846 20.4449 14.2727 20.405 14.1834 20.3319L8.88889 16ZM18.8631 16.5911L17.4411 15.169C18.3892 14.4376 19 13.2901 19 12C19 10.5697 18.2493 9.31469 17.1203 8.6076L18.5589 7.169C20.0396 8.2616 21 10.0187 21 12C21 13.8422 20.1698 15.4904 18.8631 16.5911Z" }) }) })] }) }), Y2.jsx("div", { className: "rd-words-translation-item flex flex-row gap-2", children: Y2.jsxs("span", { className: "w-max", children: [(n = o.translation) == null ? void 0 : n.text, Y2.jsx("span", { className: "icon-voice stop inline-flex align-middle cursor-pointer ml-2 text-foreground", onClick: () => {
      var i;
      return a(((i = o.translation) == null ? void 0 : i.text) ?? "", Hr);
    }, children: Y2.jsx("svg", { width: "16", height: "16", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: Y2.jsx("path", { d: "M13 7.22049L9.60282 10H6V14H9.60282L13 16.7795V7.22049ZM8.88889 16H5C4.44772 16 4 15.5523 4 15V9.00001C4 8.44772 4.44772 8.00001 5 8.00001H8.88889L14.1834 3.66815C14.3971 3.49329 14.7121 3.52479 14.887 3.73851C14.9601 3.82784 15 3.93971 15 4.05513V19.9449C15 20.221 14.7761 20.4449 14.5 20.4449C14.3846 20.4449 14.2727 20.405 14.1834 20.3319L8.88889 16ZM18.8631 16.5911L17.4411 15.169C18.3892 14.4376 19 13.2901 19 12C19 10.5697 18.2493 9.31469 17.1203 8.6076L18.5589 7.169C20.0396 8.2616 21 10.0187 21 12C21 13.8422 20.1698 15.4904 18.8631 16.5911Z" }) }) })] }) }), o != null && o.sentences && o.sentences.length > 1 ? Y2.jsx("div", { className: "rd-words-phonetic text-medium text-[hsl(var(--en-foreground-500))] overflow-clip", children: Y2.jsx(un2, { isCompact: true, variant: "bordered", className: "px-0", items: [{ title: "Sentences", content: Y2.jsx("div", { className: "bg-background/20 rounded-xl flex flex-col gap-3 max-h-[28em] p-4 overflow-y-auto", children: o.sentences.map((i) => Y2.jsxs("div", { className: "rd-words-translation flex flex-col gap-3", children: [Y2.jsx("div", { className: "rd-words-translation-item flex flex-row gap-2", children: Y2.jsxs("span", { className: "text-current/60 dark:text-current/75", children: [i.origin, Y2.jsx("span", { className: "icon-voice stop inline-flex align-middle cursor-pointer ml-2 text-foreground", onClick: () => a(i.origin, Br), children: Y2.jsx("svg", { width: "16", height: "16", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: Y2.jsx("path", { d: "M13 7.22049L9.60282 10H6V14H9.60282L13 16.7795V7.22049ZM8.88889 16H5C4.44772 16 4 15.5523 4 15V9.00001C4 8.44772 4.44772 8.00001 5 8.00001H8.88889L14.1834 3.66815C14.3971 3.49329 14.7121 3.52479 14.887 3.73851C14.9601 3.82784 15 3.93971 15 4.05513V19.9449C15 20.221 14.7761 20.4449 14.5 20.4449C14.3846 20.4449 14.2727 20.405 14.1834 20.3319L8.88889 16ZM18.8631 16.5911L17.4411 15.169C18.3892 14.4376 19 13.2901 19 12C19 10.5697 18.2493 9.31469 17.1203 8.6076L18.5589 7.169C20.0396 8.2616 21 10.0187 21 12C21 13.8422 20.1698 15.4904 18.8631 16.5911Z" }) }) })] }) }), Y2.jsx("div", { className: "rd-words-translation-item flex flex-row gap-2", children: Y2.jsxs("span", { className: "w-max", children: [i.translation, Y2.jsx("span", { className: "icon-voice stop inline-flex align-middle cursor-pointer ml-2 text-foreground", onClick: () => a(i.translation, Hr), children: Y2.jsx("svg", { width: "16", height: "16", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: Y2.jsx("path", { d: "M13 7.22049L9.60282 10H6V14H9.60282L13 16.7795V7.22049ZM8.88889 16H5C4.44772 16 4 15.5523 4 15V9.00001C4 8.44772 4.44772 8.00001 5 8.00001H8.88889L14.1834 3.66815C14.3971 3.49329 14.7121 3.52479 14.887 3.73851C14.9601 3.82784 15 3.93971 15 4.05513V19.9449C15 20.221 14.7761 20.4449 14.5 20.4449C14.3846 20.4449 14.2727 20.405 14.1834 20.3319L8.88889 16ZM18.8631 16.5911L17.4411 15.169C18.3892 14.4376 19 13.2901 19 12C19 10.5697 18.2493 9.31469 17.1203 8.6076L18.5589 7.169C20.0396 8.2616 21 10.0187 21 12C21 13.8422 20.1698 15.4904 18.8631 16.5911Z" }) }) })] }) })] })) }) }] }) }) : null] }) : null;
  };
  var cs2 = ({ text: o }) => {
    const [e, a] = S.useState(void 0), n = Ra(), i = (h, v) => {
      try {
        n.translate(h, v).then((g) => {
          a(g), console.log("result\uFF1A", g), console.log("\u539F\u59CB\u6570\u636E\uFF1A", g.raw);
        });
      } catch (g) {
        console.error("translate failed:", g), a(void 0);
      }
    }, u = (h, v) => {
      console.log("playTts");
      try {
        ...
        console.error("play TTS failed:", g);
      }
    };
    return S.useEffect(() => (o !== (e == null ? void 0 : e.text) && a(void 0), e || i(o, Hr), () => {
      n.destroy();
    }), []), e ? Y2.jsxs("div", { className: U0("rd-theme rd-words-card xor auto lt-zh-CN flex flex-col min-w-[24em] max-w-[36em] p-5 gap-4"), children: [Y2.jsxs("div", { className: "rd-words-header flex flex-row justify-between items-center", children: [e != null && e.isWord ? Y2.jsxs("div", { className: "rd-words-translation-item flex flex-row gap-2 items-center", children: [Y2.jsx("div", { className: "rd-words text-current/60 font-bold text-xl", children: e.text }), Y2.jsx("div", { className: "icon-voice stop cursor-pointer text-foreground", onClick: () => u(e.text, Br), children: Y2.jsx("svg", { width: "16", height: "16", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "currentColor", children: Y2.jsx("path", { d: "M13 7.22049L9.60282 10H6V14H9.60282L13 16.7795V7.22049ZM8.88889 16H5C4.44772 16 4 15.5523 4 15V9.00001C4 8.44772 4.44772 8.00001 5 8.00001H8.88889L14.1834 3.66815C14.3971 3.49329 14.7121 3.52479 14.887 3.73851C14.9601 3.82784 15 3.93971 15 4.05513V19.9449C15 20.221 14.7761 20.4449 14.5 20.4449C14.3846 20.4449 14.2727 20.405 14.1834 20.3319L8.88889 16ZM18.8631 16.5911L17.4411 15.169C18.3892 14.4376 19 13.2901 19 12C19 10.5697 18.2493 9.31469 17.1203 8.6076L18.5589 7.169C20.0396 8.2616 21 10.0187 21 12C21 13.8422 20.1698 15.4904 18.8631 16.5911Z" }) }) })] }) : Y2.jsx("div", { className: "rd-words-header flex flex-row justify-between items-center", children: Y2.jsxs(db, { className: "flex items-center justify-start gap-1 ml-[-0.8em] mt-[-0.8em]", color: "foreground", children: [Y2.jsx(wb, { width: "1.5em", height: "1.5em" }), Y2.jsx("span", { className: "cursor-default select-none text-sm", children: "EasyNote" })] }) }), Y2.jsx("div", { className: "rd-words-action", children: Y2.jsxs("div", { className: "btn-action-group flex flex-row gap-3", children: [Y2.jsx("div", { className: "trancy-tippy btn-action", children: Y2.jsx("div", { className: "btn-words-action", children: Y2.jsx("div", { className: "t-icon icon-22", children: Y2.jsx("svg", { width: "1.5em", height: "1.5em", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 -960 960 960", fill: "hsl(var(--en-foreground-500))", children: Y2.jsx("path", { d: "M360-140.001q-91.538 0-155.768-64.231-64.231-64.23-64.231-155.768v-240q0-91.538 64.231-155.768 64.23-64.231 155.768-64.231h240q91.538 0 155.768 64.231 64.231 64.23 64.231 155.768v240q0 91.538-64.231 155.768-64.23 64.231-155.768 64.231H360Zm80-278.152-66.924-66.923q-8.307-8.308-20.884-8.5-12.576-.193-21.268 8.5-8.693 8.692-8.693 21.076t8.693 21.076l83.769 83.769q10.846 10.846 25.307 10.846 14.461 0 25.307-10.846l179.769-179.769q8.308-8.307 8.5-20.884.193-12.576-8.5-21.268-8.692-8.693-21.076-8.693t-21.076 8.693L440-418.153ZM360-200h240q66 0 113-47t47-113v-240q0-66-47-113t-113-47H360q-66 0-113 47t-47 113v240q0 66 47 113t113 47Zm120-280Z" }) }) }) }) }), Y2.jsx("div", { className: "trancy-tippy btn-action", children: Y2.jsx("div", { className: "btn-words-action", children: Y2.jsx("div", { className: "t-icon icon-20 heart-rd red", children: Y2.jsx("svg", { width: "1.5em", height: "1.5em", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 -960 960 960", fill: "var(--en-heart-red)", children: Y2.jsx("path", { d: "M479.615-171.617q-12.846 0-25.807-4.616-12.962-4.615-22.808-14.461l-57.46-52.23q-106.385-97-189.962-190.577Q100.001-527.078 100.001-634q0-85.153 57.423-142.576Q214.847-833.999 300-833.999q48.384 0 95.577 22.308 47.192 22.308 84.423 72.462 37.231-50.154 84.423-72.462 47.193-22.308 95.577-22.308 85.153 0 142.576 57.423Q859.999-719.153 859.999-634q0 108.076-85 202.73T585.46-242.309l-56.845 51.615q-9.846 9.846-23 14.461-13.154 4.616-26 4.616Z" }) }) }) }) })] }) })] }), e != null && e.isWord ? Y2.jsx(is2, { translateResult: e }) : Y2.jsx(ss2, { translateResult: e }), Y2.jsxs("div", { className: "rd-words-footer flex flex-row justify-between", children: [Y2.jsxs("div", { className: "rd-words-times flex flex-row gap-3 items-center", children: [Y2.jsx("div", { className: "t-icon icon-12", children: Y2.jsx("svg", { width: "1em", height: "1em", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 24 24", fill: "hsl(var(--en-foreground-500))", children: Y2.jsx("path", { d: "M12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12H4C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4C9.25022 4 6.82447 5.38734 5.38451 7.50024L8 7.5V9.5H2V3.5H4L3.99989 5.99918C5.82434 3.57075 8.72873 2 12 2ZM13 7L12.9998 11.585L16.2426 14.8284L14.8284 16.2426L10.9998 12.413L11 7H13Z" }) }) }), Y2.jsx("span", { className: "mg-1 text-tiny text-[hsl(var(--en-foreground-500))]", children: "1" })] }), Y2.jsx("div", { className: "rd-words-footer-action flex flex-row gap-3", children: Y2.jsx("div", { className: "rd-words-details tippy tippy-top", children: Y2.jsxs("svg", { width: "1.5em", height: "1.5em", viewBox: "0 0 24 24", fill: "hsl(var(--en-foreground-500))", xmlns: "http://www.w3.org/2000/svg", children: [Y2.jsx("path", { d: "M7.55768 21.5C6.71281 21.5 5.99198 21.2016 5.3952 20.6048C4.7984 20.008 4.5 19.2871 4.5 18.4423V5.75C4.5 4.84743 4.81602 4.08013 5.44807 3.44808C6.08012 2.81603 6.84743 2.5 7.75 2.5H17.6922C18.191 2.5 18.6169 2.67661 18.9701 3.02982C19.3233 3.38302 19.5 3.80898 19.5 4.3077V16.1404C19.5 16.3429 19.4461 16.5253 19.3384 16.6875C19.2307 16.8496 19.0891 16.9698 18.9134 17.048C18.6224 17.1519 18.3878 17.3307 18.2095 17.5846C18.0313 17.8384 17.9422 18.1243 17.9422 18.4423C17.9422 18.7538 18.0297 19.0407 18.2047 19.3029C18.3797 19.565 18.6128 19.7429 18.9038 19.8365C19.0756 19.9006 19.2179 19.9952 19.3307 20.1202C19.4435 20.2452 19.5 20.3987 19.5 20.5807V20.7346C19.5 20.9474 19.4281 21.1282 19.2845 21.2769C19.141 21.4256 18.9628 21.5 18.75 21.5H7.55768ZM5.99997 15.8443C6.22689 15.6891 6.47177 15.5737 6.7346 15.4981C6.99742 15.4224 7.27178 15.3846 7.55768 15.3846H18V4.3077C18 4.21795 17.9711 4.14423 17.9134 4.08653C17.8557 4.02883 17.782 3.99998 17.6922 3.99998H7.75C7.26922 3.99998 6.85735 4.17145 6.5144 4.5144C6.17145 4.85735 5.99997 5.26922 5.99997 5.75V15.8443ZM7.55768 20H16.9019C16.757 19.7731 16.6442 19.5324 16.5634 19.2779C16.4827 19.0234 16.4423 18.7448 16.4423 18.4423C16.4423 18.1564 16.4801 17.882 16.5558 17.6192C16.6314 17.3564 16.7468 17.1115 16.9019 16.8846H7.55768C7.11153 16.8846 6.74037 17.0368 6.4442 17.3413C6.14805 17.6458 5.99997 18.0128 5.99997 18.4423C5.99997 18.8884 6.14805 19.2596 6.4442 19.5558C6.74037 19.8519 7.11153 20 7.55768 20Z" }), Y2.jsx("path", { d: "M11.4935 12.1056L11.8144 11.3739C12.1001 10.7229 12.6141 10.2046 13.2553 9.92128L14.1387 9.53099C14.4195 9.40692 14.4195 9.00025 14.1387 8.87617L13.2829 8.49807C12.6252 8.20747 12.1019 7.66999 11.8212 6.9967L11.4961 6.21701C11.3755 5.92766 10.9738 5.92767 10.8532 6.21701L10.5281 6.99669C10.2474 7.66999 9.72411 8.20747 9.0664 8.49807L8.21064 8.87617C7.92979 9.00025 7.92979 9.40692 8.21064 9.53099L9.09399 9.92128C9.73522 10.2046 10.2493 10.7229 10.5349 11.3739L10.8558 12.1056C10.9792 12.3868 11.3702 12.3868 11.4935 12.1056ZM14.7066 13.887L14.7969 13.6811C14.9578 13.314 15.2476 13.0217 15.6091 12.8618L15.8872 12.7388C16.0376 12.6723 16.0376 12.4547 15.8872 12.3883L15.6247 12.2721C15.2538 12.1081 14.9588 11.805 14.8007 11.4254L14.708 11.203C14.6434 11.0479 14.428 11.0479 14.3634 11.203L14.2708 11.4254C14.1127 11.805 13.8177 12.1081 13.4468 12.2721L13.1843 12.3883C13.0339 12.4547 13.0339 12.6723 13.1843 12.7388L13.4623 12.8618C13.8239 13.0217 14.1137 13.314 14.2746 13.6811L14.3649 13.887C14.4309 14.0377 14.6406 14.0377 14.7066 13.887Z" })] }) }) })] })] }) : Y2.jsx(Xw, { size: "sm", color: "success" });
  };
  var xa = 3;
  var Vr2 = ((o) => (o[o.Forward = 0] = "Forward", o[o.Backward = 1] = "Backward", o))(Vr2 || {});
  var ds2 = ({ callback: o }) => {
    const e = () => o(us2());
  ...
  function us2() {
    ...
    const i = n.getBoundingClientRect(), u = document.createRange();
    u.setStart(e.endContainer, e.endOffset), u.setEnd(e.endContainer, e.endOffset);
    const h = u.getBoundingClientRect(), v = a ? 1 : 0;
    return a ? { flowDirection: v, coords: { top: i.top + window.scrollY - xa, left: i.left + window.scrollX }, text: o.toString() } : h.x === 0 && h.y === 0 && h.width === 0 && h.height === 0 ? { flowDirection: v, coords: { top: i.top + window.scrollY - xa, left: i.left + window.scrollX }, text: o.toString() } : { flowDirection: v, coords: { top: h.bottom + window.scrollY + xa, left: h.right + window.scrollX }, text: o.toString() };
  }
  var ps3 = ({ isVisible: o, flowDirection: e, text: a, isClickOnMeFuncRef: n }) => {
    const i = S.useRef(null), u = S.useRef(null), h = S.useRef(null), [v, g] = S.useState(document.body), [b2, y2] = S.useState(false), _2 = (R3) => {
      const F = R3.composedPath(), I2 = F && F.length > 0 ? F.at(0) : null, w2 = i.current, z2 = u.current;
      return I2 ? w2 && z2 ? w2 === I2 || w2.contains(I2) || z2 === I2 || z2.contains(I2) : false : true;
    }, K2 = () => {
      y2((R3) => !R3);
    };
    return S.useEffect(() => {
      const R3 = document.getElementById(tn3), F = R3 == null ? void 0 : R3.shadowRoot, I2 = F == null ? void 0 : F.getElementById("root");
      return I2 && g(I2), n.current = _2, o || y2(false), h.current && h.current.addEventListener("click", K2), () => {
        var w2;
        (w2 = h.current) == null || w2.removeEventListener("click", K2);
      };
    }, [o, h.current, b2]), Y2.jsx(pb, { ref: i, id: "NAVBAR", maxWidth: "sm", height: "2.75em", position: "sticky", className: "bg-background rounded-full outline-solid outline-current/6 outline-1 shadow-sm", classNames: { wrapper: "px-3 h-[var(--navbar-height)/2]" }, children: Y2.jsx(mb, { className: "flex", children: Y2.jsx(vb, { className: "flex", children: Y2.jsxs(Pi2, { ref: u, isOpen: o && b2, portalContainer: v, offset: 3, placement: e === Vr2.Backward ? "top" : "bottom", children: [Y2.jsx(_i2, { children: Y2.jsx(gb, { ref: h, isIconOnly: true, variant: "light", className: U0("min-w-8 w-8", b2 ? "text-current/100 aria-expanded:opacity-100" : "text-current/60 dark:text-current/75", "hover:text-current/100", "transition-colors duration-150 ease-in-out"), children: Y2.jsx(bb, { className: U0("w-4 h-4") }) }) }), Y2.jsx(Ei2, { className: U0("bg-background/90 dark:bg-background/80 subpixel-antialiased outline-solid outline-current/6 outline-1 box-border rounded-large shadow-medium", "subpixel-antialiased backdrop-blur backdrop-saturate-150"), children: Y2.jsx(cs2, { text: a }) })] }) }) }) });
  };
  var fs2 = () => {
    var I2, w2;
    const o = S.useRef(null), [e, a] = S.useState(false), [n, i] = S.useState({ top: 0, left: 0 }), [u, h] = S.useState(false), [v, g] = S.useState(false), b2 = S.useRef(null), y2 = S.useRef(null), _2 = (z2, E) => {
      u || (h(true), a(z2), i(E), y2.current && (clearTimeout(y2.current), y2.current = null), y2.current = setTimeout(() => {
        g(true);
      }, 250));
    }, K2 = () => {
      h(false), g(false), y2.current && (clearTimeout(y2.current), y2.current = null);
    }, R3 = () => {
      setTimeout(() => {
        o.current && _2(o.current.flowDirection === Vr2.Backward, o.current.coords);
      }, 50);
    }, F = (z2) => {
      u && b2.current && !b2.current(z2) && K2();
    };
    return S.useEffect(() => {
      const z2 = ds2({ callback: (E) => {
        o.current = E;
      } });
      return document.addEventListener("mouseup", R3), document.addEventListener("mousedown", F), () => {
        z2.destroy(), document.removeEventListener("mouseup", R3), document.removeEventListener("mousedown", F);
      };
    }, [u]), Y2.jsx(ii3, { children: Y2.jsx(S.StrictMode, { children: Y2.jsx("div", { className: U0("absolute z-[9999]  transition-transform duration-250 ease-in-out will-change-transform", "rounded-[12px] border-0 bg-transparent backface-visibility-hidden", u ? e ? "translate-x-[-50%] translate-y-[-100%]" : "translate-x-[-50%] translate-y-0" : "translate-x-[-50%] translate-y-[-50%] scale-[0.6]", v ? "pointer-events-auto" : "pointer-events-none"), style: { top: (n == null ? void 0 : n.top) ?? 0, left: (n == null ? void 0 : n.left) ?? 0 }, children: Y2.jsx("div", { className: U0("transition-opacity duration-250 ease-in-out will-change-opacity", "border-0 bg-transparent backface-visibility-hidden", u ? "opacity-100" : "opacity-0"), children: Y2.jsx(ps3, { isVisible: u, flowDirection: ((I2 = o.current) == null ? void 0 : I2.flowDirection) ?? Vr2.Forward, isClickOnMeFuncRef: b2, text: ((w2 = o.current) == null ? void 0 : w2.text) ?? "" }) }) }) }) });
  };
  var pn2 = "easynote-host";
  var or2 = document.getElementById(pn2);
  or2 || (or2 = document.createElement("div"), or2.id = pn2, document.documentElement.appendChild(or2));
  var hs3 = wg.createRoot(or2);
  hs3.render(Re2.createElement(fs2));
})();
/**
* @license React
